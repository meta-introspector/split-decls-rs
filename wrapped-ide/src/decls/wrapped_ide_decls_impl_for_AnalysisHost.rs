...
impl AnalysisHost {
    ...
    #[doc = " Returns a snapshot of the current state, which you can query for"]
    #[doc = " semantic information."]
    pub fn analysis(&self) -> Analysis {
        Analysis {
            db: self.db.clone(),
        }
    }
    #[doc = " Applies changes to the current state of the world. If there are"]
    #[doc = " outstanding snapshots, they will be canceled."]
    pub fn apply_change(&mut self, change: ChangeWithProcMacros) {
        self.db.apply_change(change);
    }
    #[doc = " NB: this clears the database"]
