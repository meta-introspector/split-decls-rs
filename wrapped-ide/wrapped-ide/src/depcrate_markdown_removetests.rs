...
macro_rules! Depcrate_markdown_removetests {
() => {
// Module: crate::markdown_remove
// Provides: {"tests"}
// Dependencies: {}
# [cfg (test)] mod tests { use expect_test :: expect ; use super :: * ; # [test] fn smoke_test () { let res = remove_markdown (r##"
...
"## ,) ; expect ! [[r#"
            ...
            For more information on the various types of functions and how they're used, consult the Rust book or the Reference."#]] . assert_eq (& res) ; } # [test] fn on_char_boundary () { expect ! ["a┘"] . assert_eq (& remove_markdown ("```text\na┘\n```")) ; expect ! ["وقار"] . assert_eq (& remove_markdown ("```\nوقار\n```\n")) ; } }
};
}
