// Generated macro for extend_single_word_in_comment_or_string (function)
macro_rules! Depcrate_extend_selectionextend_single_word_in_comment_or_string {
() => {
// Module: crate::extend_selection
// Provides: {"extend_single_word_in_comment_or_string"}
// Dependencies: {}
