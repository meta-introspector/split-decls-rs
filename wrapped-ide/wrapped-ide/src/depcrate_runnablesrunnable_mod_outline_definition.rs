// Generated macro for runnable_mod_outline_definition (function)
macro_rules! Depcrate_runnablesrunnable_mod_outline_definition {
() => {
// Module: crate::runnables
// Provides: {"runnable_mod_outline_definition"}
// Dependencies: {}
