// Generated macro for signature_help_for_tuple_expr (function)
macro_rules! Depcrate_signature_helpsignature_help_for_tuple_expr {
() => {
// Module: crate::signature_help
// Provides: {"signature_help_for_tuple_expr"}
// Dependencies: {}
