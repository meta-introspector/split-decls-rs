// Generated macro for highlight_closure_captures (function)
macro_rules! Depcrate_highlight_relatedhighlight_closure_captures {
() => {
// Module: crate::highlight_related
// Provides: {"highlight_closure_captures"}
// Dependencies: {}
