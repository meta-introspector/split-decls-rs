// Generated macro for signature_help_for_tuple_pat_ish (function)
macro_rules! Depcrate_signature_helpsignature_help_for_tuple_pat_ish {
() => {
// Module: crate::signature_help
// Provides: {"signature_help_for_tuple_pat_ish"}
// Dependencies: {}
