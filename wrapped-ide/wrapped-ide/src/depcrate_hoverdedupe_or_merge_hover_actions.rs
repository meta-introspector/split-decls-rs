// Generated macro for dedupe_or_merge_hover_actions (function)
macro_rules! Depcrate_hoverdedupe_or_merge_hover_actions {
() => {
// Module: crate::hover
// Provides: {"dedupe_or_merge_hover_actions"}
// Dependencies: {}
