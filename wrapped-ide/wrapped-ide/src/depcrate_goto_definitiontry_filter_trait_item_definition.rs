// Generated macro for try_filter_trait_item_definition (function)
macro_rules! Depcrate_goto_definitiontry_filter_trait_item_definition {
() => {
// Module: crate::goto_definition
// Provides: {"try_filter_trait_item_definition"}
// Dependencies: {}
