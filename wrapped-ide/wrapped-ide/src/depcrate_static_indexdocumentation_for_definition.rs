// Generated macro for documentation_for_definition (function)
macro_rules! Depcrate_static_indexdocumentation_for_definition {
() => {
// Module: crate::static_index
// Provides: {"documentation_for_definition"}
// Dependencies: {}
