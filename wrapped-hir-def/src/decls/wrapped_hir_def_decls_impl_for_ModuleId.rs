...
impl ModuleId {
    ...
    #[doc = " Returns the module containing `self`, either the parent `mod`, or the module (or block) containing"]
    #[doc = " the block, if `self` corresponds to a block expression."]
    ...
    #[doc = " Returns the [`CrateRootModuleId`] for this module if it is the crate root module."]
    ...
    #[doc = " Returns the [`CrateRootModuleId`] for this module."]
    pub fn derive_crate_root(&self) -> CrateRootModuleId {
        CrateRootModuleId { krate: self.krate }
    }
    #[doc = " Whether this module represents the crate root module"]
