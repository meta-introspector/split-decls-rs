// Generated macro for token_mapping_across_files (function)
macro_rules! Depcrate_macro_expansion_tests_mbetoken_mapping_across_files {
() => {
// Module: crate::macro_expansion_tests::mbe
// Provides: {"token_mapping_across_files"}
// Dependencies: {}
