// Generated macro for coerce_pointee_errors (function)
macro_rules! Depcrate_macro_expansion_tests_builtin_derive_macrocoerce_pointee_errors {
() => {
// Module: crate::macro_expansion_tests::builtin_derive_macro
// Provides: {"coerce_pointee_errors"}
// Dependencies: {}
