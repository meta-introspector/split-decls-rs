// Generated macro for test_partial_ord_expand (function)
macro_rules! Depcrate_macro_expansion_tests_builtin_derive_macrotest_partial_ord_expand {
() => {
// Module: crate::macro_expansion_tests::builtin_derive_macro
// Provides: {"test_partial_ord_expand"}
// Dependencies: {}
