...
impl<'db> Type<'db> {
    ...
    #[doc = " Checks that particular type `ty` implements `std::future::IntoFuture` or"]
    #[doc = " `std::future::Future` and returns the `Output` associated type."]
    #[doc = " This function is used in `.await` syntax completion."]
    ...
    #[doc = " This does **not** resolve `IntoFuture`, only `Future`."]
    ...
    #[doc = " This does **not** resolve `IntoIterator`, only `Iterator`."]
    ...
    #[doc = " Resolves the projection `<Self as IntoIterator>::IntoIter` and returns the resulting type"]
    ...
    #[doc = " Checks that particular type `ty` implements `std::ops::FnOnce`."]
    #[doc = ""]
    #[doc = " This function can be used to check if a particular type is callable, since FnOnce is a"]
    #[doc = " supertrait of Fn and FnMut, so all callable types implements at least FnOnce."]
    ...
    #[doc = " Returns types that this type dereferences to (including this type itself). The returned"]
    #[doc = " iterator won't yield the same type more than once even if the deref chain contains a cycle."]
    pub fn autoderef(
        &self,
        db: &'db dyn HirDatabase,
    ...
    #[doc = " Iterates its type arguments"]
    #[doc = ""]
    #[doc = " It iterates the actual type arguments when concrete types are used"]
    #[doc = " and otherwise the generic names."]
    #[doc = " It does not include `const` arguments."]
    #[doc = ""]
    #[doc = " For code, such as:"]
    #[doc = " ```text"]
    #[doc = " struct Foo<T, U>"]
    #[doc = ""]
    #[doc = " impl<U> Foo<String, U>"]
    #[doc = " ```"]
    #[doc = ""]
    #[doc = " It iterates:"]
    #[doc = " ```text"]
    ...
    #[doc = " Iterates its type and const arguments"]
    #[doc = ""]
    #[doc = " It iterates the actual type and const arguments when concrete types"]
    #[doc = " are used and otherwise the generic names."]
    #[doc = ""]
    #[doc = " For code, such as:"]
    #[doc = " ```text"]
    #[doc = " struct Foo<T, const U: usize, const X: usize>"]
    #[doc = ""]
    #[doc = " impl<U> Foo<String, U, 12>"]
    #[doc = " ```"]
    #[doc = ""]
    #[doc = " It iterates:"]
    #[doc = " ```text"]
    ...
    #[doc = " Combines lifetime indicators, type and constant parameters into a single `Iterator`"]
    ...
    #[doc = " Allows you to treat inherent and non-inherent methods differently."]
    #[doc = ""]
    #[doc = " Note that inherent methods may actually be trait methods! For example, in `dyn Trait`, the trait's methods"]
    #[doc = " are considered inherent methods."]
    ...
    #[doc = " Iterates over inherent methods."]
    #[doc = ""]
    #[doc = " In some circumstances, inherent methods methods may actually be trait methods!"]
    #[doc = " For example, when `dyn Trait` is a receiver, _trait_'s methods would be considered"]
    #[doc = " to be inherent methods."]
    # [tracing :: instrument (skip_all , fields (name = ? name))]
    ...
    #[doc = " If a type can be represented as `dyn Trait`, returns all traits accessible via this type,"]
    #[doc = " or an empty iterator otherwise."]
    ...
    #[doc = " Visits every type, including generic arguments, in this type. `callback` is called with type"]
    #[doc = " itself first, and then with its generic arguments."]
    ...
    #[doc = " Check if type unifies with another type."]
    #[doc = ""]
    #[doc = " Note that we consider placeholder types to unify with everything."]
    #[doc = " For example `Option<T>` and `Option<U>` unify although there is unresolved goal `T = U`."]
    ...
    #[doc = " Check if type unifies with another type eagerly making sure there are no unresolved goals."]
    #[doc = ""]
    #[doc = " This means that placeholder types are not considered to unify if there are any bounds set on"]
    #[doc = " them. For example `Option<T>` and `Option<U>` do not unify as we cannot show that `T = U`"]
    ...
    #[doc = " Returns unique `GenericParam`s contained in this type."]
