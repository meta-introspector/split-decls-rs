...
impl Module {
    #[doc = " Name of this module."]
    pub fn name(self, db: &dyn HirDatabase) -> Option<Name> {
        self.id.name(db)
    }
    #[doc = " Returns the crate this module is part of."]
    pub fn krate(self) -> Crate {
        Crate {
            id: self.id.krate(),
        }
    }
    #[doc = " Topmost parent of this module. Every module has a `crate_root`, but some"]
    #[doc = " might be missing `krate`. This can happen if a module's file is not included"]
    #[doc = " in the module tree of any target in `Cargo.toml`."]
    ...
    #[doc = " Iterates over all child modules."]
    ...
    #[doc = " Returns a `ModuleScope`: a set of items, visible in this module."]
    pub fn scope(
        self,
        db: &dyn HirDatabase,
    ...
    #[doc = " Fills `acc` with the module's diagnostics."]
    ...
    #[doc = " Finds a path that can be used to refer to the given item from within"]
    #[doc = " this module, if possible."]
    pub fn find_path(
        self,
        db: &dyn DefDatabase,
    ...
    #[doc = " Finds a path that can be used to refer to the given item from within"]
    #[doc = " this module, if possible. This is used for returning import paths for use-statements."]
