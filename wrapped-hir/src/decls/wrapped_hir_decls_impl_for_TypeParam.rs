...
impl TypeParam {
    ...
    #[doc = " Is this type parameter implicitly introduced (eg. `Self` in a trait or an `impl Trait`"]
    #[doc = " argument)?"]
    ...
    #[doc = " FIXME: this only lists trait bounds from the item defining the type"]
    #[doc = " parameter, not additional bounds that might be added e.g. by a method if"]
    #[doc = " the parameter comes from an impl!"]
