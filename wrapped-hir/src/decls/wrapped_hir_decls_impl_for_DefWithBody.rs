...
impl DefWithBody {
    ...
    #[doc = " Returns the type this def's body has to evaluate to."]
    ...
    #[doc = " A textual representation of the HIR of this def's body for debugging purposes."]
    pub fn debug_hir(self, db: &dyn HirDatabase) -> String {
        let body = db.body(self.id());
        body.pretty_print(db, self.id(), Edition::CURRENT)
    }
    #[doc = " A textual representation of the MIR of this def's body for debugging purposes."]
