# AST Trace: library/core/src/num/dec2flt/slow.rs
...
```rust
// SRC: library/core/src/num/dec2flt/slow.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=63 | LINES=105
