# AST Trace: compiler/rustc_mir_build/src/thir/util.rs
...
```rust
// SRC: compiler/rustc_mir_build/src/thir/util.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=22 | LINES=41
