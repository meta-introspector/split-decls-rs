# AST Trace: ../rust/compiler/rustc_driver_impl/src/lib.rs
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=8
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=5
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=6
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=19
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=5
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=2
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=default_translator | COMPLEXITY=2 | LINES=4
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=config | COMPLEXITY=16 | LINES=78
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=STRUCT | NAME=TimePassesCallbacks | COMPLEXITY=2 | LINES=5
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=config | COMPLEXITY=6 | LINES=13
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=diagnostics_registry | COMPLEXITY=2 | LINES=4
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=run_compiler | COMPLEXITY=84 | LINES=180
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=dump_feature_usage_metrics | COMPLEXITY=9 | LINES=13
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=make_output | COMPLEXITY=6 | LINES=10
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=make_input | COMPLEXITY=31 | LINES=38
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=handle_explain | COMPLEXITY=24 | LINES=34
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=show_md_content_with_pager | COMPLEXITY=40 | LINES=59
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=process_rlink | COMPLEXITY=42 | LINES=40
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=list_metadata | COMPLEXITY=13 | LINES=23
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=print_crate_info | COMPLEXITY=150 | LINES=229
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=unw | COMPLEXITY=4 | LINES=18
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=version_at_macro_invocation | COMPLEXITY=16 | LINES=34
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=usage | COMPLEXITY=23 | LINES=37
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=print_wall_help | COMPLEXITY=2 | LINES=11
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=describe_lints | COMPLEXITY=52 | LINES=126
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=describe_flag_categories | COMPLEXITY=17 | LINES=32
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=get_backend_from_raw_matches | COMPLEXITY=3 | LINES=21
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=describe_debug_flags | COMPLEXITY=2 | LINES=5
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=describe_codegen_flags | COMPLEXITY=2 | LINES=5
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=print_flag_list | COMPLEXITY=8 | LINES=15
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=handle_options | COMPLEXITY=47 | LINES=95
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=warn_on_confusing_output_filename_flag | COMPLEXITY=26 | LINES=44
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=parse_crate_attrs | COMPLEXITY=9 | LINES=15
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=catch_fatal_errors | COMPLEXITY=8 | LINES=15
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=catch_with_exit_code | COMPLEXITY=8 | LINES=9
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=ice_path | COMPLEXITY=3 | LINES=13
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=ice_path_with_config | COMPLEXITY=26 | LINES=35
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=install_ice_hook | COMPLEXITY=44 | LINES=86
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=report_ice | COMPLEXITY=63 | LINES=97
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=init_rustc_env_logger | COMPLEXITY=5 | LINES=6
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=init_logger | COMPLEXITY=8 | LINES=9
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=init_logger_with_additional_layer | COMPLEXITY=11 | LINES=18
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=install_ctrlc_handler | COMPLEXITY=8 | LINES=16
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=main | COMPLEXITY=6 | LINES=23
