# AST Trace: library/std/src/sys/random/getentropy.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fill_bytes | COMPLEXITY=13 | LINES=32

```rust
// SRC: library/std/src/sys/random/getentropy.rs
