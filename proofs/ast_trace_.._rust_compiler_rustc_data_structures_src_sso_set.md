# AST Trace: ../rust/compiler/rustc_data_structures/src/sso/set.rs

Generated 11 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=SsoHashSet | COMPLEXITY=3 | LINES=27
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=entry_to_key | COMPLEXITY=4 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=new | COMPLEXITY=16 | LINES=51
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=reserve | COMPLEXITY=24 | LINES=63
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=extend | COMPLEXITY=10 | LINES=21
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=extend | COMPLEXITY=7 | LINES=20
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=into_iter | COMPLEXITY=5 | LINES=10
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=into_iter | COMPLEXITY=5 | LINES=13
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=5 | LINES=9
