# AST Trace: compiler/rustc_symbol_mangling/src/lib.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=18 | LINES=67

```rust
// SRC: compiler/rustc_symbol_mangling/src/lib.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=symbol_name_for_instance_in_crate | COMPLEXITY=7 | LINES=17
