# AST Trace: compiler/rustc_public_bridge/src/lib.rs

Generated 16 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=48

```rust
// SRC: compiler/rustc_public_bridge/src/lib.rs
