# AST Trace: ../rust/compiler/rustc_mir_transform/src/unreachable_enum_branching.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=get_discriminant_local | COMPLEXITY=7 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=get_switched_on_type | COMPLEXITY=9 | LINES=26
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=variant_discriminants | COMPLEXITY=12 | LINES=28
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=99 | LINES=138
