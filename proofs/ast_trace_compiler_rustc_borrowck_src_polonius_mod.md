# AST Trace: compiler/rustc_borrowck/src/polonius/mod.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=10 | LINES=85

```rust
// SRC: compiler/rustc_borrowck/src/polonius/mod.rs
...
// MOD DECLARATION: constraints (from compiler/rustc_borrowck/src/polonius/mod.rs)
// REPLACED: mod constraints; -> use crate::constraints::*;
use crate::constraints::*;
// MOD DECLARATION: dump (from compiler/rustc_borrowck/src/polonius/mod.rs)
// REPLACED: mod dump; -> use crate::dump::*;
use crate::dump::*;
pub(crate) mod legacy;
// MOD DECLARATION: liveness_constraints (from compiler/rustc_borrowck/src/polonius/mod.rs)
// REPLACED: mod liveness_constraints; -> use crate::liveness_constraints::*;
use crate::liveness_constraints::*;
// MOD DECLARATION: loan_liveness (from compiler/rustc_borrowck/src/polonius/mod.rs)
// REPLACED: mod loan_liveness; -> use crate::loan_liveness::*;
use crate::loan_liveness::*;
// MOD DECLARATION: typeck_constraints (from compiler/rustc_borrowck/src/polonius/mod.rs)
// REPLACED: mod typeck_constraints; -> use crate::typeck_constraints::*;
use crate::typeck_constraints::*;
