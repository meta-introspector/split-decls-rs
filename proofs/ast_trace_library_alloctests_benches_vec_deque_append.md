# AST Trace: library/alloctests/benches/vec_deque_append.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=main | COMPLEXITY=15 | LINES=55

```rust
// SRC: library/alloctests/benches/vec_deque_append.rs
