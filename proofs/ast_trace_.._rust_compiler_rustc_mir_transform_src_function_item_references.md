# AST Trace: ../rust/compiler/rustc_mir_transform/src/function_item_references.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=run_lint | COMPLEXITY=6 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=FunctionItemRefChecker | COMPLEXITY=2 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=visit_terminator | COMPLEXITY=27 | LINES=37
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=check_bound_args | COMPLEXITY=86 | LINES=128
