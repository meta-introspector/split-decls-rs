# AST Trace: compiler/rustc_thread_pool/src/thread_pool/mod.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=8 | LINES=27

```rust
// SRC: compiler/rustc_thread_pool/src/thread_pool/mod.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=ThreadPool | COMPLEXITY=6 | LINES=36
