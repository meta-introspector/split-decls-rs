# AST Trace: library/coretests/tests/iter/adapters/skip_while.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_skip_while | COMPLEXITY=7 | LINES=31

```rust
// SRC: library/coretests/tests/iter/adapters/skip_while.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_iterator_skip_while_fold | COMPLEXITY=5 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_skip_while_try_fold | COMPLEXITY=4 | LINES=16
