# AST Trace: library/proc_macro/src/escape.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=escape_single_byte | COMPLEXITY=48 | LINES=74

```rust
// SRC: library/proc_macro/src/escape.rs
