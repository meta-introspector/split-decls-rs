# AST Trace: ../rust/library/coretests/tests/iter/adapters/take.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_take | COMPLEXITY=9 | LINES=30
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_iterator_take_nth | COMPLEXITY=10 | LINES=24
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_iterator_take_nth_back | COMPLEXITY=7 | LINES=21
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_take_advance_by | COMPLEXITY=3 | LINES=25
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_iterator_take_short | COMPLEXITY=9 | LINES=27
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_take_try_folds | COMPLEXITY=3 | LINES=25
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_byref_take_consumed_items | COMPLEXITY=2 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_exact_size_take_repeat | COMPLEXITY=3 | LINES=31
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_exact_size_take_repeat_with | COMPLEXITY=4 | LINES=28
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_reverse_on_zip | COMPLEXITY=14 | LINES=31
