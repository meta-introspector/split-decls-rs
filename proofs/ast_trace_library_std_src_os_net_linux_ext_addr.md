# AST Trace: library/std/src/os/net/linux_ext/addr.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=from_abstract_name | COMPLEXITY=22 | LINES=85

```rust
// SRC: library/std/src/os/net/linux_ext/addr.rs
