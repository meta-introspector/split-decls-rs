# AST Trace: ../rust/compiler/rustc_infer/src/infer/resolve.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=OpportunisticVarResolver | COMPLEXITY=7 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=new | COMPLEXITY=4 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=34 | LINES=37
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=OpportunisticRegionResolver | COMPLEXITY=5 | LINES=11
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=26 | LINES=34
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=fully_resolve | COMPLEXITY=3 | LINES=13
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=FullTypeResolver | COMPLEXITY=2 | LINES=4
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=49 | LINES=62
