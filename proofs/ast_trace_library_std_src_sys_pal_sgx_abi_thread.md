# AST Trace: library/std/src/sys/pal/sgx/abi/thread.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=current | COMPLEXITY=24 | LINES=32

```rust
// SRC: library/std/src/sys/pal/sgx/abi/thread.rs
