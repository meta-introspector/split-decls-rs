# AST Trace: compiler/rustc_trait_selection/src/traits/select/_match.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/select/_match.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=9 | LINES=21
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=32 | LINES=85
