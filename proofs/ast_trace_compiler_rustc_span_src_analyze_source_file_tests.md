# AST Trace: compiler/rustc_span/src/analyze_source_file/tests.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$test_name | COMPLEXITY=13 | LINES=40

```rust
// SRC: compiler/rustc_span/src/analyze_source_file/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=84
