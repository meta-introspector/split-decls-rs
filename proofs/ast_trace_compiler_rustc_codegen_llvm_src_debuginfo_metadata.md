# AST Trace: compiler/rustc_codegen_llvm/src/debuginfo/metadata.rs
...
```rust
// SRC: compiler/rustc_codegen_llvm/src/debuginfo/metadata.rs
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=14 | LINES=23
