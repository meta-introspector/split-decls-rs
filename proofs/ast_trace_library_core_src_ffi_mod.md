# AST Trace: library/core/src/ffi/mod.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=8 | LINES=46

```rust
// SRC: library/core/src/ffi/mod.rs
...
// MOD DECLARATION: primitives (from library/core/src/ffi/mod.rs)
// REPLACED: mod primitives; -> use crate::primitives::*;
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=6 | LINES=29
