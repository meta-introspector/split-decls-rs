# AST Trace: compiler/rustc_codegen_ssa/src/traits/consts.rs
...
```rust
// SRC: compiler/rustc_codegen_ssa/src/traits/consts.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=const_null | COMPLEXITY=8 | LINES=43
