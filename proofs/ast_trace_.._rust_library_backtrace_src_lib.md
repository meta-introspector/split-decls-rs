# AST Trace: ../rust/library/backtrace/src/lib.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=16 | LINES=40
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=10
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=20
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=Bomb | COMPLEXITY=2 | LINES=5
