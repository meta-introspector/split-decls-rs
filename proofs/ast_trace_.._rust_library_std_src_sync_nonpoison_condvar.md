# AST Trace: ../rust/library/std/src/sync/nonpoison/condvar.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=14
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Condvar | COMPLEXITY=2 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=wait | COMPLEXITY=127 | LINES=382
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=default | COMPLEXITY=5 | LINES=8
