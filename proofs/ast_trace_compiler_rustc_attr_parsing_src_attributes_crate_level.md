# AST Trace: compiler/rustc_attr_parsing/src/attributes/crate_level.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=parse_limit_int | COMPLEXITY=20 | LINES=54

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/crate_level.rs
