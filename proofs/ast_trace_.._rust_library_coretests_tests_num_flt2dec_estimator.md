# AST Trace: ../rust/library/coretests/tests/num/flt2dec/estimator.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_estimate_scaling_factor | COMPLEXITY=29 | LINES=64
