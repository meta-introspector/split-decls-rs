# AST Trace: ../rust/compiler/rustc_ast/src/util/parser.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=15
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=from_token | COMPLEXITY=58 | LINES=110
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=3 | LINES=34
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=prec_let_scrutinee_needs_par | COMPLEXITY=2 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=needs_par_as_let_scrutinee | COMPLEXITY=2 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=3
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=1
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=contains_exterior_struct_lit | COMPLEXITY=16 | LINES=29
