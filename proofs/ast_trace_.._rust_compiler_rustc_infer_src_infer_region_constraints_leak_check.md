# AST Trace: ../rust/compiler/rustc_infer/src/infer/region_constraints/leak_check.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=leak_check | COMPLEXITY=36 | LINES=86
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=LeakCheck | COMPLEXITY=16 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=new | COMPLEXITY=97 | LINES=155
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=SccUniverse | COMPLEXITY=19 | LINES=48
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=take_min | COMPLEXITY=6 | LINES=11
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=MiniGraph | COMPLEXITY=4 | LINES=12
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=new | COMPLEXITY=30 | LINES=59
