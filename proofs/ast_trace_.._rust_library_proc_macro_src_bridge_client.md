# AST Trace: ../rust/library/proc_macro/src/bridge/client.rs

Generated 20 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=49 | LINES=99
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=clone | COMPLEXITY=5 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=5 | LINES=14
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=13 | LINES=28
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Bridge | COMPLEXITY=6 | LINES=13
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=1
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=RestoreOnDrop(*const | COMPLEXITY=20 | LINES=42
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=with | COMPLEXITY=6 | LINES=12
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=4
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=Client | COMPLEXITY=5 | LINES=20
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=clone | COMPLEXITY=5 | LINES=5
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=maybe_install_panic_hook | COMPLEXITY=10 | LINES=18
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=run_client | COMPLEXITY=20 | LINES=50
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=5 | LINES=12
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=7 | LINES=16
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=20
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=name | COMPLEXITY=18 | LINES=32
