# AST Trace: library/compiler-builtins/libm/src/math/sinf.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/sinf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sinf | COMPLEXITY=55 | LINES=77
