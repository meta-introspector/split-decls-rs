# AST Trace: ../rust/compiler/rustc_codegen_gcc/build_system/src/config.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=as_str | COMPLEXITY=7 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=failed_config_parsing | COMPLEXITY=4 | LINES=4
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=ConfigFile | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=38 | LINES=59
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=ConfigInfo | COMPLEXITY=10 | LINES=28
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=parse_argument | COMPLEXITY=244 | LINES=366
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=download_gccjit | COMPLEXITY=31 | LINES=61
