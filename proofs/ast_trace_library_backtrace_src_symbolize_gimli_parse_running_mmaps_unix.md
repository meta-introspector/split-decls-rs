# AST Trace: library/backtrace/src/symbolize/gimli/parse_running_mmaps_unix.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=22 | LINES=71

```rust
// SRC: library/backtrace/src/symbolize/gimli/parse_running_mmaps_unix.rs
