# AST Trace: compiler/rustc_codegen_cranelift/src/pointer.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=8 | LINES=29

```rust
// SRC: compiler/rustc_codegen_cranelift/src/pointer.rs
