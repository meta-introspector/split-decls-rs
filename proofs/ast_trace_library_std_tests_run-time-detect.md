# AST Trace: library/std/tests/run-time-detect.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=arm_linux | COMPLEXITY=10 | LINES=50

```rust
// SRC: library/std/tests/run-time-detect.rs
