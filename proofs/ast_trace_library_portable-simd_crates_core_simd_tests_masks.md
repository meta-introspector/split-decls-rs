# AST Trace: library/portable-simd/crates/core_simd/tests/masks.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=set_and_test | COMPLEXITY=38 | LINES=153

```rust
// SRC: library/portable-simd/crates/core_simd/tests/masks.rs
