# AST Trace: compiler/rustc_ast_pretty/src/helpers.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=word_space | COMPLEXITY=19 | LINES=66

```rust
// SRC: compiler/rustc_ast_pretty/src/helpers.rs
