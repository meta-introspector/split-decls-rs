# AST Trace: library/backtrace/tests/smoke.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=get_actual_fn_pointer | COMPLEXITY=16 | LINES=41

```rust
// SRC: library/backtrace/tests/smoke.rs
