# AST Trace: compiler/rustc_mir_transform/src/check_inline_always_target_features.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/check_inline_always_target_features.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=run_lint | COMPLEXITY=5 | LINES=10
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=check_inline_always_target_features | COMPLEXITY=41 | LINES=74
