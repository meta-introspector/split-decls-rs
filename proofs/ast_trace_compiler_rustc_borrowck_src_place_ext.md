# AST Trace: compiler/rustc_borrowck/src/place_ext.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/place_ext.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=ignore_borrow | COMPLEXITY=48 | LINES=68
