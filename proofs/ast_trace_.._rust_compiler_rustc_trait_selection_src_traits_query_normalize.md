# AST Trace: ../rust/compiler/rustc_trait_selection/src/traits/query/normalize.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=query_normalize | COMPLEXITY=42 | LINES=94
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=MaxEscapingBoundVarVisitor | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=visit_binder | COMPLEXITY=24 | LINES=36
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=QueryNormalizer | COMPLEXITY=2 | LINES=10
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=99 | LINES=188
