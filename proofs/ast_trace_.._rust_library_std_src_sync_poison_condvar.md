# AST Trace: ../rust/library/std/src/sync/poison/condvar.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=17
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=13
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Condvar | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=wait | COMPLEXITY=162 | LINES=441
