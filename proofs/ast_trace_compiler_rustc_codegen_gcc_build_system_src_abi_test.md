# AST Trace: compiler/rustc_codegen_gcc/build_system/src/abi_test.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=show_usage | COMPLEXITY=4 | LINES=29

```rust
// SRC: compiler/rustc_codegen_gcc/build_system/src/abi_test.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=run | COMPLEXITY=23 | LINES=53
