# AST Trace: compiler/rustc_codegen_cranelift/example/std_example.rs

Generated 32 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=main | COMPLEXITY=56 | LINES=200

```rust
// SRC: compiler/rustc_codegen_cranelift/example/std_example.rs
