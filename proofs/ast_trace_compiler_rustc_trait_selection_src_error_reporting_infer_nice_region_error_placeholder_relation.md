# AST Trace: compiler/rustc_trait_selection/src/error_reporting/infer/nice_region_error/placeholder_relation.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/error_reporting/infer/nice_region_error/placeholder_relation.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=46 | LINES=82
