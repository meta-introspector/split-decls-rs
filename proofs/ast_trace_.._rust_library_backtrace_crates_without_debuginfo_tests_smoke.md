# AST Trace: ../rust/library/backtrace/crates/without_debuginfo/tests/smoke.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=all_frames_have_symbols | COMPLEXITY=19 | LINES=29
