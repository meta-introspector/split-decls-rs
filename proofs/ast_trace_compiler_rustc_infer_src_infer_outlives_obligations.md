# AST Trace: compiler/rustc_infer/src/infer/outlives/obligations.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=51

```rust
// SRC: compiler/rustc_infer/src/infer/outlives/obligations.rs
