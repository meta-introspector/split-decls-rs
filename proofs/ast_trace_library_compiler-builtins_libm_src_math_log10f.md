# AST Trace: library/compiler-builtins/libm/src/math/log10f.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log10f | COMPLEXITY=23 | LINES=107

```rust
// SRC: library/compiler-builtins/libm/src/math/log10f.rs
