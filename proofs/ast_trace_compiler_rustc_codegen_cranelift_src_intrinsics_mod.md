# AST Trace: compiler/rustc_codegen_cranelift/src/intrinsics/mod.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=14 | LINES=30

```rust
// SRC: compiler/rustc_codegen_cranelift/src/intrinsics/mod.rs
