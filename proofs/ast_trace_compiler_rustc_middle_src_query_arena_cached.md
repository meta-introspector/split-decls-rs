# AST Trace: compiler/rustc_middle/src/query/arena_cached.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=alloc_in_arena | COMPLEXITY=7 | LINES=37

```rust
// SRC: compiler/rustc_middle/src/query/arena_cached.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=alloc_in_arena | COMPLEXITY=5 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=alloc_in_arena | COMPLEXITY=5 | LINES=14
