# AST Trace: compiler/rustc_codegen_gcc/src/builder.rs
...
```rust
// SRC: compiler/rustc_codegen_gcc/src/builder.rs
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=build | COMPLEXITY=484 | LINES=1303
