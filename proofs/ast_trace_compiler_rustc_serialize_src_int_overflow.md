# AST Trace: compiler/rustc_serialize/src/int_overflow.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=debug_strict_add | COMPLEXITY=7 | LINES=34

```rust
// SRC: compiler/rustc_serialize/src/int_overflow.rs
