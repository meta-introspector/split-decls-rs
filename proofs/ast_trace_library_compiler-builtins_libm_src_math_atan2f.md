# AST Trace: library/compiler-builtins/libm/src/math/atan2f.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/atan2f.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=atan2f | COMPLEXITY=58 | LINES=74
