# AST Trace: compiler/rustc_codegen_ssa/src/back/mod.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=versioned_llvm_target | COMPLEXITY=11 | LINES=47

```rust
// SRC: compiler/rustc_codegen_ssa/src/back/mod.rs
