# AST Trace: compiler/rustc_codegen_ssa/src/mir/mod.rs
...
```rust
// SRC: compiler/rustc_codegen_ssa/src/mir/mod.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=35

```rust
use crate::base;
use crate::traits::*;

// MOD DECLARATION: analyze (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod analyze; -> use crate::analyze::*;
use crate::analyze::*;
// MOD DECLARATION: block (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod block; -> use crate::block::*;
use crate::block::*;
// MOD DECLARATION: constant (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod constant; -> use crate::constant::*;
use crate::constant::*;
// MOD DECLARATION: coverageinfo (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod coverageinfo; -> use crate::coverageinfo::*;
use crate::coverageinfo::*;
pub mod debuginfo;
// MOD DECLARATION: intrinsic (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod intrinsic; -> use crate::intrinsic::*;
use crate::intrinsic::*;
// MOD DECLARATION: locals (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod locals; -> use crate::locals::*;
use crate::locals::*;
pub mod naked_asm;
pub mod operand;
pub mod place;
// MOD DECLARATION: rvalue (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod rvalue; -> use crate::rvalue::*;
use crate::rvalue::*;
// MOD DECLARATION: statement (from compiler/rustc_codegen_ssa/src/mir/mod.rs)
// REPLACED: mod statement; -> use crate::statement::*;
use crate::statement::*;
