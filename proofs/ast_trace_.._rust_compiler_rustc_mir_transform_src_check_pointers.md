# AST Trace: ../rust/compiler/rustc_mir_transform/src/check_pointers.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=6 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=39 | LINES=101
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=PointerFinder | COMPLEXITY=2 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=12 | LINES=45
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=visit_place | COMPLEXITY=37 | LINES=52
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=split_block | COMPLEXITY=3 | LINES=16
