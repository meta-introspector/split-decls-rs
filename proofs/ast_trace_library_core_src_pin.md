# AST Trace: library/core/src/pin.rs

Generated 71 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=28 | LINES=97

```rust
// SRC: library/core/src/pin.rs
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=28 | LINES=93

```rust
// MOD DECLARATION: unsafe_pinned (from library/core/src/pin.rs)
// REPLACED: mod unsafe_pinned; -> use crate::unsafe_pinned::*;
use crate::unsafe_pinned::*;
