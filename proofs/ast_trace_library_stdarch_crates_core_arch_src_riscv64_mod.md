# AST Trace: library/stdarch/crates/core_arch/src/riscv64/mod.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=44

```rust
// SRC: library/stdarch/crates/core_arch/src/riscv64/mod.rs
...
// MOD DECLARATION: zk (from library/stdarch/crates/core_arch/src/riscv64/mod.rs)
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=18
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=14
