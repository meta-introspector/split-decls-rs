# AST Trace: library/backtrace/src/backtrace/win32.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=8 | LINES=30

```rust
// SRC: library/backtrace/src/backtrace/win32.rs
