# AST Trace: compiler/rustc_errors/src/lock.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Handle(HANDLE); | COMPLEXITY=55 | LINES=95

```rust
// SRC: compiler/rustc_errors/src/lock.rs
