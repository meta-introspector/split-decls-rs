# AST Trace: compiler/rustc_sanitizers/src/cfi/typeid/itanium_cxx_abi/encode.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=13 | LINES=27

```rust
// SRC: compiler/rustc_sanitizers/src/cfi/typeid/itanium_cxx_abi/encode.rs
