# AST Trace: library/std_detect/src/detect/macros.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=12 | LINES=32

```rust
// SRC: library/std_detect/src/detect/macros.rs
