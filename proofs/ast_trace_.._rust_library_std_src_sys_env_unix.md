# AST Trace: ../rust/library/std/src/sys/env/unix.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=16 | LINES=30
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=env_read_lock | COMPLEXITY=2 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=env | COMPLEXITY=25 | LINES=36
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=getenv | COMPLEXITY=20 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=13 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=7
