# AST Trace: compiler/rustc_data_structures/src/work_queue.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=WorkQueue | COMPLEXITY=8 | LINES=30

```rust
// SRC: compiler/rustc_data_structures/src/work_queue.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=with_none | COMPLEXITY=17 | LINES=30
