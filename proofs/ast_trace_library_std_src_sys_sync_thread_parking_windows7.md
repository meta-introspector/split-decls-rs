# AST Trace: library/std/src/sys/sync/thread_parking/windows7.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=27 | LINES=80

```rust
// SRC: library/std/src/sys/sync/thread_parking/windows7.rs
