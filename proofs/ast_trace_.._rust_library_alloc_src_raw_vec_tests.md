# AST Trace: ../rust/library/alloc/src/raw_vec/tests.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=allocator_param | COMPLEXITY=33 | LINES=48
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=reserve_does_not_overallocate | COMPLEXITY=6 | LINES=32
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=ZST; | COMPLEXITY=2 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=zst | COMPLEXITY=5 | LINES=47
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=zst_reserve_panic | COMPLEXITY=2 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=zst_reserve_exact_panic | COMPLEXITY=2 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=niches | COMPLEXITY=2 | LINES=8
