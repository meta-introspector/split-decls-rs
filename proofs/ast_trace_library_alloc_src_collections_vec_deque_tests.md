# AST Trace: library/alloc/src/collections/vec_deque/tests.rs

Generated 47 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=bench_push_back_100 | COMPLEXITY=8 | LINES=31

```rust
// SRC: library/alloc/src/collections/vec_deque/tests.rs
