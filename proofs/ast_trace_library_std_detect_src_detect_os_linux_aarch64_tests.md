# AST Trace: library/std_detect/src/detect/os/linux/aarch64/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=baseline_hwcaps | COMPLEXITY=23 | LINES=92

```rust
// SRC: library/std_detect/src/detect/os/linux/aarch64/tests.rs
