# AST Trace: compiler/rustc_codegen_ssa/src/back/rpath/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_minimize1 | COMPLEXITY=3 | LINES=22

```rust
// SRC: compiler/rustc_codegen_ssa/src/back/rpath/tests.rs
