# AST Trace: library/compiler-builtins/libm-test/examples/plot_domains.rs
...
```rust
// SRC: library/compiler-builtins/libm-test/examples/plot_domains.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=main | COMPLEXITY=12 | LINES=33
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=plot_one_operator | COMPLEXITY=5 | LINES=24
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=plot_one_generator | COMPLEXITY=17 | LINES=35
