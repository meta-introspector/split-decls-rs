# AST Trace: library/compiler-builtins/compiler-builtins/src/float/extend.rs
...
```rust
// SRC: library/compiler-builtins/compiler-builtins/src/float/extend.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=extend | COMPLEXITY=18 | LINES=68
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=45
