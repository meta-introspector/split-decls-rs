# AST Trace: compiler/rustc_mir_transform/src/promote_consts.rs

Generated 23 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=32

```rust
// SRC: compiler/rustc_mir_transform/src/promote_consts.rs
