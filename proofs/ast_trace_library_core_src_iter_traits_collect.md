# AST Trace: library/core/src/iter/traits/collect.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=82

```rust
// SRC: library/core/src/iter/traits/collect.rs
