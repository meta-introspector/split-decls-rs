# AST Trace: library/std/src/sys/pal/wasip1/time.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Instant(Duration); | COMPLEXITY=9 | LINES=36

```rust
// SRC: library/std/src/sys/pal/wasip1/time.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=now | COMPLEXITY=9 | LINES=26
