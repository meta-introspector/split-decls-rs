# AST Trace: library/std/src/sys/sync/once/no_threads.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Once | COMPLEXITY=3 | LINES=22

```rust
// SRC: library/std/src/sys/sync/once/no_threads.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=OnceState | COMPLEXITY=2 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=CompletionGuard | COMPLEXITY=2 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=5 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=is_completed | COMPLEXITY=36 | LINES=68
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=is_poisoned | COMPLEXITY=4 | LINES=12
