# AST Trace: compiler/rustc_data_structures/src/graph/scc/tests.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=MaxReached(usize); | COMPLEXITY=8 | LINES=38

```rust
// SRC: compiler/rustc_data_structures/src/graph/scc/tests.rs
