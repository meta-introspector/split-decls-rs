# AST Trace: library/core/src/iter/traits/exact_size.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=15 | LINES=70

```rust
// SRC: library/core/src/iter/traits/exact_size.rs
