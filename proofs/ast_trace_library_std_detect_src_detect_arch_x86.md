# AST Trace: library/std_detect/src/detect/arch/x86.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=47 | LINES=299

```rust
// SRC: library/std_detect/src/detect/arch/x86.rs
