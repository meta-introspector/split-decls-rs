# AST Trace: compiler/rustc_codegen_ssa/src/back/apple/tests.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_add_version_to_llvm_target | COMPLEXITY=4 | LINES=30

```rust
// SRC: compiler/rustc_codegen_ssa/src/back/apple/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=lookup_developer_dir | COMPLEXITY=2 | LINES=6
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=lookup_sdk | COMPLEXITY=11 | LINES=17
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=lookup_sdk_verbose | COMPLEXITY=6 | LINES=21
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=try_lookup_invalid_sdk | COMPLEXITY=12 | LINES=22
