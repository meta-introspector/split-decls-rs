# AST Trace: library/panic_unwind/src/lib.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=17 | LINES=113

```rust
// SRC: library/panic_unwind/src/lib.rs
...
cfg_select! {
    all(target_os = "emscripten", not(emscripten_wasm_eh)) => {
        #[path = "emcc.rs"]
// MOD DECLARATION: imp (from library/panic_unwind/src/lib.rs)
// REPLACED: mod imp; -> use crate::imp::*;
use crate::imp::*;
    }
    target_os = "hermit" => {
        #[path = "hermit.rs"]
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=__rust_drop_panic | COMPLEXITY=6 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=13 | LINES=11
