# AST Trace: compiler/rustc_borrowck/src/places_conflict.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=24 | LINES=77

```rust
// SRC: compiler/rustc_borrowck/src/places_conflict.rs
