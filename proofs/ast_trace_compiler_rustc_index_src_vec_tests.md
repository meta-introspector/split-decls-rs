# AST Trace: compiler/rustc_index/src/vec/tests.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=MyIdx | COMPLEXITY=4 | LINES=25

```rust
// SRC: compiler/rustc_index/src/vec/tests.rs
