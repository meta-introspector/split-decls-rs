# AST Trace: library/std/src/sys/args/sgx.rs
...
```rust
// SRC: library/std/src/sys/args/sgx.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=16 | LINES=18
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=args | COMPLEXITY=8 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=Args | COMPLEXITY=2 | LINES=4
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=next | COMPLEXITY=12 | LINES=42
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=next_back | COMPLEXITY=6 | LINES=11
