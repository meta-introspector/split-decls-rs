# AST Trace: library/coretests/tests/ascii.rs

Generated 25 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_is_ascii | COMPLEXITY=6 | LINES=34

```rust
// SRC: library/coretests/tests/ascii.rs
