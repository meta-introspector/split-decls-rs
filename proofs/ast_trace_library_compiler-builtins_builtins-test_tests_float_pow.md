# AST Trace: library/compiler-builtins/builtins-test/tests/float_pow.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=36 | LINES=68

```rust
// SRC: library/compiler-builtins/builtins-test/tests/float_pow.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=6
