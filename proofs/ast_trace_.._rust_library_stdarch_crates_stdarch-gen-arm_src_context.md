# AST Trace: ../rust/library/stdarch/crates/stdarch-gen-arm/src/context.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=ArchitectureSettings | COMPLEXITY=2 | LINES=17
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=GlobalContext | COMPLEXITY=2 | LINES=15
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=GroupContext | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=LocalContext | COMPLEXITY=2 | LINES=10
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=111 | LINES=199
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=Context | COMPLEXITY=2 | LINES=6
