# AST Trace: ../rust/compiler/rustc_codegen_llvm/src/builder/gpu_offload.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=19
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=generate_at_one | COMPLEXITY=5 | LINES=25
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=7 | LINES=24
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=gen_tgt_kernel_global | COMPLEXITY=23 | LINES=40
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=gen_tgt_data_mappers | COMPLEXITY=4 | LINES=24
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=add_priv_unnamed_arr | COMPLEXITY=5 | LINES=10
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=gen_define_handling | COMPLEXITY=20 | LINES=66
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=declare_offload_fn | COMPLEXITY=2 | LINES=15
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=gen_call_handling | COMPLEXITY=74 | LINES=175
