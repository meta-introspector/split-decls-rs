# AST Trace: compiler/rustc_infer/src/lib.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=47

```rust
// SRC: compiler/rustc_infer/src/lib.rs
...
// MOD DECLARATION: errors (from compiler/rustc_infer/src/lib.rs)
