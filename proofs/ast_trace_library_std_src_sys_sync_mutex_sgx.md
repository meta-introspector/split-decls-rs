# AST Trace: library/std/src/sys/sync/mutex/sgx.rs
...
```rust
// SRC: library/std/src/sys/sync/mutex/sgx.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=get | COMPLEXITY=33 | LINES=50
