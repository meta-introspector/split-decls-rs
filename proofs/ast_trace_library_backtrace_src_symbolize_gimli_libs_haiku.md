# AST Trace: library/backtrace/src/symbolize/gimli/libs_haiku.rs
...
```rust
// SRC: library/backtrace/src/symbolize/gimli/libs_haiku.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=40
