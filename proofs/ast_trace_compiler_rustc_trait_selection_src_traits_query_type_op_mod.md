# AST Trace: compiler/rustc_trait_selection/src/traits/query/type_op/mod.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/query/type_op/mod.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=fully_perform | COMPLEXITY=5 | LINES=23
