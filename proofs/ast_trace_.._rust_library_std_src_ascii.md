# AST Trace: ../rust/library/std/src/ascii.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=is_ascii | COMPLEXITY=21 | LINES=125
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=is_ascii | COMPLEXITY=15 | LINES=34
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
