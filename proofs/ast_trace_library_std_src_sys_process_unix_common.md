# AST Trace: library/std/src/sys/process/unix/common.rs
...
```rust
// SRC: library/std/src/sys/process/unix/common.rs
...
// MOD DECLARATION: tests (from library/std/src/sys/process/unix/common.rs)
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=16

```rust
// MOD DECLARATION: cstring_array (from library/std/src/sys/process/unix/common.rs)
// REPLACED: mod cstring_array; -> use crate::cstring_array::*;
use crate::cstring_array::*;
