# AST Trace: compiler/rustc_attr_parsing/src/attributes/allow_unstable.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=extend | COMPLEXITY=8 | LINES=43

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/allow_unstable.rs
