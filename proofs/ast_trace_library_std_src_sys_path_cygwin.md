# AST Trace: library/std/src/sys/path/cygwin.rs
...
```rust
// SRC: library/std/src/sys/path/cygwin.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=is_verbatim_sep | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=cygwin_conv_path | COMPLEXITY=7 | LINES=22
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=31 | LINES=42
