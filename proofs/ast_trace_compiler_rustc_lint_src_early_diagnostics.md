# AST Trace: compiler/rustc_lint/src/early/diagnostics.rs
...
```rust
// SRC: compiler/rustc_lint/src/early/diagnostics.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=decorate_builtin_lint | COMPLEXITY=261 | LINES=445
...
// MOD DECLARATION: check_cfg (from compiler/rustc_lint/src/early/diagnostics.rs)
// REPLACED: mod check_cfg; -> use crate::check_cfg::*;
use crate::check_cfg::*;
