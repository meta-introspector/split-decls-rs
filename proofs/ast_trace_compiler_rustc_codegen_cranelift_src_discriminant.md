# AST Trace: compiler/rustc_codegen_cranelift/src/discriminant.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=22

```rust
// SRC: compiler/rustc_codegen_cranelift/src/discriminant.rs
