# AST Trace: ../rust/compiler/rustc_incremental/src/persist/fs/tests.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_all_except_most_recent | COMPLEXITY=3 | LINES=18
