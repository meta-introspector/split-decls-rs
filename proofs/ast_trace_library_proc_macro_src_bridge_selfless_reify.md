# AST Trace: library/proc_macro/src/bridge/selfless_reify.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=51

```rust
// SRC: library/proc_macro/src/bridge/selfless_reify.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=$name:ident | COMPLEXITY=23 | LINES=37
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=_reify_to_extern_c_fn_unary | COMPLEXITY=7 | LINES=11
