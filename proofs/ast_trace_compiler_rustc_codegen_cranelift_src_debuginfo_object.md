# AST Trace: compiler/rustc_codegen_cranelift/src/debuginfo/object.rs
...
```rust
// SRC: compiler/rustc_codegen_cranelift/src/debuginfo/object.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=add_debug_section | COMPLEXITY=2 | LINES=12
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=add_debug_section | COMPLEXITY=39 | LINES=71
