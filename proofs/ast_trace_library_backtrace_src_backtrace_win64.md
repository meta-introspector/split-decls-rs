# AST Trace: library/backtrace/src/backtrace/win64.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Frame | COMPLEXITY=7 | LINES=36

```rust
// SRC: library/backtrace/src/backtrace/win64.rs
