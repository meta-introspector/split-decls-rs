# AST Trace: compiler/rustc_mir_build/src/builder/scope.rs

Generated 33 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=22 | LINES=67

```rust
// SRC: compiler/rustc_mir_build/src/builder/scope.rs
