# AST Trace: ../rust/compiler/rustc_thread_pool/src/scope/tests.rs

Generated 49 AST blocks from source file
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=scope_empty | COMPLEXITY=3 | LINES=5
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=scope_result | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=scope_two | COMPLEXITY=5 | LINES=16
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=scope_divide_and_conquer | COMPLEXITY=2 | LINES=13
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=divide_and_conquer | COMPLEXITY=6 | LINES=10
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=divide_and_conquer_seq | COMPLEXITY=6 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=Tree | COMPLEXITY=2 | LINES=5
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=iter | COMPLEXITY=11 | LINES=31
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=random_tree | COMPLEXITY=2 | LINES=8
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=random_tree1 | COMPLEXITY=7 | LINES=12
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=update_tree | COMPLEXITY=5 | LINES=12
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=linear_stack_growth | COMPLEXITY=12 | LINES=23
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=the_final_countdown | COMPLEXITY=9 | LINES=19
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=panic_propagate_scope | COMPLEXITY=2 | LINES=6
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=panic_propagate_spawn | COMPLEXITY=2 | LINES=6
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=panic_propagate_nested_spawn | COMPLEXITY=2 | LINES=6
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=panic_propagate_nested_scope_spawn | COMPLEXITY=2 | LINES=6
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=panic_propagate_still_execute_1 | COMPLEXITY=8 | LINES=16
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=panic_propagate_still_execute_2 | COMPLEXITY=8 | LINES=16
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=panic_propagate_still_execute_3 | COMPLEXITY=8 | LINES=16
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=panic_propagate_still_execute_4 | COMPLEXITY=8 | LINES=16
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=20 | LINES=23
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=lifo_order | COMPLEXITY=2 | LINES=11
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=fifo_order | COMPLEXITY=2 | LINES=11
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=21 | LINES=26
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=nested_lifo_order | COMPLEXITY=2 | LINES=11
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=nested_fifo_order | COMPLEXITY=2 | LINES=11
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=nested_lifo_fifo_order | COMPLEXITY=2 | LINES=11
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=nested_fifo_lifo_order | COMPLEXITY=2 | LINES=11
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=9 | LINES=6
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=14 | LINES=26
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=mixed_lifo_order | COMPLEXITY=2 | LINES=12
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=mixed_fifo_order | COMPLEXITY=2 | LINES=10
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=mixed_lifo_fifo_order | COMPLEXITY=2 | LINES=12
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=mixed_fifo_lifo_order | COMPLEXITY=2 | LINES=10
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=static_scope | COMPLEXITY=8 | LINES=22
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=static_scope_fifo | COMPLEXITY=8 | LINES=22
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=mixed_lifetime_scope | COMPLEXITY=9 | LINES=18
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=mixed_lifetime_scope_fifo | COMPLEXITY=9 | LINES=18
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=scope_spawn_broadcast | COMPLEXITY=4 | LINES=13
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=scope_fifo_spawn_broadcast | COMPLEXITY=4 | LINES=13
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=scope_spawn_broadcast_nested | COMPLEXITY=5 | LINES=16
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=scope_spawn_broadcast_barrier | COMPLEXITY=4 | LINES=13
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=scope_spawn_broadcast_panic_one | COMPLEXITY=9 | LINES=19
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=scope_spawn_broadcast_panic_many | COMPLEXITY=9 | LINES=19
