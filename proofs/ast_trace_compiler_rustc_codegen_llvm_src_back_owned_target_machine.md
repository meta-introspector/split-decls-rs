# AST Trace: compiler/rustc_codegen_llvm/src/back/owned_target_machine.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=OwnedTargetMachine | COMPLEXITY=8 | LINES=32

```rust
// SRC: compiler/rustc_codegen_llvm/src/back/owned_target_machine.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=raw | COMPLEXITY=21 | LINES=76
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=10 | LINES=11
