# AST Trace: ../rust/library/std/src/sys/sync/condvar/itron.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Condvar | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=notify_one | COMPLEXITY=116 | LINES=102
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=WaiterQueue | COMPLEXITY=129 | LINES=177
