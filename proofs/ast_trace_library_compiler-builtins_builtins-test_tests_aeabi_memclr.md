# AST Trace: library/compiler-builtins/builtins-test/tests/aeabi_memclr.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=10 | LINES=40

```rust
// SRC: library/compiler-builtins/builtins-test/tests/aeabi_memclr.rs
