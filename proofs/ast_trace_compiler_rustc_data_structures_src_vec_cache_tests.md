# AST Trace: compiler/rustc_data_structures/src/vec_cache/tests.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=vec_cache_empty | COMPLEXITY=7 | LINES=25

```rust
// SRC: compiler/rustc_data_structures/src/vec_cache/tests.rs
