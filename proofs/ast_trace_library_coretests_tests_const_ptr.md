# AST Trace: library/coretests/tests/const_ptr.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=24

```rust
// SRC: library/coretests/tests/const_ptr.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=read | COMPLEXITY=17 | LINES=16
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=const_ptr_read | COMPLEXITY=17 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=mut_ptr_read | COMPLEXITY=17 | LINES=14
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=write | COMPLEXITY=15 | LINES=26
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=mut_ptr_write | COMPLEXITY=15 | LINES=24
