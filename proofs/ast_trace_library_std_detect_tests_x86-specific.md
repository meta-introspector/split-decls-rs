# AST Trace: library/std_detect/tests/x86-specific.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=dump | COMPLEXITY=87 | LINES=100

```rust
// SRC: library/std_detect/tests/x86-specific.rs
