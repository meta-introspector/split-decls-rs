# AST Trace: library/compiler-builtins/libm/src/math/exp10.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/exp10.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=exp10 | COMPLEXITY=9 | LINES=22
