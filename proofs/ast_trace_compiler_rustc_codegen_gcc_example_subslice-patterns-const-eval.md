# AST Trace: compiler/rustc_codegen_gcc/example/subslice-patterns-const-eval.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=N(u8); | COMPLEXITY=10 | LINES=32

```rust
// SRC: compiler/rustc_codegen_gcc/example/subslice-patterns-const-eval.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=2 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=15 | LINES=15
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=main | COMPLEXITY=20 | LINES=31
