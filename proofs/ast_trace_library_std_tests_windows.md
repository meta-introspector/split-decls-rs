# AST Trace: library/std/tests/windows.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=os_string_must_know_it_isnt_utf8_issue_126291 | COMPLEXITY=4 | LINES=33

```rust
// SRC: library/std/tests/windows.rs
