# AST Trace: compiler/rustc_type_ir/src/data_structures/mod.rs
...
```rust
// SRC: compiler/rustc_type_ir/src/data_structures/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=10
