# AST Trace: ../rust/library/stdarch/crates/intrinsic-test/src/common/argument.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Argument | COMPLEXITY=5 | LINES=17
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=27 | LINES=52
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=ArgumentList | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=as_call_param_c | COMPLEXITY=72 | LINES=117
