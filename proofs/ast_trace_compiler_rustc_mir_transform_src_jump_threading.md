# AST Trace: compiler/rustc_mir_transform/src/jump_threading.rs

Generated 21 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=29

```rust
// SRC: compiler/rustc_mir_transform/src/jump_threading.rs
