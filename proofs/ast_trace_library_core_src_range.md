# AST Trace: library/core/src/range.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=21
...
// MOD DECLARATION: iter (from library/core/src/range.rs)
