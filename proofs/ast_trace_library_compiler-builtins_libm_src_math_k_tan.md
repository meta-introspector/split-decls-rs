# AST Trace: library/compiler-builtins/libm/src/math/k_tan.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=36 | LINES=118

```rust
// SRC: library/compiler-builtins/libm/src/math/k_tan.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=zero_low_word | COMPLEXITY=2 | LINES=4
