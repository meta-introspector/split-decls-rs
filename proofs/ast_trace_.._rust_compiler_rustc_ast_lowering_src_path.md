# AST Trace: ../rust/compiler/rustc_ast_lowering/src/path.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=maybe_insert_elided_lifetimes_in_path | COMPLEXITY=271 | LINES=586
