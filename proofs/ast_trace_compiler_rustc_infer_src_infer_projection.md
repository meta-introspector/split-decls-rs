# AST Trace: compiler/rustc_infer/src/infer/projection.rs
...
```rust
// SRC: compiler/rustc_infer/src/infer/projection.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=projection_term_to_infer | COMPLEXITY=12 | LINES=37
