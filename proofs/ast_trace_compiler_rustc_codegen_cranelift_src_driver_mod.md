# AST Trace: compiler/rustc_codegen_cranelift/src/driver/mod.rs
...
```rust
// SRC: compiler/rustc_codegen_cranelift/src/driver/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=predefine_mono_items | COMPLEXITY=21 | LINES=47
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=MeasuremeProfiler(SelfProfilerRef); | COMPLEXITY=2 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=start_pass | COMPLEXITY=12 | LINES=14
