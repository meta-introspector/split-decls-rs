# AST Trace: compiler/rustc_mir_transform/src/coverage/counters/balanced_flow.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=14 | LINES=62

```rust
// SRC: compiler/rustc_mir_transform/src/coverage/counters/balanced_flow.rs
