# AST Trace: compiler/rustc_codegen_gcc/tests/run/volatile2.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=sigaction | COMPLEXITY=15 | LINES=53

```rust
// SRC: compiler/rustc_codegen_gcc/tests/run/volatile2.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=main | COMPLEXITY=21 | LINES=62
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=19
