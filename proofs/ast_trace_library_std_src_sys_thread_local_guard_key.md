# AST Trace: library/std/src/sys/thread_local/guard/key.rs
...
```rust
// SRC: library/std/src/sys/thread_local/guard/key.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=enable | COMPLEXITY=18 | LINES=25
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=enable | COMPLEXITY=25 | LINES=29
