# AST Trace: compiler/rustc_codegen_gcc/tests/run/condition.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=16 | LINES=49

```rust
// SRC: compiler/rustc_codegen_gcc/tests/run/condition.rs
