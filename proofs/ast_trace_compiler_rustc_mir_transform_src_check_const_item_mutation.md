# AST Trace: compiler/rustc_mir_transform/src/check_const_item_mutation.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=run_lint | COMPLEXITY=8 | LINES=33

```rust
// SRC: compiler/rustc_mir_transform/src/check_const_item_mutation.rs
