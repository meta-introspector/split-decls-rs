# AST Trace: ../rust/library/stdarch/crates/intrinsic-test/src/common/gen_rust.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=write_cargo_toml_header | COMPLEXITY=8 | LINES=24
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=write_bin_cargo_toml | COMPLEXITY=9 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=write_lib_cargo_toml | COMPLEXITY=4 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=write_main_rs | COMPLEXITY=26 | LINES=42
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=write_lib_rs | COMPLEXITY=12 | LINES=32
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=compile_rust_programs | COMPLEXITY=30 | LINES=61
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=generate_rust_test_loop | COMPLEXITY=55 | LINES=66
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=generate_rust_specializations | COMPLEXITY=10 | LINES=21
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=create_rust_test_module | COMPLEXITY=7 | LINES=28
