# AST Trace: compiler/rustc_borrowck/src/polonius/constraints.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=8 | LINES=43

```rust
// SRC: compiler/rustc_borrowck/src/polonius/constraints.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=10
