# AST Trace: compiler/rustc_transmute/src/layout/tree/tests.rs
...
```rust
// SRC: compiler/rustc_transmute/src/layout/tree/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=has_safety_invariants | COMPLEXITY=5 | LINES=6
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=seq_1 | COMPLEXITY=18 | LINES=84
