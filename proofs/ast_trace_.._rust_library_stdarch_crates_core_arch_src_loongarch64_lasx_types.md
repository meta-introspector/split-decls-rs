# AST Trace: ../rust/library/stdarch/crates/core_arch/src/loongarch64/lasx/types.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=m256i(4 | COMPLEXITY=23 | LINES=76
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=64
