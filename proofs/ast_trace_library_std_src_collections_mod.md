# AST Trace: library/std/src/collections/mod.rs

Generated 22 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=69 | LINES=227

```rust
// SRC: library/std/src/collections/mod.rs
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=27
...
// MOD DECLARATION: hash (from library/std/src/collections/mod.rs)
