# AST Trace: compiler/rustc_codegen_cranelift/src/compiler_builtins.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$name:ident | COMPLEXITY=16 | LINES=52

```rust
// SRC: compiler/rustc_codegen_cranelift/src/compiler_builtins.rs
