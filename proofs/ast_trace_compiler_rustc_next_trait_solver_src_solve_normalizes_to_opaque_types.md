# AST Trace: compiler/rustc_next_trait_solver/src/solve/normalizes_to/opaque_types.rs
...
```rust
// SRC: compiler/rustc_next_trait_solver/src/solve/normalizes_to/opaque_types.rs
