# AST Trace: library/compiler-builtins/libm/src/math/acos.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=r | COMPLEXITY=14 | LINES=70

```rust
// SRC: library/compiler-builtins/libm/src/math/acos.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=acos | COMPLEXITY=22 | LINES=57
