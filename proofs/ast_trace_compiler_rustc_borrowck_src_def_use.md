# AST Trace: compiler/rustc_borrowck/src/def_use.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/def_use.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=20 | LINES=76
