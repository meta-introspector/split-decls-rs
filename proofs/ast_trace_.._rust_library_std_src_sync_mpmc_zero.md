# AST Trace: ../rust/library/std/src/sync/mpmc/zero.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=default | COMPLEXITY=5 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Packet | COMPLEXITY=8 | LINES=12
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=empty_on_stack | COMPLEXITY=13 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=Inner | COMPLEXITY=2 | LINES=12
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=173 | LINES=236
