# AST Trace: compiler/rustc_errors/src/timings.rs
...
```rust
// SRC: compiler/rustc_errors/src/timings.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=TimingRecord | COMPLEXITY=2 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=from_origin | COMPLEXITY=6 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=TimingSectionHandler | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=new | COMPLEXITY=33 | LINES=51
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=TimingSectionGuard | COMPLEXITY=4 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=create | COMPLEXITY=7 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=8 | LINES=8
