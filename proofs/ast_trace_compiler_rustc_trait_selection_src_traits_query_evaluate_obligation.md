# AST Trace: compiler/rustc_trait_selection/src/traits/query/evaluate_obligation.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/query/evaluate_obligation.rs
