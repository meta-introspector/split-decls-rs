# AST Trace: library/coretests/tests/num/bignum.rs

Generated 29 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_from_u64_overflow | COMPLEXITY=3 | LINES=23

```rust
// SRC: library/coretests/tests/num/bignum.rs
