# AST Trace: library/std/src/sys/personality/dwarf/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=dwarf_reader | COMPLEXITY=9 | LINES=34

```rust
// SRC: library/std/src/sys/personality/dwarf/tests.rs
