# AST Trace: compiler/rustc_codegen_cranelift/example/float-minmax-pass.rs
...
```rust
// SRC: compiler/rustc_codegen_cranelift/example/float-minmax-pass.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=f32x4(pub | COMPLEXITY=8 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=main | COMPLEXITY=9 | LINES=38
