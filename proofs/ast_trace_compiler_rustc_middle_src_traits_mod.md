# AST Trace: compiler/rustc_middle/src/traits/mod.rs
...
```rust
// SRC: compiler/rustc_middle/src/traits/mod.rs
...
// MOD DECLARATION: structural_impls (from compiler/rustc_middle/src/traits/mod.rs)
