# AST Trace: ../rust/library/core/src/num/dec2flt/lemire.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=compute_float | COMPLEXITY=56 | LINES=108
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=power | COMPLEXITY=4 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=full_multiplication | COMPLEXITY=2 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=compute_product_approx | COMPLEXITY=23 | LINES=38
