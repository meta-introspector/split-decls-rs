# AST Trace: library/portable-simd/crates/core_simd/src/select.rs
...
```rust
// SRC: library/portable-simd/crates/core_simd/src/select.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=select | COMPLEXITY=18 | LINES=53
