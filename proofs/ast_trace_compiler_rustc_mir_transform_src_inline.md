# AST Trace: compiler/rustc_mir_transform/src/inline.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/inline.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=CallSite | COMPLEXITY=2 | LINES=12
