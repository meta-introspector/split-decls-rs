# AST Trace: library/coretests/tests/iter/traits/iterator.rs

Generated 43 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Mod3(i32); | COMPLEXITY=9 | LINES=30

```rust
// SRC: library/coretests/tests/iter/traits/iterator.rs
