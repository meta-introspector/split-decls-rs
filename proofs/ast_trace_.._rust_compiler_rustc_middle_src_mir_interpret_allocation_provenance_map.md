# AST Trace: ../rust/compiler/rustc_middle/src/mir/interpret/allocation/provenance_map.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=ProvenanceMap | COMPLEXITY=5 | LINES=14
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=decode | COMPLEXITY=8 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=encode | COMPLEXITY=6 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=6 | LINES=12
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=ptrs | COMPLEXITY=3 | LINES=12
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=adjusted_range_ptrs | COMPLEXITY=104 | LINES=209
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=ProvenanceCopy | COMPLEXITY=2 | LINES=8
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=prepare_copy | COMPLEXITY=78 | LINES=119
