# AST Trace: library/coretests/tests/floats/f64.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_mul_add | COMPLEXITY=5 | LINES=38

```rust
// SRC: library/coretests/tests/floats/f64.rs
