# AST Trace: library/std/src/sys/process/unix/unsupported/wait_status/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=compare_with_linux | COMPLEXITY=21 | LINES=51

```rust
// SRC: library/std/src/sys/process/unix/unsupported/wait_status/tests.rs
