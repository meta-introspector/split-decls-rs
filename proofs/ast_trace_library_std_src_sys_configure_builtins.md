# AST Trace: library/std/src/sys/configure_builtins.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=__rust_enable_lse | COMPLEXITY=18 | LINES=39

```rust
// SRC: library/std/src/sys/configure_builtins.rs
