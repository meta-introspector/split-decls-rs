# AST Trace: library/coretests/tests/fmt/mod.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_lifetime | COMPLEXITY=9 | LINES=41

```rust
// SRC: library/coretests/tests/fmt/mod.rs
...
// MOD DECLARATION: builders (from library/coretests/tests/fmt/mod.rs)
// REPLACED: mod builders; -> use crate::builders::*;
use crate::builders::*;
// MOD DECLARATION: float (from library/coretests/tests/fmt/mod.rs)
// REPLACED: mod float; -> use crate::float::*;
use crate::float::*;
// MOD DECLARATION: num (from library/coretests/tests/fmt/mod.rs)
