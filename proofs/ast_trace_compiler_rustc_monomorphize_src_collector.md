# AST Trace: compiler/rustc_monomorphize/src/collector.rs

Generated 50 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=33 | LINES=113

```rust
// SRC: compiler/rustc_monomorphize/src/collector.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=48 | LINES=107
