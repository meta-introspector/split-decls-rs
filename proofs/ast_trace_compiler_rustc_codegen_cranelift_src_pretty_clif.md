# AST Trace: compiler/rustc_codegen_cranelift/src/pretty_clif.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=93 | LINES=73

```rust
// SRC: compiler/rustc_codegen_cranelift/src/pretty_clif.rs
