# AST Trace: ../rust/library/std/src/net/udp.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=47
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UdpSocket(net_imp::UdpSocket); | COMPLEXITY=186 | LINES=753
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=as_inner | COMPLEXITY=5 | LINES=13
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=from_inner | COMPLEXITY=5 | LINES=6
