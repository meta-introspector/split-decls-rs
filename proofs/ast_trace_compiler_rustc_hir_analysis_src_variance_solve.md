# AST Trace: compiler/rustc_hir_analysis/src/variance/solve.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=glb | COMPLEXITY=13 | LINES=51

```rust
// SRC: compiler/rustc_hir_analysis/src/variance/solve.rs
