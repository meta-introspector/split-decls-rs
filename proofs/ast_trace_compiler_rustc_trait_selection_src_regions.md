# AST Trace: compiler/rustc_trait_selection/src/regions.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/regions.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=new | COMPLEXITY=25 | LINES=63
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=resolve_regions | COMPLEXITY=14 | LINES=46
