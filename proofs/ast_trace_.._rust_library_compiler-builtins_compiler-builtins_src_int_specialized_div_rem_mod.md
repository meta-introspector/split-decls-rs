# AST Trace: ../rust/library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=zero_div_fn | COMPLEXITY=22 | LINES=78
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=26 | LINES=26
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=u64_by_u64_div_rem | COMPLEXITY=6 | LINES=30
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=22 | LINES=75
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=u32_by_u32_div_rem | COMPLEXITY=6 | LINES=27
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=60
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=1 | LINES=24
