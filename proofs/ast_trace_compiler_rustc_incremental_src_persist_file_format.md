# AST Trace: compiler/rustc_incremental/src/persist/file_format.rs
...
```rust
// SRC: compiler/rustc_incremental/src/persist/file_format.rs
...
// SRC: compiler/rustc_incremental/src/persist/file_format.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/compiler/rustc_incremental/src/persist/file_format.rs
...
use crate::rustc_serialize::Encoder;
use crate::rustc_serialize::opaque::{FileEncodeResult, FileEncoder};
```

## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=5 | LINES=21
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=26 | LINES=41
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=40 | LINES=73
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=report_format_mismatch | COMPLEXITY=8 | LINES=12
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=rustc_version | COMPLEXITY=10 | LINES=13
