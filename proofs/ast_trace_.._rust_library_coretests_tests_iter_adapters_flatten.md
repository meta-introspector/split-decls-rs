# AST Trace: ../rust/library/coretests/tests/iter/adapters/flatten.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_flatten | COMPLEXITY=5 | LINES=18
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_iterator_flatten_fold | COMPLEXITY=5 | LINES=25
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_flatten_try_folds | COMPLEXITY=3 | LINES=18
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_flatten_advance_by | COMPLEXITY=3 | LINES=20
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_flatten_non_fused_outer | COMPLEXITY=2 | LINES=17
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_flatten_non_fused_inner | COMPLEXITY=3 | LINES=19
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_double_ended_flatten | COMPLEXITY=3 | LINES=17
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_trusted_len_flatten | COMPLEXITY=5 | LINES=39
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_flatten_count | COMPLEXITY=3 | LINES=21
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_flatten_last | COMPLEXITY=3 | LINES=21
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_flatten_one_shot | COMPLEXITY=3 | LINES=27
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_flatten_one_shot_rev | COMPLEXITY=4 | LINES=28
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_flatten_one_shot_arrays | COMPLEXITY=3 | LINES=11
