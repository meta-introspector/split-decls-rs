# AST Trace: compiler/rustc_public_bridge/src/alloc.rs
...
```rust
// SRC: compiler/rustc_public_bridge/src/alloc.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=create_ty_and_layout | COMPLEXITY=2 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=try_new_scalar | COMPLEXITY=2 | LINES=14
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=try_new_slice | COMPLEXITY=3 | LINES=21
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=try_new_indirect | COMPLEXITY=2 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=allocation_filter | COMPLEXITY=13 | LINES=33
