# AST Trace: compiler/rustc_codegen_cranelift/src/intrinsics/simd.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=report_simd_type_validation_error | COMPLEXITY=6 | LINES=33

```rust
// SRC: compiler/rustc_codegen_cranelift/src/intrinsics/simd.rs
