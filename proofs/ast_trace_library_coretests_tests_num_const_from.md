# AST Trace: library/coretests/tests/num/const_from.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=from | COMPLEXITY=4 | LINES=40

```rust
// SRC: library/coretests/tests/num/const_from.rs
