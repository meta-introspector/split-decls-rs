# AST Trace: library/compiler-builtins/compiler-builtins/src/float/div.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=11 | LINES=36

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/float/div.rs
