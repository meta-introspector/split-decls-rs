# AST Trace: compiler/rustc_metadata/src/rmeta/table.rs

Generated 34 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=is_default | COMPLEXITY=4 | LINES=25

```rust
// SRC: compiler/rustc_metadata/src/rmeta/table.rs
