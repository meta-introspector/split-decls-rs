# AST Trace: compiler/rustc_attr_parsing/src/attributes/rustc_internal.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=8 | LINES=32

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/rustc_internal.rs
