# AST Trace: compiler/rustc_hir/src/hir/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$name | COMPLEXITY=25 | LINES=34

```rust
// SRC: compiler/rustc_hir/src/hir/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=19 | LINES=24
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=trait_object_roundtrips | COMPLEXITY=2 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=trait_object_roundtrips_impl | COMPLEXITY=24 | LINES=28
