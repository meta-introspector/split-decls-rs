# AST Trace: library/proc_macro/src/bridge/mod.rs
...
```rust
// SRC: library/proc_macro/src/bridge/mod.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=42

```rust
#[allow(unsafe_code)]
// MOD DECLARATION: arena (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod arena; -> use crate::arena::*;
use crate::arena::*;
#[allow(unsafe_code)]
// MOD DECLARATION: buffer (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod buffer; -> use crate::buffer::*;
use crate::buffer::*;
#[deny(unsafe_code)]
pub mod client;
#[allow(unsafe_code)]
// MOD DECLARATION: closure (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod closure; -> use crate::closure::*;
use crate::closure::*;
#[forbid(unsafe_code)]
// MOD DECLARATION: fxhash (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod fxhash; -> use crate::fxhash::*;
use crate::fxhash::*;
#[forbid(unsafe_code)]
// MOD DECLARATION: handle (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod handle; -> use crate::handle::*;
use crate::handle::*;
#[macro_use]
#[forbid(unsafe_code)]
// MOD DECLARATION: rpc (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod rpc; -> use crate::rpc::*;
use crate::rpc::*;
#[allow(unsafe_code)]
// MOD DECLARATION: selfless_reify (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod selfless_reify; -> use crate::selfless_reify::*;
use crate::selfless_reify::*;
#[forbid(unsafe_code)]
pub mod server;
#[allow(unsafe_code)]
// MOD DECLARATION: symbol (from library/proc_macro/src/bridge/mod.rs)
// REPLACED: mod symbol; -> use crate::symbol::*;
use crate::symbol::*;
