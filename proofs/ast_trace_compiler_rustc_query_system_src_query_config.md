# AST Trace: compiler/rustc_query_system/src/query/config.rs
...
```rust
// SRC: compiler/rustc_query_system/src/query/config.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=name | COMPLEXITY=9 | LINES=64
