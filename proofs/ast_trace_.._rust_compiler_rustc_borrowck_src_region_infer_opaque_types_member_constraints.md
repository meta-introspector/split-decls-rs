# AST Trace: ../rust/compiler/rustc_borrowck/src/region_infer/opaque_types/member_constraints.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=21 | LINES=48
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=apply_member_constraint | COMPLEXITY=37 | LINES=83
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=CollectMemberConstraintsVisitor | COMPLEXITY=2 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=7 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=visit_region | COMPLEXITY=32 | LINES=39
