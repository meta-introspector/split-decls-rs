# AST Trace: library/alloc/src/wtf8/tests.rs

Generated 57 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=code_point_from_u32 | COMPLEXITY=3 | LINES=26

```rust
// SRC: library/alloc/src/wtf8/tests.rs
