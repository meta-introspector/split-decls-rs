# AST Trace: compiler/rustc_codegen_gcc/src/mono_item.rs
...
```rust
// SRC: compiler/rustc_codegen_gcc/src/mono_item.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=predefine_static | COMPLEXITY=23 | LINES=65
