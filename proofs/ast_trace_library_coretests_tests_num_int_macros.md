# AST Trace: library/coretests/tests/num/int_macros.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_overflows | COMPLEXITY=167 | LINES=780

```rust
// SRC: library/coretests/tests/num/int_macros.rs
