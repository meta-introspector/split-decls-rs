# AST Trace: compiler/rustc_codegen_cranelift/src/value_and_place.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=codegen_field | COMPLEXITY=23 | LINES=73

```rust
// SRC: compiler/rustc_codegen_cranelift/src/value_and_place.rs
