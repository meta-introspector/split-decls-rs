# AST Trace: compiler/rustc_mir_transform/src/simplify_branches.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/simplify_branches.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=name | COMPLEXITY=48 | LINES=59
