# AST Trace: library/std/src/sys/args/windows/tests.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=chk | COMPLEXITY=10 | LINES=26

```rust
// SRC: library/std/src/sys/args/windows/tests.rs
