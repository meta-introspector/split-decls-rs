# AST Trace: library/core/src/num/flt2dec/estimator.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=estimate_scaling_factor | COMPLEXITY=6 | LINES=31

```rust
// SRC: library/core/src/num/flt2dec/estimator.rs
