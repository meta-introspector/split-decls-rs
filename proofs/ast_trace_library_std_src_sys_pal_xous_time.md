# AST Trace: library/std/src/sys/pal/xous/time.rs
...
```rust
// SRC: library/std/src/sys/pal/xous/time.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=Instant(Duration); | COMPLEXITY=9 | LINES=31
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=now | COMPLEXITY=8 | LINES=22
