# AST Trace: compiler/rustc_symbol_mangling/src/hashed.rs
...
```rust
// SRC: compiler/rustc_symbol_mangling/src/hashed.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=31
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=push_hash64 | COMPLEXITY=4 | LINES=8
