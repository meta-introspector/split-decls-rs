# AST Trace: ../rust/compiler/rustc_type_ir/src/outlives.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=12 | LINES=41
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=push_outlives_components | COMPLEXITY=5 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=OutlivesCollector | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=visit_ty | COMPLEXITY=65 | LINES=150
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=compute_alias_components_recursive | COMPLEXITY=12 | LINES=22
