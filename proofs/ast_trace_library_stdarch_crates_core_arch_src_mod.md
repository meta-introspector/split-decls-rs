# AST Trace: library/stdarch/crates/core_arch/src/mod.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=139 | LINES=335

```rust
// SRC: library/stdarch/crates/core_arch/src/mod.rs
...
#[macro_use]
// MOD DECLARATION: macros (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod macros; -> use crate::macros::*;
use crate::macros::*;

#[cfg(any(target_arch = "riscv32", target_arch = "riscv64", doc))]
// MOD DECLARATION: riscv_shared (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod riscv_shared; -> use crate::riscv_shared::*;
use crate::riscv_shared::*;
...
// MOD DECLARATION: arm_shared (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod arm_shared; -> use crate::arm_shared::*;
use crate::arm_shared::*;

#[cfg(any(target_arch = "loongarch32", target_arch = "loongarch64", doc))]
// MOD DECLARATION: loongarch_shared (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod loongarch_shared; -> use crate::loongarch_shared::*;
use crate::loongarch_shared::*;

// MOD DECLARATION: simd (from library/stdarch/crates/core_arch/src/mod.rs)
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=82

```rust
#[cfg(any(target_arch = "x86", target_arch = "x86_64", doc))]
#[doc(cfg(any(target_arch = "x86", target_arch = "x86_64")))]
// MOD DECLARATION: x86 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod x86; -> use crate::x86::*;
use crate::x86::*;
#[cfg(any(target_arch = "x86_64", doc))]
#[doc(cfg(target_arch = "x86_64"))]
// MOD DECLARATION: x86_64 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod x86_64; -> use crate::x86_64::*;
use crate::x86_64::*;

#[cfg(any(target_arch = "aarch64", target_arch = "arm64ec", doc))]
#[doc(cfg(any(target_arch = "aarch64", target_arch = "arm64ec")))]
// MOD DECLARATION: aarch64 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod aarch64; -> use crate::aarch64::*;
use crate::aarch64::*;
#[cfg(any(target_arch = "arm", doc))]
#[doc(cfg(any(target_arch = "arm")))]
// MOD DECLARATION: arm (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod arm; -> use crate::arm::*;
use crate::arm::*;

#[cfg(any(target_arch = "riscv32", doc))]
#[doc(cfg(any(target_arch = "riscv32")))]
// MOD DECLARATION: riscv32 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod riscv32; -> use crate::riscv32::*;
use crate::riscv32::*;

#[cfg(any(target_arch = "riscv64", doc))]
#[doc(cfg(any(target_arch = "riscv64")))]
// MOD DECLARATION: riscv64 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod riscv64; -> use crate::riscv64::*;
use crate::riscv64::*;

#[cfg(any(target_family = "wasm", doc))]
#[doc(cfg(target_family = "wasm"))]
// MOD DECLARATION: wasm32 (from library/stdarch/crates/core_arch/src/mod.rs)
...
// MOD DECLARATION: mips (from library/stdarch/crates/core_arch/src/mod.rs)
...
// MOD DECLARATION: powerpc (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod powerpc; -> use crate::powerpc::*;
use crate::powerpc::*;

#[cfg(any(target_arch = "powerpc64", doc))]
#[doc(cfg(target_arch = "powerpc64"))]
// MOD DECLARATION: powerpc64 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod powerpc64; -> use crate::powerpc64::*;
use crate::powerpc64::*;

#[cfg(any(target_arch = "nvptx64", doc))]
#[doc(cfg(target_arch = "nvptx64"))]
// MOD DECLARATION: nvptx (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod nvptx; -> use crate::nvptx::*;
use crate::nvptx::*;

#[cfg(any(target_arch = "loongarch32", doc))]
#[doc(cfg(target_arch = "loongarch32"))]
// MOD DECLARATION: loongarch32 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod loongarch32; -> use crate::loongarch32::*;
use crate::loongarch32::*;

#[cfg(any(target_arch = "loongarch64", doc))]
#[doc(cfg(target_arch = "loongarch64"))]
// MOD DECLARATION: loongarch64 (from library/stdarch/crates/core_arch/src/mod.rs)
// REPLACED: mod loongarch64; -> use crate::loongarch64::*;
use crate::loongarch64::*;

#[cfg(any(target_arch = "s390x", doc))]
#[doc(cfg(target_arch = "s390x"))]
// MOD DECLARATION: s390x (from library/stdarch/crates/core_arch/src/mod.rs)
