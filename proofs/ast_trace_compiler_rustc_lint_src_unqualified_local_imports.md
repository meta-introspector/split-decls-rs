# AST Trace: compiler/rustc_lint/src/unqualified_local_imports.rs
...
```rust
// SRC: compiler/rustc_lint/src/unqualified_local_imports.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=37
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=check_item | COMPLEXITY=28 | LINES=41
