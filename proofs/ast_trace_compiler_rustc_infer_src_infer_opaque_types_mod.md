# AST Trace: compiler/rustc_infer/src/infer/opaque_types/mod.rs
...
```rust
// SRC: compiler/rustc_infer/src/infer/opaque_types/mod.rs
...
```rust
// MOD DECLARATION: table (from compiler/rustc_infer/src/infer/opaque_types/mod.rs)
