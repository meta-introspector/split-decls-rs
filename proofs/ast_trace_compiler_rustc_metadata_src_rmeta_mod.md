# AST Trace: compiler/rustc_metadata/src/rmeta/mod.rs
...
```rust
// SRC: compiler/rustc_metadata/src/rmeta/mod.rs
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
