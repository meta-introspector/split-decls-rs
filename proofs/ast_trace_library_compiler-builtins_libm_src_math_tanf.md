# AST Trace: library/compiler-builtins/libm/src/math/tanf.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/tanf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=tanf | COMPLEXITY=52 | LINES=62
