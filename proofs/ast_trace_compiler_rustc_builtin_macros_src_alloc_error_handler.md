# AST Trace: compiler/rustc_builtin_macros/src/alloc_error_handler.rs
...
```rust
// SRC: compiler/rustc_builtin_macros/src/alloc_error_handler.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=23 | LINES=49
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=generate_handler | COMPLEXITY=7 | LINES=38
