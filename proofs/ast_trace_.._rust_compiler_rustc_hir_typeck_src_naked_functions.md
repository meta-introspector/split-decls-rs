# AST Trace: ../rust/compiler/rustc_hir_typeck/src/naked_functions.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=check_no_patterns | COMPLEXITY=14 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=check_no_parameters_use | COMPLEXITY=7 | LINES=11
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=CheckParameters | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=visit_expr | COMPLEXITY=14 | LINES=16
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=check_asm | COMPLEXITY=29 | LINES=45
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=CheckInlineAssembly | COMPLEXITY=2 | LINES=4
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=check_expr | COMPLEXITY=22 | LINES=60
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=visit_stmt | COMPLEXITY=14 | LINES=18
