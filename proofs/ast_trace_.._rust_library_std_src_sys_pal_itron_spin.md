# AST Trace: ../rust/library/std/src/sys/pal/itron/spin.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=SpinMutex | COMPLEXITY=6 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=with_locked | COMPLEXITY=36 | LINES=34
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=SpinIdOnceCell | COMPLEXITY=6 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=get | COMPLEXITY=71 | LINES=96
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=13 | LINES=9
