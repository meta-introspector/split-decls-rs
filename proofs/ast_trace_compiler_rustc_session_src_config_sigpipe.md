# AST Trace: compiler/rustc_session/src/config/sigpipe.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=42

```rust
// SRC: compiler/rustc_session/src/config/sigpipe.rs
