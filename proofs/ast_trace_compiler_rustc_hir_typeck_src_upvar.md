# AST Trace: compiler/rustc_hir_typeck/src/upvar.rs

Generated 19 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=19 | LINES=53

```rust
// SRC: compiler/rustc_hir_typeck/src/upvar.rs
