# AST Trace: library/std/src/sys/sync/mutex/pthread.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Mutex | COMPLEXITY=4 | LINES=27

```rust
// SRC: library/std/src/sys/sync/mutex/pthread.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=get | COMPLEXITY=48 | LINES=46
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=25 | LINES=16
