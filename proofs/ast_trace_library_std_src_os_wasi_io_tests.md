# AST Trace: library/std/src/os/wasi/io/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_raw_fd_layout | COMPLEXITY=4 | LINES=27

```rust
// SRC: library/std/src/os/wasi/io/tests.rs
