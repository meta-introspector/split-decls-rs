# AST Trace: library/std/src/sys/stdio/teeos.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Stdout; | COMPLEXITY=13 | LINES=47

```rust
// SRC: library/std/src/sys/stdio/teeos.rs
...
#[expect(dead_code)]
#[path = "unsupported.rs"]
// MOD DECLARATION: unsupported_stdio (from library/std/src/sys/stdio/teeos.rs)
