# AST Trace: compiler/rustc_const_eval/src/interpret/projection.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=13 | LINES=30

```rust
// SRC: compiler/rustc_const_eval/src/interpret/projection.rs
