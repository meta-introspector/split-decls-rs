# AST Trace: library/compiler-builtins/libm/src/math/log1p.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log1p | COMPLEXITY=53 | LINES=159

```rust
// SRC: library/compiler-builtins/libm/src/math/log1p.rs
