# AST Trace: compiler/rustc_mir_transform/src/coverage/tests.rs

Generated 19 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=15 | LINES=42

```rust
// SRC: compiler/rustc_mir_transform/src/coverage/tests.rs
