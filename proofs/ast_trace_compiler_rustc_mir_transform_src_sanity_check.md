# AST Trace: compiler/rustc_mir_transform/src/sanity_check.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=run_lint | COMPLEXITY=7 | LINES=26

```rust
// SRC: compiler/rustc_mir_transform/src/sanity_check.rs
