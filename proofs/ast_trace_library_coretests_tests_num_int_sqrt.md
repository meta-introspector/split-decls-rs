# AST Trace: library/coretests/tests/num/int_sqrt.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=isqrt | COMPLEXITY=67 | LINES=190

```rust
// SRC: library/coretests/tests/num/int_sqrt.rs
