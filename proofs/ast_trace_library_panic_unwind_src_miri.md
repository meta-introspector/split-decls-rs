# AST Trace: library/panic_unwind/src/miri.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=miri_start_unwind | COMPLEXITY=12 | LINES=28

```rust
// SRC: library/panic_unwind/src/miri.rs
