# AST Trace: ../rust/library/coretests/tests/num/bignum.rs

Generated 29 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_from_u64_overflow | COMPLEXITY=2 | LINES=8
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_add | COMPLEXITY=3 | LINES=10
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_add_overflow_1 | COMPLEXITY=2 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_add_overflow_2 | COMPLEXITY=2 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_add_small | COMPLEXITY=3 | LINES=11
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_add_small_overflow | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_sub | COMPLEXITY=2 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_sub_underflow_1 | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_sub_underflow_2 | COMPLEXITY=2 | LINES=6
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_mul_small | COMPLEXITY=2 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_mul_small_overflow | COMPLEXITY=2 | LINES=6
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_mul_pow2 | COMPLEXITY=3 | LINES=12
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_mul_pow2_overflow_1 | COMPLEXITY=2 | LINES=6
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_mul_pow2_overflow_2 | COMPLEXITY=2 | LINES=6
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_mul_pow5 | COMPLEXITY=3 | LINES=12
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_mul_pow5_overflow_1 | COMPLEXITY=2 | LINES=6
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_mul_pow5_overflow_2 | COMPLEXITY=2 | LINES=6
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_mul_digits | COMPLEXITY=3 | LINES=11
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_mul_digits_overflow_1 | COMPLEXITY=2 | LINES=6
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_mul_digits_overflow_2 | COMPLEXITY=2 | LINES=6
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_div_rem_small | COMPLEXITY=3 | LINES=16
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_div_rem | COMPLEXITY=4 | LINES=19
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_is_zero | COMPLEXITY=2 | LINES=9
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_get_bit | COMPLEXITY=2 | LINES=13
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_get_bit_out_of_range | COMPLEXITY=2 | LINES=6
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_bit_length | COMPLEXITY=9 | LINES=20
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_bit_length_32x40 | COMPLEXITY=9 | LINES=24
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_ord | COMPLEXITY=2 | LINES=6
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=test_fmt | COMPLEXITY=9 | LINES=11
