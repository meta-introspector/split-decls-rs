# AST Trace: library/panic_unwind/src/seh.rs

Generated 21 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=16 | LINES=66

```rust
// SRC: library/panic_unwind/src/seh.rs
...
// SRC: library/panic_unwind/src/seh.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/library/panic_unwind/src/seh.rs
//! Windows SEH
//!
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Exception | COMPLEXITY=7 | LINES=15
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=8 | LINES=30
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=29
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=37
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=_ThrowInfo | COMPLEXITY=2 | LINES=10
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=_CatchableTypeArray | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=_CatchableType | COMPLEXITY=2 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=_PMD | COMPLEXITY=2 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=_TypeDescriptor | COMPLEXITY=2 | LINES=7
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=14
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=8
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=12
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=11
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=39 | LINES=37
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=4
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=_CxxThrowException | COMPLEXITY=34 | LINES=65
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=18 | LINES=17
