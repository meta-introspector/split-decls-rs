# AST Trace: library/coretests/tests/iter/adapters/skip.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_skip | COMPLEXITY=7 | LINES=34

```rust
// SRC: library/coretests/tests/iter/adapters/skip.rs
