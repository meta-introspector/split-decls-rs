# AST Trace: ../rust/library/portable-simd/crates/core_simd/src/simd/num/uint.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cast | COMPLEXITY=12 | LINES=120
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=cast | COMPLEXITY=118 | LINES=138
