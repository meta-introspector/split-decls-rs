# AST Trace: compiler/rustc_metadata/src/locator.rs

Generated 31 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=52 | LINES=165

```rust
// SRC: compiler/rustc_metadata/src/locator.rs
