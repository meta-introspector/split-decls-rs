# AST Trace: compiler/rustc_data_structures/src/graph/iterate/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=diamond_post_order | COMPLEXITY=4 | LINES=27

```rust
// SRC: compiler/rustc_data_structures/src/graph/iterate/tests.rs
