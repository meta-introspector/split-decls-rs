# AST Trace: library/stdarch/crates/intrinsic-test/src/common/compile_c.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=CompilationCommandBuilder | COMPLEXITY=4 | LINES=25

```rust
// SRC: library/stdarch/crates/intrinsic-test/src/common/compile_c.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=15 | LINES=58
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=into_cpp_compilation | COMPLEXITY=13 | LINES=25
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=CppCompilation(std::process::Command); | COMPLEXITY=8 | LINES=16
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=command_mut | COMPLEXITY=6 | LINES=27
