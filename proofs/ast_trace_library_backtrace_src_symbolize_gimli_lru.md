# AST Trace: library/backtrace/src/symbolize/gimli/lru.rs
...
```rust
// SRC: library/backtrace/src/symbolize/gimli/lru.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=2 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=default | COMPLEXITY=7 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=clear | COMPLEXITY=49 | LINES=57
