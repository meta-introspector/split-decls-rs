# AST Trace: library/std/src/sys/fs/windows.rs
...
```rust
// SRC: library/std/src/sys/fs/windows.rs
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=STRUCT | NAME=File | COMPLEXITY=2 | LINES=9

```rust
// MOD DECLARATION: remove_dir_all (from library/std/src/sys/fs/windows.rs)
// REPLACED: mod remove_dir_all; -> use crate::remove_dir_all::*;
