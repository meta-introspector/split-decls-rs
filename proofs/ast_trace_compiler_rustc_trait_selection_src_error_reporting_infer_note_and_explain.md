# AST Trace: compiler/rustc_trait_selection/src/error_reporting/infer/note_and_explain.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/error_reporting/infer/note_and_explain.rs
