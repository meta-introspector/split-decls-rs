# AST Trace: compiler/rustc_borrowck/src/type_check/input_output.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=7 | LINES=29

```rust
// SRC: compiler/rustc_borrowck/src/type_check/input_output.rs
