# AST Trace: compiler/rustc_hir_typeck/src/autoderef.rs
...
```rust
// SRC: compiler/rustc_hir_typeck/src/autoderef.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=30 | LINES=57
