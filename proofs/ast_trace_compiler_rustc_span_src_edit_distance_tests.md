# AST Trace: compiler/rustc_span/src/edit_distance/tests.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_edit_distance | COMPLEXITY=8 | LINES=38

```rust
// SRC: compiler/rustc_span/src/edit_distance/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_edit_distance_limit | COMPLEXITY=2 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_method_name_similarity_score | COMPLEXITY=3 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_find_best_match_for_name | COMPLEXITY=5 | LINES=32
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_precise_algorithm | COMPLEXITY=2 | LINES=10
