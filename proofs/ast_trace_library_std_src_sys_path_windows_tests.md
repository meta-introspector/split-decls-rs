# AST Trace: library/std/src/sys/path/windows/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_parse_next_component | COMPLEXITY=37 | LINES=168

```rust
// SRC: library/std/src/sys/path/windows/tests.rs
