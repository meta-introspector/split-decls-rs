# AST Trace: ../rust/compiler/rustc_builtin_macros/src/format_foreign/printf/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=9
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_escape | COMPLEXITY=2 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_parse | COMPLEXITY=41 | LINES=77
            ...
            assert_eq!(
                ...
                Some((
                    S::Format(F {
                        ...
                        length: $len,
                        type_: $type_,
                        position: crate::rustc_span::InnerSpan::new($pos.0, $pos.1),
                    }),
                    "!"
                ))
            )
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_iter | COMPLEXITY=4 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_translation | COMPLEXITY=35 | LINES=39
