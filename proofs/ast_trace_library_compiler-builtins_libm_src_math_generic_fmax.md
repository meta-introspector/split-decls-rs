# AST Trace: library/compiler-builtins/libm/src/math/generic/fmax.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fmax | COMPLEXITY=15 | LINES=40

```rust
// SRC: library/compiler-builtins/libm/src/math/generic/fmax.rs
