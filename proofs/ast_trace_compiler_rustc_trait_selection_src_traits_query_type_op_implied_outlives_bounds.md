# AST Trace: compiler/rustc_trait_selection/src/traits/query/type_op/implied_outlives_bounds.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/query/type_op/implied_outlives_bounds.rs
