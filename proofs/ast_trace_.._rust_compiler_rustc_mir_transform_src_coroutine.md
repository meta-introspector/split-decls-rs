# AST Trace: ../rust/compiler/rustc_mir_transform/src/coroutine.rs
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=STRUCT | NAME=RenameLocalVisitor | COMPLEXITY=2 | LINES=8
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=16 | LINES=22
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=STRUCT | NAME=SelfArgVisitor | COMPLEXITY=2 | LINES=5
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=new | COMPLEXITY=5 | LINES=6
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=18 | LINES=24
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=replace_base | COMPLEXITY=2 | LINES=9
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=STRUCT | NAME=SuspensionPoint | COMPLEXITY=7 | LINES=17
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=STRUCT | NAME=TransformVisitor | COMPLEXITY=3 | LINES=27
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=insert_none_ret_block | COMPLEXITY=62 | LINES=172
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=54 | LINES=90
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=make_aggregate_adt | COMPLEXITY=2 | LINES=9
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=make_coroutine_state_argument_indirect | COMPLEXITY=2 | LINES=12
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=make_coroutine_state_argument_pinned | COMPLEXITY=3 | LINES=16
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=replace_local | COMPLEXITY=4 | LINES=21
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=transform_async_context | COMPLEXITY=30 | LINES=54
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=eliminate_get_context_call | COMPLEXITY=7 | LINES=19
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=replace_resume_ty_local | COMPLEXITY=11 | LINES=21
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=transform_gen_context | COMPLEXITY=5 | LINES=16
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=STRUCT | NAME=LivenessInfo | COMPLEXITY=5 | LINES=20
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=locals_live_across_suspend_points | COMPLEXITY=44 | LINES=127
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=CoroutineSavedLocals(DenseBitSet | COMPLEXITY=18 | LINES=37
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=deref | COMPLEXITY=5 | LINES=8
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=compute_storage_conflicts | COMPLEXITY=39 | LINES=57
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=STRUCT | NAME=StorageConflictVisitor | COMPLEXITY=4 | LINES=10
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=visit_after_early_statement_effect | COMPLEXITY=7 | LINES=24
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=apply_state | COMPLEXITY=15 | LINES=20
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=compute_layout | COMPLEXITY=43 | LINES=109
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=insert_switch | COMPLEXITY=9 | LINES=30
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=insert_term_block | COMPLEXITY=3 | LINES=5
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=return_poll_ready_assign | COMPLEXITY=4 | LINES=16
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=insert_poll_ready_block | COMPLEXITY=3 | LINES=9
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=insert_panic_block | COMPLEXITY=5 | LINES=21
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=can_return | COMPLEXITY=5 | LINES=11
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=can_unwind | COMPLEXITY=31 | LINES=43
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=generate_poison_block_and_redirect_unwinds_there | COMPLEXITY=19 | LINES=32
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=create_coroutine_resume_function | COMPLEXITY=39 | LINES=77
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=target_block | COMPLEXITY=7 | LINES=9
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=create_cases | COMPLEXITY=24 | LINES=50
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=34
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=check_field_tys_sized | COMPLEXITY=15 | LINES=39
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=80 | LINES=223
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=STRUCT | NAME=EnsureCoroutineFieldAssignmentsNeverAlias | COMPLEXITY=8 | LINES=18
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=saved_local_for_direct_place | COMPLEXITY=11 | LINES=20
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=visit_place | COMPLEXITY=59 | LINES=91
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=check_suspend_tys | COMPLEXITY=15 | LINES=32
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=STRUCT | NAME=SuspendCheckData | COMPLEXITY=2 | LINES=9
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=check_must_not_suspend_ty | COMPLEXITY=74 | LINES=118
...
## Block 66
**Metadata**: AST_ID=66 | TYPE=FUNCTION | NAME=check_must_not_suspend_def | COMPLEXITY=9 | LINES=32
