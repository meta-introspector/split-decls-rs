# AST Trace: library/std/src/backtrace/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=generate_fake_frames | COMPLEXITY=13 | LINES=59

```rust
// SRC: library/std/src/backtrace/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_debug | COMPLEXITY=10 | LINES=22
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_frames | COMPLEXITY=10 | LINES=30
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=backtrace_unwind_safe | COMPLEXITY=3 | LINES=6
