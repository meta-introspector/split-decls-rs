# AST Trace: library/compiler-builtins/libm/src/math/log1pf.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log1pf | COMPLEXITY=43 | LINES=116

```rust
// SRC: library/compiler-builtins/libm/src/math/log1pf.rs
