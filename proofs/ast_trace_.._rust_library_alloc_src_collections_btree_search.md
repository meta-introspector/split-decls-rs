# AST Trace: ../rust/library/alloc/src/collections/btree/search.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=103 | LINES=145
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=find_lower_bound_index | COMPLEXITY=118 | LINES=104
