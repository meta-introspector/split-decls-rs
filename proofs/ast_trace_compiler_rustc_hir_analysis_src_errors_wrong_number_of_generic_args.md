# AST Trace: compiler/rustc_hir_analysis/src/errors/wrong_number_of_generic_args.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/errors/wrong_number_of_generic_args.rs
