# AST Trace: library/core/src/slice/sort/unstable/heapsort.rs
...
```rust
// SRC: library/core/src/slice/sort/unstable/heapsort.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=28
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=34 | LINES=46
