# AST Trace: compiler/rustc_type_ir/src/upcast.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=upcast | COMPLEXITY=3 | LINES=21

```rust
// SRC: compiler/rustc_type_ir/src/upcast.rs
