# AST Trace: ../rust/library/coretests/tests/fmt/mod.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_lifetime | COMPLEXITY=7 | LINES=18
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_format_flags | COMPLEXITY=6 | LINES=9
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_pointer_formats_data_pointer | COMPLEXITY=6 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_fmt_debug_of_raw_pointers | COMPLEXITY=18 | LINES=23
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_estimated_capacity | COMPLEXITY=10 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=pad_integral_resets | COMPLEXITY=7 | LINES=15
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_maybe_uninit_short | COMPLEXITY=3 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=formatting_options_ctor | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=formatting_options_flags | COMPLEXITY=18 | LINES=44
