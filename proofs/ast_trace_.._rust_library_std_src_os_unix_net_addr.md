# AST Trace: ../rust/library/std/src/os/unix/net/addr.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=sockaddr; | COMPLEXITY=3 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=27 | LINES=38
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=15
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=SocketAddr | COMPLEXITY=2 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=from_pathname | COMPLEXITY=73 | LINES=165
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=as_abstract_name | COMPLEXITY=20 | LINES=35
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=11 | LINES=11
