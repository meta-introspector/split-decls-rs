# AST Trace: library/portable-simd/crates/core_simd/src/ops.rs
...
```rust
// SRC: library/portable-simd/crates/core_simd/src/ops.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=index | COMPLEXITY=6 | LINES=26

```rust
// MOD DECLARATION: assign (from library/portable-simd/crates/core_simd/src/ops.rs)
// REPLACED: mod assign; -> use crate::assign::*;
use crate::assign::*;
// MOD DECLARATION: deref (from library/portable-simd/crates/core_simd/src/ops.rs)
// REPLACED: mod deref; -> use crate::deref::*;
use crate::deref::*;
// MOD DECLARATION: shift_scalar (from library/portable-simd/crates/core_simd/src/ops.rs)
// REPLACED: mod shift_scalar; -> use crate::shift_scalar::*;
use crate::shift_scalar::*;
// MOD DECLARATION: unary (from library/portable-simd/crates/core_simd/src/ops.rs)
// REPLACED: mod unary; -> use crate::unary::*;
use crate::unary::*;
