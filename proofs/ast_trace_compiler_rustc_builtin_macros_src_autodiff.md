# AST Trace: compiler/rustc_builtin_macros/src/autodiff.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=has_ret | COMPLEXITY=452 | LINES=894

```rust
// SRC: compiler/rustc_builtin_macros/src/autodiff.rs
