# AST Trace: compiler/rustc_middle/src/mir/loops.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=maybe_loop_headers | COMPLEXITY=29 | LINES=44

```rust
// SRC: compiler/rustc_middle/src/mir/loops.rs
