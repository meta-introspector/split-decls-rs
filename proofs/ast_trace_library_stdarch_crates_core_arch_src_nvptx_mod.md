# AST Trace: library/stdarch/crates/core_arch/src/nvptx/mod.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=syncthreads | COMPLEXITY=11 | LINES=68

```rust
// SRC: library/stdarch/crates/core_arch/src/nvptx/mod.rs
...
// MOD DECLARATION: packed (from library/stdarch/crates/core_arch/src/nvptx/mod.rs)
// REPLACED: mod packed; -> use crate::packed::*;
use crate::packed::*;
