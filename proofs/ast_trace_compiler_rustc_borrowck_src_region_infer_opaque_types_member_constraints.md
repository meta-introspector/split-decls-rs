# AST Trace: compiler/rustc_borrowck/src/region_infer/opaque_types/member_constraints.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/region_infer/opaque_types/member_constraints.rs
