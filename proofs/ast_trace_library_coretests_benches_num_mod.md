# AST Trace: library/coretests/benches/num/mod.rs
...
```rust
// SRC: library/coretests/benches/num/mod.rs
...
// MOD DECLARATION: dec2flt (from library/coretests/benches/num/mod.rs)
// REPLACED: mod dec2flt; -> use crate::dec2flt::*;
use crate::dec2flt::*;
// MOD DECLARATION: flt2dec (from library/coretests/benches/num/mod.rs)
// REPLACED: mod flt2dec; -> use crate::flt2dec::*;
use crate::flt2dec::*;
// MOD DECLARATION: int_log (from library/coretests/benches/num/mod.rs)
// REPLACED: mod int_log; -> use crate::int_log::*;
use crate::int_log::*;
// MOD DECLARATION: int_pow (from library/coretests/benches/num/mod.rs)
// REPLACED: mod int_pow; -> use crate::int_pow::*;
use crate::int_pow::*;
// MOD DECLARATION: int_sqrt (from library/coretests/benches/num/mod.rs)
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=$mac | COMPLEXITY=11 | LINES=38
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=$mac | COMPLEXITY=10 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=48
