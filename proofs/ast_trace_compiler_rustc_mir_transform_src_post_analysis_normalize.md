# AST Trace: compiler/rustc_mir_transform/src/post_analysis_normalize.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/post_analysis_normalize.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=8 | LINES=15
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=PostAnalysisNormalizeVisitor | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=28 | LINES=54
