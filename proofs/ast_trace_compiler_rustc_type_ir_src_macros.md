# AST Trace: compiler/rustc_type_ir/src/macros.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=try_fold_with | COMPLEXITY=22 | LINES=53

```rust
// SRC: compiler/rustc_type_ir/src/macros.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=27
