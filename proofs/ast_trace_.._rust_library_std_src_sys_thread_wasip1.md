# AST Trace: ../rust/library/std/src/sys/thread/wasip1.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=pthread_attr_t | COMPLEXITY=24 | LINES=44
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Thread | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=10 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=join | COMPLEXITY=83 | LINES=67
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=available_parallelism | COMPLEXITY=11 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=yield_now | COMPLEXITY=7 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=sleep | COMPLEXITY=22 | LINES=36
