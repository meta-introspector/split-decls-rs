# AST Trace: library/test/src/stats/tests.rs

Generated 22 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=13 | LINES=33

```rust
// SRC: library/test/src/stats/tests.rs
...
// SRC: library/test/src/stats/tests.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/library/test/src/stats/tests.rs
use super::*;
