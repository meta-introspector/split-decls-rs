# AST Trace: compiler/rustc_trait_selection/src/lib.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=MODULE | NAME=UNNAMED | COMPLEXITY=5 | LINES=57

```rust
// SRC: compiler/rustc_trait_selection/src/lib.rs
