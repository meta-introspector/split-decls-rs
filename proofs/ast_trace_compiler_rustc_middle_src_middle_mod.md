# AST Trace: compiler/rustc_middle/src/middle/mod.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=LibFeatures | COMPLEXITY=12 | LINES=47

```rust
// SRC: compiler/rustc_middle/src/middle/mod.rs
