# AST Trace: library/alloctests/tests/autotraits.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=require_sync | COMPLEXITY=3 | LINES=18

```rust
// SRC: library/alloctests/tests/autotraits.rs
