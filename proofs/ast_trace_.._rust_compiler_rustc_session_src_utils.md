# AST Trace: ../rust/compiler/rustc_session/src/utils.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=timer | COMPLEXITY=4 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=NativeLib | COMPLEXITY=2 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=has_modifiers | COMPLEXITY=3 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=CanonicalizedPath | COMPLEXITY=2 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=new | COMPLEXITY=6 | LINES=14
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=extra_compiler_flags | COMPLEXITY=36 | LINES=48
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=was_invoked_from_cargo | COMPLEXITY=3 | LINES=15
