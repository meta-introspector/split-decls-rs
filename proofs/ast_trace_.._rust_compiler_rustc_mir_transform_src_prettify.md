# AST Trace: ../rust/compiler/rustc_mir_transform/src/prettify.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=27 | LINES=54
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=BasicBlockUpdater | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=6 | LINES=10
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=LocalFinder | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=track | COMPLEXITY=6 | LINES=8
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=visit_local | COMPLEXITY=8 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=LocalUpdater | COMPLEXITY=2 | LINES=5
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=6 | LINES=10
