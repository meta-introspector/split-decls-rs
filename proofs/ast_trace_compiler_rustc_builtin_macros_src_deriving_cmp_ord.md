# AST Trace: compiler/rustc_builtin_macros/src/deriving/cmp/ord.rs
...
```rust
// SRC: compiler/rustc_builtin_macros/src/deriving/cmp/ord.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=38
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=16 | LINES=39
