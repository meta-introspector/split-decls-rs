# AST Trace: library/coretests/tests/num/flt2dec/estimator.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_estimate_scaling_factor | COMPLEXITY=31 | LINES=81

```rust
// SRC: library/coretests/tests/num/flt2dec/estimator.rs
