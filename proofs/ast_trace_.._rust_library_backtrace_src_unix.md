# AST Trace: ../rust/library/backtrace/src/unix.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=print | COMPLEXITY=54 | LINES=122
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=print | COMPLEXITY=119 | LINES=192
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=output | COMPLEXITY=8 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=output_fileline | COMPLEXITY=9 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=_Unwind_Backtrace | COMPLEXITY=36 | LINES=124
