# AST Trace: ../rust/compiler/rustc_codegen_ssa/src/back/apple/tests.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_add_version_to_llvm_target | COMPLEXITY=2 | LINES=13
