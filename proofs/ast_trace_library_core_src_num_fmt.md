# AST Trace: library/core/src/num/fmt.rs
...
```rust
// SRC: library/core/src/num/fmt.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=len | COMPLEXITY=29 | LINES=39
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Formatted | COMPLEXITY=2 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=len | COMPLEXITY=10 | LINES=21
