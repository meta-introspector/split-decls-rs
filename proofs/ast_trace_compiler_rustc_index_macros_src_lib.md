# AST Trace: compiler/rustc_index_macros/src/lib.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=newtype_index | COMPLEXITY=10 | LINES=59

```rust
// SRC: compiler/rustc_index_macros/src/lib.rs
...
// MOD DECLARATION: newtype (from compiler/rustc_index_macros/src/lib.rs)
// REPLACED: mod newtype; -> use crate::newtype::*;
use crate::newtype::*;
