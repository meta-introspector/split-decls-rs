# AST Trace: library/std/src/sys/env/uefi.rs
...
```rust
// SRC: library/std/src/sys/env/uefi.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=env | COMPLEXITY=2 | LINES=6
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=getenv | COMPLEXITY=2 | LINES=4
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=4
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=4
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=84 | LINES=82
