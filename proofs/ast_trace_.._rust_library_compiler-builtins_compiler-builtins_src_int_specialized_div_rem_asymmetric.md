# AST Trace: ../rust/library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/asymmetric.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=56 | LINES=69
