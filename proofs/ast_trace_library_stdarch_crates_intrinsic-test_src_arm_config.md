# AST Trace: library/stdarch/crates/intrinsic-test/src/arm/config.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=build_notices | COMPLEXITY=9 | LINES=26

```rust
// SRC: library/stdarch/crates/intrinsic-test/src/arm/config.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=debug_simd_finish | COMPLEXITY=20 | LINES=51
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=47 | LINES=61
