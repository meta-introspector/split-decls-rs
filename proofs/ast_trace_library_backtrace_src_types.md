# AST Trace: library/backtrace/src/types.rs
...
```rust
// SRC: library/backtrace/src/types.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=11
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=to_str_lossy | COMPLEXITY=29 | LINES=54
