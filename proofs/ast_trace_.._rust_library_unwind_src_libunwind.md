# AST Trace: ../rust/library/unwind/src/libunwind.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=15
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=_Unwind_Exception | COMPLEXITY=7 | LINES=74
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=2
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=_Unwind_Resume | COMPLEXITY=8 | LINES=22
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=_Unwind_DeleteException | COMPLEXITY=6 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=_Unwind_GetGR | COMPLEXITY=89 | LINES=142
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=_Unwind_SjLj_RaiseException | COMPLEXITY=23 | LINES=30
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=_GCC_specific_handler | COMPLEXITY=18 | LINES=31
