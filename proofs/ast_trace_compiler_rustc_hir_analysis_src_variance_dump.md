# AST Trace: compiler/rustc_hir_analysis/src/variance/dump.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/variance/dump.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=24
