# AST Trace: compiler/rustc_parse/src/parser/cfg_select.rs
...
```rust
// SRC: compiler/rustc_parse/src/parser/cfg_select.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=CfgSelectBranches | COMPLEXITY=5 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=parse_token_tree | COMPLEXITY=16 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=parse_cfg_select | COMPLEXITY=21 | LINES=36
