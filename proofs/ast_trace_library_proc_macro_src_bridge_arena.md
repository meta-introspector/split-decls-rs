# AST Trace: library/proc_macro/src/bridge/arena.rs
...
```rust
// SRC: library/proc_macro/src/bridge/arena.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=22
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=grow | COMPLEXITY=43 | LINES=80
