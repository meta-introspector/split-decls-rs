# AST Trace: library/alloctests/tests/thin_box.rs

Generated 21 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=want_niche_optimization | COMPLEXITY=6 | LINES=31

```rust
// SRC: library/alloctests/tests/thin_box.rs
