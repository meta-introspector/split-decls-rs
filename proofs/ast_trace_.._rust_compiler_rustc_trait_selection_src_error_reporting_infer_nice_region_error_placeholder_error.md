# AST Trace: ../rust/compiler/rustc_trait_selection/src/error_reporting/infer/nice_region_error/placeholder_error.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=Highlighted | COMPLEXITY=2 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=into_diag_arg | COMPLEXITY=5 | LINES=9
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=map | COMPLEXITY=4 | LINES=6
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=try_report_trait_placeholder_mismatch | COMPLEXITY=160 | LINES=441
