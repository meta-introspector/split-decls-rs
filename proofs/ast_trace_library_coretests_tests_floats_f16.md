# AST Trace: library/coretests/tests/floats/f16.rs
...
```rust
// SRC: library/coretests/tests/floats/f16.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_mul_add | COMPLEXITY=12 | LINES=37
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_max_recip | COMPLEXITY=2 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_from | COMPLEXITY=2 | LINES=12
