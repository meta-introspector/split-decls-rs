# AST Trace: compiler/rustc_resolve/src/lib.rs

Generated 88 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=44

```rust
// SRC: compiler/rustc_resolve/src/lib.rs
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=39
...
// MOD DECLARATION: build_reduced_graph (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod build_reduced_graph; -> use crate::build_reduced_graph::*;
use crate::build_reduced_graph::*;
// MOD DECLARATION: check_unused (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod check_unused; -> use crate::check_unused::*;
use crate::check_unused::*;
// MOD DECLARATION: def_collector (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod def_collector; -> use crate::def_collector::*;
use crate::def_collector::*;
// MOD DECLARATION: diagnostics (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod diagnostics; -> use crate::diagnostics::*;
use crate::diagnostics::*;
// MOD DECLARATION: effective_visibilities (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod effective_visibilities; -> use crate::effective_visibilities::*;
use crate::effective_visibilities::*;
// MOD DECLARATION: errors (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod errors; -> use crate::errors::*;
use crate::errors::*;
// MOD DECLARATION: ident (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod ident; -> use crate::ident::*;
use crate::ident::*;
// MOD DECLARATION: imports (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod imports; -> use crate::imports::*;
use crate::imports::*;
// MOD DECLARATION: late (from compiler/rustc_resolve/src/lib.rs)
// REPLACED: mod late; -> use crate::late::*;
use crate::late::*;
// MOD DECLARATION: macros (from compiler/rustc_resolve/src/lib.rs)
