# AST Trace: ../rust/library/core/src/slice/iter/macros.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=53 | LINES=37
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=10
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=15 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=$name:ident | COMPLEXITY=304 | LINES=424
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=next | COMPLEXITY=17 | LINES=25
