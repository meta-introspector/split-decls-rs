# AST Trace: library/coretests/tests/iter/traits/double_ended.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_rev_nth_back | COMPLEXITY=8 | LINES=38

```rust
// SRC: library/coretests/tests/iter/traits/double_ended.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_iterator_rev_nth | COMPLEXITY=5 | LINES=9
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_rev | COMPLEXITY=2 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_rev_try_folds | COMPLEXITY=3 | LINES=15
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_rposition | COMPLEXITY=4 | LINES=16
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_rev_rposition | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_rposition_panic | COMPLEXITY=6 | LINES=15
