# AST Trace: compiler/rustc_ast_pretty/src/pp/convenience.rs
...
```rust
// SRC: compiler/rustc_ast_pretty/src/pp/convenience.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=rbox | COMPLEXITY=33 | LINES=86
