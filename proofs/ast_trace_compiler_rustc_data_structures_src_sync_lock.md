# AST Trace: compiler/rustc_data_structures/src/sync/lock.rs

Generated 16 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=6 | LINES=25

```rust
// SRC: compiler/rustc_data_structures/src/sync/lock.rs
