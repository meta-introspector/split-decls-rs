# AST Trace: compiler/rustc_lint/src/unit_bindings.rs
...
```rust
// SRC: compiler/rustc_lint/src/unit_bindings.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=16 | LINES=40
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=check_local | COMPLEXITY=13 | LINES=28
