# AST Trace: compiler/rustc_index/src/interval/tests.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=insert_collapses | COMPLEXITY=3 | LINES=24

```rust
// SRC: compiler/rustc_index/src/interval/tests.rs
