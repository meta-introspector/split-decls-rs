# AST Trace: ../rust/library/core/src/iter/adapters/chain.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Chain | COMPLEXITY=10 | LINES=33
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=chain | COMPLEXITY=5 | LINES=31
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=next | COMPLEXITY=75 | LINES=132
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=next_back | COMPLEXITY=48 | LINES=86
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=8
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=default | COMPLEXITY=9 | LINES=23
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=and_then_or_clear | COMPLEXITY=5 | LINES=9
