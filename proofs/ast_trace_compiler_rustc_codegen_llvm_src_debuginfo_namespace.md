# AST Trace: compiler/rustc_codegen_llvm/src/debuginfo/namespace.rs
...
```rust
// SRC: compiler/rustc_codegen_llvm/src/debuginfo/namespace.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=30
