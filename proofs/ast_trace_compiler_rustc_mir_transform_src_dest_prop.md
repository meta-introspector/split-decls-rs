# AST Trace: compiler/rustc_mir_transform/src/dest_prop.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=21

```rust
// SRC: compiler/rustc_mir_transform/src/dest_prop.rs
