# AST Trace: library/proc_macro/src/bridge/client.rs

Generated 20 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=50 | LINES=114

```rust
// SRC: library/proc_macro/src/bridge/client.rs
