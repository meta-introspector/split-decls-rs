# AST Trace: library/portable-simd/crates/core_simd/tests/ops_macros.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=17 | LINES=35

```rust
// SRC: library/portable-simd/crates/core_simd/tests/ops_macros.rs
