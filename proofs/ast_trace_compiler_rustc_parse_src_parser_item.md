# AST Trace: compiler/rustc_parse/src/parser/item.rs
...
```rust
// SRC: compiler/rustc_parse/src/parser/item.rs
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=parse_crate_mod | COMPLEXITY=17 | LINES=27
