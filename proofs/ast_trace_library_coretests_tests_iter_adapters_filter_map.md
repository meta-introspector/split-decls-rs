# AST Trace: library/coretests/tests/iter/adapters/filter_map.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_filter_map | COMPLEXITY=8 | LINES=22

```rust
// SRC: library/coretests/tests/iter/adapters/filter_map.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_filter_map_fold | COMPLEXITY=13 | LINES=19
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_filter_map_try_folds | COMPLEXITY=11 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_double_ended_filter_map | COMPLEXITY=6 | LINES=10
