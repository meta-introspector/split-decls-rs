# AST Trace: compiler/rustc_span/src/tests.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_lookup_line | COMPLEXITY=5 | LINES=42

```rust
// SRC: compiler/rustc_span/src/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_normalize_newlines | COMPLEXITY=4 | LINES=23
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_trim | COMPLEXITY=13 | LINES=57
