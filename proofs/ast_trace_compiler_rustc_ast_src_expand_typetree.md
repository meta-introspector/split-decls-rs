# AST Trace: compiler/rustc_ast/src/expand/typetree.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=26

```rust
// SRC: compiler/rustc_ast/src/expand/typetree.rs
