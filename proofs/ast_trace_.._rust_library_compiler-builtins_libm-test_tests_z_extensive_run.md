# AST Trace: ../rust/library/compiler-builtins/libm-test/tests/z_extensive/run.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=run | COMPLEXITY=3 | LINES=26
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=11
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=register_all_tests | COMPLEXITY=5 | LINES=18
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=register_single_test | COMPLEXITY=18 | LINES=32
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=run_single_test | COMPLEXITY=22 | LINES=54
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=Progress | COMPLEXITY=2 | LINES=8
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=new | COMPLEXITY=58 | LINES=82
