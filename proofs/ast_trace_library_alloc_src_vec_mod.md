# AST Trace: library/alloc/src/vec/mod.rs

Generated 59 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=14 | LINES=96

```rust
// SRC: library/alloc/src/vec/mod.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=80
...
// MOD DECLARATION: extract_if (from library/alloc/src/vec/mod.rs)
// REPLACED: mod extract_if; -> use crate::extract_if::*;
use crate::extract_if::*;
...
#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: splice (from library/alloc/src/vec/mod.rs)
// REPLACED: mod splice; -> use crate::splice::*;
use crate::splice::*;

#[stable(feature = "drain", since = "1.6.0")]
pub use self::drain::Drain;

// MOD DECLARATION: drain (from library/alloc/src/vec/mod.rs)
// REPLACED: mod drain; -> use crate::drain::*;
use crate::drain::*;

#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: cow (from library/alloc/src/vec/mod.rs)
// REPLACED: mod cow; -> use crate::cow::*;
use crate::cow::*;
...
// MOD DECLARATION: into_iter (from library/alloc/src/vec/mod.rs)
// REPLACED: mod into_iter; -> use crate::into_iter::*;
use crate::into_iter::*;
...
#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: is_zero (from library/alloc/src/vec/mod.rs)
// REPLACED: mod is_zero; -> use crate::is_zero::*;
use crate::is_zero::*;

#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: in_place_collect (from library/alloc/src/vec/mod.rs)
// REPLACED: mod in_place_collect; -> use crate::in_place_collect::*;
use crate::in_place_collect::*;

// MOD DECLARATION: partial_eq (from library/alloc/src/vec/mod.rs)
// REPLACED: mod partial_eq; -> use crate::partial_eq::*;
use crate::partial_eq::*;

#[unstable(feature = "vec_peek_mut", issue = "122742")]
pub use self::peek_mut::PeekMut;

// MOD DECLARATION: peek_mut (from library/alloc/src/vec/mod.rs)
// REPLACED: mod peek_mut; -> use crate::peek_mut::*;
use crate::peek_mut::*;
...
#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: spec_from_elem (from library/alloc/src/vec/mod.rs)
// REPLACED: mod spec_from_elem; -> use crate::spec_from_elem::*;
use crate::spec_from_elem::*;

#[cfg(not(no_global_oom_handling))]
use self::set_len_on_drop::SetLenOnDrop;

#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: set_len_on_drop (from library/alloc/src/vec/mod.rs)
// REPLACED: mod set_len_on_drop; -> use crate::set_len_on_drop::*;
use crate::set_len_on_drop::*;
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=10 | LINES=53

```rust
#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: in_place_drop (from library/alloc/src/vec/mod.rs)
// REPLACED: mod in_place_drop; -> use crate::in_place_drop::*;
use crate::in_place_drop::*;

#[cfg(not(no_global_oom_handling))]
use self::spec_from_iter_nested::SpecFromIterNested;

#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: spec_from_iter_nested (from library/alloc/src/vec/mod.rs)
// REPLACED: mod spec_from_iter_nested; -> use crate::spec_from_iter_nested::*;
use crate::spec_from_iter_nested::*;

#[cfg(not(no_global_oom_handling))]
use self::spec_from_iter::SpecFromIter;

#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: spec_from_iter (from library/alloc/src/vec/mod.rs)
// REPLACED: mod spec_from_iter; -> use crate::spec_from_iter::*;
use crate::spec_from_iter::*;

#[cfg(not(no_global_oom_handling))]
use self::spec_extend::SpecExtend;

#[cfg(not(no_global_oom_handling))]
// MOD DECLARATION: spec_extend (from library/alloc/src/vec/mod.rs)
// REPLACED: mod spec_extend; -> use crate::spec_extend::*;
use crate::spec_extend::*;
