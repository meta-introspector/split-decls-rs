# AST Trace: ../rust/compiler/rustc_hir_typeck/src/fn_ctxt/adjust_fulfillment_errors.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=index | COMPLEXITY=7 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=point_at_expr_if_possible | COMPLEXITY=452 | LINES=1013
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=find_param_in_ty | COMPLEXITY=13 | LINES=21
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=11
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=is_iterator_singleton | COMPLEXITY=8 | LINES=11
