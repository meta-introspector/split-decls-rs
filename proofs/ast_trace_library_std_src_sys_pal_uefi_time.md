# AST Trace: library/std/src/sys/pal/uefi/time.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Instant(Duration); | COMPLEXITY=5 | LINES=42

```rust
// SRC: library/std/src/sys/pal/uefi/time.rs
