# AST Trace: compiler/rustc_mir_transform/src/gvn.rs

Generated 19 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=89

```rust
// SRC: compiler/rustc_mir_transform/src/gvn.rs
