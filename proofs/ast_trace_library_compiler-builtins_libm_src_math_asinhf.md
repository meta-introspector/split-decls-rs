# AST Trace: library/compiler-builtins/libm/src/math/asinhf.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/asinhf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=asinhf | COMPLEXITY=20 | LINES=34
