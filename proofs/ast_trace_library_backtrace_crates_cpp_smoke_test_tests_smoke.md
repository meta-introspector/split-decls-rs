# AST Trace: library/backtrace/crates/cpp_smoke_test/tests/smoke.rs
...
```rust
// SRC: library/backtrace/crates/cpp_smoke_test/tests/smoke.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cpp_trampoline | COMPLEXITY=6 | LINES=4
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=smoke_test_cpp | COMPLEXITY=22 | LINES=65
