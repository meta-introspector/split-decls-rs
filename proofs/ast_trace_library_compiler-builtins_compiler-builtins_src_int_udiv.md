# AST Trace: library/compiler-builtins/compiler-builtins/src/int/udiv.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=34

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/udiv.rs
