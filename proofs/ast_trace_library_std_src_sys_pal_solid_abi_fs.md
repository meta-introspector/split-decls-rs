# AST Trace: library/std/src/sys/pal/solid/abi/fs.rs
...
```rust
// SRC: library/std/src/sys/pal/solid/abi/fs.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=dirent | COMPLEXITY=2 | LINES=12
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=SOLID_FS_Open | COMPLEXITY=9 | LINES=34
