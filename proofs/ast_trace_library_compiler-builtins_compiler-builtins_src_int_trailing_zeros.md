# AST Trace: library/compiler-builtins/compiler-builtins/src/int/trailing_zeros.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=trailing_zeros | COMPLEXITY=21 | LINES=67

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/trailing_zeros.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=22
