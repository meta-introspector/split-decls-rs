# AST Trace: ../rust/library/stdarch/crates/intrinsic-test/src/common/intrinsic_helpers.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=15
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=from_str | COMPLEXITY=12 | LINES=21
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=11 | LINES=21
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=c_prefix | COMPLEXITY=21 | LINES=28
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=IntrinsicType | COMPLEXITY=11 | LINES=26
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=kind | COMPLEXITY=120 | LINES=189
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=get_load_function | COMPLEXITY=7 | LINES=16
