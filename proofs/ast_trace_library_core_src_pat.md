# AST Trace: library/core/src/pat.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=12 | LINES=31

```rust
// SRC: library/core/src/pat.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sub_one | COMPLEXITY=12 | LINES=24
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=sub_one | COMPLEXITY=17 | LINES=18
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=sub_one | COMPLEXITY=9 | LINES=14
