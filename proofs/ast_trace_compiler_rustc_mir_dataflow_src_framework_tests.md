# AST Trace: compiler/rustc_mir_dataflow/src/framework/tests.rs

Generated 11 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=mock_body | COMPLEXITY=14 | LINES=76

```rust
// SRC: compiler/rustc_mir_dataflow/src/framework/tests.rs
...
// SRC: compiler/rustc_mir_dataflow/src/framework/tests.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/compiler/rustc_mir_dataflow/src/framework/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=MockAnalysis | COMPLEXITY=2 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=mock_entry_set | COMPLEXITY=40 | LINES=75
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=bottom_value | COMPLEXITY=13 | LINES=56
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=block | COMPLEXITY=15 | LINES=28
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_cursor | COMPLEXITY=19 | LINES=41
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=backward_cursor | COMPLEXITY=3 | LINES=8
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=forward_cursor | COMPLEXITY=3 | LINES=8
