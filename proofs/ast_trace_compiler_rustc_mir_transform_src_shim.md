# AST Trace: compiler/rustc_mir_transform/src/shim.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/shim.rs
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=8

```rust
// MOD DECLARATION: async_destructor_ctor (from compiler/rustc_mir_transform/src/shim.rs)
// REPLACED: mod async_destructor_ctor; -> use crate::async_destructor_ctor::*;
use crate::async_destructor_ctor::*;
