# AST Trace: library/compiler-builtins/libm/src/math/support/env.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=FpResult | COMPLEXITY=10 | LINES=36

```rust
// SRC: library/compiler-builtins/libm/src/math/support/env.rs
