# AST Trace: compiler/rustc_middle/src/ty/cast.rs
...
```rust
// SRC: compiler/rustc_middle/src/ty/cast.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=is_signed | COMPLEXITY=3 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=6 | LINES=14
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=from_ty | COMPLEXITY=13 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=mir_cast_kind | COMPLEXITY=12 | LINES=24
