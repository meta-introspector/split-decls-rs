# AST Trace: compiler/rustc_sanitizers/src/kcfi/typeid/mod.rs
...
```rust
// SRC: compiler/rustc_sanitizers/src/kcfi/typeid/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=typeid_for_fnabi | COMPLEXITY=5 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=typeid_for_instance | COMPLEXITY=20 | LINES=31
