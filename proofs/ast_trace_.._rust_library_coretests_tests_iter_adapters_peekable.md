# AST Trace: ../rust/library/coretests/tests/iter/adapters/peekable.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_peekable | COMPLEXITY=5 | LINES=62
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_iterator_peekable_count | COMPLEXITY=3 | LINES=24
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_iterator_peekable_nth | COMPLEXITY=2 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_iterator_peekable_last | COMPLEXITY=2 | LINES=19
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_iterator_peekable_fold | COMPLEXITY=3 | LINES=12
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_iterator_peekable_rfold | COMPLEXITY=3 | LINES=12
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_iterator_peekable_next_if_eq | COMPLEXITY=5 | LINES=24
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_iterator_peekable_mut | COMPLEXITY=8 | LINES=11
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_iterator_peekable_remember_peek_none_1 | COMPLEXITY=10 | LINES=18
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_iterator_peekable_remember_peek_none_2 | COMPLEXITY=2 | LINES=9
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_iterator_peekable_remember_peek_none_3 | COMPLEXITY=2 | LINES=13
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_peek_try_folds | COMPLEXITY=5 | LINES=47
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_peekable_non_fused | COMPLEXITY=2 | LINES=8
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_peekable_next_if_map_mutation | COMPLEXITY=8 | LINES=20
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_peekable_next_if_map_panic | COMPLEXITY=19 | LINES=66
