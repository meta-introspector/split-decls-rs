# AST Trace: ../rust/library/std/src/sync/poison/once.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=22
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Once | COMPLEXITY=2 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=OnceState | COMPLEXITY=2 | LINES=7
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=call_once | COMPLEXITY=74 | LINES=263
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=is_poisoned | COMPLEXITY=13 | LINES=49
