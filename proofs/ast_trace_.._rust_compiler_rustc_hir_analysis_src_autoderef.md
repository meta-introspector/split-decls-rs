# AST Trace: ../rust/compiler/rustc_hir_analysis/src/autoderef.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=AutoderefSnapshot | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=Autoderef | COMPLEXITY=3 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=next | COMPLEXITY=43 | LINES=66
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=new | COMPLEXITY=56 | LINES=143
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=report_autoderef_recursion_limit_error | COMPLEXITY=7 | LINES=18
