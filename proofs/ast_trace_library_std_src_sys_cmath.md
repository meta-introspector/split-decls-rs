# AST Trace: library/std/src/sys/cmath.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=65

```rust
// SRC: library/std/src/sys/cmath.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=acosf | COMPLEXITY=22 | LINES=59
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=lgammaf_r | COMPLEXITY=2 | LINES=7
