# AST Trace: library/alloc/src/collections/btree/append.rs
...
```rust
// SRC: library/alloc/src/collections/btree/append.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=40 | LINES=91
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=MergeIter | COMPLEXITY=8 | LINES=16
