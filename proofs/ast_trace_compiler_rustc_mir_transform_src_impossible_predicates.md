# AST Trace: compiler/rustc_mir_transform/src/impossible_predicates.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=21

```rust
// SRC: compiler/rustc_mir_transform/src/impossible_predicates.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=23
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=13 | LINES=39
