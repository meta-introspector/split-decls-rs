# AST Trace: compiler/rustc_interface/src/queries.rs
...
```rust
// SRC: compiler/rustc_interface/src/queries.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Linker | COMPLEXITY=2 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=codegen_and_build_linker | COMPLEXITY=27 | LINES=84
