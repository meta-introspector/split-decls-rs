# AST Trace: ../rust/library/std/src/sys/stdio/uefi.rs

Generated 16 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Stdin | COMPLEXITY=2 | LINES=10
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=IncompleteUtf8 | COMPLEXITY=2 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=read | COMPLEXITY=14 | LINES=23
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=Stdout; | COMPLEXITY=4 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=read | COMPLEXITY=40 | LINES=55
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=write | COMPLEXITY=11 | LINES=13
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=write | COMPLEXITY=11 | LINES=13
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=is_ebadf | COMPLEXITY=6 | LINES=11
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=panic_output | COMPLEXITY=2 | LINES=4
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=write | COMPLEXITY=17 | LINES=19
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=8
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=simple_text_input_read | COMPLEXITY=11 | LINES=12
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=wait_stdin | COMPLEXITY=18 | LINES=13
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=read_key_stroke | COMPLEXITY=17 | LINES=16
