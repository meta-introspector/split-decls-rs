# AST Trace: library/std/src/sys/alloc/unix.rs
...
```rust
// SRC: library/std/src/sys/alloc/unix.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=99 | LINES=57
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=34 | LINES=28
