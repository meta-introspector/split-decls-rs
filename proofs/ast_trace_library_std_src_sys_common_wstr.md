# AST Trace: library/std/src/sys_common/wstr.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=WStrUnits | COMPLEXITY=6 | LINES=30

```rust
// SRC: library/std/src/sys_common/wstr.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=peek | COMPLEXITY=27 | LINES=30
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=next | COMPLEXITY=10 | LINES=15
