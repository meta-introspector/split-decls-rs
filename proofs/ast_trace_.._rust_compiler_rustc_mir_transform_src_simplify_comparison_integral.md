# AST Trace: ../rust/compiler/rustc_mir_transform/src/simplify_comparison_integral.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=88 | LINES=141
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=OptimizationFinder | COMPLEXITY=2 | LINES=4
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=find_optimizations | COMPLEXITY=28 | LINES=51
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=find_branch_value_info | COMPLEXITY=16 | LINES=23
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=OptimizationInfo | COMPLEXITY=5 | LINES=21
