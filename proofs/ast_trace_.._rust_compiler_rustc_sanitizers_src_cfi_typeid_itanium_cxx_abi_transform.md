# AST Trace: ../rust/compiler/rustc_sanitizers/src/cfi/typeid/itanium_cxx_abi/transform.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=12
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=fold_ty | COMPLEXITY=117 | LINES=194
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=trait_object_ty | COMPLEXITY=13 | LINES=41
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=107 | LINES=187
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=implemented_method | COMPLEXITY=11 | LINES=32
