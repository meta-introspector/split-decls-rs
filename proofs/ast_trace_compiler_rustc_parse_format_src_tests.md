# AST Trace: compiler/rustc_parse_format/src/tests.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=same | COMPLEXITY=4 | LINES=26

```rust
// SRC: compiler/rustc_parse_format/src/tests.rs
