# AST Trace: compiler/rustc_builtin_macros/src/source_util.rs
...
```rust
// SRC: compiler/rustc_builtin_macros/src/source_util.rs
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=ExpandInclude | COMPLEXITY=47 | LINES=99
