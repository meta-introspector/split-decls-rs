# AST Trace: ../rust/library/compiler-builtins/libm/configure.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Config | COMPLEXITY=3 | LINES=23
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=from_env | COMPLEXITY=7 | LINES=32
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=emit_libm_config | COMPLEXITY=2 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=emit_test_config | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=emit_intrinsics_cfg | COMPLEXITY=7 | LINES=12
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=emit_arch_cfg | COMPLEXITY=7 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=emit_optimization_cfg | COMPLEXITY=5 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=emit_cfg_shorthands | COMPLEXITY=7 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=emit_cfg_env | COMPLEXITY=7 | LINES=13
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=emit_f16_f128_cfg | COMPLEXITY=14 | LINES=26
