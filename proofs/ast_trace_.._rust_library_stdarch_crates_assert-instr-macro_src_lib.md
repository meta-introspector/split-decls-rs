# AST Trace: ../rust/library/stdarch/crates/assert-instr-macro/src/lib.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=assert_instr | COMPLEXITY=96 | LINES=160
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Invoc | COMPLEXITY=2 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=parse | COMPLEXITY=38 | LINES=45
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=Append | COMPLEXITY=8 | LINES=14
