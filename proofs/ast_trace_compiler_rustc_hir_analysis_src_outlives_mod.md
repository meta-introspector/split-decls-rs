# AST Trace: compiler/rustc_hir_analysis/src/outlives/mod.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/outlives/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=29 | LINES=50

```rust
use rustc_span::Span;

pub(crate) mod dump;
// MOD DECLARATION: explicit (from compiler/rustc_hir_analysis/src/outlives/mod.rs)
// REPLACED: mod explicit; -> use crate::explicit::*;
use crate::explicit::*;
// MOD DECLARATION: implicit_infer (from compiler/rustc_hir_analysis/src/outlives/mod.rs)
// REPLACED: mod implicit_infer; -> use crate::implicit_infer::*;
use crate::implicit_infer::*;
// MOD DECLARATION: utils (from compiler/rustc_hir_analysis/src/outlives/mod.rs)
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=19 | LINES=49
