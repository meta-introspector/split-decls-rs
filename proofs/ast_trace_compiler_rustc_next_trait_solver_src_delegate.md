# AST Trace: compiler/rustc_next_trait_solver/src/delegate.rs
...
```rust
// SRC: compiler/rustc_next_trait_solver/src/delegate.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=9 | LINES=89
