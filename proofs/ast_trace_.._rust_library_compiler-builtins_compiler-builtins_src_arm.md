# AST Trace: ../rust/library/compiler-builtins/compiler-builtins/src/arm.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=__udivmodsi4 | COMPLEXITY=6 | LINES=7
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=__aeabi_idiv | COMPLEXITY=8 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=240 | LINES=266
