# AST Trace: library/core/src/ops/async_function.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=30

```rust
// SRC: library/core/src/ops/async_function.rs
