# AST Trace: ../rust/compiler/rustc_attr_parsing/src/attributes/crate_level.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=parse_limit_int | COMPLEXITY=18 | LINES=37
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=10 | LINES=33
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=9 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=9 | LINES=27
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=9 | LINES=27
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=9 | LINES=27
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=12
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=12
