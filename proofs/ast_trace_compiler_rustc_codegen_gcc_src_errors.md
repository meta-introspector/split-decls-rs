# AST Trace: compiler/rustc_codegen_gcc/src/errors.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=24

```rust
// SRC: compiler/rustc_codegen_gcc/src/errors.rs
