# AST Trace: compiler/rustc_trait_selection/src/traits/dyn_compatibility.rs

Generated 37 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=8 | LINES=28

```rust
// SRC: compiler/rustc_trait_selection/src/traits/dyn_compatibility.rs
