# AST Trace: ../rust/library/std/src/os/windows/ffi.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=17 | LINES=58
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=from_wide | COMPLEXITY=5 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=from_wide | COMPLEXITY=6 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=encode_wide | COMPLEXITY=6 | LINES=31
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=encode_wide | COMPLEXITY=6 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=EncodeWide | COMPLEXITY=2 | LINES=7
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=next | COMPLEXITY=6 | LINES=14
