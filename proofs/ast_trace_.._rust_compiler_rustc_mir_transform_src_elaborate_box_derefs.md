# AST Trace: ../rust/compiler/rustc_mir_transform/src/elaborate_box_derefs.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=build_ptr_tys | COMPLEXITY=3 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=ElaborateBoxDerefVisitor | COMPLEXITY=2 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=11 | LINES=46
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=37 | LINES=69
