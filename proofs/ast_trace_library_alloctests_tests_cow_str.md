# AST Trace: library/alloctests/tests/cow_str.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=check_cow_add_cow | COMPLEXITY=18 | LINES=47

```rust
// SRC: library/alloctests/tests/cow_str.rs
