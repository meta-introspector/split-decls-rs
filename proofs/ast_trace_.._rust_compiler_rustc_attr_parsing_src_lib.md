# AST Trace: ../rust/compiler/rustc_attr_parsing/src/lib.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=15 | LINES=73
...
// - [crate::rustc_hir::attrs](https://doc.rust-lang.org/nightly/nightly-rustc/rustc_hir/index.html): Defines the data structures that store parsed attributes
...
// Data structures (`crate::rustc_hir::attrs`) define what attributes look like after parsing.
...
// [`AttributeKind::Stability`](crate::rustc_hir::attrs::AttributeKind::Stability).
//
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=35
