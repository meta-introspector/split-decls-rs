# AST Trace: compiler/rustc_span/src/source_map/tests.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=init_source_map | COMPLEXITY=4 | LINES=26

```rust
// SRC: compiler/rustc_span/src/source_map/tests.rs
