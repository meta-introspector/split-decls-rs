# AST Trace: compiler/rustc_passes/src/reachable.rs

Generated 16 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=15 | LINES=46

```rust
// SRC: compiler/rustc_passes/src/reachable.rs
