# AST Trace: library/stdarch/crates/core_arch/src/riscv_shared/mod.rs

Generated 41 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=pause | COMPLEXITY=16 | LINES=69

```rust
// SRC: library/stdarch/crates/core_arch/src/riscv_shared/mod.rs
...
//! of the block.
// MOD DECLARATION: p (from library/stdarch/crates/core_arch/src/riscv_shared/mod.rs)
// REPLACED: mod p; -> use crate::p::*;
use crate::p::*;
// MOD DECLARATION: zb (from library/stdarch/crates/core_arch/src/riscv_shared/mod.rs)
// REPLACED: mod zb; -> use crate::zb::*;
use crate::zb::*;
// MOD DECLARATION: zk (from library/stdarch/crates/core_arch/src/riscv_shared/mod.rs)
// REPLACED: mod zk; -> use crate::zk::*;
use crate::zk::*;
