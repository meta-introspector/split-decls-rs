# AST Trace: ../rust/library/compiler-builtins/libm-test/src/op.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=MODULE | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=14
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=MODULE | NAME=UNNAMED | COMPLEXITY=2 | LINES=4
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=49
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=Routine; | COMPLEXITY=19 | LINES=54
