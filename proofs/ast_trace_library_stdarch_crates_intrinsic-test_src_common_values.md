# AST Trace: library/stdarch/crates/intrinsic-test/src/common/values.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=value_for_array | COMPLEXITY=13 | LINES=28

```rust
// SRC: library/stdarch/crates/intrinsic-test/src/common/values.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=107
