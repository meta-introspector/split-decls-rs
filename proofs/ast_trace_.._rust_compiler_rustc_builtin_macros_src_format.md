# AST Trace: ../rust/compiler/rustc_builtin_macros/src/format.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=19
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=MacroInput | COMPLEXITY=5 | LINES=17
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=parse_args | COMPLEXITY=59 | LINES=100
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=invalid_placeholder_type_error | COMPLEXITY=9 | LINES=28
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=report_missing_placeholders | COMPLEXITY=278 | LINES=439
