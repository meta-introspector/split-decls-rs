# AST Trace: compiler/rustc_mir_transform/src/strip_debuginfo.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=25 | LINES=53

```rust
// SRC: compiler/rustc_mir_transform/src/strip_debuginfo.rs
