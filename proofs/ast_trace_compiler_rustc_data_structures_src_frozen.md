# AST Trace: compiler/rustc_data_structures/src/frozen.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=8 | LINES=24

```rust
// SRC: compiler/rustc_data_structures/src/frozen.rs
