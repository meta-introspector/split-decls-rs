# AST Trace: compiler/rustc_passes/src/liveness.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=29 | LINES=110

```rust
// SRC: compiler/rustc_passes/src/liveness.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Variable | COMPLEXITY=4 | LINES=10
