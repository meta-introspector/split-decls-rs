# AST Trace: compiler/rustc_type_ir/src/search_graph/mod.rs

Generated 27 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=33

```rust
// SRC: compiler/rustc_type_ir/src/search_graph/mod.rs
...
```rust
// MOD DECLARATION: stack (from compiler/rustc_type_ir/src/search_graph/mod.rs)
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=mk_tracked | COMPLEXITY=4 | LINES=30

```rust
// MOD DECLARATION: global_cache (from compiler/rustc_type_ir/src/search_graph/mod.rs)
// REPLACED: mod global_cache; -> use crate::global_cache::*;
