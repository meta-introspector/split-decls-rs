# AST Trace: library/std/src/sys/thread_local/guard/apple.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=enable | COMPLEXITY=36 | LINES=47

```rust
// SRC: library/std/src/sys/thread_local/guard/apple.rs
