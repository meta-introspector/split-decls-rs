# AST Trace: compiler/rustc_macros/src/print_attribute.rs
...
```rust
// SRC: compiler/rustc_macros/src/print_attribute.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=print_fields | COMPLEXITY=49 | LINES=78
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=should_render | COMPLEXITY=28 | LINES=49
