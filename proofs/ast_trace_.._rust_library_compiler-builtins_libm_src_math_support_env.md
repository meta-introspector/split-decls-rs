# AST Trace: ../rust/library/compiler-builtins/libm/src/math/support/env.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=FpResult | COMPLEXITY=8 | LINES=19
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=6 | LINES=14
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=Status(u8); | COMPLEXITY=31 | LINES=81
