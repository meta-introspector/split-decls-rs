# AST Trace: library/proc_macro/src/bridge/fxhash.rs
...
```rust
// SRC: library/proc_macro/src/bridge/fxhash.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=add_to_hash | COMPLEXITY=3 | LINES=12
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=write | COMPLEXITY=28 | LINES=67
