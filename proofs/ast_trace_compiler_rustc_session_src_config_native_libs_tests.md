# AST Trace: compiler/rustc_session/src/config/native_libs/tests.rs
...
```rust
// SRC: compiler/rustc_session/src/config/native_libs/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=split | COMPLEXITY=26 | LINES=41
