# AST Trace: compiler/rustc_infer/src/infer/free_regions.rs
...
```rust
// SRC: compiler/rustc_infer/src/infer/free_regions.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=5 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=FreeRegionMap | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=elements | COMPLEXITY=32 | LINES=66
