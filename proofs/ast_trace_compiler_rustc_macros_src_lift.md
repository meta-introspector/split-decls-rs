# AST Trace: compiler/rustc_macros/src/lift.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=lift_to_interner | COMPLEXITY=31 | LINES=64

```rust
// SRC: compiler/rustc_macros/src/lift.rs
