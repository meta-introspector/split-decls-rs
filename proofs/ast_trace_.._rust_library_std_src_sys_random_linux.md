# AST Trace: ../rust/library/std/src/sys/random/linux.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=25 | LINES=67
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=getrandom | COMPLEXITY=75 | LINES=90
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=fill_bytes | COMPLEXITY=2 | LINES=4
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=hashmap_random_keys | COMPLEXITY=2 | LINES=8
