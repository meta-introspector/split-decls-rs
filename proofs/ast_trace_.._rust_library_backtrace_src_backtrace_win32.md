# AST Trace: ../rust/library/backtrace/src/backtrace/win32.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Frame | COMPLEXITY=2 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=8 | LINES=4
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=ip | COMPLEXITY=39 | LINES=61
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=MyContext(CONTEXT); | COMPLEXITY=106 | LINES=102
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=init_frame | COMPLEXITY=2 | LINES=12
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=init_frame | COMPLEXITY=7 | LINES=13
