# AST Trace: ../rust/library/std/tests/sync/rwlock.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=NonCopy(i32); | COMPLEXITY=5 | LINES=14
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_needs_drop | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=17
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=21 | LINES=35
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=19 | LINES=42
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=Unwinder | COMPLEXITY=10 | LINES=27
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=16
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=Foo(Arc | COMPLEXITY=8 | LINES=23
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=STRUCT | NAME=Cloneable(i32); | COMPLEXITY=2 | LINES=14
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=11
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=inner | COMPLEXITY=4 | LINES=21
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=inner | COMPLEXITY=4 | LINES=21
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=do_stuff | COMPLEXITY=5 | LINES=16
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=do_stuff | COMPLEXITY=6 | LINES=18
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=12
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=20 | LINES=47
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=19 | LINES=65
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=26
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=nonpoison_test_rwlock_try_write | COMPLEXITY=16 | LINES=26
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=poison_test_rwlock_try_write | COMPLEXITY=16 | LINES=27
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=new_poisoned_rwlock | COMPLEXITY=4 | LINES=20
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_into_inner_poison | COMPLEXITY=7 | LINES=11
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_get_cloned_poison | COMPLEXITY=7 | LINES=14
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=test_get_mut_poison | COMPLEXITY=7 | LINES=11
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=test_set_poison | COMPLEXITY=10 | LINES=22
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_replace_poison | COMPLEXITY=10 | LINES=22
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_rw_arc_poison_wr | COMPLEXITY=3 | LINES=13
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_rw_arc_poison_mapped_w_r | COMPLEXITY=3 | LINES=14
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=test_rw_arc_poison_ww | COMPLEXITY=3 | LINES=15
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_rw_arc_poison_mapped_w_w | COMPLEXITY=3 | LINES=15
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=test_rw_arc_no_poison_rr | COMPLEXITY=3 | LINES=14
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_rw_arc_no_poison_mapped_r_r | COMPLEXITY=3 | LINES=15
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_rw_arc_no_poison_rw | COMPLEXITY=3 | LINES=14
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_rw_arc_no_poison_mapped_r_w | COMPLEXITY=3 | LINES=15
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=panic_while_mapping_read_unlocked_no_poison | COMPLEXITY=37 | LINES=74
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=panic_while_mapping_write_unlocked_poison | COMPLEXITY=34 | LINES=70
