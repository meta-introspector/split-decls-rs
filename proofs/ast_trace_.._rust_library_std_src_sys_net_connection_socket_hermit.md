# AST Trace: ../rust/library/std/src/sys/net/connection/socket/hermit.rs
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=cvt_gai | COMPLEXITY=6 | LINES=16
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=init | COMPLEXITY=2 | LINES=2
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=Socket(FileDesc); | COMPLEXITY=211 | LINES=281
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=as_inner | COMPLEXITY=5 | LINES=7
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=as_raw_fd | COMPLEXITY=5 | LINES=7
