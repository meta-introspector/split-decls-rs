# AST Trace: library/coretests/tests/cell.rs

Generated 41 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=smoketest_unsafe_cell | COMPLEXITY=9 | LINES=35

```rust
// SRC: library/coretests/tests/cell.rs
