# AST Trace: library/std/src/os/xous/ffi.rs
...
```rust
// SRC: library/std/src/os/xous/ffi.rs
...
// MOD DECLARATION: os_str (from library/std/src/os/xous/ffi.rs)
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=lend_mut_impl | COMPLEXITY=20 | LINES=48

```rust
// MOD DECLARATION: definitions (from library/std/src/os/xous/ffi.rs)
// REPLACED: mod definitions; -> use crate::definitions::*;
