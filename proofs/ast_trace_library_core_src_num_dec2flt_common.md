# AST Trace: library/core/src/num/dec2flt/common.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=read_u64 | COMPLEXITY=6 | LINES=35

```rust
// SRC: library/core/src/num/dec2flt/common.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=read_u64 | COMPLEXITY=16 | LINES=36
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=BiasedFp | COMPLEXITY=2 | LINES=10
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
