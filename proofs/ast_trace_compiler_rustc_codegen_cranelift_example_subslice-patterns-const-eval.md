# AST Trace: compiler/rustc_codegen_cranelift/example/subslice-patterns-const-eval.rs
...
```rust
// SRC: compiler/rustc_codegen_cranelift/example/subslice-patterns-const-eval.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=14
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=main | COMPLEXITY=20 | LINES=32
