# AST Trace: compiler/rustc_hir_analysis/src/check/mod.rs

Generated 26 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=20 | LINES=100

```rust
// SRC: compiler/rustc_hir_analysis/src/check/mod.rs
...
// MOD DECLARATION: check (from compiler/rustc_hir_analysis/src/check/mod.rs)
// REPLACED: mod check; -> use crate::check::*;
use crate::check::*;
// MOD DECLARATION: compare_impl_item (from compiler/rustc_hir_analysis/src/check/mod.rs)
// REPLACED: mod compare_impl_item; -> use crate::compare_impl_item::*;
use crate::compare_impl_item::*;
// MOD DECLARATION: entry (from compiler/rustc_hir_analysis/src/check/mod.rs)
// REPLACED: mod entry; -> use crate::entry::*;
use crate::entry::*;
pub mod intrinsic;
// MOD DECLARATION: region (from compiler/rustc_hir_analysis/src/check/mod.rs)
