# AST Trace: compiler/rustc_pattern_analysis/tests/exhaustiveness.rs
...
```rust
// SRC: compiler/rustc_pattern_analysis/tests/exhaustiveness.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=run | COMPLEXITY=7 | LINES=22
