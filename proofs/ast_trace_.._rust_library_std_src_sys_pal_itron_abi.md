# AST Trace: ../rust/library/std/src/sys/pal/itron/abi.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=T_CSEM | COMPLEXITY=19 | LINES=108
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=T_CFLG | COMPLEXITY=2 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=T_CMTX | COMPLEXITY=2 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=T_CTSK | COMPLEXITY=2 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=acre_tsk | COMPLEXITY=10 | LINES=64
