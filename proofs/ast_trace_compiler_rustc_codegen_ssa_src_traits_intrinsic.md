# AST Trace: compiler/rustc_codegen_ssa/src/traits/intrinsic.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=codegen_intrinsic_call | COMPLEXITY=15 | LINES=60

```rust
// SRC: compiler/rustc_codegen_ssa/src/traits/intrinsic.rs
