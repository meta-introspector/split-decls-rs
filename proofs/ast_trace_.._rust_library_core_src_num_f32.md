# AST Trace: ../rust/library/core/src/num/f32.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=total_cmp | COMPLEXITY=393 | LINES=1184
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=mul_add | COMPLEXITY=143 | LINES=439
