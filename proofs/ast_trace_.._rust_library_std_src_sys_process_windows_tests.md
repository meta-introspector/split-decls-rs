# AST Trace: ../rust/library/std/src/sys/process/windows/tests.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_raw_args | COMPLEXITY=3 | LINES=20
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_thread_handle | COMPLEXITY=27 | LINES=36
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_make_command_line | COMPLEXITY=16 | LINES=46
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=windows_env_unicode_case | COMPLEXITY=17 | LINES=59
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=windows_exe_resolver | COMPLEXITY=14 | LINES=69
