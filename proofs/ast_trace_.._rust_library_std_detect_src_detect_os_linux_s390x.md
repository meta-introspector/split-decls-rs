# AST Trace: ../rust/library/std_detect/src/detect/os/linux/s390x.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=AtHwcap | COMPLEXITY=2 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=from | COMPLEXITY=8 | LINES=31
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=ExtendedFacilityList([u64; | COMPLEXITY=12 | LINES=24
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=cache | COMPLEXITY=18 | LINES=59
