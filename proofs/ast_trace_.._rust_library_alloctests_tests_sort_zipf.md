# AST Trace: ../rust/library/alloctests/tests/sort/zipf.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=ZipfDistribution | COMPLEXITY=2 | LINES=15
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=49 | LINES=128
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=sample | COMPLEXITY=39 | LINES=65
