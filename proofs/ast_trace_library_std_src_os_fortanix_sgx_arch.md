# AST Trace: library/std/src/os/fortanix_sgx/arch.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Align16 | COMPLEXITY=17 | LINES=69

```rust
// SRC: library/std/src/os/fortanix_sgx/arch.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=ereport | COMPLEXITY=10 | LINES=29
