# AST Trace: library/alloc/src/collections/btree/split.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=new_pillar | COMPLEXITY=34 | LINES=94

```rust
// SRC: library/alloc/src/collections/btree/split.rs
