# AST Trace: ../rust/library/coretests/tests/hash/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=MyHasher | COMPLEXITY=2 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=write | COMPLEXITY=10 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_writer_hasher | COMPLEXITY=16 | LINES=88
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=Custom | COMPLEXITY=2 | LINES=4
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=CustomHasher | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=finish | COMPLEXITY=7 | LINES=12
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=hash | COMPLEXITY=5 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_custom_state | COMPLEXITY=7 | LINES=15
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_indirect_hasher | COMPLEXITY=4 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_build_hasher_dyn_compatible | COMPLEXITY=3 | LINES=7
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=_build_hasher_default_impl_all_auto_traits | COMPLEXITY=4 | LINES=8
