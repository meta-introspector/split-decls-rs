# AST Trace: library/coretests/tests/fmt/builders.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_empty | COMPLEXITY=93 | LINES=193

```rust
// SRC: library/coretests/tests/fmt/builders.rs
