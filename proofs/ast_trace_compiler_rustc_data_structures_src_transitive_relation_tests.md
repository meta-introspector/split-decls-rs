# AST Trace: compiler/rustc_data_structures/src/transitive_relation/tests.rs

Generated 19 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=postdom_parent | COMPLEXITY=7 | LINES=24

```rust
// SRC: compiler/rustc_data_structures/src/transitive_relation/tests.rs
