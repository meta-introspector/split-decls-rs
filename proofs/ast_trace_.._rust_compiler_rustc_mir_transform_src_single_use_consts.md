# AST Trace: ../rust/compiler/rustc_mir_transform/src/single_use_consts.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=LocationPair | COMPLEXITY=2 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=SingleUseConstsFinder | COMPLEXITY=2 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=visit_assign | COMPLEXITY=38 | LINES=57
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=LocalReplacer | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=17 | LINES=34
