# AST Trace: library/std/tests/process_spawning.rs
...
```rust
// SRC: library/std/tests/process_spawning.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=issue_15149 | COMPLEXITY=8 | LINES=36

```rust
// MOD DECLARATION: common (from library/std/tests/process_spawning.rs)
