# AST Trace: ../rust/compiler/rustc_codegen_gcc/tests/run/asm.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=add_asm | COMPLEXITY=2 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=asm | COMPLEXITY=129 | LINES=198
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=asm | COMPLEXITY=2 | LINES=3
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=main | COMPLEXITY=2 | LINES=4
