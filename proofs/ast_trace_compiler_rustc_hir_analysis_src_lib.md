# AST Trace: compiler/rustc_hir_analysis/src/lib.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=19 | LINES=124

```rust
// SRC: compiler/rustc_hir_analysis/src/lib.rs
...
pub mod autoderef;
// MOD DECLARATION: check_unused (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod check_unused; -> use crate::check_unused::*;
use crate::check_unused::*;
// MOD DECLARATION: coherence (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod coherence; -> use crate::coherence::*;
use crate::coherence::*;
// MOD DECLARATION: collect (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod collect; -> use crate::collect::*;
use crate::collect::*;
// MOD DECLARATION: constrained_generic_params (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod constrained_generic_params; -> use crate::constrained_generic_params::*;
use crate::constrained_generic_params::*;
// MOD DECLARATION: delegation (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod delegation; -> use crate::delegation::*;
use crate::delegation::*;
pub mod errors;
pub mod hir_ty_lowering;
pub mod hir_wf_check;
// MOD DECLARATION: impl_wf_check (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod impl_wf_check; -> use crate::impl_wf_check::*;
use crate::impl_wf_check::*;
// MOD DECLARATION: outlives (from compiler/rustc_hir_analysis/src/lib.rs)
// REPLACED: mod outlives; -> use crate::outlives::*;
use crate::outlives::*;
// MOD DECLARATION: variance (from compiler/rustc_hir_analysis/src/lib.rs)
