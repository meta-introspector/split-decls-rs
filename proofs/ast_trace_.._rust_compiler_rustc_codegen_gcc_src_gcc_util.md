# AST Trace: ../rust/compiler/rustc_codegen_gcc/src/gcc_util.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=gcc_features_by_flags | COMPLEXITY=2 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=54
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=to_gcc_features | COMPLEXITY=18 | LINES=45
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=arch_to_gcc | COMPLEXITY=6 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=handle_native | COMPLEXITY=6 | LINES=15
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=target_cpu | COMPLEXITY=6 | LINES=7
