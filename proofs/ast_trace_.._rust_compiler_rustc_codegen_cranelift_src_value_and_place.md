# AST Trace: ../rust/compiler/rustc_codegen_cranelift/src/value_and_place.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=codegen_field | COMPLEXITY=21 | LINES=56
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=scalar_pair_calculate_b_offset | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=128 | LINES=273
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=write_cvalue_maybe_transmute | COMPLEXITY=257 | LINES=487
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=113 | LINES=154
