# AST Trace: compiler/rustc_middle/src/mir/interpret/allocation/init_mask/tests.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=uninit_mask | COMPLEXITY=17 | LINES=35

```rust
// SRC: compiler/rustc_middle/src/mir/interpret/allocation/init_mask/tests.rs
