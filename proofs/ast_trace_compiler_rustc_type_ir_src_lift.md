# AST Trace: compiler/rustc_type_ir/src/lift.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=lift_to_interner | COMPLEXITY=23 | LINES=36

```rust
// SRC: compiler/rustc_type_ir/src/lift.rs
