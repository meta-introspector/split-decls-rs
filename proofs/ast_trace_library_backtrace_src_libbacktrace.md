# AST Trace: library/backtrace/src/libbacktrace.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=write | COMPLEXITY=75 | LINES=123

```rust
// SRC: library/backtrace/src/libbacktrace.rs
