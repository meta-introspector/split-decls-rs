# AST Trace: compiler/rustc_codegen_gcc/src/back/write.rs
...
```rust
// SRC: compiler/rustc_codegen_gcc/src/back/write.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=18
