# AST Trace: compiler/rustc_monomorphize/src/partitioning.rs

Generated 33 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=48 | LINES=114

```rust
// SRC: compiler/rustc_monomorphize/src/partitioning.rs
