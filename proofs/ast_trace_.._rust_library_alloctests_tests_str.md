# AST Trace: ../rust/library/alloctests/tests/str.rs

Generated 131 AST blocks from source file
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_le | COMPLEXITY=2 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_find | COMPLEXITY=2 | LINES=10
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_rfind | COMPLEXITY=2 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_collect | COMPLEXITY=2 | LINES=10
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_into_bytes | COMPLEXITY=2 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_find_str | COMPLEXITY=19 | LINES=48
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=s | COMPLEXITY=2 | LINES=4
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=9 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_concat_for_different_types | COMPLEXITY=2 | LINES=6
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_concat_for_different_lengths | COMPLEXITY=2 | LINES=9
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=9 | LINES=7
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_join_for_different_types | COMPLEXITY=2 | LINES=10
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_join_for_different_lengths | COMPLEXITY=2 | LINES=9
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_join_for_different_lengths_with_long_separator | COMPLEXITY=4 | LINES=13
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_join_issue_80335 | COMPLEXITY=17 | LINES=31
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_unsafe_slice | COMPLEXITY=31 | LINES=28
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_starts_with | COMPLEXITY=2 | LINES=11
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_ends_with | COMPLEXITY=2 | LINES=11
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_is_empty | COMPLEXITY=2 | LINES=6
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_replacen | COMPLEXITY=3 | LINES=14
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_replace | COMPLEXITY=2 | LINES=11
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_replace_2a | COMPLEXITY=2 | LINES=10
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_replace_2b | COMPLEXITY=2 | LINES=10
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_replace_2c | COMPLEXITY=2 | LINES=10
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_replace_2d | COMPLEXITY=2 | LINES=9
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_replace_pattern | COMPLEXITY=3 | LINES=9
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=assert_range_eq_can_fail_by_panic | COMPLEXITY=147 | LINES=405
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=test_str_slice_rangetoinclusive_ok | COMPLEXITY=2 | LINES=7
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_str_slice_rangetoinclusive_notok | COMPLEXITY=2 | LINES=7
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_str_slicemut_rangetoinclusive_ok | COMPLEXITY=2 | LINES=8
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_str_slicemut_rangetoinclusive_notok | COMPLEXITY=2 | LINES=8
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=test_is_char_boundary | COMPLEXITY=13 | LINES=20
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_trim_start_matches | COMPLEXITY=3 | LINES=15
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=test_trim_end_matches | COMPLEXITY=3 | LINES=15
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_trim_matches | COMPLEXITY=3 | LINES=15
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_trim_start | COMPLEXITY=3 | LINES=10
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_trim_end | COMPLEXITY=3 | LINES=10
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=test_trim | COMPLEXITY=3 | LINES=10
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=test_is_whitespace | COMPLEXITY=3 | LINES=9
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_is_utf8 | COMPLEXITY=3 | LINES=25
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=test_const_is_utf8 | COMPLEXITY=5 | LINES=27
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=from_utf8_mostly_ascii | COMPLEXITY=5 | LINES=12
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=const_from_utf8_mostly_ascii | COMPLEXITY=6 | LINES=17
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=from_utf8_error | COMPLEXITY=18 | LINES=43
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=test_as_bytes | COMPLEXITY=2 | LINES=13
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=test_as_bytes_fail | COMPLEXITY=4 | LINES=10
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=test_as_ptr | COMPLEXITY=7 | LINES=12
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=vec_str_conversions | COMPLEXITY=5 | LINES=18
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=test_contains | COMPLEXITY=3 | LINES=17
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=test_contains_char | COMPLEXITY=2 | LINES=8
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=test_split_at | COMPLEXITY=5 | LINES=13
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=test_split_at_mut | COMPLEXITY=3 | LINES=11
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=test_split_at_boundscheck | COMPLEXITY=2 | LINES=7
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=test_escape_unicode | COMPLEXITY=36 | LINES=13
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=test_escape_debug | COMPLEXITY=26 | LINES=24
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=test_escape_default | COMPLEXITY=22 | LINES=14
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=test_total_ord | COMPLEXITY=2 | LINES=9
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=test_iterator | COMPLEXITY=5 | LINES=16
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=test_iterator_advance | COMPLEXITY=2 | LINES=11
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=test_rev_iterator | COMPLEXITY=5 | LINES=15
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=test_to_lowercase_rev_iterator | COMPLEXITY=6 | LINES=15
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=test_to_uppercase_rev_iterator | COMPLEXITY=5 | LINES=16
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=test_chars_decoding | COMPLEXITY=10 | LINES=12
...
## Block 66
**Metadata**: AST_ID=66 | TYPE=FUNCTION | NAME=test_chars_rev_decoding | COMPLEXITY=10 | LINES=12
...
## Block 67
**Metadata**: AST_ID=67 | TYPE=FUNCTION | NAME=test_iterator_clone | COMPLEXITY=2 | LINES=8
...
## Block 68
**Metadata**: AST_ID=68 | TYPE=FUNCTION | NAME=test_iterator_last | COMPLEXITY=2 | LINES=8
...
## Block 69
**Metadata**: AST_ID=69 | TYPE=FUNCTION | NAME=test_chars_debug | COMPLEXITY=3 | LINES=10
...
## Block 70
**Metadata**: AST_ID=70 | TYPE=FUNCTION | NAME=test_bytesator | COMPLEXITY=5 | LINES=15
...
## Block 71
**Metadata**: AST_ID=71 | TYPE=FUNCTION | NAME=test_bytes_revator | COMPLEXITY=5 | LINES=15
...
## Block 72
**Metadata**: AST_ID=72 | TYPE=FUNCTION | NAME=test_bytesator_nth | COMPLEXITY=2 | LINES=14
...
## Block 73
**Metadata**: AST_ID=73 | TYPE=FUNCTION | NAME=test_bytesator_count | COMPLEXITY=2 | LINES=8
...
## Block 74
**Metadata**: AST_ID=74 | TYPE=FUNCTION | NAME=test_bytesator_last | COMPLEXITY=2 | LINES=8
...
## Block 75
**Metadata**: AST_ID=75 | TYPE=FUNCTION | NAME=test_char_indicesator | COMPLEXITY=5 | LINES=17
...
## Block 76
**Metadata**: AST_ID=76 | TYPE=FUNCTION | NAME=test_char_indices_revator | COMPLEXITY=5 | LINES=17
...
## Block 77
**Metadata**: AST_ID=77 | TYPE=FUNCTION | NAME=test_char_indices_last | COMPLEXITY=2 | LINES=8
...
## Block 78
**Metadata**: AST_ID=78 | TYPE=FUNCTION | NAME=test_splitn_char_iterator | COMPLEXITY=3 | LINES=18
...
## Block 79
**Metadata**: AST_ID=79 | TYPE=FUNCTION | NAME=test_split_char_iterator_no_trailing | COMPLEXITY=2 | LINES=11
...
## Block 80
**Metadata**: AST_ID=80 | TYPE=FUNCTION | NAME=test_split_char_iterator_inclusive | COMPLEXITY=4 | LINES=19
...
## Block 81
**Metadata**: AST_ID=81 | TYPE=FUNCTION | NAME=test_split_char_iterator_inclusive_rev | COMPLEXITY=8 | LINES=24
...
## Block 82
**Metadata**: AST_ID=82 | TYPE=FUNCTION | NAME=test_rsplit | COMPLEXITY=3 | LINES=14
...
## Block 83
**Metadata**: AST_ID=83 | TYPE=FUNCTION | NAME=test_rsplitn | COMPLEXITY=3 | LINES=14
...
## Block 84
**Metadata**: AST_ID=84 | TYPE=FUNCTION | NAME=test_split_once | COMPLEXITY=2 | LINES=12
...
## Block 85
**Metadata**: AST_ID=85 | TYPE=FUNCTION | NAME=test_rsplit_once | COMPLEXITY=2 | LINES=12
...
## Block 86
**Metadata**: AST_ID=86 | TYPE=FUNCTION | NAME=test_split_whitespace | COMPLEXITY=2 | LINES=7
...
## Block 87
**Metadata**: AST_ID=87 | TYPE=FUNCTION | NAME=test_lines | COMPLEXITY=4 | LINES=23
...
## Block 88
**Metadata**: AST_ID=88 | TYPE=FUNCTION | NAME=test_splitator | COMPLEXITY=4 | LINES=22
...
## Block 89
**Metadata**: AST_ID=89 | TYPE=FUNCTION | NAME=test_str_default | COMPLEXITY=3 | LINES=14
...
## Block 90
**Metadata**: AST_ID=90 | TYPE=FUNCTION | NAME=test_str_container | COMPLEXITY=3 | LINES=12
...
## Block 91
**Metadata**: AST_ID=91 | TYPE=FUNCTION | NAME=test_str_from_utf8 | COMPLEXITY=2 | LINES=12
...
## Block 92
**Metadata**: AST_ID=92 | TYPE=FUNCTION | NAME=test_pattern_deref_forward | COMPLEXITY=2 | LINES=8
...
## Block 93
**Metadata**: AST_ID=93 | TYPE=FUNCTION | NAME=test_empty_match_indices | COMPLEXITY=2 | LINES=7
...
## Block 94
**Metadata**: AST_ID=94 | TYPE=FUNCTION | NAME=test_bool_from_str | COMPLEXITY=2 | LINES=7
...
## Block 95
**Metadata**: AST_ID=95 | TYPE=FUNCTION | NAME=check_contains_all_substrings | COMPLEXITY=12 | LINES=25
...
## Block 96
**Metadata**: AST_ID=96 | TYPE=FUNCTION | NAME=strslice_issue_16589 | COMPLEXITY=6 | LINES=10
...
## Block 97
**Metadata**: AST_ID=97 | TYPE=FUNCTION | NAME=strslice_issue_16878 | COMPLEXITY=2 | LINES=6
...
## Block 98
**Metadata**: AST_ID=98 | TYPE=FUNCTION | NAME=strslice_issue_104726 | COMPLEXITY=2 | LINES=12
...
## Block 99
**Metadata**: AST_ID=99 | TYPE=FUNCTION | NAME=test_strslice_contains | COMPLEXITY=2 | LINES=7
...
## Block 100
**Metadata**: AST_ID=100 | TYPE=FUNCTION | NAME=test_rsplitn_char_iterator | COMPLEXITY=3 | LINES=22
...
## Block 101
**Metadata**: AST_ID=101 | TYPE=FUNCTION | NAME=test_split_char_iterator | COMPLEXITY=4 | LINES=34
...
## Block 102
**Metadata**: AST_ID=102 | TYPE=FUNCTION | NAME=test_rev_split_char_iterator_no_trailing | COMPLEXITY=2 | LINES=13
...
## Block 103
**Metadata**: AST_ID=103 | TYPE=FUNCTION | NAME=test_utf16_code_units | COMPLEXITY=3 | LINES=5
...
## Block 104
**Metadata**: AST_ID=104 | TYPE=FUNCTION | NAME=test_utf16_size_hint | COMPLEXITY=9 | LINES=22
...
## Block 105
**Metadata**: AST_ID=105 | TYPE=FUNCTION | NAME=starts_with_in_unicode | COMPLEXITY=2 | LINES=5
...
## Block 106
**Metadata**: AST_ID=106 | TYPE=FUNCTION | NAME=starts_short_long | COMPLEXITY=3 | LINES=19
...
## Block 107
**Metadata**: AST_ID=107 | TYPE=FUNCTION | NAME=contains_weird_cases | COMPLEXITY=3 | LINES=7
...
## Block 108
**Metadata**: AST_ID=108 | TYPE=FUNCTION | NAME=trim_ws | COMPLEXITY=3 | LINES=14
...
## Block 109
**Metadata**: AST_ID=109 | TYPE=FUNCTION | NAME=to_lowercase | COMPLEXITY=6 | LINES=53
...
## Block 110
**Metadata**: AST_ID=110 | TYPE=FUNCTION | NAME=to_uppercase | COMPLEXITY=2 | LINES=6
...
## Block 111
**Metadata**: AST_ID=111 | TYPE=FUNCTION | NAME=test_into_string | COMPLEXITY=2 | LINES=8
...
## Block 112
**Metadata**: AST_ID=112 | TYPE=FUNCTION | NAME=test_box_slice_clone | COMPLEXITY=2 | LINES=8
...
## Block 113
**Metadata**: AST_ID=113 | TYPE=FUNCTION | NAME=test_cow_from | COMPLEXITY=6 | LINES=10
...
## Block 114
**Metadata**: AST_ID=114 | TYPE=FUNCTION | NAME=test_repeat | COMPLEXITY=2 | LINES=7
...
## Block 115
**Metadata**: AST_ID=115 | TYPE=FUNCTION | NAME=fwd | COMPLEXITY=64 | LINES=190
...
## Block 116
**Metadata**: AST_ID=116 | TYPE=FUNCTION | NAME=$name | COMPLEXITY=19 | LINES=47
...
## Block 117
**Metadata**: AST_ID=117 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=8
...
## Block 118
**Metadata**: AST_ID=118 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
...
## Block 119
**Metadata**: AST_ID=119 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
...
## Block 120
**Metadata**: AST_ID=120 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
...
## Block 121
**Metadata**: AST_ID=121 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
...
## Block 122
**Metadata**: AST_ID=122 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
...
## Block 123
**Metadata**: AST_ID=123 | TYPE=FUNCTION | NAME=different_str_pattern_forwarding_lifetimes | COMPLEXITY=6 | LINES=16
...
## Block 124
**Metadata**: AST_ID=124 | TYPE=FUNCTION | NAME=test_str_multiline | COMPLEXITY=2 | LINES=14
...
## Block 125
**Metadata**: AST_ID=125 | TYPE=FUNCTION | NAME=test_str_escapes | COMPLEXITY=2 | LINES=7
...
## Block 126
**Metadata**: AST_ID=126 | TYPE=FUNCTION | NAME=const_str_ptr | COMPLEXITY=8 | LINES=20
...
## Block 127
**Metadata**: AST_ID=127 | TYPE=FUNCTION | NAME=utf8 | COMPLEXITY=36 | LINES=50
...
## Block 128
**Metadata**: AST_ID=128 | TYPE=FUNCTION | NAME=utf8_chars | COMPLEXITY=5 | LINES=29
...
## Block 129
**Metadata**: AST_ID=129 | TYPE=FUNCTION | NAME=utf8_char_counts | COMPLEXITY=40 | LINES=45
...
## Block 130
**Metadata**: AST_ID=130 | TYPE=FUNCTION | NAME=floor_char_boundary | COMPLEXITY=11 | LINES=43
...
## Block 131
**Metadata**: AST_ID=131 | TYPE=FUNCTION | NAME=ceil_char_boundary | COMPLEXITY=11 | LINES=46
