# AST Trace: compiler/rustc_session/src/config.rs
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=43
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=7 | LINES=19
