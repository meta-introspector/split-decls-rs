# AST Trace: compiler/rustc_borrowck/src/type_check/liveness/mod.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/type_check/liveness/mod.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=66
...
// MOD DECLARATION: local_use_map (from compiler/rustc_borrowck/src/type_check/liveness/mod.rs)
// REPLACED: mod local_use_map; -> use crate::local_use_map::*;
use crate::local_use_map::*;
// MOD DECLARATION: trace (from compiler/rustc_borrowck/src/type_check/liveness/mod.rs)
// REPLACED: mod trace; -> use crate::trace::*;
use crate::trace::*;
