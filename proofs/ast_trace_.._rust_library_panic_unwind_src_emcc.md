# AST Trace: ../rust/library/panic_unwind/src/emcc.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=TypeInfo | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=15
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=10
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=Exception | COMPLEXITY=3 | LINES=18
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=CatchData | COMPLEXITY=23 | LINES=31
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=16 | LINES=18
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=__cxa_allocate_exception | COMPLEXITY=6 | LINES=11
