# AST Trace: library/std/src/sys/env/wasi.rs
...
```rust
// SRC: library/std/src/sys/env/wasi.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=env_read_lock | COMPLEXITY=14 | LINES=23
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=env | COMPLEXITY=23 | LINES=36
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=getenv | COMPLEXITY=20 | LINES=20
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=7
