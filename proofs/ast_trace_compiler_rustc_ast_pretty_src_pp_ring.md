# AST Trace: compiler/rustc_ast_pretty/src/pp/ring.rs
...
```rust
// SRC: compiler/rustc_ast_pretty/src/pp/ring.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=16
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=46
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=index | COMPLEXITY=5 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=index_mut | COMPLEXITY=5 | LINES=6
