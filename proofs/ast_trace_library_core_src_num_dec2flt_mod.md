# AST Trace: library/core/src/num/dec2flt/mod.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=21 | LINES=86

```rust
// SRC: library/core/src/num/dec2flt/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=from_str | COMPLEXITY=24 | LINES=90
...
// MOD DECLARATION: common (from library/core/src/num/dec2flt/mod.rs)
// REPLACED: mod common; -> use crate::common::*;
use crate::common::*;
pub mod decimal;
pub mod decimal_seq;
// MOD DECLARATION: fpu (from library/core/src/num/dec2flt/mod.rs)
// REPLACED: mod fpu; -> use crate::fpu::*;
use crate::fpu::*;
// MOD DECLARATION: slow (from library/core/src/num/dec2flt/mod.rs)
// REPLACED: mod slow; -> use crate::slow::*;
use crate::slow::*;
// MOD DECLARATION: table (from library/core/src/num/dec2flt/mod.rs)
// REPLACED: mod table; -> use crate::table::*;
use crate::table::*;
