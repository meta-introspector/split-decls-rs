# AST Trace: ../rust/library/std/src/ffi/os_str/tests.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_os_string_with_capacity | COMPLEXITY=2 | LINES=16
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_os_string_clear | COMPLEXITY=2 | LINES=10
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_os_string_leak | COMPLEXITY=7 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_os_string_capacity | COMPLEXITY=2 | LINES=13
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_os_string_reserve | COMPLEXITY=5 | LINES=22
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_os_string_reserve_exact | COMPLEXITY=5 | LINES=22
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_os_string_join | COMPLEXITY=3 | LINES=14
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_os_string_default | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_os_str_is_empty | COMPLEXITY=2 | LINES=12
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_os_str_len | COMPLEXITY=2 | LINES=12
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_os_str_default | COMPLEXITY=2 | LINES=6
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=into_boxed | COMPLEXITY=2 | LINES=11
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=boxed_default | COMPLEXITY=2 | LINES=6
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_os_str_clone_into | COMPLEXITY=2 | LINES=10
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=into_rc | COMPLEXITY=2 | LINES=17
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=slice_encoded_bytes | COMPLEXITY=3 | LINES=19
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=slice_out_of_bounds | COMPLEXITY=2 | LINES=7
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=slice_mid_char | COMPLEXITY=2 | LINES=7
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=slice_invalid_data | COMPLEXITY=2 | LINES=10
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=slice_partial_utf8 | COMPLEXITY=3 | LINES=12
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=slice_invalid_edge | COMPLEXITY=4 | LINES=21
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=slice_between_surrogates | COMPLEXITY=2 | LINES=11
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=slice_surrogate_edge | COMPLEXITY=3 | LINES=17
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=clone_to_uninit | COMPLEXITY=18 | LINES=15
