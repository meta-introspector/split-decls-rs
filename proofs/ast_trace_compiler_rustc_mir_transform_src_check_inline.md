# AST Trace: compiler/rustc_mir_transform/src/check_inline.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/check_inline.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=20 | LINES=33
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=15
