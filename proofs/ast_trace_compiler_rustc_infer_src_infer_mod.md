# AST Trace: compiler/rustc_infer/src/infer/mod.rs
...
```rust
// SRC: compiler/rustc_infer/src/infer/mod.rs
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=STRUCT | NAME=InferOk | COMPLEXITY=8 | LINES=46

```rust
pub mod at;
pub mod canonical;
// MOD DECLARATION: context (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod context; -> use crate::context::*;
use crate::context::*;
// MOD DECLARATION: free_regions (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod free_regions; -> use crate::free_regions::*;
use crate::free_regions::*;
// MOD DECLARATION: freshen (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod freshen; -> use crate::freshen::*;
use crate::freshen::*;
// MOD DECLARATION: lexical_region_resolve (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod lexical_region_resolve; -> use crate::lexical_region_resolve::*;
use crate::lexical_region_resolve::*;
// MOD DECLARATION: opaque_types (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod opaque_types; -> use crate::opaque_types::*;
use crate::opaque_types::*;
pub mod outlives;
// MOD DECLARATION: projection (from compiler/rustc_infer/src/infer/mod.rs)
...
// MOD DECLARATION: type_variable (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod type_variable; -> use crate::type_variable::*;
use crate::type_variable::*;
// MOD DECLARATION: unify_key (from compiler/rustc_infer/src/infer/mod.rs)
// REPLACED: mod unify_key; -> use crate::unify_key::*;
use crate::unify_key::*;
