# AST Trace: library/std/src/sys/personality/dwarf/eh.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=EHContext | COMPLEXITY=6 | LINES=60

```rust
// SRC: library/std/src/sys/personality/dwarf/eh.rs
