# AST Trace: ../rust/compiler/rustc_trait_selection/src/opaque_types.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=from | COMPLEXITY=5 | LINES=5
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=report | COMPLEXITY=16 | LINES=32
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=opaque_type_has_defining_use_args | COMPLEXITY=41 | LINES=67
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=LazyOpaqueTyEnv | COMPLEXITY=5 | LINES=15
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=new | COMPLEXITY=35 | LINES=70
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=report_item_does_not_constrain_error | COMPLEXITY=9 | LINES=24
