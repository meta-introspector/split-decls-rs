# AST Trace: library/backtrace/src/symbolize/mod.rs
...
```rust
// SRC: library/backtrace/src/symbolize/mod.rs
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=14 | LINES=29

```rust
cfg_if::cfg_if! {
    if #[cfg(miri)] {
// MOD DECLARATION: miri (from library/backtrace/src/symbolize/mod.rs)
// REPLACED: mod miri; -> use crate::miri::*;
use crate::miri::*;
        use miri as imp;
    } else if #[cfg(all(windows, target_env = "msvc", not(target_vendor = "uwp")))] {
// MOD DECLARATION: dbghelp (from library/backtrace/src/symbolize/mod.rs)
// REPLACED: mod dbghelp; -> use crate::dbghelp::*;
use crate::dbghelp::*;
        use dbghelp as imp;
    } else if #[cfg(all(
...
// MOD DECLARATION: gimli (from library/backtrace/src/symbolize/mod.rs)
// REPLACED: mod gimli; -> use crate::gimli::*;
use crate::gimli::*;
        use gimli as imp;
    } else {
// MOD DECLARATION: noop (from library/backtrace/src/symbolize/mod.rs)
// REPLACED: mod noop; -> use crate::noop::*;
use crate::noop::*;
        use noop as imp;
    }
}
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=11

```rust
cascade! {
    if #[cfg(feature = "libbacktrace")] {
    } else if #[cfg(feature = "dladdr")] {
// MOD DECLARATION: dladdr (from library/backtrace/src/symbolize/mod.rs)
// REPLACED: mod dladdr; -> use crate::dladdr::*;
use crate::dladdr::*;
