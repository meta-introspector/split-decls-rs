# AST Trace: library/std/src/os/xous/services.rs
...
```rust
// SRC: library/std/src/os/xous/services.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=ConnectRequest | COMPLEXITY=34 | LINES=94

```rust
use crate::os::xous::ffi::Connection;

// MOD DECLARATION: dns (from library/std/src/os/xous/services.rs)
// REPLACED: mod dns; -> use crate::dns::*;
use crate::dns::*;
pub(crate) use dns::*;

// MOD DECLARATION: log (from library/std/src/os/xous/services.rs)
// REPLACED: mod log; -> use crate::log::*;
use crate::log::*;
pub(crate) use log::*;

// MOD DECLARATION: net (from library/std/src/os/xous/services.rs)
// REPLACED: mod net; -> use crate::net::*;
use crate::net::*;
pub(crate) use net::*;

// MOD DECLARATION: systime (from library/std/src/os/xous/services.rs)
// REPLACED: mod systime; -> use crate::systime::*;
use crate::systime::*;
pub(crate) use systime::*;

// MOD DECLARATION: ticktimer (from library/std/src/os/xous/services.rs)
// REPLACED: mod ticktimer; -> use crate::ticktimer::*;
use crate::ticktimer::*;
