# AST Trace: ../rust/compiler/rustc_thread_pool/src/sleep/counters.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=19 | LINES=32
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=try_exchange | COMPLEXITY=58 | LINES=156
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=select_thread | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=select_jec | COMPLEXITY=2 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=14 | LINES=42
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=6 | LINES=12
