# AST Trace: ../rust/library/std/src/sys/thread/xous.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=join | COMPLEXITY=56 | LINES=101
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=available_parallelism | COMPLEXITY=7 | LINES=5
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=yield_now | COMPLEXITY=2 | LINES=4
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=sleep | COMPLEXITY=14 | LINES=13
