# AST Trace: ../rust/library/stdarch/crates/stdarch-gen-arm/src/fn_suffix.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=32
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=type_to_size | COMPLEXITY=8 | LINES=15
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=neon_get_base_and_char | COMPLEXITY=8 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=make_neon_suffix | COMPLEXITY=119 | LINES=102
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=from_str | COMPLEXITY=12 | LINES=33
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=11 | LINES=30
