# AST Trace: compiler/rustc_trait_selection/src/traits/query/type_op/prove_predicate.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/query/type_op/prove_predicate.rs
