# AST Trace: library/std/src/os/fd/tests.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_raw_fd | COMPLEXITY=16 | LINES=30

```rust
// SRC: library/std/src/os/fd/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_fd | COMPLEXITY=10 | LINES=19
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_niche_optimizations | COMPLEXITY=10 | LINES=18
