# AST Trace: ../rust/library/alloctests/tests/boxed.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=uninitialized_zero_size_box | COMPLEXITY=3 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Dummy | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=box_clone_and_clone_from_equivalence | COMPLEXITY=7 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=box_clone_from_ptr_stability | COMPLEXITY=8 | LINES=16
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=box_deref_lval | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=panic_no_leak | COMPLEXITY=30 | LINES=38
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=ConstAllocator; | COMPLEXITY=107 | LINES=122
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=action | COMPLEXITY=16 | LINES=37
