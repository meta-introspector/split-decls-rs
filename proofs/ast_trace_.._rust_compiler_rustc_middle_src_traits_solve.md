# AST Trace: ../rust/compiler/rustc_middle/src/traits/solve.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=PredefinedOpaques | COMPLEXITY=6 | LINES=18
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=ExternalConstraints | COMPLEXITY=5 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=try_fold_with | COMPLEXITY=20 | LINES=47
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=visit_with | COMPLEXITY=5 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=try_fold_with | COMPLEXITY=12 | LINES=26
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=visit_with | COMPLEXITY=5 | LINES=6
