# AST Trace: library/backtrace/tests/sgx-image-base.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=sgx_image_base_with_std | COMPLEXITY=8 | LINES=37

```rust
// SRC: library/backtrace/tests/sgx-image-base.rs
