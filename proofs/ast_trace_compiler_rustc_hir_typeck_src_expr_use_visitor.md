# AST Trace: compiler/rustc_hir_typeck/src/expr_use_visitor.rs

Generated 18 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=23

```rust
// SRC: compiler/rustc_hir_typeck/src/expr_use_visitor.rs
