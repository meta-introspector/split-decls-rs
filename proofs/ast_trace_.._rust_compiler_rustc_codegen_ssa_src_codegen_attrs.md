# AST Trace: ../rust/compiler/rustc_codegen_ssa/src/codegen_attrs.rs
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=try_fn_sig | COMPLEXITY=9 | LINES=21
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=parse_instruction_set_attr | COMPLEXITY=23 | LINES=31
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=parse_patchable_function_entry | COMPLEXITY=26 | LINES=53
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=STRUCT | NAME=InterestingAttributeDiagnosticSpans | COMPLEXITY=4 | LINES=10
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=process_builtin_attrs | COMPLEXITY=116 | LINES=188
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=apply_overrides | COMPLEXITY=47 | LINES=80
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=check_result | COMPLEXITY=29 | LINES=80
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=handle_lang_items | COMPLEXITY=20 | LINES=47
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=codegen_fn_attrs | COMPLEXITY=12 | LINES=28
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=disabled_sanitizers_for | COMPLEXITY=14 | LINES=26
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=should_inherit_track_caller | COMPLEXITY=7 | LINES=8
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=inherited_align | COMPLEXITY=4 | LINES=6
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=autodiff_attrs | COMPLEXITY=77 | LINES=110
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=10
