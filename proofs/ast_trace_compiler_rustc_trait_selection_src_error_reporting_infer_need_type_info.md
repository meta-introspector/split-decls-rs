# AST Trace: compiler/rustc_trait_selection/src/error_reporting/infer/need_type_info.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/error_reporting/infer/need_type_info.rs
