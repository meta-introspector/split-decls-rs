# AST Trace: library/stdarch/crates/core_arch/src/arm_shared/neon/shift_and_insert_tests.rs
...
```rust
// SRC: library/stdarch/crates/core_arch/src/arm_shared/neon/shift_and_insert_tests.rs
