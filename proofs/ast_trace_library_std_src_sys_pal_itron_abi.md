# AST Trace: library/std/src/sys/pal/itron/abi.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=T_CSEM | COMPLEXITY=20 | LINES=125

```rust
// SRC: library/std/src/sys/pal/itron/abi.rs
