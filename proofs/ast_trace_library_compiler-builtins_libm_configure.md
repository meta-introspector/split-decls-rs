# AST Trace: library/compiler-builtins/libm/configure.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Config | COMPLEXITY=4 | LINES=38

```rust
// SRC: library/compiler-builtins/libm/configure.rs
