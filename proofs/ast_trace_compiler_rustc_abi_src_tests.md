# AST Trace: compiler/rustc_abi/src/tests.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=align_constants | COMPLEXITY=3 | LINES=22

```rust
// SRC: compiler/rustc_abi/src/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=wrapping_range_contains_range | COMPLEXITY=40 | LINES=63
