# AST Trace: compiler/rustc_errors/src/markdown/tests/term.rs
...
```rust
// SRC: compiler/rustc_errors/src/markdown/tests/term.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_wrapping_write | COMPLEXITY=10 | LINES=58
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_output | COMPLEXITY=12 | LINES=29
