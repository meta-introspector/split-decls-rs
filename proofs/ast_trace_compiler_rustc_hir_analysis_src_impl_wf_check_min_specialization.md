# AST Trace: compiler/rustc_hir_analysis/src/impl_wf_check/min_specialization.rs

Generated 27 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=29 | LINES=48

```rust
// SRC: compiler/rustc_hir_analysis/src/impl_wf_check/min_specialization.rs
