# AST Trace: library/std/src/sync/nonpoison.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=WouldBlock; | COMPLEXITY=12 | LINES=40

```rust
// SRC: library/std/src/sync/nonpoison.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=5 | LINES=7
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=1 | LINES=10

```rust
// MOD DECLARATION: condvar (from library/std/src/sync/nonpoison.rs)
// REPLACED: mod condvar; -> use crate::condvar::*;
use crate::condvar::*;
// MOD DECLARATION: mutex (from library/std/src/sync/nonpoison.rs)
// REPLACED: mod mutex; -> use crate::mutex::*;
use crate::mutex::*;
// MOD DECLARATION: rwlock (from library/std/src/sync/nonpoison.rs)
