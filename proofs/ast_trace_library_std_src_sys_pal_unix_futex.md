# AST Trace: library/std/src/sys/pal/unix/futex.rs

Generated 18 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=futex_wait | COMPLEXITY=43 | LINES=110

```rust
// SRC: library/std/src/sys/pal/unix/futex.rs
