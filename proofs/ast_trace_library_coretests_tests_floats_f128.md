# AST Trace: library/coretests/tests/floats/f128.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_mul_add | COMPLEXITY=10 | LINES=56

```rust
// SRC: library/coretests/tests/floats/f128.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_max_recip | COMPLEXITY=2 | LINES=10
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_from | COMPLEXITY=5 | LINES=31
