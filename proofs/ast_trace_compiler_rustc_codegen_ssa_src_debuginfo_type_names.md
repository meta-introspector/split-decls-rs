# AST Trace: compiler/rustc_codegen_ssa/src/debuginfo/type_names.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=compute_debuginfo_type_name | COMPLEXITY=457 | LINES=830

```rust
// SRC: compiler/rustc_codegen_ssa/src/debuginfo/type_names.rs
