# AST Trace: library/stdarch/crates/core_arch/src/arm_shared/barrier/not_mclass.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=ST; | COMPLEXITY=6 | LINES=67

```rust
// SRC: library/stdarch/crates/core_arch/src/arm_shared/barrier/not_mclass.rs
