# AST Trace: ../rust/compiler/rustc_trait_selection/src/solve/select.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=select_in_new_trait_solver | COMPLEXITY=5 | LINES=18
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Select | COMPLEXITY=2 | LINES=4
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=span | COMPLEXITY=28 | LINES=50
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=candidate_should_be_dropped_in_favor_of | COMPLEXITY=22 | LINES=53
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=to_selection | COMPLEXITY=34 | LINES=53
