# AST Trace: ../rust/library/std/src/sys/pal/unix/stack_overflow/thread_info.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=31
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=ThreadInfo | COMPLEXITY=2 | LINES=6
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UnlockOnDrop; | COMPLEXITY=5 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=with_current_info | COMPLEXITY=32 | LINES=39
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=spin_lock_in_setup | COMPLEXITY=20 | LINES=18
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=set_current_info | COMPLEXITY=8 | LINES=10
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=delete_current_info | COMPLEXITY=7 | LINES=10
