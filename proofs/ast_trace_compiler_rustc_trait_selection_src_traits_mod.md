# AST Trace: compiler/rustc_trait_selection/src/traits/mod.rs

Generated 33 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=63

```rust
// SRC: compiler/rustc_trait_selection/src/traits/mod.rs
...
// MOD DECLARATION: dyn_compatibility (from compiler/rustc_trait_selection/src/traits/mod.rs)
// REPLACED: mod dyn_compatibility; -> use crate::dyn_compatibility::*;
use crate::dyn_compatibility::*;
pub mod effects;
// MOD DECLARATION: engine (from compiler/rustc_trait_selection/src/traits/mod.rs)
// REPLACED: mod engine; -> use crate::engine::*;
use crate::engine::*;
// MOD DECLARATION: fulfill (from compiler/rustc_trait_selection/src/traits/mod.rs)
...
// MOD DECLARATION: select (from compiler/rustc_trait_selection/src/traits/mod.rs)
// REPLACED: mod select; -> use crate::select::*;
use crate::select::*;
// MOD DECLARATION: specialize (from compiler/rustc_trait_selection/src/traits/mod.rs)
// REPLACED: mod specialize; -> use crate::specialize::*;
use crate::specialize::*;
// MOD DECLARATION: structural_normalize (from compiler/rustc_trait_selection/src/traits/mod.rs)
// REPLACED: mod structural_normalize; -> use crate::structural_normalize::*;
use crate::structural_normalize::*;
#[allow(hidden_glob_reexports)]
// MOD DECLARATION: util (from compiler/rustc_trait_selection/src/traits/mod.rs)
