# AST Trace: compiler/rustc_data_structures/src/thousands/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_format_with_underscores | COMPLEXITY=4 | LINES=28

```rust
// SRC: compiler/rustc_data_structures/src/thousands/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_usize_with_underscores | COMPLEXITY=3 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_isize_with_underscores | COMPLEXITY=3 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_f64p1_with_underscores | COMPLEXITY=3 | LINES=13
