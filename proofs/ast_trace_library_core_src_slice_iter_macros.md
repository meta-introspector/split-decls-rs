# AST Trace: library/core/src/slice/iter/macros.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=54 | LINES=54

```rust
// SRC: library/core/src/slice/iter/macros.rs
