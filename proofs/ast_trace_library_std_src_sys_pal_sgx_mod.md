# AST Trace: library/std/src/sys/pal/sgx/mod.rs
...
```rust
// SRC: library/std/src/sys/pal/sgx/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=19

```rust
pub mod abi;
// MOD DECLARATION: libunwind_integration (from library/std/src/sys/pal/sgx/mod.rs)
// REPLACED: mod libunwind_integration; -> use crate::libunwind_integration::*;
use crate::libunwind_integration::*;
pub mod os;
