# AST Trace: ../rust/library/compiler-builtins/builtins-test/src/bench.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=skip_sys_checks | COMPLEXITY=17 | LINES=55
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=skip_asm_checks | COMPLEXITY=2 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=$sys_fn | COMPLEXITY=93 | LINES=173
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=make_testvec | COMPLEXITY=2 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=make_testvec | COMPLEXITY=46 | LINES=87
