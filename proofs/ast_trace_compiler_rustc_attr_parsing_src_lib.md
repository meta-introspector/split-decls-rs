# AST Trace: compiler/rustc_attr_parsing/src/lib.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=16 | LINES=88

```rust
// SRC: compiler/rustc_attr_parsing/src/lib.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=45
...
// MOD DECLARATION: attributes (from compiler/rustc_attr_parsing/src/lib.rs)
...
/// attribute.
// MOD DECLARATION: interface (from compiler/rustc_attr_parsing/src/lib.rs)
// REPLACED: mod interface; -> use crate::interface::*;
use crate::interface::*;
...
// MOD DECLARATION: lints (from compiler/rustc_attr_parsing/src/lib.rs)
// REPLACED: mod lints; -> use crate::lints::*;
use crate::lints::*;
// MOD DECLARATION: session_diagnostics (from compiler/rustc_attr_parsing/src/lib.rs)
// REPLACED: mod session_diagnostics; -> use crate::session_diagnostics::*;
use crate::session_diagnostics::*;
// MOD DECLARATION: target_checking (from compiler/rustc_attr_parsing/src/lib.rs)
// REPLACED: mod target_checking; -> use crate::target_checking::*;
