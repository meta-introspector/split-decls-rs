# AST Trace: ../rust/compiler/rustc_const_eval/src/interpret/util.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=14
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=make_result | COMPLEXITY=5 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=or_if_tracing_disabled | COMPLEXITY=7 | LINES=10
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=or_if_tracing_disabled | COMPLEXITY=5 | LINES=6
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=or_if_tracing_disabled | COMPLEXITY=5 | LINES=5
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=26 | LINES=83
