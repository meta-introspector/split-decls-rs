# AST Trace: ../rust/compiler/rustc_infer/src/infer/outlives/env.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=OutlivesEnvironment | COMPLEXITY=12 | LINES=42
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=from_normalized_bounds | COMPLEXITY=33 | LINES=69
