# AST Trace: ../rust/compiler/rustc_hir_analysis/src/collect/generics_of.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=208 | LINES=387
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=param_default_policy | COMPLEXITY=24 | LINES=34
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=has_late_bound_regions | COMPLEXITY=40 | LINES=74
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=AnonConstInParamTyDetector | COMPLEXITY=2 | LINES=5
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=visit_generic_param | COMPLEXITY=15 | LINES=23
