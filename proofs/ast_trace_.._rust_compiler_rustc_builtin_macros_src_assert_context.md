# AST Trace: ../rust/compiler/rustc_builtin_macros/src/assert/context.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=26
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=build_initial_imports | COMPLEXITY=134 | LINES=383
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=Capture | COMPLEXITY=4 | LINES=13
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=escape_to_fmt | COMPLEXITY=11 | LINES=13
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=expr_addr_of_mut | COMPLEXITY=2 | LINES=4
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=expr_method_call | COMPLEXITY=3 | LINES=10
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=expr_paren | COMPLEXITY=2 | LINES=4
