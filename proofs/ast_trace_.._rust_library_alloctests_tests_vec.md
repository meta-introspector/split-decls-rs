# AST Trace: ../rust/library/alloctests/tests/vec.rs

Generated 161 AST blocks from source file
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=11
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=DropCounter | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_small_vec_struct | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_double_drop | COMPLEXITY=8 | LINES=25
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_reserve | COMPLEXITY=5 | LINES=22
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_zst_capacity | COMPLEXITY=2 | LINES=5
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_indexing | COMPLEXITY=2 | LINES=13
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_debug_fmt | COMPLEXITY=5 | LINES=12
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_push | COMPLEXITY=2 | LINES=11
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_extend | COMPLEXITY=11 | LINES=45
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_extend_from_slice | COMPLEXITY=2 | LINES=12
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_extend_ref | COMPLEXITY=2 | LINES=15
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_slice_from_ref | COMPLEXITY=2 | LINES=8
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_slice_from_mut | COMPLEXITY=6 | LINES=14
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_slice_to_mut | COMPLEXITY=6 | LINES=14
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_split_at_mut | COMPLEXITY=12 | LINES=25
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_clone | COMPLEXITY=2 | LINES=13
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_clone_from | COMPLEXITY=2 | LINES=22
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_retain | COMPLEXITY=2 | LINES=7
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_retain_predicate_order | COMPLEXITY=6 | LINES=16
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_retain_pred_panic_with_hole | COMPLEXITY=8 | LINES=18
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_retain_pred_panic_no_hole | COMPLEXITY=7 | LINES=16
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_retain_drop_panic | COMPLEXITY=15 | LINES=30
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=test_retain_maybeuninits | COMPLEXITY=23 | LINES=29
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=test_dedup | COMPLEXITY=3 | LINES=17
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_dedup_by_key | COMPLEXITY=4 | LINES=17
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_dedup_by | COMPLEXITY=4 | LINES=18
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_dedup_unique | COMPLEXITY=2 | LINES=12
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=zero_sized_values | COMPLEXITY=14 | LINES=33
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_partition | COMPLEXITY=2 | LINES=8
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=test_zip_unzip | COMPLEXITY=2 | LINES=11
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_cmp | COMPLEXITY=3 | LINES=23
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_vec_truncate_drop | COMPLEXITY=2 | LINES=13
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_vec_truncate_fail | COMPLEXITY=9 | LINES=17
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=test_index | COMPLEXITY=2 | LINES=6
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=test_index_out_of_bounds | COMPLEXITY=2 | LINES=7
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_slice_out_of_bounds_1 | COMPLEXITY=2 | LINES=7
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=test_slice_out_of_bounds_2 | COMPLEXITY=2 | LINES=7
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=test_slice_out_of_bounds_3 | COMPLEXITY=2 | LINES=7
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=test_slice_out_of_bounds_4 | COMPLEXITY=2 | LINES=7
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=test_slice_out_of_bounds_5 | COMPLEXITY=2 | LINES=7
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=test_swap_remove_empty | COMPLEXITY=2 | LINES=7
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=test_move_items | COMPLEXITY=5 | LINES=10
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=test_move_items_reverse | COMPLEXITY=5 | LINES=10
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=test_move_items_zero_sized | COMPLEXITY=5 | LINES=10
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=test_drain_empty_vec | COMPLEXITY=5 | LINES=11
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=test_drain_items | COMPLEXITY=5 | LINES=11
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=test_drain_items_reverse | COMPLEXITY=5 | LINES=11
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=test_drain_items_zero_sized | COMPLEXITY=5 | LINES=11
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=test_drain_out_of_bounds | COMPLEXITY=2 | LINES=7
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=test_drain_range | COMPLEXITY=15 | LINES=19
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=test_drain_inclusive_range | COMPLEXITY=18 | LINES=23
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=test_drain_max_vec_size | COMPLEXITY=18 | LINES=17
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=test_drain_index_overflow | COMPLEXITY=7 | LINES=10
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=test_drain_inclusive_out_of_bounds | COMPLEXITY=2 | LINES=7
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=test_drain_start_overflow | COMPLEXITY=2 | LINES=7
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=test_drain_end_overflow | COMPLEXITY=2 | LINES=7
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=test_drain_leak | COMPLEXITY=7 | LINES=24
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=test_drain_keep_rest | COMPLEXITY=2 | LINES=12
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=test_drain_keep_rest_all | COMPLEXITY=2 | LINES=7
...
## Block 66
**Metadata**: AST_ID=66 | TYPE=FUNCTION | NAME=test_drain_keep_rest_none | COMPLEXITY=2 | LINES=11
...
## Block 67
**Metadata**: AST_ID=67 | TYPE=FUNCTION | NAME=test_splice | COMPLEXITY=2 | LINES=10
...
## Block 68
**Metadata**: AST_ID=68 | TYPE=FUNCTION | NAME=test_splice_inclusive_range | COMPLEXITY=2 | LINES=12
...
## Block 69
**Metadata**: AST_ID=69 | TYPE=FUNCTION | NAME=test_splice_out_of_bounds | COMPLEXITY=2 | LINES=8
...
## Block 70
**Metadata**: AST_ID=70 | TYPE=FUNCTION | NAME=test_splice_inclusive_out_of_bounds | COMPLEXITY=2 | LINES=8
...
## Block 71
**Metadata**: AST_ID=71 | TYPE=FUNCTION | NAME=test_splice_items_zero_sized | COMPLEXITY=2 | LINES=9
...
## Block 72
**Metadata**: AST_ID=72 | TYPE=FUNCTION | NAME=test_splice_unbounded | COMPLEXITY=2 | LINES=8
...
## Block 73
**Metadata**: AST_ID=73 | TYPE=FUNCTION | NAME=test_splice_forget | COMPLEXITY=2 | LINES=8
...
## Block 74
**Metadata**: AST_ID=74 | TYPE=FUNCTION | NAME=test_into_boxed_slice | COMPLEXITY=2 | LINES=7
...
## Block 75
**Metadata**: AST_ID=75 | TYPE=FUNCTION | NAME=test_append | COMPLEXITY=2 | LINES=9
...
## Block 76
**Metadata**: AST_ID=76 | TYPE=FUNCTION | NAME=test_split_off | COMPLEXITY=2 | LINES=13
...
## Block 77
**Metadata**: AST_ID=77 | TYPE=FUNCTION | NAME=test_split_off_take_all | COMPLEXITY=3 | LINES=21
...
## Block 78
**Metadata**: AST_ID=78 | TYPE=FUNCTION | NAME=test_into_iter_as_slice | COMPLEXITY=2 | LINES=12
...
## Block 79
**Metadata**: AST_ID=79 | TYPE=FUNCTION | NAME=test_into_iter_as_mut_slice | COMPLEXITY=2 | LINES=11
...
## Block 80
**Metadata**: AST_ID=80 | TYPE=FUNCTION | NAME=test_into_iter_debug | COMPLEXITY=3 | LINES=8
...
## Block 81
**Metadata**: AST_ID=81 | TYPE=FUNCTION | NAME=test_into_iter_count | COMPLEXITY=2 | LINES=5
...
## Block 82
**Metadata**: AST_ID=82 | TYPE=FUNCTION | NAME=test_into_iter_next_chunk | COMPLEXITY=2 | LINES=9
...
## Block 83
**Metadata**: AST_ID=83 | TYPE=FUNCTION | NAME=test_into_iter_clone | COMPLEXITY=4 | LINES=18
...
## Block 84
**Metadata**: AST_ID=84 | TYPE=FUNCTION | NAME=test_into_iter_leak | COMPLEXITY=5 | LINES=12
...
## Block 85
**Metadata**: AST_ID=85 | TYPE=FUNCTION | NAME=test_into_iter_advance_by | COMPLEXITY=3 | LINES=21
...
## Block 86
**Metadata**: AST_ID=86 | TYPE=FUNCTION | NAME=test_into_iter_drop_allocator | COMPLEXITY=23 | LINES=26
...
## Block 87
**Metadata**: AST_ID=87 | TYPE=FUNCTION | NAME=test_into_iter_zst | COMPLEXITY=13 | LINES=29
...
## Block 88
**Metadata**: AST_ID=88 | TYPE=FUNCTION | NAME=test_from_iter_specialization | COMPLEXITY=2 | LINES=9
...
## Block 89
**Metadata**: AST_ID=89 | TYPE=FUNCTION | NAME=test_from_iter_partially_drained_in_place_specialization | COMPLEXITY=2 | LINES=12
...
## Block 90
**Metadata**: AST_ID=90 | TYPE=FUNCTION | NAME=test_from_iter_specialization_with_iterator_adapters | COMPLEXITY=8 | LINES=24
...
## Block 91
**Metadata**: AST_ID=91 | TYPE=FUNCTION | NAME=test_in_place_specialization_step_up_down | COMPLEXITY=5 | LINES=31
...
## Block 92
**Metadata**: AST_ID=92 | TYPE=FUNCTION | NAME=test_from_iter_specialization_head_tail_drop | COMPLEXITY=3 | LINES=15
...
## Block 93
**Metadata**: AST_ID=93 | TYPE=FUNCTION | NAME=test_from_iter_specialization_panic_during_iteration_drops | COMPLEXITY=8 | LINES=25
...
## Block 94
**Metadata**: AST_ID=94 | TYPE=FUNCTION | NAME=test_from_iter_specialization_panic_during_drop_doesnt_leak | COMPLEXITY=11 | LINES=29
...
## Block 95
**Metadata**: AST_ID=95 | TYPE=FUNCTION | NAME=test_collect_after_iterator_clone | COMPLEXITY=4 | LINES=13
...
## Block 96
**Metadata**: AST_ID=96 | TYPE=FUNCTION | NAME=test_flatten_clone | COMPLEXITY=4 | LINES=13
...
## Block 97
**Metadata**: AST_ID=97 | TYPE=FUNCTION | NAME=test_cow_from | COMPLEXITY=6 | LINES=10
...
## Block 98
**Metadata**: AST_ID=98 | TYPE=FUNCTION | NAME=test_from_cow | COMPLEXITY=2 | LINES=8
...
## Block 99
**Metadata**: AST_ID=99 | TYPE=FUNCTION | NAME=assert_covariance | COMPLEXITY=4 | LINES=10
...
## Block 100
**Metadata**: AST_ID=100 | TYPE=FUNCTION | NAME=from_into_inner | COMPLEXITY=2 | LINES=16
...
## Block 101
**Metadata**: AST_ID=101 | TYPE=FUNCTION | NAME=overaligned_allocations | COMPLEXITY=5 | LINES=15
...
## Block 102
**Metadata**: AST_ID=102 | TYPE=FUNCTION | NAME=extract_if_empty | COMPLEXITY=3 | LINES=16
...
## Block 103
**Metadata**: AST_ID=103 | TYPE=FUNCTION | NAME=extract_if_zst | COMPLEXITY=7 | LINES=22
...
## Block 104
**Metadata**: AST_ID=104 | TYPE=FUNCTION | NAME=extract_if_false | COMPLEXITY=7 | LINES=22
...
## Block 105
**Metadata**: AST_ID=105 | TYPE=FUNCTION | NAME=extract_if_true | COMPLEXITY=7 | LINES=23
...
## Block 106
**Metadata**: AST_ID=106 | TYPE=FUNCTION | NAME=extract_if_ranges | COMPLEXITY=3 | LINES=18
...
## Block 107
**Metadata**: AST_ID=107 | TYPE=FUNCTION | NAME=extract_if_out_of_bounds | COMPLEXITY=2 | LINES=7
...
## Block 108
**Metadata**: AST_ID=108 | TYPE=FUNCTION | NAME=extract_if_complex | COMPLEXITY=11 | LINES=69
...
## Block 109
**Metadata**: AST_ID=109 | TYPE=FUNCTION | NAME=extract_if_consumed_panic | COMPLEXITY=29 | LINES=51
...
## Block 110
**Metadata**: AST_ID=110 | TYPE=FUNCTION | NAME=extract_if_unconsumed_panic | COMPLEXITY=29 | LINES=50
...
## Block 111
**Metadata**: AST_ID=111 | TYPE=FUNCTION | NAME=extract_if_unconsumed | COMPLEXITY=2 | LINES=8
...
## Block 112
**Metadata**: AST_ID=112 | TYPE=FUNCTION | NAME=test_reserve_exact | COMPLEXITY=5 | LINES=24
...
## Block 113
**Metadata**: AST_ID=113 | TYPE=FUNCTION | NAME=test_try_with_capacity | COMPLEXITY=2 | LINES=11
...
## Block 114
**Metadata**: AST_ID=114 | TYPE=FUNCTION | NAME=test_try_reserve | COMPLEXITY=30 | LINES=95
...
## Block 115
**Metadata**: AST_ID=115 | TYPE=FUNCTION | NAME=test_try_reserve_exact | COMPLEXITY=30 | LINES=89
...
## Block 116
**Metadata**: AST_ID=116 | TYPE=FUNCTION | NAME=test_stable_pointers | COMPLEXITY=18 | LINES=90
...
## Block 117
**Metadata**: AST_ID=117 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=9
...
## Block 118
**Metadata**: AST_ID=118 | TYPE=FUNCTION | NAME=vec_macro_repeating_null_raw_fat_pointer | COMPLEXITY=24 | LINES=32
...
## Block 119
**Metadata**: AST_ID=119 | TYPE=FUNCTION | NAME=test_push_growth_strategy | COMPLEXITY=60 | LINES=115
...
## Block 120
**Metadata**: AST_ID=120 | TYPE=FUNCTION | NAME=$name | COMPLEXITY=9 | LINES=9
...
## Block 121
**Metadata**: AST_ID=121 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=2
...
## Block 122
**Metadata**: AST_ID=122 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=1
...
## Block 123
**Metadata**: AST_ID=123 | TYPE=FUNCTION | NAME=partialeq_vec_and_prim | COMPLEXITY=2 | LINES=6
...
## Block 124
**Metadata**: AST_ID=124 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=13
...
## Block 125
**Metadata**: AST_ID=125 | TYPE=FUNCTION | NAME=partialeq_vec_full | COMPLEXITY=3 | LINES=23
...
## Block 126
**Metadata**: AST_ID=126 | TYPE=FUNCTION | NAME=test_vec_cycle | COMPLEXITY=7 | LINES=38
...
## Block 127
**Metadata**: AST_ID=127 | TYPE=FUNCTION | NAME=test_vec_cycle_wrapped | COMPLEXITY=11 | LINES=41
...
## Block 128
**Metadata**: AST_ID=128 | TYPE=FUNCTION | NAME=test_zero_sized_capacity | COMPLEXITY=5 | LINES=9
...
## Block 129
**Metadata**: AST_ID=129 | TYPE=FUNCTION | NAME=test_zero_sized_vec_push | COMPLEXITY=8 | LINES=17
...
## Block 130
**Metadata**: AST_ID=130 | TYPE=FUNCTION | NAME=test_vec_macro_repeat | COMPLEXITY=2 | LINES=13
...
## Block 131
**Metadata**: AST_ID=131 | TYPE=FUNCTION | NAME=test_vec_swap | COMPLEXITY=2 | LINES=12
...
## Block 132
**Metadata**: AST_ID=132 | TYPE=FUNCTION | NAME=test_extend_from_within_spec | COMPLEXITY=6 | LINES=14
...
## Block 133
**Metadata**: AST_ID=133 | TYPE=FUNCTION | NAME=test_extend_from_within_clone | COMPLEXITY=2 | LINES=8
...
## Block 134
**Metadata**: AST_ID=134 | TYPE=FUNCTION | NAME=test_extend_from_within_complete_rande | COMPLEXITY=2 | LINES=8
...
## Block 135
**Metadata**: AST_ID=135 | TYPE=FUNCTION | NAME=test_extend_from_within_empty_rande | COMPLEXITY=2 | LINES=8
...
## Block 136
**Metadata**: AST_ID=136 | TYPE=FUNCTION | NAME=test_extend_from_within_out_of_rande | COMPLEXITY=2 | LINES=7
...
## Block 137
**Metadata**: AST_ID=137 | TYPE=FUNCTION | NAME=test_extend_from_within_zst | COMPLEXITY=2 | LINES=8
...
## Block 138
**Metadata**: AST_ID=138 | TYPE=FUNCTION | NAME=test_extend_from_within_empty_vec | COMPLEXITY=2 | LINES=8
...
## Block 139
**Metadata**: AST_ID=139 | TYPE=FUNCTION | NAME=test_extend_from_within | COMPLEXITY=2 | LINES=9
...
## Block 140
**Metadata**: AST_ID=140 | TYPE=FUNCTION | NAME=test_vec_dedup_by | COMPLEXITY=2 | LINES=9
...
## Block 141
**Metadata**: AST_ID=141 | TYPE=FUNCTION | NAME=test_vec_dedup_empty | COMPLEXITY=2 | LINES=9
...
## Block 142
**Metadata**: AST_ID=142 | TYPE=FUNCTION | NAME=test_vec_dedup_one | COMPLEXITY=2 | LINES=9
...
## Block 143
**Metadata**: AST_ID=143 | TYPE=FUNCTION | NAME=test_vec_dedup_multiple_ident | COMPLEXITY=2 | LINES=9
...
## Block 144
**Metadata**: AST_ID=144 | TYPE=FUNCTION | NAME=test_vec_dedup_partialeq | COMPLEXITY=6 | LINES=17
...
## Block 145
**Metadata**: AST_ID=145 | TYPE=FUNCTION | NAME=test_vec_dedup | COMPLEXITY=5 | LINES=20
...
## Block 146
**Metadata**: AST_ID=146 | TYPE=FUNCTION | NAME=test_vec_dedup_panicking | COMPLEXITY=36 | LINES=56
...
## Block 147
**Metadata**: AST_ID=147 | TYPE=FUNCTION | NAME=test_extend_from_within_panicking_clone | COMPLEXITY=28 | LINES=42
...
## Block 148
**Metadata**: AST_ID=148 | TYPE=FUNCTION | NAME=test_into_flattened_size_overflow | COMPLEXITY=2 | LINES=7
...
## Block 149
**Metadata**: AST_ID=149 | TYPE=FUNCTION | NAME=test_box_zero_allocator | COMPLEXITY=44 | LINES=65
...
## Block 150
**Metadata**: AST_ID=150 | TYPE=FUNCTION | NAME=test_vec_from_array_ref | COMPLEXITY=2 | LINES=5
...
## Block 151
**Metadata**: AST_ID=151 | TYPE=FUNCTION | NAME=test_vec_from_array_mut_ref | COMPLEXITY=2 | LINES=5
...
## Block 152
**Metadata**: AST_ID=152 | TYPE=FUNCTION | NAME=test_pop_if | COMPLEXITY=2 | LINES=12
...
## Block 153
**Metadata**: AST_ID=153 | TYPE=FUNCTION | NAME=test_pop_if_empty | COMPLEXITY=2 | LINES=7
...
## Block 154
**Metadata**: AST_ID=154 | TYPE=FUNCTION | NAME=test_pop_if_mutates | COMPLEXITY=3 | LINES=11
...
## Block 155
**Metadata**: AST_ID=155 | TYPE=FUNCTION | NAME=test_peek_mut | COMPLEXITY=6 | LINES=17
...
## Block 156
**Metadata**: AST_ID=156 | TYPE=FUNCTION | NAME=max_dont_panic | COMPLEXITY=2 | LINES=13
...
## Block 157
**Metadata**: AST_ID=157 | TYPE=FUNCTION | NAME=max_insert | COMPLEXITY=2 | LINES=7
...
## Block 158
**Metadata**: AST_ID=158 | TYPE=FUNCTION | NAME=max_remove | COMPLEXITY=2 | LINES=7
...
## Block 159
**Metadata**: AST_ID=159 | TYPE=FUNCTION | NAME=max_splice | COMPLEXITY=2 | LINES=7
...
## Block 160
**Metadata**: AST_ID=160 | TYPE=FUNCTION | NAME=max_swap_remove | COMPLEXITY=2 | LINES=7
...
## Block 161
**Metadata**: AST_ID=161 | TYPE=FUNCTION | NAME=vec_null_ptr_roundtrip | COMPLEXITY=9 | LINES=10
