# AST Trace: compiler/rustc_abi/src/callconv.rs
...
```rust
// SRC: compiler/rustc_abi/src/callconv.rs
...
```rust
// MOD DECLARATION: reg (from compiler/rustc_abi/src/callconv.rs)
// REPLACED: mod reg; -> use crate::reg::*;
use crate::reg::*;
