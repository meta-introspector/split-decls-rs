# AST Trace: library/alloc/src/boxed.rs

Generated 64 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=9 | LINES=49

```rust
// SRC: library/alloc/src/boxed.rs
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=Box | COMPLEXITY=67 | LINES=192
...
// MOD DECLARATION: convert (from library/alloc/src/boxed.rs)
// REPLACED: mod convert; -> use crate::convert::*;
use crate::convert::*;
/// Iterator related impls for `Box<_>`.
// MOD DECLARATION: iter (from library/alloc/src/boxed.rs)
// REPLACED: mod iter; -> use crate::iter::*;
use crate::iter::*;
/// [`ThinBox`] implementation.
// MOD DECLARATION: thin (from library/alloc/src/boxed.rs)
// REPLACED: mod thin; -> use crate::thin::*;
use crate::thin::*;
