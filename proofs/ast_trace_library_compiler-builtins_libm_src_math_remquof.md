# AST Trace: library/compiler-builtins/libm/src/math/remquof.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=remquof | COMPLEXITY=67 | LINES=108

```rust
// SRC: library/compiler-builtins/libm/src/math/remquof.rs
