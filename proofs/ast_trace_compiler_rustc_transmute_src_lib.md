# AST Trace: compiler/rustc_transmute/src/lib.rs
...
```rust
// SRC: compiler/rustc_transmute/src/lib.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Assume | COMPLEXITY=2 | LINES=13

```rust
pub mod layout;
// MOD DECLARATION: maybe_transmutable (from compiler/rustc_transmute/src/lib.rs)
// REPLACED: mod maybe_transmutable; -> use crate::maybe_transmutable::*;
use crate::maybe_transmutable::*;
