# AST Trace: compiler/rustc_public/src/mir/alloc.rs
...
```rust
// SRC: compiler/rustc_public/src/mir/alloc.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=19
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=vtable_allocation | COMPLEXITY=15 | LINES=12
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=AllocId(usize); | COMPLEXITY=8 | LINES=13
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=15
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=15
