# AST Trace: ../rust/compiler/rustc_index/src/interval/tests.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=insert_collapses | COMPLEXITY=2 | LINES=9
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=contains | COMPLEXITY=2 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=insert | COMPLEXITY=15 | LINES=53
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=insert_range | COMPLEXITY=31 | LINES=45
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=insert_range_dual | COMPLEXITY=2 | LINES=13
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=last_set_before_adjacent | COMPLEXITY=2 | LINES=14
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=last_set_in | COMPLEXITY=23 | LINES=53
