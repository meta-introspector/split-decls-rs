# AST Trace: compiler/rustc_borrowck/src/region_infer/mod.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/region_infer/mod.rs
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=6 | LINES=24

```rust
// MOD DECLARATION: dump_mir (from compiler/rustc_borrowck/src/region_infer/mod.rs)
// REPLACED: mod dump_mir; -> use crate::dump_mir::*;
use crate::dump_mir::*;
// MOD DECLARATION: graphviz (from compiler/rustc_borrowck/src/region_infer/mod.rs)
// REPLACED: mod graphviz; -> use crate::graphviz::*;
use crate::graphviz::*;
pub(crate) mod opaque_types;
// MOD DECLARATION: reverse_sccs (from compiler/rustc_borrowck/src/region_infer/mod.rs)
// REPLACED: mod reverse_sccs; -> use crate::reverse_sccs::*;
use crate::reverse_sccs::*;
