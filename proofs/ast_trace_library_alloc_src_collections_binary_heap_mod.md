# AST Trace: library/alloc/src/collections/binary_heap/mod.rs

Generated 77 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=44

```rust
// SRC: library/alloc/src/collections/binary_heap/mod.rs
