# AST Trace: library/backtrace/crates/debuglink/src/main.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=main | COMPLEXITY=19 | LINES=49

```rust
// SRC: library/backtrace/crates/debuglink/src/main.rs
