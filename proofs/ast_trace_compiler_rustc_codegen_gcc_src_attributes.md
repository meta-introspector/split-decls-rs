# AST Trace: compiler/rustc_codegen_gcc/src/attributes.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=recursively_inline | COMPLEXITY=31 | LINES=61

```rust
// SRC: compiler/rustc_codegen_gcc/src/attributes.rs
