# AST Trace: compiler/rustc_mir_build/src/builder/matches/mod.rs

Generated 42 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=29

```rust
// SRC: compiler/rustc_mir_build/src/builder/matches/mod.rs
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=ThenElseArgs | COMPLEXITY=11 | LINES=28

```rust
// helper functions, broken out by category:
// MOD DECLARATION: match_pair (from compiler/rustc_mir_build/src/builder/matches/mod.rs)
// REPLACED: mod match_pair; -> use crate::match_pair::*;
use crate::match_pair::*;
// MOD DECLARATION: test (from compiler/rustc_mir_build/src/builder/matches/mod.rs)
// REPLACED: mod test; -> use crate::test::*;
use crate::test::*;
// MOD DECLARATION: user_ty (from compiler/rustc_mir_build/src/builder/matches/mod.rs)
// REPLACED: mod user_ty; -> use crate::user_ty::*;
use crate::user_ty::*;
// MOD DECLARATION: util (from compiler/rustc_mir_build/src/builder/matches/mod.rs)
