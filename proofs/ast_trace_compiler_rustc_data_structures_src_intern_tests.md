# AST Trace: compiler/rustc_data_structures/src/intern/tests.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=S(u32); | COMPLEXITY=6 | LINES=25

```rust
// SRC: compiler/rustc_data_structures/src/intern/tests.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=cmp | COMPLEXITY=5 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_uniq | COMPLEXITY=4 | LINES=30
