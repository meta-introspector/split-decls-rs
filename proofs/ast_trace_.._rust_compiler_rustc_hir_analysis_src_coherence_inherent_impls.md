# AST Trace: ../rust/compiler/rustc_hir_analysis/src/coherence/inherent_impls.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=17
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=InherentCollect | COMPLEXITY=2 | LINES=5
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=check_def_id | COMPLEXITY=89 | LINES=146
