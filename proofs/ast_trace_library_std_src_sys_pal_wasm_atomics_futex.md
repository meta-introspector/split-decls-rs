# AST Trace: library/std/src/sys/pal/wasm/atomics/futex.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=futex_wait | COMPLEXITY=18 | LINES=50

```rust
// SRC: library/std/src/sys/pal/wasm/atomics/futex.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=futex_wake | COMPLEXITY=11 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=futex_wake_all | COMPLEXITY=7 | LINES=7
