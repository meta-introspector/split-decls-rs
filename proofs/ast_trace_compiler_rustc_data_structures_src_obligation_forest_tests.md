# AST Trace: compiler/rustc_data_structures/src/obligation_forest/tests.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=as_cache_key | COMPLEXITY=7 | LINES=30

```rust
// SRC: compiler/rustc_data_structures/src/obligation_forest/tests.rs
