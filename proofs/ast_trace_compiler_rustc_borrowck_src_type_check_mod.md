# AST Trace: compiler/rustc_borrowck/src/type_check/mod.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/type_check/mod.rs
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=32 | LINES=126
