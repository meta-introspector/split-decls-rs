# AST Trace: ../rust/compiler/rustc_codegen_ssa/src/back/lto.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=ThinModule | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=name | COMPLEXITY=9 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=ThinShared | COMPLEXITY=2 | LINES=7
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=data | COMPLEXITY=7 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=crate_type_allows_lto | COMPLEXITY=6 | LINES=12
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=36 | LINES=50
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=24 | LINES=26
