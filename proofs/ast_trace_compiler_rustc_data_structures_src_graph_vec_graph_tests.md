# AST Trace: compiler/rustc_data_structures/src/graph/vec_graph/tests.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=create_graph | COMPLEXITY=4 | LINES=33

```rust
// SRC: compiler/rustc_data_structures/src/graph/vec_graph/tests.rs
