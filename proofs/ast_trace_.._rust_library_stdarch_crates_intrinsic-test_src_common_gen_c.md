# AST Trace: ../rust/library/stdarch/crates/intrinsic-test/src/common/gen_c.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=generate_c_test_loop | COMPLEXITY=16 | LINES=29
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=generate_c_constraint_blocks | COMPLEXITY=17 | LINES=32
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=create_c_test_function | COMPLEXITY=6 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=write_mod_cpp | COMPLEXITY=17 | LINES=49
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=write_main_cpp | COMPLEXITY=34 | LINES=62
