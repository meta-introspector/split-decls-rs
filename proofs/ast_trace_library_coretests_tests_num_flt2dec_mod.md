# AST Trace: library/coretests/tests/num/flt2dec/mod.rs
...
```rust
// SRC: library/coretests/tests/num/flt2dec/mod.rs
...
```rust
// MOD DECLARATION: estimator (from library/coretests/tests/num/flt2dec/mod.rs)
// REPLACED: mod estimator; -> use crate::estimator::*;
use crate::estimator::*;
mod strategy {
// MOD DECLARATION: dragon (from library/coretests/tests/num/flt2dec/mod.rs)
// REPLACED: mod dragon; -> use crate::dragon::*;
use crate::dragon::*;
// MOD DECLARATION: grisu (from library/coretests/tests/num/flt2dec/mod.rs)
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=decode_finite | COMPLEXITY=10 | LINES=10

```rust
// MOD DECLARATION: random (from library/coretests/tests/num/flt2dec/mod.rs)
// REPLACED: mod random; -> use crate::random::*;
use crate::random::*;
