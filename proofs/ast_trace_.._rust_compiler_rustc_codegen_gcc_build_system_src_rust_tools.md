# AST Trace: ../rust/compiler/rustc_codegen_gcc/build_system/src/rust_tools.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=args | COMPLEXITY=11 | LINES=15
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=usage | COMPLEXITY=3 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=RustcTools | COMPLEXITY=2 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=new | COMPLEXITY=35 | LINES=54
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=exec | COMPLEXITY=13 | LINES=20
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=run_cargo | COMPLEXITY=6 | LINES=11
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=run_rustc | COMPLEXITY=6 | LINES=9
