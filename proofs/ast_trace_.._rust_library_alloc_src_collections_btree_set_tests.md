# AST Trace: ../rust/library/alloc/src/collections/btree/set/tests.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_clone_eq | COMPLEXITY=2 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_iter_min_max | COMPLEXITY=4 | LINES=31
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=check | COMPLEXITY=13 | LINES=25
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_intersection | COMPLEXITY=8 | LINES=32
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_intersection_size_hint | COMPLEXITY=2 | LINES=16
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_difference | COMPLEXITY=8 | LINES=36
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_difference_size_hint | COMPLEXITY=6 | LINES=64
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_symmetric_difference | COMPLEXITY=3 | LINES=12
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_symmetric_difference_size_hint | COMPLEXITY=2 | LINES=12
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_union | COMPLEXITY=3 | LINES=16
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_union_size_hint | COMPLEXITY=2 | LINES=12
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_is_disjoint | COMPLEXITY=2 | LINES=8
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_is_subset | COMPLEXITY=8 | LINES=38
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_is_superset | COMPLEXITY=8 | LINES=36
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_retain | COMPLEXITY=2 | LINES=10
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_extract_if | COMPLEXITY=2 | LINES=11
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_extract_if_drop_panic_leak | COMPLEXITY=3 | LINES=21
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_extract_if_pred_panic_leak | COMPLEXITY=3 | LINES=25
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_clear | COMPLEXITY=2 | LINES=9
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_remove | COMPLEXITY=2 | LINES=20
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_zip | COMPLEXITY=2 | LINES=20
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_from_iter | COMPLEXITY=5 | LINES=11
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_show | COMPLEXITY=6 | LINES=14
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_extend_ref | COMPLEXITY=3 | LINES=28
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_recovery | COMPLEXITY=20 | LINES=47
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=assert_covariance | COMPLEXITY=6 | LINES=17
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=assert_sync | COMPLEXITY=12 | LINES=39
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=assert_send | COMPLEXITY=12 | LINES=39
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=assert_derives | COMPLEXITY=11 | LINES=31
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_ord_absence | COMPLEXITY=9 | LINES=27
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=test_append | COMPLEXITY=2 | LINES=24
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_first_last | COMPLEXITY=7 | LINES=33
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=rand_data | COMPLEXITY=2 | LINES=8
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_split_off_empty_right | COMPLEXITY=2 | LINES=12
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_split_off_empty_left | COMPLEXITY=2 | LINES=12
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_split_off_large_random_sorted | COMPLEXITY=6 | LINES=15
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=from_array | COMPLEXITY=2 | LINES=7
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=test_range_panic_1 | COMPLEXITY=2 | LINES=11
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_range_panic_2 | COMPLEXITY=2 | LINES=11
