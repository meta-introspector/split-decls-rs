# AST Trace: library/core/src/num/int_macros.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=1257 | LINES=3786

```rust
// SRC: library/core/src/num/int_macros.rs
