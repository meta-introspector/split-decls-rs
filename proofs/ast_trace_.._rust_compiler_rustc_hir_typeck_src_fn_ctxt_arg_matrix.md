# AST Trace: ../rust/compiler/rustc_hir_typeck/src/fn_ctxt/arg_matrix.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=15
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=cmp | COMPLEXITY=15 | LINES=22
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=partial_cmp | COMPLEXITY=5 | LINES=6
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=6 | LINES=13
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=eliminate_provided | COMPLEXITY=175 | LINES=315
