# AST Trace: compiler/rustc_middle/src/mir/interpret/allocation/provenance_map.rs
...
```rust
// SRC: compiler/rustc_middle/src/mir/interpret/allocation/provenance_map.rs
