# AST Trace: ../rust/compiler/rustc_hir_analysis/src/errors/wrong_number_of_generic_args.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=28
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=14
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=10 | LINES=39
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=missing_lifetimes | COMPLEXITY=625 | LINES=1049
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=into_diag | COMPLEXITY=6 | LINES=20
