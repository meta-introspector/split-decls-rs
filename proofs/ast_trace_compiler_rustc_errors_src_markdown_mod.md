# AST Trace: compiler/rustc_errors/src/markdown/mod.rs
...
```rust
// SRC: compiler/rustc_errors/src/markdown/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=MdStream | COMPLEXITY=5 | LINES=23

```rust
// MOD DECLARATION: parse (from compiler/rustc_errors/src/markdown/mod.rs)
// REPLACED: mod parse; -> use crate::parse::*;
use crate::parse::*;
// MOD DECLARATION: term (from compiler/rustc_errors/src/markdown/mod.rs)
// REPLACED: mod term; -> use crate::term::*;
use crate::term::*;
