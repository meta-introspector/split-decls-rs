# AST Trace: ../rust/compiler/rustc_thread_pool/src/spawn/tests.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=spawn_then_join_in_worker | COMPLEXITY=3 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=spawn_then_join_outside_worker | COMPLEXITY=2 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=panic_fwd | COMPLEXITY=12 | LINES=26
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=termination_while_things_are_executing | COMPLEXITY=7 | LINES=30
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=custom_panic_handler_and_spawn | COMPLEXITY=9 | LINES=28
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=custom_panic_handler_and_nested_spawn | COMPLEXITY=17 | LINES=37
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=19 | LINES=22
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=lifo_order | COMPLEXITY=2 | LINES=11
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=fifo_order | COMPLEXITY=2 | LINES=11
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=lifo_fifo_order | COMPLEXITY=2 | LINES=11
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=fifo_lifo_order | COMPLEXITY=2 | LINES=11
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=9 | LINES=7
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=11 | LINES=20
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=mixed_lifo_fifo_order | COMPLEXITY=2 | LINES=10
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=mixed_fifo_lifo_order | COMPLEXITY=2 | LINES=10
