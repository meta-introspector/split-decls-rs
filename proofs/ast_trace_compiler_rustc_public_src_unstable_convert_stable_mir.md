# AST Trace: compiler/rustc_public/src/unstable/convert/stable/mir.rs
...
```rust
// SRC: compiler/rustc_public/src/unstable/convert/stable/mir.rs
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=11 | LINES=23
