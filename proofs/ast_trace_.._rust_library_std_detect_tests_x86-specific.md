# AST Trace: ../rust/library/std_detect/tests/x86-specific.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=dump | COMPLEXITY=85 | LINES=83
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=x86_deprecated | COMPLEXITY=5 | LINES=8
