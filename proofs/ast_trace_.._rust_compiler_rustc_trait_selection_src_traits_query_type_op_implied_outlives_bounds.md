# AST Trace: ../rust/compiler/rustc_trait_selection/src/traits/query/type_op/implied_outlives_bounds.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=try_fast_path | COMPLEXITY=18 | LINES=33
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=compute_implied_outlives_bounds_inner | COMPLEXITY=45 | LINES=106
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=ContainsBevyParamSet | COMPLEXITY=2 | LINES=4
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=visit_ty | COMPLEXITY=18 | LINES=21
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=implied_bounds_from_components | COMPLEXITY=16 | LINES=38
