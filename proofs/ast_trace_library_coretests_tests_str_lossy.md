# AST Trace: library/coretests/tests/str_lossy.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=chunks | COMPLEXITY=16 | LINES=89

```rust
// SRC: library/coretests/tests/str_lossy.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=debug | COMPLEXITY=4 | LINES=11
