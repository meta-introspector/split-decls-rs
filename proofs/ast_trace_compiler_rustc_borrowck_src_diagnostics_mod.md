# AST Trace: compiler/rustc_borrowck/src/diagnostics/mod.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/diagnostics/mod.rs
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=40

```rust
// MOD DECLARATION: find_all_local_uses (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod find_all_local_uses; -> use crate::find_all_local_uses::*;
use crate::find_all_local_uses::*;
// MOD DECLARATION: find_use (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod find_use; -> use crate::find_use::*;
use crate::find_use::*;
// MOD DECLARATION: outlives_suggestion (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod outlives_suggestion; -> use crate::outlives_suggestion::*;
use crate::outlives_suggestion::*;
// MOD DECLARATION: region_name (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod region_name; -> use crate::region_name::*;
use crate::region_name::*;
// MOD DECLARATION: var_name (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod var_name; -> use crate::var_name::*;
use crate::var_name::*;

// MOD DECLARATION: bound_region_errors (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod bound_region_errors; -> use crate::bound_region_errors::*;
use crate::bound_region_errors::*;
// MOD DECLARATION: conflict_errors (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod conflict_errors; -> use crate::conflict_errors::*;
use crate::conflict_errors::*;
// MOD DECLARATION: explain_borrow (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod explain_borrow; -> use crate::explain_borrow::*;
use crate::explain_borrow::*;
// MOD DECLARATION: move_errors (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod move_errors; -> use crate::move_errors::*;
use crate::move_errors::*;
// MOD DECLARATION: mutability_errors (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod mutability_errors; -> use crate::mutability_errors::*;
use crate::mutability_errors::*;
// MOD DECLARATION: opaque_types (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod opaque_types; -> use crate::opaque_types::*;
use crate::opaque_types::*;
// MOD DECLARATION: region_errors (from compiler/rustc_borrowck/src/diagnostics/mod.rs)
// REPLACED: mod region_errors; -> use crate::region_errors::*;
use crate::region_errors::*;
