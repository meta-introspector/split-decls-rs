# AST Trace: library/alloc/src/raw_vec/tests.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=allocator_param | COMPLEXITY=34 | LINES=63

```rust
// SRC: library/alloc/src/raw_vec/tests.rs
