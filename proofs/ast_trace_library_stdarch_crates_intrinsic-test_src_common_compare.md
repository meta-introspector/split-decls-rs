# AST Trace: library/stdarch/crates/intrinsic-test/src/common/compare.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=runner_command | COMPLEXITY=4 | LINES=26

```rust
// SRC: library/stdarch/crates/intrinsic-test/src/common/compare.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=compare_outputs | COMPLEXITY=59 | LINES=81
