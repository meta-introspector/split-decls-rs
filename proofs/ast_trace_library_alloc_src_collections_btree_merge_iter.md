# AST Trace: library/alloc/src/collections/btree/merge_iter.rs
...
```rust
// SRC: library/alloc/src/collections/btree/merge_iter.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=clone | COMPLEXITY=6 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=32 | LINES=59
