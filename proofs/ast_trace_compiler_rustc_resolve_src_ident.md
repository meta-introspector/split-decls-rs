# AST Trace: compiler/rustc_resolve/src/ident.rs
...
```rust
// SRC: compiler/rustc_resolve/src/ident.rs
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=hygienic_lexical_parent | COMPLEXITY=976 | LINES=1738
