# AST Trace: library/std/src/sys/pal/uefi/helpers.rs

Generated 44 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=11 | LINES=29

```rust
// SRC: library/std/src/sys/pal/uefi/helpers.rs
