# AST Trace: library/stdarch/crates/assert-instr-macro/src/lib.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=assert_instr | COMPLEXITY=98 | LINES=175

```rust
// SRC: library/stdarch/crates/assert-instr-macro/src/lib.rs
