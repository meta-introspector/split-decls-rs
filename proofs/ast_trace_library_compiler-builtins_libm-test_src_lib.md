# AST Trace: library/compiler-builtins/libm-test/src/lib.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=5 | LINES=48

```rust
// SRC: library/compiler-builtins/libm-test/src/lib.rs
...
pub mod domain;
// MOD DECLARATION: f8_impl (from library/compiler-builtins/libm-test/src/lib.rs)
// REPLACED: mod f8_impl; -> use crate::f8_impl::*;
use crate::f8_impl::*;
pub mod generate;
#[cfg(feature = "build-mpfr")]
pub mod mpfloat;
// MOD DECLARATION: num (from library/compiler-builtins/libm-test/src/lib.rs)
// REPLACED: mod num; -> use crate::num::*;
use crate::num::*;
pub mod op;
// MOD DECLARATION: precision (from library/compiler-builtins/libm-test/src/lib.rs)
// REPLACED: mod precision; -> use crate::precision::*;
use crate::precision::*;
// MOD DECLARATION: run_cfg (from library/compiler-builtins/libm-test/src/lib.rs)
// REPLACED: mod run_cfg; -> use crate::run_cfg::*;
use crate::run_cfg::*;
// MOD DECLARATION: test_traits (from library/compiler-builtins/libm-test/src/lib.rs)
// REPLACED: mod test_traits; -> use crate::test_traits::*;
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=13
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_log | COMPLEXITY=30 | LINES=49
