# AST Trace: ../rust/compiler/rustc_middle/src/mir/generic_graphviz.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=GraphvizWriter | COMPLEXITY=2 | LINES=17
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=new | COMPLEXITY=99 | LINES=154
