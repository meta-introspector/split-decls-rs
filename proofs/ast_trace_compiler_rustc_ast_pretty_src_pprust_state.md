# AST Trace: compiler/rustc_ast_pretty/src/pprust/state.rs
...
```rust
// SRC: compiler/rustc_ast_pretty/src/pprust/state.rs
...
// MOD DECLARATION: expr (from compiler/rustc_ast_pretty/src/pprust/state.rs)
// REPLACED: mod expr; -> use crate::expr::*;
use crate::expr::*;
// MOD DECLARATION: fixup (from compiler/rustc_ast_pretty/src/pprust/state.rs)
// REPLACED: mod fixup; -> use crate::fixup::*;
use crate::fixup::*;
// MOD DECLARATION: item (from compiler/rustc_ast_pretty/src/pprust/state.rs)
// REPLACED: mod item; -> use crate::item::*;
use crate::item::*;
