# AST Trace: ../rust/library/core/src/alloc/layout.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=Layout | COMPLEXITY=4 | LINES=31
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=262 | LINES=480
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=LayoutError; | COMPLEXITY=5 | LINES=20
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=7 | LINES=8
