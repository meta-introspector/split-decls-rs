# AST Trace: compiler/rustc_index/src/bit_set/tests.rs

Generated 23 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_new_filled | COMPLEXITY=7 | LINES=30

```rust
// SRC: compiler/rustc_index/src/bit_set/tests.rs
