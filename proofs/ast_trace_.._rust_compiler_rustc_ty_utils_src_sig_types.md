# AST Trace: ../rust/compiler/rustc_ty_utils/src/sig_types.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=visit | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=walk_types | COMPLEXITY=78 | LINES=115
