# AST Trace: library/compiler-builtins/compiler-builtins/src/int/sdiv.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=31 | LINES=62

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/sdiv.rs
