# AST Trace: ../rust/compiler/rustc_mir_transform/src/ffi_unwind_calls.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=required_panic_strategy | COMPLEXITY=29 | LINES=40
