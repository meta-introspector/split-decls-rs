# AST Trace: compiler/rustc_data_structures/src/sso/map.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=11 | LINES=88

```rust
// SRC: compiler/rustc_data_structures/src/sso/map.rs
