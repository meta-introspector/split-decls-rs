# AST Trace: ../rust/compiler/rustc_trait_selection/src/error_reporting/infer/nice_region_error/util.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=find_param_with_region | COMPLEXITY=35 | LINES=75
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=includes_region | COMPLEXITY=37 | LINES=63
