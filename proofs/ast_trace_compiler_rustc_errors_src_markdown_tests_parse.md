# AST Trace: compiler/rustc_errors/src/markdown/tests/parse.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_parse_simple | COMPLEXITY=4 | LINES=31

```rust
// SRC: compiler/rustc_errors/src/markdown/tests/parse.rs
