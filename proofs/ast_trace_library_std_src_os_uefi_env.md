# AST Trace: library/std/src/os/uefi/env.rs
...
```rust
// SRC: library/std/src/os/uefi/env.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=42
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=system_table | COMPLEXITY=4 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=image_handle | COMPLEXITY=4 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=boot_services | COMPLEXITY=13 | LINES=13
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=7
