# AST Trace: ../rust/library/std/src/sys/thread_local/key/windows.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=20 | LINES=29
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=LazyKey | COMPLEXITY=9 | LINES=18
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=force | COMPLEXITY=74 | LINES=78
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=20
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=53 | LINES=41
