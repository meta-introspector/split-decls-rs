# AST Trace: ../rust/compiler/rustc_mir_build/src/thir/print.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=thir_flat | COMPLEXITY=9 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=ThirPrinter | COMPLEXITY=2 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=9 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=write_str | COMPLEXITY=5 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=new | COMPLEXITY=608 | LINES=927
