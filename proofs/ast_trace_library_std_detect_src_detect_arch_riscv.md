# AST Trace: library/std_detect/src/detect/arch/riscv.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=230 | LINES=393

```rust
// SRC: library/std_detect/src/detect/arch/riscv.rs
