# AST Trace: ../rust/library/std/src/fs/tests.rs

Generated 67 AST blocks from source file
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=14 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=16 | LINES=12
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=7
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=16 | LINES=11
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=got_symlink_permission | COMPLEXITY=16 | LINES=19
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=file_test_io_smoke_test | COMPLEXITY=9 | LINES=21
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=invalid_path_raises | COMPLEXITY=2 | LINES=14
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=file_test_iounlinking_invalid_path_should_raise_condition | COMPLEXITY=2 | LINES=15
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=file_test_io_non_positional_read | COMPLEXITY=7 | LINES=26
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=file_test_io_seek_and_tell_smoke_test | COMPLEXITY=5 | LINES=27
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=file_test_io_seek_and_write | COMPLEXITY=5 | LINES=24
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=file_lock_multiple_shared | COMPLEXITY=3 | LINES=25
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=file_lock_blocking | COMPLEXITY=3 | LINES=26
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=file_lock_drop | COMPLEXITY=3 | LINES=23
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=file_lock_dup | COMPLEXITY=5 | LINES=25
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=file_lock_double_unlock | COMPLEXITY=3 | LINES=17
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=file_lock_blocking_async | COMPLEXITY=13 | LINES=38
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=file_try_lock_async | COMPLEXITY=3 | LINES=22
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=file_test_io_seek_shakedown | COMPLEXITY=6 | LINES=32
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=file_test_io_eof | COMPLEXITY=3 | LINES=14
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=file_test_io_read_write_at | COMPLEXITY=9 | LINES=56
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_read_buf_at | COMPLEXITY=10 | LINES=43
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=test_read_buf_exact_at | COMPLEXITY=6 | LINES=36
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=set_get_unix_permissions | COMPLEXITY=3 | LINES=22
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=file_test_io_seek_read_write | COMPLEXITY=9 | LINES=54
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_seek_read_buf | COMPLEXITY=6 | LINES=33
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=file_test_read_buf | COMPLEXITY=3 | LINES=17
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=file_test_stat_is_correct_on_is_file | COMPLEXITY=4 | LINES=20
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=file_test_stat_is_correct_on_is_dir | COMPLEXITY=2 | LINES=12
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=file_test_fileinfo_false_when_checking_is_file_on_a_directory | COMPLEXITY=2 | LINES=9
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=file_test_fileinfo_check_exists_before_and_after_file_creation | COMPLEXITY=2 | LINES=10
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=file_test_directoryinfo_check_exists_before_and_after_mkdir | COMPLEXITY=2 | LINES=12
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=file_test_directoryinfo_readdir | COMPLEXITY=15 | LINES=29
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=file_create_new_already_exists_error | COMPLEXITY=2 | LINES=9
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=mkdir_path_already_exists_error | COMPLEXITY=2 | LINES=9
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=recursive_mkdir | COMPLEXITY=2 | LINES=8
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=recursive_mkdir_failure | COMPLEXITY=2 | LINES=14
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=concurrent_recursive_mkdir | COMPLEXITY=13 | LINES=21
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=recursive_mkdir_slash | COMPLEXITY=2 | LINES=5
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=recursive_mkdir_dot | COMPLEXITY=2 | LINES=5
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=recursive_mkdir_empty | COMPLEXITY=2 | LINES=5
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=recursive_rmdir | COMPLEXITY=3 | LINES=23
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=recursive_rmdir_of_symlink | COMPLEXITY=3 | LINES=20
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=recursive_rmdir_of_file_fails | COMPLEXITY=2 | LINES=15
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=recursive_rmdir_of_file_symlink | COMPLEXITY=10 | LINES=19
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=recursive_rmdir_toctou | COMPLEXITY=22 | LINES=53
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=unicode_path_is_dir | COMPLEXITY=8 | LINES=19
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=unicode_path_exists | COMPLEXITY=2 | LINES=13
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=copy_file_does_not_exist | COMPLEXITY=7 | LINES=14
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=copy_src_does_not_exist | COMPLEXITY=2 | LINES=13
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=copy_file_ok | COMPLEXITY=2 | LINES=15
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=copy_file_dst_dir | COMPLEXITY=7 | LINES=12
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=copy_file_dst_exists | COMPLEXITY=2 | LINES=15
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=copy_file_src_dir | COMPLEXITY=7 | LINES=12
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=copy_file_preserves_perm_bits | COMPLEXITY=3 | LINES=16
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=copy_file_preserves_streams | COMPLEXITY=2 | LINES=12
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=copy_file_returns_metadata_len | COMPLEXITY=2 | LINES=12
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=copy_file_follows_dst_symlink | COMPLEXITY=6 | LINES=22
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=symlinks_work | COMPLEXITY=6 | LINES=19
...
## Block 66
**Metadata**: AST_ID=66 | TYPE=FUNCTION | NAME=symlink_noexist | COMPLEXITY=9 | LINES=14
...
## Block 67
**Metadata**: AST_ID=67 | TYPE=FUNCTION | NAME=read_link | COMPLEXITY=289 | LINES=1022
