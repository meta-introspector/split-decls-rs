# AST Trace: library/compiler-builtins/libm/src/math/acosf.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=r | COMPLEXITY=5 | LINES=44

```rust
// SRC: library/compiler-builtins/libm/src/math/acosf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=acosf | COMPLEXITY=22 | LINES=50
