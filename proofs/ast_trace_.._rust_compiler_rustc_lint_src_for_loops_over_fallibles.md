# AST Trace: ../rust/compiler/rustc_lint/src/for_loops_over_fallibles.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=31 | LINES=30
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=check_expr | COMPLEXITY=42 | LINES=63
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=extract_for_loop | COMPLEXITY=7 | LINES=16
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=extract_iterator_next_call | COMPLEXITY=8 | LINES=17
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=suggest_question_mark | COMPLEXITY=14 | LINES=44
