# AST Trace: ../rust/library/coretests/tests/iter/traits/double_ended.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_rev_nth_back | COMPLEXITY=6 | LINES=21
