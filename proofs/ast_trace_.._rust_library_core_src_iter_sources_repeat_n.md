# AST Trace: ../rust/library/core/src/iter/sources/repeat_n.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=45
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=repeat_n | COMPLEXITY=3 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=RepeatNInner | COMPLEXITY=2 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=RepeatN | COMPLEXITY=4 | LINES=10
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=take_element | COMPLEXITY=3 | LINES=8
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=next | COMPLEXITY=20 | LINES=53
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=len | COMPLEXITY=5 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=next_back | COMPLEXITY=10 | LINES=35
