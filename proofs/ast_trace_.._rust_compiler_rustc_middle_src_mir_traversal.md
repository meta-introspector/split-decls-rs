# AST Trace: ../rust/compiler/rustc_middle/src/mir/traversal.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Preorder | COMPLEXITY=3 | LINES=26
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=4 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=preorder | COMPLEXITY=2 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=next | COMPLEXITY=18 | LINES=32
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=Postorder | COMPLEXITY=5 | LINES=27
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=new | COMPLEXITY=30 | LINES=86
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=next | COMPLEXITY=9 | LINES=22
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=postorder | COMPLEXITY=3 | LINES=15
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=mono_reachable_reverse_postorder | COMPLEXITY=5 | LINES=14
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=reachable | COMPLEXITY=2 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=reachable_as_bitset | COMPLEXITY=5 | LINES=7
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=reverse_postorder | COMPLEXITY=6 | LINES=31
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=mono_reachable | COMPLEXITY=7 | LINES=17
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=mono_reachable_as_bitset | COMPLEXITY=5 | LINES=12
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=STRUCT | NAME=MonoReachable | COMPLEXITY=2 | LINES=11
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=new | COMPLEXITY=12 | LINES=26
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=next | COMPLEXITY=12 | LINES=22
