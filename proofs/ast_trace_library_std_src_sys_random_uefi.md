# AST Trace: library/std/src/sys/random/uefi.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fill_bytes | COMPLEXITY=15 | LINES=38

```rust
// SRC: library/std/src/sys/random/uefi.rs
