# AST Trace: compiler/rustc_middle/src/mir/traversal.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Preorder | COMPLEXITY=4 | LINES=41

```rust
// SRC: compiler/rustc_middle/src/mir/traversal.rs
