# AST Trace: compiler/rustc_mir_transform/src/coroutine/drop.rs

Generated 16 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=FixReturnPendingVisitor | COMPLEXITY=8 | LINES=23

```rust
// SRC: compiler/rustc_mir_transform/src/coroutine/drop.rs
