# AST Trace: ../rust/library/alloctests/tests/thin_box.rs

Generated 21 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=want_niche_optimization | COMPLEXITY=4 | LINES=14
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=want_thin | COMPLEXITY=4 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=assert_covariance | COMPLEXITY=3 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=verify_aligned | COMPLEXITY=13 | LINES=23
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=check_thin_sized | COMPLEXITY=2 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=check_thin_dyn | COMPLEXITY=4 | LINES=12
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=$Type:ident($inner:ty); | COMPLEXITY=29 | LINES=61
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=Align1Zst(()); | COMPLEXITY=2 | LINES=8
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=Align1Small(u8); | COMPLEXITY=2 | LINES=8
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=Align64NotPow2Size([u8; | COMPLEXITY=2 | LINES=8
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=Align1Big([u8; | COMPLEXITY=2 | LINES=8
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=STRUCT | NAME=Align2Zst(()); | COMPLEXITY=2 | LINES=12
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=STRUCT | NAME=Align2Small(u8); | COMPLEXITY=2 | LINES=9
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=STRUCT | NAME=Align2Full([u8; | COMPLEXITY=2 | LINES=8
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=STRUCT | NAME=Align2NotPower2Size([u8; | COMPLEXITY=2 | LINES=9
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=STRUCT | NAME=Align2Big([u8; | COMPLEXITY=2 | LINES=9
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=STRUCT | NAME=Align64Zst(()); | COMPLEXITY=2 | LINES=9
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=STRUCT | NAME=Align64Small(u8); | COMPLEXITY=2 | LINES=9
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=STRUCT | NAME=Align64Med([u8; | COMPLEXITY=2 | LINES=8
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=STRUCT | NAME=Align64NotPow2Size([u8; | COMPLEXITY=2 | LINES=9
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=STRUCT | NAME=Align64Big([u8; | COMPLEXITY=2 | LINES=9
