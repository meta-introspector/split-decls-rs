# AST Trace: compiler/rustc_resolve/src/diagnostics.rs
...
```rust
// SRC: compiler/rustc_resolve/src/diagnostics.rs
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=report_with_use_injections | COMPLEXITY=1688 | LINES=2972
