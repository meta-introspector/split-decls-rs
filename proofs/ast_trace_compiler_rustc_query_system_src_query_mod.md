# AST Trace: compiler/rustc_query_system/src/query/mod.rs
...
```rust
// SRC: compiler/rustc_query_system/src/query/mod.rs
...
// MOD DECLARATION: plumbing (from compiler/rustc_query_system/src/query/mod.rs)
...
// MOD DECLARATION: job (from compiler/rustc_query_system/src/query/mod.rs)
// REPLACED: mod job; -> use crate::job::*;
use crate::job::*;
pub use self::job::{
...
```rust
// MOD DECLARATION: caches (from compiler/rustc_query_system/src/query/mod.rs)
// REPLACED: mod caches; -> use crate::caches::*;
use crate::caches::*;
...
```rust
// MOD DECLARATION: config (from compiler/rustc_query_system/src/query/mod.rs)
