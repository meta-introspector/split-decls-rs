# AST Trace: library/coretests/tests/fmt/float.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_format_f64 | COMPLEXITY=25 | LINES=40

```rust
// SRC: library/coretests/tests/fmt/float.rs
