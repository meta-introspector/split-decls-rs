# AST Trace: library/core/src/intrinsics/mod.rs

Generated 70 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=19 | LINES=74

```rust
// SRC: library/core/src/intrinsics/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=13

```rust
use crate::ptr;

// MOD DECLARATION: bounds (from library/core/src/intrinsics/mod.rs)
// REPLACED: mod bounds; -> use crate::bounds::*;
use crate::bounds::*;
pub mod fallback;
pub mod mir;
pub mod simd;
