# AST Trace: compiler/rustc_attr_parsing/src/attributes/mod.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=16 | LINES=40

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/mod.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=finalize | COMPLEXITY=15 | LINES=49
