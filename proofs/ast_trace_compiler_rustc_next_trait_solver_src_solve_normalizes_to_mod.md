# AST Trace: compiler/rustc_next_trait_solver/src/solve/normalizes_to/mod.rs
...
```rust
// SRC: compiler/rustc_next_trait_solver/src/solve/normalizes_to/mod.rs
...
// MOD DECLARATION: anon_const (from compiler/rustc_next_trait_solver/src/solve/normalizes_to/mod.rs)
// REPLACED: mod anon_const; -> use crate::anon_const::*;
use crate::anon_const::*;
// MOD DECLARATION: free_alias (from compiler/rustc_next_trait_solver/src/solve/normalizes_to/mod.rs)
// REPLACED: mod free_alias; -> use crate::free_alias::*;
use crate::free_alias::*;
// MOD DECLARATION: inherent (from compiler/rustc_next_trait_solver/src/solve/normalizes_to/mod.rs)
// REPLACED: mod inherent; -> use crate::inherent::*;
use crate::inherent::*;
// MOD DECLARATION: opaque_types (from compiler/rustc_next_trait_solver/src/solve/normalizes_to/mod.rs)
