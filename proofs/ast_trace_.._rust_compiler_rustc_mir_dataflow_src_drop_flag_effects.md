# AST Trace: ../rust/compiler/rustc_mir_dataflow/src/drop_flag_effects.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=value | COMPLEXITY=7 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=move_path_children_matching | COMPLEXITY=12 | LINES=22
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=on_lookup_result_bits | COMPLEXITY=7 | LINES=15
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=on_all_children_bits | COMPLEXITY=7 | LINES=25
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=drop_flag_effects_for_function_entry | COMPLEXITY=6 | LINES=16
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=drop_flag_effects_for_location | COMPLEXITY=17 | LINES=31
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=for_location_inits | COMPLEXITY=12 | LINES=21
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=contains | COMPLEXITY=7 | LINES=9
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=30
