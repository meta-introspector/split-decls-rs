# AST Trace: compiler/rustc_data_structures/src/thinvec.rs
...
```rust
// SRC: compiler/rustc_data_structures/src/thinvec.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=ExtractIf | COMPLEXITY=7 | LINES=16
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=new | COMPLEXITY=9 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=next | COMPLEXITY=22 | LINES=34
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=14 | LINES=21
