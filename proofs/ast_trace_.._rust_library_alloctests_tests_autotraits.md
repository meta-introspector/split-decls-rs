# AST Trace: ../rust/library/alloctests/tests/autotraits.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=require_sync | COMPLEXITY=2 | LINES=3
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=require_send_sync | COMPLEXITY=2 | LINES=1
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=NotSend(#[allow(dead_code)] | COMPLEXITY=8 | LINES=3
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_btree_map | COMPLEXITY=57 | LINES=133
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_btree_set | COMPLEXITY=22 | LINES=50
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_binary_heap | COMPLEXITY=18 | LINES=38
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_linked_list | COMPLEXITY=18 | LINES=42
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_vec_deque | COMPLEXITY=13 | LINES=28
