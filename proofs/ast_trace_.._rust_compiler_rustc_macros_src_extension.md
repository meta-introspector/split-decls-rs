# AST Trace: ../rust/compiler/rustc_macros/src/extension.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=21 | LINES=58
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=scrub_attrs | COMPLEXITY=3 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=scrub_header | COMPLEXITY=25 | LINES=36
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=ExtensionAttr | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=parse | COMPLEXITY=6 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=Impl | COMPLEXITY=2 | LINES=8
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=parse | COMPLEXITY=10 | LINES=19
