# AST Trace: library/std/src/sys/pal/xous/os/params/tests.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=create_args_test | COMPLEXITY=16 | LINES=70

```rust
// SRC: library/std/src/sys/pal/xous/os/params/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=basic_arg_parsing | COMPLEXITY=25 | LINES=22
