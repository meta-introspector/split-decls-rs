# AST Trace: compiler/rustc_trait_selection/src/traits/select/mod.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/select/mod.rs
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=8
