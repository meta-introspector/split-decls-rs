# AST Trace: ../rust/compiler/rustc_mir_transform/src/remove_zsts.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=20 | LINES=29
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Replacer | COMPLEXITY=2 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=trivially_zst | COMPLEXITY=18 | LINES=30
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=known_to_be_zst | COMPLEXITY=10 | LINES=21
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=39 | LINES=58
