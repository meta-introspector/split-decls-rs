# AST Trace: ../rust/compiler/rustc_codegen_cranelift/src/concurrency_limiter.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=36 | LINES=76
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=8 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=5 | LINES=8
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=drop_excess_capacity | COMPLEXITY=25 | LINES=94
