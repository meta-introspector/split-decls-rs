# AST Trace: compiler/rustc_infer/src/infer/snapshot/mod.rs
...
```rust
// SRC: compiler/rustc_infer/src/infer/snapshot/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=CombinedSnapshot | COMPLEXITY=2 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=VariableLengths | COMPLEXITY=2 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=variable_lengths | COMPLEXITY=31 | LINES=97
