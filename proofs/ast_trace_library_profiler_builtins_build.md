# AST Trace: library/profiler_builtins/build.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=main | COMPLEXITY=44 | LINES=121

```rust
// SRC: library/profiler_builtins/build.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=tracked_env_var | COMPLEXITY=3 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=tracked_env_var_or_fallback | COMPLEXITY=5 | LINES=6
