# AST Trace: compiler/rustc_attr_parsing/src/attributes/inline.rs
...
```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/inline.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=28 | LINES=62
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=18 | LINES=42
