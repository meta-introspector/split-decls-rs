# AST Trace: compiler/rustc_const_eval/src/lib.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=51

```rust
// SRC: compiler/rustc_const_eval/src/lib.rs
...
pub mod const_eval;
// MOD DECLARATION: errors (from compiler/rustc_const_eval/src/lib.rs)
