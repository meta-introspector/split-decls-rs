# AST Trace: ../rust/library/core/src/slice/sort/stable/drift.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sort | COMPLEXITY=54 | LINES=111
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=merge_tree_scale_factor | COMPLEXITY=13 | LINES=42
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=merge_tree_depth | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=sqrt_approx | COMPLEXITY=7 | LINES=16
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=logical_merge | COMPLEXITY=18 | LINES=30
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=create_run | COMPLEXITY=25 | LINES=43
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=stable_quicksort | COMPLEXITY=2 | LINES=11
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=DriftsortRun(usize); | COMPLEXITY=7 | LINES=27
