# AST Trace: library/stdarch/crates/simd-test-macro/src/lib.rs
...
```rust
// SRC: library/stdarch/crates/simd-test-macro/src/lib.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=string | COMPLEXITY=2 | LINES=6
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=simd_test | COMPLEXITY=66 | LINES=110
