# AST Trace: compiler/rustc_builtin_macros/src/format_foreign/shell/tests.rs
...
```rust
// SRC: compiler/rustc_builtin_macros/src/format_foreign/shell/tests.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_parse | COMPLEXITY=9 | LINES=15
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_iter | COMPLEXITY=4 | LINES=11
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_translation | COMPLEXITY=9 | LINES=11
