# AST Trace: library/alloctests/tests/btree_set_hash.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_hash | COMPLEXITY=4 | LINES=36

```rust
// SRC: library/alloctests/tests/btree_set_hash.rs
