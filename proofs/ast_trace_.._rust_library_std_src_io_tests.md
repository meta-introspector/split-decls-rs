# AST Trace: ../rust/library/std/src/io/tests.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=read_until | COMPLEXITY=3 | LINES=21
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=skip_until | COMPLEXITY=10 | LINES=30
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=split | COMPLEXITY=2 | LINES=14
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=read_line | COMPLEXITY=3 | LINES=19
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=lines | COMPLEXITY=2 | LINES=14
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=buf_read_has_data_left | COMPLEXITY=2 | LINES=10
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=read_to_end | COMPLEXITY=7 | LINES=21
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=read_to_string | COMPLEXITY=2 | LINES=17
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=read_exact | COMPLEXITY=2 | LINES=15
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=read_exact_slice | COMPLEXITY=3 | LINES=22
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=read_buf_exact | COMPLEXITY=3 | LINES=22
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=borrowed_cursor_advance_overflow | COMPLEXITY=2 | LINES=9
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=take_eof | COMPLEXITY=12 | LINES=21
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=cmp_bufread | COMPLEXITY=14 | LINES=22
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=chain_bufread | COMPLEXITY=2 | LINES=9
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=chain_splitted_char | COMPLEXITY=2 | LINES=11
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=bufreader_size_hint | COMPLEXITY=3 | LINES=20
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=empty_size_hint | COMPLEXITY=2 | LINES=6
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=slice_size_hint | COMPLEXITY=2 | LINES=6
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=take_size_hint | COMPLEXITY=2 | LINES=12
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=chain_empty_size_hint | COMPLEXITY=2 | LINES=7
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=chain_size_hint | COMPLEXITY=2 | LINES=14
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=chain_zero_length_read_is_not_eof | COMPLEXITY=2 | LINES=11
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=bench_read_to_end | COMPLEXITY=3 | LINES=10
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=seek_len | COMPLEXITY=2 | LINES=19
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=seek_position | COMPLEXITY=3 | LINES=30
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=take_seek | COMPLEXITY=5 | LINES=60
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=take_seek_error | COMPLEXITY=2 | LINES=11
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=STRUCT | NAME=ExampleHugeRangeOfZeroes | COMPLEXITY=2 | LINES=4
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=read | COMPLEXITY=11 | LINES=14
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=seek | COMPLEXITY=17 | LINES=18
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=take_seek_big_offsets | COMPLEXITY=4 | LINES=13
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=STRUCT | NAME=ExampleSliceReader | COMPLEXITY=2 | LINES=6
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=read | COMPLEXITY=5 | LINES=9
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_read_to_end_capacity | COMPLEXITY=3 | LINES=14
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=io_slice_mut_advance_slices | COMPLEXITY=3 | LINES=27
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=io_slice_mut_advance_slices_empty_slice | COMPLEXITY=2 | LINES=7
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=io_slice_mut_advance_slices_beyond_total_length | COMPLEXITY=2 | LINES=10
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=io_slice_advance_slices | COMPLEXITY=3 | LINES=23
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=io_slice_advance_slices_empty_slice | COMPLEXITY=2 | LINES=7
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=io_slice_advance_slices_beyond_total_length | COMPLEXITY=2 | LINES=10
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=io_slice_as_slice | COMPLEXITY=2 | LINES=7
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=io_slice_into_slice | COMPLEXITY=2 | LINES=7
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=test_writer | COMPLEXITY=3 | LINES=6
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=STRUCT | NAME=TestWriter | COMPLEXITY=2 | LINES=6
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=write | COMPLEXITY=11 | LINES=22
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=test_writer_read_from_one_buf | COMPLEXITY=3 | LINES=19
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=test_writer_read_from_multiple_bufs | COMPLEXITY=3 | LINES=15
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=test_write_all_vectored | COMPLEXITY=11 | LINES=36
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=test_take_wrong_length | COMPLEXITY=11 | LINES=19
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=slice_read_exact_eof | COMPLEXITY=2 | LINES=16
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=cursor_read_exact_eof | COMPLEXITY=2 | LINES=16
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=bench_take_read | COMPLEXITY=3 | LINES=9
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=bench_take_read_buf | COMPLEXITY=3 | LINES=11
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=read_buf_broken_read | COMPLEXITY=6 | LINES=16
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=read_buf_full_read | COMPLEXITY=6 | LINES=13
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=DataAndErrorReader(&'static | COMPLEXITY=6 | LINES=13
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=read_buf_data_and_error_take | COMPLEXITY=2 | LINES=14
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=read_buf_data_and_error_buf | COMPLEXITY=2 | LINES=8
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=read_buf_data_and_error_read_to_end | COMPLEXITY=2 | LINES=10
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=read_to_end_error | COMPLEXITY=6 | LINES=18
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=try_oom_error | COMPLEXITY=9 | LINES=16
