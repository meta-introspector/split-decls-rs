# AST Trace: library/coretests/tests/iter/mod.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=is_trusted_len | COMPLEXITY=12 | LINES=51

```rust
// SRC: library/coretests/tests/iter/mod.rs
...
// MOD DECLARATION: adapters (from library/coretests/tests/iter/mod.rs)
// REPLACED: mod adapters; -> use crate::adapters::*;
use crate::adapters::*;
// MOD DECLARATION: range (from library/coretests/tests/iter/mod.rs)
// REPLACED: mod range; -> use crate::range::*;
use crate::range::*;
// MOD DECLARATION: sources (from library/coretests/tests/iter/mod.rs)
// REPLACED: mod sources; -> use crate::sources::*;
use crate::sources::*;
// MOD DECLARATION: traits (from library/coretests/tests/iter/mod.rs)
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_multi_iter | COMPLEXITY=2 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_counter_from_iter | COMPLEXITY=2 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_functor_laws | COMPLEXITY=6 | LINES=21
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_monad_laws_left_identity | COMPLEXITY=3 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_monad_laws_right_identity | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_monad_laws_associativity | COMPLEXITY=4 | LINES=14
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=extend_for_unit | COMPLEXITY=4 | LINES=12
