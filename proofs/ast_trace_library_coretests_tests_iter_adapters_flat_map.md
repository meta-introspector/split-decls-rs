# AST Trace: library/coretests/tests/iter/adapters/flat_map.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_flat_map | COMPLEXITY=7 | LINES=29

```rust
// SRC: library/coretests/tests/iter/adapters/flat_map.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_iterator_flat_map_fold | COMPLEXITY=5 | LINES=25
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_flat_map_try_folds | COMPLEXITY=3 | LINES=18
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_double_ended_flat_map | COMPLEXITY=3 | LINES=17
