# AST Trace: compiler/rustc_borrowck/src/polonius/legacy/location.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/polonius/legacy/location.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=PoloniusLocationTable | COMPLEXITY=5 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=LocationIndex | COMPLEXITY=4 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=all_points | COMPLEXITY=31 | LINES=76
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=is_start | COMPLEXITY=3 | LINES=7
