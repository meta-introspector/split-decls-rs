# AST Trace: ../rust/library/coretests/tests/iter/adapters/map_windows.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=DropInfo | COMPLEXITY=41 | LINES=146
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=output_n1 | COMPLEXITY=2 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=output_n2 | COMPLEXITY=2 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_case_from_pr_82413_comment | COMPLEXITY=6 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=check_zero_window | COMPLEXITY=2 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_zero_sized_type | COMPLEXITY=2 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_too_large_array_size | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_laziness | COMPLEXITY=4 | LINES=27
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_size_hint | COMPLEXITY=19 | LINES=67
