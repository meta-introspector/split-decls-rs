# AST Trace: compiler/rustc_trait_selection/src/traits/select/candidate_assembly.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/select/candidate_assembly.rs
