# AST Trace: library/coretests/tests/clone.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_borrowed_clone | COMPLEXITY=3 | LINES=28

```rust
// SRC: library/coretests/tests/clone.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_clone_from | COMPLEXITY=2 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_clone_to_uninit_slice_success | COMPLEXITY=10 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_clone_to_uninit_slice_drops_on_panic | COMPLEXITY=31 | LINES=49
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_clone_to_uninit_str | COMPLEXITY=17 | LINES=15
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_clone_to_uninit_cstr | COMPLEXITY=17 | LINES=15
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=cstr_metadata_is_length_with_nul | COMPLEXITY=2 | LINES=8
