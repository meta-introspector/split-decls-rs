# AST Trace: compiler/rustc_hir_analysis/src/outlives/implicit_infer.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/outlives/implicit_infer.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=insert_required_predicates_to_be_wf | COMPLEXITY=35 | LINES=116
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=2 | LINES=4
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=check_explicit_predicates | COMPLEXITY=34 | LINES=73
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=2 | LINES=4
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=check_inferred_predicates | COMPLEXITY=12 | LINES=29
