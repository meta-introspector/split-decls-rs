# AST Trace: library/std/src/sync/mod.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=45

```rust
// SRC: library/std/src/sync/mod.rs
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=WaitTimeoutResult(bool); | COMPLEXITY=24 | LINES=85
...
// MOD DECLARATION: barrier (from library/std/src/sync/mod.rs)
// REPLACED: mod barrier; -> use crate::barrier::*;
use crate::barrier::*;
// MOD DECLARATION: lazy_lock (from library/std/src/sync/mod.rs)
// REPLACED: mod lazy_lock; -> use crate::lazy_lock::*;
use crate::lazy_lock::*;
// MOD DECLARATION: once_lock (from library/std/src/sync/mod.rs)
// REPLACED: mod once_lock; -> use crate::once_lock::*;
use crate::once_lock::*;
// MOD DECLARATION: reentrant_lock (from library/std/src/sync/mod.rs)
