# AST Trace: ../rust/library/portable-simd/crates/std_float/src/lib.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=MODULE | NAME=UNNAMED | COMPLEXITY=3 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=mul_add | COMPLEXITY=59 | LINES=122
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=1
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=fract | COMPLEXITY=36 | LINES=53
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=10
