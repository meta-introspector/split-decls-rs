# AST Trace: library/std/src/sys/random/zkvm.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fill_bytes | COMPLEXITY=25 | LINES=36

```rust
// SRC: library/std/src/sys/random/zkvm.rs
