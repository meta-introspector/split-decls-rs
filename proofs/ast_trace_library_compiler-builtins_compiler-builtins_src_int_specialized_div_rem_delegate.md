# AST Trace: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/delegate.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=104 | LINES=203

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/delegate.rs
