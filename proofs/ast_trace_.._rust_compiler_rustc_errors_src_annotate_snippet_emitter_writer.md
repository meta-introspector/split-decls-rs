# AST Trace: ../rust/compiler/rustc_errors/src/annotate_snippet_emitter_writer.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=AnnotateSnippetEmitter | COMPLEXITY=2 | LINES=13
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=emit_diagnostic | COMPLEXITY=12 | LINES=39
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=source_string | COMPLEXITY=4 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=annotation_level_for_level | COMPLEXITY=8 | LINES=16
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=46 | LINES=103
