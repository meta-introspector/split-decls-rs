# AST Trace: ../rust/library/std/src/sys/pal/unix/kernel_copy/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=copy_specialization | COMPLEXITY=8 | LINES=61
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=copies_append_mode_sink | COMPLEXITY=3 | LINES=18
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=dont_splice_pipes_from_files | COMPLEXITY=5 | LINES=42
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=bench_file_to_file_copy | COMPLEXITY=4 | LINES=30
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=bench_file_to_socket_copy | COMPLEXITY=8 | LINES=32
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=bench_file_to_uds_copy | COMPLEXITY=8 | LINES=30
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=bench_socket_pipe_socket_copy | COMPLEXITY=43 | LINES=94
