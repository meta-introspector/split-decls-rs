# AST Trace: compiler/rustc_trait_selection/src/error_reporting/traits/call_kind.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/error_reporting/traits/call_kind.rs
