# AST Trace: ../rust/library/compiler-builtins/libm/src/math/jnf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=jnf | COMPLEXITY=82 | LINES=176
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=ynf | COMPLEXITY=36 | LINES=61
