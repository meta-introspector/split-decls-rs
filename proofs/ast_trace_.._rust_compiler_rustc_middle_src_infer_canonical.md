# AST Trace: ../rust/compiler/rustc_middle/src/infer/canonical.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=OriginalQueryValues | COMPLEXITY=6 | LINES=23
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=default | COMPLEXITY=6 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=QueryResponse | COMPLEXITY=3 | LINES=12
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=QueryRegionConstraints | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=is_empty | COMPLEXITY=10 | LINES=12
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=7 | LINES=24
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=is_proven | COMPLEXITY=7 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=is_proven | COMPLEXITY=3 | LINES=6
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=CanonicalParamEnvCache | COMPLEXITY=2 | LINES=12
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=get_or_insert | COMPLEXITY=24 | LINES=57
