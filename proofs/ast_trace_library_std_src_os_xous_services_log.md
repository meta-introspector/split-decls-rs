# AST Trace: library/std/src/os/xous/services/log.rs
...
```rust
// SRC: library/std/src/os/xous/services/log.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=group_or_null | COMPLEXITY=9 | LINES=17
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=into | COMPLEXITY=11 | LINES=21
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=into | COMPLEXITY=5 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=19
