# AST Trace: compiler/rustc_borrowck/src/universal_regions.rs

Generated 19 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=20

```rust
// SRC: compiler/rustc_borrowck/src/universal_regions.rs
