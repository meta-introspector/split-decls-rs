# AST Trace: library/std/src/sys/net/connection/xous/dns.rs
...
```rust
// SRC: library/std/src/sys/net/connection/xous/dns.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=DnsError | COMPLEXITY=2 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=LookupHostQuery([u8; | COMPLEXITY=2 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=port | COMPLEXITY=3 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=next | COMPLEXITY=26 | LINES=46
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=lookup | COMPLEXITY=11 | LINES=27
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=try_from | COMPLEXITY=17 | LINES=20
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=try_from | COMPLEXITY=5 | LINES=8
