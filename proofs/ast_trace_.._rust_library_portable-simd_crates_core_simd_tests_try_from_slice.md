# AST Trace: ../rust/library/portable-simd/crates/core_simd/tests/try_from_slice.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=try_from_slice | COMPLEXITY=3 | LINES=25
