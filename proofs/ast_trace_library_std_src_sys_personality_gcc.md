# AST Trace: library/std/src/sys/personality/gcc.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=57

```rust
// SRC: library/std/src/sys/personality/gcc.rs
