# AST Trace: library/stdarch/crates/core_arch/src/loongarch64/lsx/types.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=m128i(2 | COMPLEXITY=23 | LINES=91

```rust
// SRC: library/stdarch/crates/core_arch/src/loongarch64/lsx/types.rs
