# AST Trace: ../rust/compiler/rustc_middle/src/ty/significant_drop_order.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=true_significant_drop_ty | COMPLEXITY=40 | LINES=63
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=extract_component_raw | COMPLEXITY=20 | LINES=32
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=extract_component_with_significant_dtor | COMPLEXITY=2 | LINES=12
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=ty_dtor_span | COMPLEXITY=13 | LINES=45
