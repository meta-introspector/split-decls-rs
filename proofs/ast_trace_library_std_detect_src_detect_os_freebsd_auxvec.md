# AST Trace: library/std_detect/src/detect/os/freebsd/auxvec.rs
...
```rust
// SRC: library/std_detect/src/detect/os/freebsd/auxvec.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=25
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=archauxv | COMPLEXITY=8 | LINES=18
