# AST Trace: library/alloc/src/vec/in_place_collect.rs

Generated 20 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=51 | LINES=140

```rust
// SRC: library/alloc/src/vec/in_place_collect.rs
