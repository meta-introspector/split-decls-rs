# AST Trace: library/coretests/tests/iter/adapters/flatten.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_flatten | COMPLEXITY=7 | LINES=33

```rust
// SRC: library/coretests/tests/iter/adapters/flatten.rs
