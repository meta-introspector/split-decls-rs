# AST Trace: library/compiler-builtins/builtins-test/tests/addsub.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn_add | COMPLEXITY=63 | LINES=99

```rust
// SRC: library/compiler-builtins/builtins-test/tests/addsub.rs
