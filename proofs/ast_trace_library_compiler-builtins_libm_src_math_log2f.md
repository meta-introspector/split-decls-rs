# AST Trace: library/compiler-builtins/libm/src/math/log2f.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log2f | COMPLEXITY=23 | LINES=103

```rust
// SRC: library/compiler-builtins/libm/src/math/log2f.rs
