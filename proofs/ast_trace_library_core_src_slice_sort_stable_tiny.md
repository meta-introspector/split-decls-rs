# AST Trace: library/core/src/slice/sort/stable/tiny.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=mergesort | COMPLEXITY=26 | LINES=56

```rust
// SRC: library/core/src/slice/sort/stable/tiny.rs
