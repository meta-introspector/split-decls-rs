# AST Trace: ../rust/compiler/rustc_public/src/crate_def.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=DefId(pub(crate) | COMPLEXITY=11 | LINES=25
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=def_id | COMPLEXITY=19 | LINES=55
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=ty | COMPLEXITY=7 | LINES=17
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=associated_items | COMPLEXITY=5 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=Attribute | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=def_id | COMPLEXITY=12 | LINES=16
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=def_id | COMPLEXITY=15 | LINES=18
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=11 | LINES=6
