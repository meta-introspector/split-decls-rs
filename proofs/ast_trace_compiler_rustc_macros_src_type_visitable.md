# AST Trace: compiler/rustc_macros/src/type_visitable.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=visit_with | COMPLEXITY=37 | LINES=78

```rust
// SRC: compiler/rustc_macros/src/type_visitable.rs
