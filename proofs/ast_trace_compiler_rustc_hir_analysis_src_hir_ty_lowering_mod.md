# AST Trace: compiler/rustc_hir_analysis/src/hir_ty_lowering/mod.rs

Generated 33 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=50

```rust
// SRC: compiler/rustc_hir_analysis/src/hir_ty_lowering/mod.rs
...
// MOD DECLARATION: bounds (from compiler/rustc_hir_analysis/src/hir_ty_lowering/mod.rs)
// REPLACED: mod bounds; -> use crate::bounds::*;
use crate::bounds::*;
// MOD DECLARATION: cmse (from compiler/rustc_hir_analysis/src/hir_ty_lowering/mod.rs)
// REPLACED: mod cmse; -> use crate::cmse::*;
use crate::cmse::*;
// MOD DECLARATION: dyn_compatibility (from compiler/rustc_hir_analysis/src/hir_ty_lowering/mod.rs)
// REPLACED: mod dyn_compatibility; -> use crate::dyn_compatibility::*;
use crate::dyn_compatibility::*;
pub mod errors;
pub mod generics;
// MOD DECLARATION: lint (from compiler/rustc_hir_analysis/src/hir_ty_lowering/mod.rs)
// REPLACED: mod lint; -> use crate::lint::*;
use crate::lint::*;
