# AST Trace: library/coretests/tests/iter/adapters/cycle.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_cycle | COMPLEXITY=8 | LINES=48

```rust
// SRC: library/coretests/tests/iter/adapters/cycle.rs
