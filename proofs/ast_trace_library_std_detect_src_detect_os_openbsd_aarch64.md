# AST Trace: library/std_detect/src/detect/os/openbsd/aarch64.rs
...
```rust
// SRC: library/std_detect/src/detect/os/openbsd/aarch64.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sysctl64 | COMPLEXITY=16 | LINES=22
