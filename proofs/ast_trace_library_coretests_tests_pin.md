# AST Trace: library/coretests/tests/pin.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=pin_const | COMPLEXITY=21 | LINES=52

```rust
// SRC: library/coretests/tests/pin.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cell | COMPLEXITY=18 | LINES=46
