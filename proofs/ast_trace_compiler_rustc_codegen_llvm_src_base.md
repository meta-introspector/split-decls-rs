# AST Trace: compiler/rustc_codegen_llvm/src/base.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=8 | LINES=51

```rust
// SRC: compiler/rustc_codegen_llvm/src/base.rs
