# AST Trace: library/std/src/sys/net/connection/uefi/tcp.rs
...
```rust
// SRC: library/std/src/sys/net/connection/uefi/tcp.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=5
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=peer_addr | COMPLEXITY=54 | LINES=66
