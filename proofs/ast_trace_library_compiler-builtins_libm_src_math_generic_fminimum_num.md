# AST Trace: library/compiler-builtins/libm/src/math/generic/fminimum_num.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fminimum_num | COMPLEXITY=27 | LINES=44

```rust
// SRC: library/compiler-builtins/libm/src/math/generic/fminimum_num.rs
