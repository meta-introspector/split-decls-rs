# AST Trace: library/coretests/tests/iter/range.rs

Generated 26 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_range | COMPLEXITY=5 | LINES=43

```rust
// SRC: library/coretests/tests/iter/range.rs
