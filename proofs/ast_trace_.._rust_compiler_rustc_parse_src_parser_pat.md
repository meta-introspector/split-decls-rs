# AST Trace: ../rust/compiler/rustc_parse/src/parser/pat.rs
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=12
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=8
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=to_string_or_fallback | COMPLEXITY=7 | LINES=13
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=9
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=12
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=7
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=parse_pat_allow_top_guard | COMPLEXITY=129 | LINES=241
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=recover_trailing_vert | COMPLEXITY=18 | LINES=38
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=maybe_recover_trailing_expr | COMPLEXITY=50 | LINES=126
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=PatVisitor | COMPLEXITY=114 | LINES=186
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=eat_metavar_pat | COMPLEXITY=12 | LINES=21
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=parse_pat_with_range_pat | COMPLEXITY=126 | LINES=177
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=recover_dotdotdot_rest_pat | COMPLEXITY=5 | LINES=14
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=recover_intersection_pat | COMPLEXITY=18 | LINES=50
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=ban_pat_range_if_ambiguous | COMPLEXITY=13 | LINES=20
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=parse_pat_deref | COMPLEXITY=7 | LINES=18
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=parse_pat_tuple_or_parens | COMPLEXITY=30 | LINES=67
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=parse_pat_ident_mut | COMPLEXITY=14 | LINES=37
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=make_all_value_bindings_mutable | COMPLEXITY=12 | LINES=21
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=ban_mut_general_pat | COMPLEXITY=8 | LINES=12
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=recover_additional_muts | COMPLEXITY=11 | LINES=13
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=parse_pat_mac_invoc | COMPLEXITY=3 | LINES=8
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=fatal_unexpected_non_pat | COMPLEXITY=9 | LINES=21
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=parse_range_end | COMPLEXITY=13 | LINES=14
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=parse_pat_range_begin_with | COMPLEXITY=10 | LINES=21
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=20 | LINES=32
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=parse_pat_range_to | COMPLEXITY=9 | LINES=13
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=is_pat_range_end_start | COMPLEXITY=6 | LINES=17
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=parse_pat_range_end | COMPLEXITY=25 | LINES=45
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=is_start_of_pat_with_path | COMPLEXITY=4 | LINES=7
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=can_be_ident_pat | COMPLEXITY=5 | LINES=15
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=parse_pat_ident | COMPLEXITY=27 | LINES=51
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=2
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=parse_pat_struct | COMPLEXITY=12 | LINES=16
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=parse_pat_tuple_struct | COMPLEXITY=7 | LINES=20
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=isnt_pattern_start | COMPLEXITY=5 | LINES=18
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=parse_pat_builtin | COMPLEXITY=8 | LINES=15
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=parse_pat_box | COMPLEXITY=13 | LINES=29
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=parse_pat_fields | COMPLEXITY=104 | LINES=173
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=report_misplaced_at_in_struct_pat | COMPLEXITY=13 | LINES=17
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=2
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=recover_misplaced_pattern_modifiers | COMPLEXITY=4 | LINES=8
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=4
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=12
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=recover_bad_dot_dot | COMPLEXITY=7 | LINES=8
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=parse_pat_field | COMPLEXITY=9 | LINES=18
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=6 | LINES=14
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=10
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=8
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=1 | LINES=2
