# AST Trace: library/compiler-builtins/libm/src/math/log2.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log2 | COMPLEXITY=29 | LINES=122

```rust
// SRC: library/compiler-builtins/libm/src/math/log2.rs
