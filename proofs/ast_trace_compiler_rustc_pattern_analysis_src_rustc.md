# AST Trace: compiler/rustc_pattern_analysis/src/rustc.rs
...
```rust
// SRC: compiler/rustc_pattern_analysis/src/rustc.rs
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=RevealedTy | COMPLEXITY=11 | LINES=28
