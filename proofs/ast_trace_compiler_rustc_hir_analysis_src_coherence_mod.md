# AST Trace: compiler/rustc_hir_analysis/src/coherence/mod.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/coherence/mod.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=check_impl | COMPLEXITY=10 | LINES=34
