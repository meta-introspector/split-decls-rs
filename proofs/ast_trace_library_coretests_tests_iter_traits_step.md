# AST Trace: library/coretests/tests/iter/traits/step.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_steps_between | COMPLEXITY=9 | LINES=53

```rust
// SRC: library/coretests/tests/iter/traits/step.rs
