# AST Trace: compiler/rustc_codegen_llvm/src/debuginfo/metadata/enums/mod.rs
...
```rust
// SRC: compiler/rustc_codegen_llvm/src/debuginfo/metadata/enums/mod.rs
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=13 | LINES=30

```rust
// MOD DECLARATION: cpp_like (from compiler/rustc_codegen_llvm/src/debuginfo/metadata/enums/mod.rs)
// REPLACED: mod cpp_like; -> use crate::cpp_like::*;
use crate::cpp_like::*;
// MOD DECLARATION: native (from compiler/rustc_codegen_llvm/src/debuginfo/metadata/enums/mod.rs)
// REPLACED: mod native; -> use crate::native::*;
use crate::native::*;
