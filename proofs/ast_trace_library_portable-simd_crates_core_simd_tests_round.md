# AST Trace: library/portable-simd/crates/core_simd/tests/round.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=ceil | COMPLEXITY=41 | LINES=100

```rust
// SRC: library/portable-simd/crates/core_simd/tests/round.rs
