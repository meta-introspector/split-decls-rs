# AST Trace: compiler/rustc_macros/src/type_foldable.rs
...
```rust
// SRC: compiler/rustc_macros/src/type_foldable.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=try_fold_with | COMPLEXITY=38 | LINES=64
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=has_ignore_attr | COMPLEXITY=10 | LINES=17
