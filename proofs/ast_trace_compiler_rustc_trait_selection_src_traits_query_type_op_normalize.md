# AST Trace: compiler/rustc_trait_selection/src/traits/query/type_op/normalize.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/query/type_op/normalize.rs
