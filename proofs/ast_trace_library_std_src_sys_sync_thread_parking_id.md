# AST Trace: library/std/src/sys/sync/thread_parking/id.rs
...
```rust
// SRC: library/std/src/sys/sync/thread_parking/id.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=Parker | COMPLEXITY=2 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=new | COMPLEXITY=57 | LINES=78
