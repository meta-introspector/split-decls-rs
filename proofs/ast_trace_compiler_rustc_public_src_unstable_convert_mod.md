# AST Trace: compiler/rustc_public/src/unstable/convert/mod.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=8 | LINES=48

```rust
// SRC: compiler/rustc_public/src/unstable/convert/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=5 | LINES=15
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=9 | LINES=19
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=5 | LINES=14
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=5 | LINES=15
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=stable | COMPLEXITY=5 | LINES=14
