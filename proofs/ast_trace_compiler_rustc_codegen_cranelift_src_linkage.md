# AST Trace: compiler/rustc_codegen_cranelift/src/linkage.rs
...
```rust
// SRC: compiler/rustc_codegen_cranelift/src/linkage.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=18
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=17
