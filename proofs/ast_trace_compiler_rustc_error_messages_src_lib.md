# AST Trace: compiler/rustc_error_messages/src/lib.rs
...
```rust
// SRC: compiler/rustc_error_messages/src/lib.rs
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new_bundle | COMPLEXITY=2 | LINES=9
