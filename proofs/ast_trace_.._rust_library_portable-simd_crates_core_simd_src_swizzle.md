# AST Trace: ../rust/library/portable-simd/crates/core_simd/src/swizzle.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=Impl; | COMPLEXITY=18 | LINES=38
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=swizzle | COMPLEXITY=42 | LINES=116
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=reverse | COMPLEXITY=115 | LINES=329
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=reverse | COMPLEXITY=104 | LINES=174
