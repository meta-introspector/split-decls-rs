# AST Trace: compiler/rustc_attr_parsing/src/attributes/test_attrs.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=20 | LINES=61

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/test_attrs.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=25 | LINES=56
