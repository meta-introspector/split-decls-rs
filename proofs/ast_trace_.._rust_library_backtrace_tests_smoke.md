# AST Trace: ../rust/library/backtrace/tests/smoke.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=get_actual_fn_pointer | COMPLEXITY=14 | LINES=26
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=smoke_test_frames | COMPLEXITY=88 | LINES=186
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=many_threads | COMPLEXITY=13 | LINES=22
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=is_serde | COMPLEXITY=4 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=sp_smoke_test | COMPLEXITY=55 | LINES=132
