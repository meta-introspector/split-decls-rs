# AST Trace: compiler/rustc_ast_lowering/src/lib.rs

Generated 36 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=17 | LINES=59

```rust
// SRC: compiler/rustc_ast_lowering/src/lib.rs
