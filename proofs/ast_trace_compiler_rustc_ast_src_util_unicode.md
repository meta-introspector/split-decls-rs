# AST Trace: compiler/rustc_ast/src/util/unicode.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=10 | LINES=17

```rust
// SRC: compiler/rustc_ast/src/util/unicode.rs
