# AST Trace: compiler/rustc_middle/src/mir/graphviz.rs
...
```rust
// SRC: compiler/rustc_middle/src/mir/graphviz.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=write_mir_graphviz | COMPLEXITY=19 | LINES=41
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=write_mir_fn_graphviz | COMPLEXITY=9 | LINES=37
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=write_graph_label | COMPLEXITY=29 | LINES=46
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=escape | COMPLEXITY=3 | LINES=4
