# AST Trace: compiler/rustc_borrowck/src/region_infer/opaque_types/mod.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/region_infer/opaque_types/mod.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=7 | LINES=24
