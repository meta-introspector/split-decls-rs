# AST Trace: library/coretests/tests/alloc.rs
...
```rust
// SRC: library/coretests/tests/alloc.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=const_unchecked_layout | COMPLEXITY=7 | LINES=11
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=layout_round_up_to_align_edge_cases | COMPLEXITY=9 | LINES=20
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=layout_array_edge_cases | COMPLEXITY=7 | LINES=23
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=layout_errors | COMPLEXITY=5 | LINES=24
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=layout_debug_shows_log2_of_alignment | COMPLEXITY=4 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=layout_accepts_all_valid_alignments | COMPLEXITY=5 | LINES=10
