# AST Trace: compiler/rustc_mir_transform/src/coroutine.rs

Generated 66 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=22 | LINES=41

```rust
// SRC: compiler/rustc_mir_transform/src/coroutine.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=33
...
// MOD DECLARATION: by_move_body (from compiler/rustc_mir_transform/src/coroutine.rs)
// REPLACED: mod by_move_body; -> use crate::by_move_body::*;
use crate::by_move_body::*;
// MOD DECLARATION: drop (from compiler/rustc_mir_transform/src/coroutine.rs)
// REPLACED: mod drop; -> use crate::drop::*;
use crate::drop::*;
use std::{iter, ops};
```
