# AST Trace: compiler/rustc_mir_transform/src/lower_slice_len.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=14 | LINES=50

```rust
// SRC: compiler/rustc_mir_transform/src/lower_slice_len.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=lower_slice_len_call | COMPLEXITY=13 | LINES=34
