# AST Trace: library/std/src/sys/platform_version/darwin/public_extern.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=22 | LINES=77

```rust
// SRC: library/std/src/sys/platform_version/darwin/public_extern.rs
