# AST Trace: library/compiler-builtins/builtins-test/tests/aeabi_memcpy.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=10 | LINES=40

```rust
// SRC: library/compiler-builtins/builtins-test/tests/aeabi_memcpy.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=__aeabi_memcpy | COMPLEXITY=6 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=memcpy | COMPLEXITY=10 | LINES=14
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=memcpy4 | COMPLEXITY=10 | LINES=15
