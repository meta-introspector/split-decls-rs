# AST Trace: library/coretests/tests/num/dec2flt/lemire.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=compute_float16 | COMPLEXITY=4 | LINES=25

```rust
// SRC: library/coretests/tests/num/dec2flt/lemire.rs
