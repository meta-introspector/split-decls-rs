# AST Trace: ../rust/library/std/src/sync/mod.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=13 | LINES=28
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=37 | LINES=154
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=16
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=WaitTimeoutResult(bool); | COMPLEXITY=23 | LINES=77
