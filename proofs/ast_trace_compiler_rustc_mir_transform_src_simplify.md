# AST Trace: compiler/rustc_mir_transform/src/simplify.rs

Generated 23 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=7 | LINES=38

```rust
// SRC: compiler/rustc_mir_transform/src/simplify.rs
