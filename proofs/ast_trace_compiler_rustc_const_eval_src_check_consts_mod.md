# AST Trace: compiler/rustc_const_eval/src/check_consts/mod.rs
...
```rust
// SRC: compiler/rustc_const_eval/src/check_consts/mod.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=ConstCx | COMPLEXITY=3 | LINES=22
...
pub mod check;
// MOD DECLARATION: ops (from compiler/rustc_const_eval/src/check_consts/mod.rs)
// REPLACED: mod ops; -> use crate::ops::*;
use crate::ops::*;
pub mod post_drop_elaboration;
pub mod qualifs;
// MOD DECLARATION: resolver (from compiler/rustc_const_eval/src/check_consts/mod.rs)
// REPLACED: mod resolver; -> use crate::resolver::*;
use crate::resolver::*;
