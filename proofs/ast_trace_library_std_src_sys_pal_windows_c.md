# AST Trace: library/std/src/sys/pal/windows/c.rs
...
```rust
// SRC: library/std/src/sys/pal/windows/c.rs
...
// MOD DECLARATION: windows_sys (from library/std/src/sys/pal/windows/c.rs)
