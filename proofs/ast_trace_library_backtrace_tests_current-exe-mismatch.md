# AST Trace: library/backtrace/tests/current-exe-mismatch.rs
...
```rust
// SRC: library/backtrace/tests/current-exe-mismatch.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=main | COMPLEXITY=23 | LINES=34

```rust
use std::process::Command;

// MOD DECLARATION: common (from library/backtrace/tests/current-exe-mismatch.rs)
