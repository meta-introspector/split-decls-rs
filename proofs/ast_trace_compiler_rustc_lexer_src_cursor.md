# AST Trace: compiler/rustc_lexer/src/cursor.rs
...
```rust
// SRC: compiler/rustc_lexer/src/cursor.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=Cursor | COMPLEXITY=2 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=new | COMPLEXITY=38 | LINES=106
