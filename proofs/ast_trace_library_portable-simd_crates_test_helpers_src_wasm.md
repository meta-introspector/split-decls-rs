# AST Trace: library/portable-simd/crates/test_helpers/src/wasm.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Any | COMPLEXITY=38 | LINES=63

```rust
// SRC: library/portable-simd/crates/test_helpers/src/wasm.rs
