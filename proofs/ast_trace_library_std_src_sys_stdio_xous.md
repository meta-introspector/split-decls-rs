# AST Trace: library/std/src/sys/stdio/xous.rs
...
```rust
// SRC: library/std/src/sys/stdio/xous.rs
...
#[expect(dead_code)]
#[path = "unsupported.rs"]
// MOD DECLARATION: unsupported_stdio (from library/std/src/sys/stdio/xous.rs)
