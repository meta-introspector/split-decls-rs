# AST Trace: library/compiler-builtins/libm/src/math/jn.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=16 | LINES=52

```rust
// SRC: library/compiler-builtins/libm/src/math/jn.rs
