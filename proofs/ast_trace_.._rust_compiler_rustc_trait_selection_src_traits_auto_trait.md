# AST Trace: ../rust/compiler/rustc_trait_selection/src/traits/auto_trait.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=RegionDeps | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=AutoTraitInfo | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=AutoTraitFinder | COMPLEXITY=2 | LINES=4
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=new | COMPLEXITY=386 | LINES=775
