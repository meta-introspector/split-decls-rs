# AST Trace: library/std_detect/src/detect/os/linux/loongarch.rs
...
```rust
// SRC: library/std_detect/src/detect/os/linux/loongarch.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=24 | LINES=54
