# AST Trace: library/std/src/sys/thread_local/key/racy.rs
...
```rust
// SRC: library/std/src/sys/thread_local/key/racy.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=LazyKey | COMPLEXITY=10 | LINES=11
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=force | COMPLEXITY=36 | LINES=61
