# AST Trace: ../rust/library/coretests/tests/result.rs

Generated 42 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=op1 | COMPLEXITY=2 | LINES=6
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=op2 | COMPLEXITY=2 | LINES=3
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_and | COMPLEXITY=2 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_and_then | COMPLEXITY=2 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_or | COMPLEXITY=2 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_or_else | COMPLEXITY=2 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_impl_map | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_impl_map_err | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_collect | COMPLEXITY=7 | LINES=19
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_fmt_default | COMPLEXITY=4 | LINES=11
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_unwrap_or | COMPLEXITY=2 | LINES=9
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_unwrap_or_else | COMPLEXITY=7 | LINES=13
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_unwrap_or_else_panic | COMPLEXITY=7 | LINES=11
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_unwrap_unchecked | COMPLEXITY=7 | LINES=6
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_unwrap_err_unchecked | COMPLEXITY=7 | LINES=6
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_expect_ok | COMPLEXITY=2 | LINES=6
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_expect_err | COMPLEXITY=2 | LINES=6
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_expect_err_err | COMPLEXITY=2 | LINES=6
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_expect_err_ok | COMPLEXITY=2 | LINES=6
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_iter | COMPLEXITY=2 | LINES=14
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_iter_mut | COMPLEXITY=11 | LINES=20
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_unwrap_or_default | COMPLEXITY=2 | LINES=6
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_into_ok | COMPLEXITY=13 | LINES=23
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_into_err | COMPLEXITY=13 | LINES=23
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_try | COMPLEXITY=4 | LINES=17
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_result_as_deref | COMPLEXITY=4 | LINES=34
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_result_as_deref_mut | COMPLEXITY=5 | LINES=38
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=result_const | COMPLEXITY=2 | LINES=16
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=23
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=result_opt_conversions | COMPLEXITY=13 | LINES=38
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=result_try_trait_v2_branch | COMPLEXITY=3 | LINES=15
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=5
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=1
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_const_result | COMPLEXITY=6 | LINES=53
