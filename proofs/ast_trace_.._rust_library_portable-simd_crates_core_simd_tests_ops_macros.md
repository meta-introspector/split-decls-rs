# AST Trace: ../rust/library/portable-simd/crates/core_simd/tests/ops_macros.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=15 | LINES=20
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=normal | COMPLEXITY=19 | LINES=34
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=normal | COMPLEXITY=22 | LINES=39
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=shr | COMPLEXITY=49 | LINES=175
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=neg | COMPLEXITY=43 | LINES=149
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=rem_zero_panic | COMPLEXITY=22 | LINES=53
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=is_sign_positive | COMPLEXITY=113 | LINES=286
