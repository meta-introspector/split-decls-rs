# AST Trace: ../rust/library/core/src/slice/sort/stable/mod.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=sort | COMPLEXITY=39 | LINES=76
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=driftsort_main | COMPLEXITY=16 | LINES=50
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=with_capacity | COMPLEXITY=2 | LINES=10
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=AlignedStorage | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=new | COMPLEXITY=11 | LINES=13
