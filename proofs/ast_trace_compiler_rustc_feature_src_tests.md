# AST Trace: compiler/rustc_feature/src/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=rustc_bootstrap_parsing | COMPLEXITY=8 | LINES=54

```rust
// SRC: compiler/rustc_feature/src/tests.rs
