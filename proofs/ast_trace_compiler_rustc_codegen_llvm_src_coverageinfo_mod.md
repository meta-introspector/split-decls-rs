# AST Trace: compiler/rustc_codegen_llvm/src/coverageinfo/mod.rs
...
```rust
// SRC: compiler/rustc_codegen_llvm/src/coverageinfo/mod.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=9 | LINES=19
