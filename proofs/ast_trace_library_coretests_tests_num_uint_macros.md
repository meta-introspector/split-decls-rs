# AST Trace: library/coretests/tests/num/uint_macros.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_overflows | COMPLEXITY=151 | LINES=636

```rust
// SRC: library/coretests/tests/num/uint_macros.rs
