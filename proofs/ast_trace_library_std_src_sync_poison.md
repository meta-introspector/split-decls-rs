# AST Trace: library/std/src/sync/poison.rs

Generated 22 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=33 | LINES=85

```rust
// SRC: library/std/src/sync/poison.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=19

```rust
#[cfg(panic = "unwind")]
use crate::thread;

// MOD DECLARATION: condvar (from library/std/src/sync/poison.rs)
// REPLACED: mod condvar; -> use crate::condvar::*;
use crate::condvar::*;
#[stable(feature = "rust1", since = "1.0.0")]
// MOD DECLARATION: mutex (from library/std/src/sync/poison.rs)
// REPLACED: mod mutex; -> use crate::mutex::*;
use crate::mutex::*;
pub(crate) mod once;
// MOD DECLARATION: rwlock (from library/std/src/sync/poison.rs)
