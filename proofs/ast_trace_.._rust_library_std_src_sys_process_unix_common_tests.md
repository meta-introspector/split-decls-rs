# AST Trace: ../rust/library/std/src/sys/process/unix/common/tests.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=16 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_process_mask | COMPLEXITY=22 | LINES=67
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_process_group_posix_spawn | COMPLEXITY=8 | LINES=27
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_process_group_no_posix_spawn | COMPLEXITY=8 | LINES=28
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_setsid_posix_spawn | COMPLEXITY=8 | LINES=28
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_setsid_no_posix_spawn | COMPLEXITY=8 | LINES=30
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_program_kind | COMPLEXITY=9 | LINES=24
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=unix_exit_statuses | COMPLEXITY=15 | LINES=33
