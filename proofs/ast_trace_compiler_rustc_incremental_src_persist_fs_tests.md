# AST Trace: compiler/rustc_incremental/src/persist/fs/tests.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_all_except_most_recent | COMPLEXITY=5 | LINES=33

```rust
// SRC: compiler/rustc_incremental/src/persist/fs/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_timestamp_serialization | COMPLEXITY=5 | LINES=9
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_find_source_directory_in_iter | COMPLEXITY=4 | LINES=50
