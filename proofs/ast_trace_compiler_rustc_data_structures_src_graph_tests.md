# AST Trace: compiler/rustc_data_structures/src/graph/tests.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=26

```rust
// SRC: compiler/rustc_data_structures/src/graph/tests.rs
