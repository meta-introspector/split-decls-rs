# AST Trace: ../rust/compiler/rustc_borrowck/src/consumers.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=25
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=26
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=BodyWithBorrowckFacts | COMPLEXITY=7 | LINES=28
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=get_bodies_with_borrowck_facts | COMPLEXITY=10 | LINES=26
