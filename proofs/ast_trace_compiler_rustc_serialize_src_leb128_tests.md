# AST Trace: compiler/rustc_serialize/src/leb128/tests.rs
...
```rust
// SRC: compiler/rustc_serialize/src/leb128/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=$test_name | COMPLEXITY=17 | LINES=37
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=$test_name | COMPLEXITY=23 | LINES=49
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=1 | LINES=6
