# AST Trace: library/coretests/tests/iter/adapters/step_by.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_step_by | COMPLEXITY=5 | LINES=48

```rust
// SRC: library/coretests/tests/iter/adapters/step_by.rs
