# AST Trace: compiler/rustc_codegen_llvm/src/debuginfo/mod.rs
...
```rust
// SRC: compiler/rustc_codegen_llvm/src/debuginfo/mod.rs
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=6 | LINES=26
