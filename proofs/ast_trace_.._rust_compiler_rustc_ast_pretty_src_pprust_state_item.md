# AST Trace: ../rust/compiler/rustc_ast_pretty/src/pprust/state/item.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=visibility_qualified | COMPLEXITY=4 | LINES=4
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=print_foreign_mod | COMPLEXITY=370 | LINES=861
