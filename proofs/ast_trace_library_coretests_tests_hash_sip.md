# AST Trace: library/coretests/tests/hash/sip.rs
...
```rust
// SRC: library/coretests/tests/hash/sip.rs
...
// SRC: library/coretests/tests/hash/sip.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/library/coretests/tests/hash/sip.rs
#![allow(deprecated)]
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=Bytes | COMPLEXITY=5 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=15
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_siphash_1_3 | COMPLEXITY=13 | LINES=95
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_siphash_2_4 | COMPLEXITY=13 | LINES=94
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_hash_usize | COMPLEXITY=2 | LINES=8
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_hash_usize | COMPLEXITY=2 | LINES=8
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_hash_idempotent | COMPLEXITY=2 | LINES=8
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_hash_no_bytes_dropped_64 | COMPLEXITY=4 | LINES=19
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_hash_no_bytes_dropped_32 | COMPLEXITY=3 | LINES=15
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_hash_no_concat_alias | COMPLEXITY=2 | LINES=19
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_write_short_works | COMPLEXITY=8 | LINES=19
