# AST Trace: library/compiler-builtins/libm/src/math/cosf.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/cosf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cosf | COMPLEXITY=48 | LINES=67
