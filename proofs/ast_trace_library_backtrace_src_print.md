# AST Trace: library/backtrace/src/print.rs
...
```rust
// SRC: library/backtrace/src/print.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=BacktraceFmt | COMPLEXITY=5 | LINES=22
...
// MOD DECLARATION: fuchsia (from library/backtrace/src/print.rs)
