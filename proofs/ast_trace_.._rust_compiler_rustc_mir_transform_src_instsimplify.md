# AST Trace: ../rust/compiler/rustc_mir_transform/src/instsimplify.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=name | COMPLEXITY=26 | LINES=51
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=InstSimplifyContext | COMPLEXITY=2 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=simplify_repeated_aggregate | COMPLEXITY=122 | LINES=262
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=intrinsic_assert_panics | COMPLEXITY=2 | LINES=11
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=resolve_rust_intrinsic | COMPLEXITY=3 | LINES=9
