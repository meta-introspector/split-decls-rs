# AST Trace: compiler/rustc_sanitizers/src/cfi/typeid/mod.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=10 | LINES=23

```rust
// SRC: compiler/rustc_sanitizers/src/cfi/typeid/mod.rs
