# AST Trace: library/std/src/sys/pal/zkvm/abi.rs
...
```rust
// SRC: library/std/src/sys/pal/zkvm/abi.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sys_halt | COMPLEXITY=8 | LINES=36
