# AST Trace: ../rust/library/std_detect/src/detect/mod.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=15 | LINES=58
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=check_for | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=features | COMPLEXITY=14 | LINES=34
