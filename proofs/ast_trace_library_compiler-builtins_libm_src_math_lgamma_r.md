# AST Trace: library/compiler-builtins/libm/src/math/lgamma_r.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=28 | LINES=96

```rust
// SRC: library/compiler-builtins/libm/src/math/lgamma_r.rs
