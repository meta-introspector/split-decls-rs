# AST Trace: compiler/rustc_mir_transform/src/coverage/spans.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/coverage/spans.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=66 | LINES=130
