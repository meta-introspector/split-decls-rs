# AST Trace: ../rust/library/alloctests/tests/vec_deque.rs

Generated 92 AST blocks from source file
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_simple | COMPLEXITY=3 | LINES=41
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_parameterized | COMPLEXITY=4 | LINES=30
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_pop_if | COMPLEXITY=2 | LINES=18
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_pop_if_empty | COMPLEXITY=2 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_pop_if_mutates | COMPLEXITY=3 | LINES=13
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_push_front_grow | COMPLEXITY=14 | LINES=22
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_index | COMPLEXITY=5 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_index_out_of_bounds | COMPLEXITY=5 | LINES=10
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_range_start_overflow | COMPLEXITY=2 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_range_end_overflow | COMPLEXITY=2 | LINES=7
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=STRUCT | NAME=RecCy | COMPLEXITY=2 | LINES=7
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_param_int | COMPLEXITY=2 | LINES=5
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_param_taggy | COMPLEXITY=2 | LINES=5
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_param_taggypar | COMPLEXITY=2 | LINES=10
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_param_reccy | COMPLEXITY=6 | LINES=9
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_with_capacity | COMPLEXITY=2 | LINES=10
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_with_capacity_non_power_two | COMPLEXITY=6 | LINES=41
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_reserve_exact | COMPLEXITY=2 | LINES=8
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_reserve | COMPLEXITY=2 | LINES=8
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_swap | COMPLEXITY=2 | LINES=8
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_iter | COMPLEXITY=19 | LINES=35
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_rev_iter | COMPLEXITY=9 | LINES=20
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_mut_rev_iter_wrap | COMPLEXITY=2 | LINES=14
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_mut_iter | COMPLEXITY=9 | LINES=23
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_mut_rev_iter | COMPLEXITY=10 | LINES=23
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=test_into_iter | COMPLEXITY=32 | LINES=80
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=test_drain | COMPLEXITY=26 | LINES=65
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_from_iter | COMPLEXITY=5 | LINES=15
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_clone | COMPLEXITY=5 | LINES=17
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_eq | COMPLEXITY=2 | LINES=21
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=test_partial_eq_array | COMPLEXITY=2 | LINES=19
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_hash | COMPLEXITY=2 | LINES=18
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=test_hash_after_rotation | COMPLEXITY=11 | LINES=19
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_eq_after_rotation | COMPLEXITY=17 | LINES=27
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_ord | COMPLEXITY=2 | LINES=13
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_show | COMPLEXITY=4 | LINES=9
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=test_drop | COMPLEXITY=2 | LINES=14
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=test_drop_with_pop | COMPLEXITY=2 | LINES=18
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_drop_clear | COMPLEXITY=2 | LINES=16
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=test_drop_panic | COMPLEXITY=6 | LINES=20
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=test_reserve_grow | COMPLEXITY=28 | LINES=44
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=test_get | COMPLEXITY=3 | LINES=32
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=test_get_mut | COMPLEXITY=10 | LINES=23
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=test_front | COMPLEXITY=2 | LINES=12
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=test_as_slices | COMPLEXITY=9 | LINES=28
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=test_as_mut_slices | COMPLEXITY=9 | LINES=28
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=test_append | COMPLEXITY=3 | LINES=21
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=test_append_permutations | COMPLEXITY=48 | LINES=76
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=STRUCT | NAME=DropCounter | COMPLEXITY=2 | LINES=4
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=5 | LINES=6
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=test_append_double_drop | COMPLEXITY=5 | LINES=15
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=test_append_zst_capacity_overflow | COMPLEXITY=9 | LINES=14
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=test_retain | COMPLEXITY=2 | LINES=9
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=test_extend_ref | COMPLEXITY=3 | LINES=26
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=test_contains | COMPLEXITY=2 | LINES=13
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=assert_covariance | COMPLEXITY=3 | LINES=7
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=test_is_empty | COMPLEXITY=6 | LINES=21
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=test_reserve_exact_2 | COMPLEXITY=5 | LINES=23
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=test_try_with_capacity | COMPLEXITY=2 | LINES=10
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=test_try_reserve | COMPLEXITY=30 | LINES=95
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=test_try_reserve_exact | COMPLEXITY=31 | LINES=89
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=test_rotate_nop | COMPLEXITY=5 | LINES=58
...
## Block 66
**Metadata**: AST_ID=66 | TYPE=FUNCTION | NAME=test_rotate_left_parts | COMPLEXITY=3 | LINES=20
...
## Block 67
**Metadata**: AST_ID=67 | TYPE=FUNCTION | NAME=test_rotate_right_parts | COMPLEXITY=3 | LINES=20
...
## Block 68
**Metadata**: AST_ID=68 | TYPE=FUNCTION | NAME=test_rotate_left_random | COMPLEXITY=8 | LINES=18
...
## Block 69
**Metadata**: AST_ID=69 | TYPE=FUNCTION | NAME=test_rotate_right_random | COMPLEXITY=8 | LINES=18
...
## Block 70
**Metadata**: AST_ID=70 | TYPE=FUNCTION | NAME=test_try_fold_empty | COMPLEXITY=2 | LINES=5
...
## Block 71
**Metadata**: AST_ID=71 | TYPE=FUNCTION | NAME=test_try_fold_none | COMPLEXITY=6 | LINES=6
...
## Block 72
**Metadata**: AST_ID=72 | TYPE=FUNCTION | NAME=test_try_fold_ok | COMPLEXITY=2 | LINES=6
...
## Block 73
**Metadata**: AST_ID=73 | TYPE=FUNCTION | NAME=test_try_fold_unit | COMPLEXITY=2 | LINES=6
...
## Block 74
**Metadata**: AST_ID=74 | TYPE=FUNCTION | NAME=test_try_fold_unit_none | COMPLEXITY=2 | LINES=8
...
## Block 75
**Metadata**: AST_ID=75 | TYPE=FUNCTION | NAME=test_try_fold_rotated | COMPLEXITY=9 | LINES=13
...
## Block 76
**Metadata**: AST_ID=76 | TYPE=FUNCTION | NAME=test_try_fold_moves_iter | COMPLEXITY=2 | LINES=8
...
## Block 77
**Metadata**: AST_ID=77 | TYPE=FUNCTION | NAME=test_try_fold_exhaust_wrap | COMPLEXITY=2 | LINES=13
...
## Block 78
**Metadata**: AST_ID=78 | TYPE=FUNCTION | NAME=test_try_fold_wraparound | COMPLEXITY=2 | LINES=13
...
## Block 79
**Metadata**: AST_ID=79 | TYPE=FUNCTION | NAME=test_try_rfold_rotated | COMPLEXITY=9 | LINES=13
...
## Block 80
**Metadata**: AST_ID=80 | TYPE=FUNCTION | NAME=test_try_rfold_moves_iter | COMPLEXITY=2 | LINES=8
...
## Block 81
**Metadata**: AST_ID=81 | TYPE=FUNCTION | NAME=truncate_leak | COMPLEXITY=6 | LINES=20
...
## Block 82
**Metadata**: AST_ID=82 | TYPE=FUNCTION | NAME=truncate_front_leak | COMPLEXITY=6 | LINES=20
...
## Block 83
**Metadata**: AST_ID=83 | TYPE=FUNCTION | NAME=test_drain_leak | COMPLEXITY=7 | LINES=25
...
## Block 84
**Metadata**: AST_ID=84 | TYPE=FUNCTION | NAME=test_binary_search | COMPLEXITY=3 | LINES=23
...
## Block 85
**Metadata**: AST_ID=85 | TYPE=FUNCTION | NAME=test_binary_search_by | COMPLEXITY=2 | LINES=8
...
## Block 86
**Metadata**: AST_ID=86 | TYPE=FUNCTION | NAME=test_binary_search_by_key | COMPLEXITY=2 | LINES=8
...
## Block 87
**Metadata**: AST_ID=87 | TYPE=FUNCTION | NAME=test_partition_point | COMPLEXITY=3 | LINES=18
...
## Block 88
**Metadata**: AST_ID=88 | TYPE=FUNCTION | NAME=test_zero_sized_push | COMPLEXITY=18 | LINES=30
...
## Block 89
**Metadata**: AST_ID=89 | TYPE=FUNCTION | NAME=test_from_zero_sized_vec | COMPLEXITY=2 | LINES=7
...
## Block 90
**Metadata**: AST_ID=90 | TYPE=FUNCTION | NAME=test_resize_keeps_reserved_space_from_item | COMPLEXITY=2 | LINES=8
...
## Block 91
**Metadata**: AST_ID=91 | TYPE=FUNCTION | NAME=test_collect_from_into_iter_keeps_allocation | COMPLEXITY=5 | LINES=36
...
## Block 92
**Metadata**: AST_ID=92 | TYPE=FUNCTION | NAME=test_truncate_front | COMPLEXITY=4 | LINES=35
