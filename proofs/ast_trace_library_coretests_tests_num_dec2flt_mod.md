# AST Trace: library/coretests/tests/num/dec2flt/mod.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=28 | LINES=58

```rust
// SRC: library/coretests/tests/num/dec2flt/mod.rs
...
// MOD DECLARATION: decimal (from library/coretests/tests/num/dec2flt/mod.rs)
// REPLACED: mod decimal; -> use crate::decimal::*;
use crate::decimal::*;
// MOD DECLARATION: decimal_seq (from library/coretests/tests/num/dec2flt/mod.rs)
// REPLACED: mod decimal_seq; -> use crate::decimal_seq::*;
use crate::decimal_seq::*;
// MOD DECLARATION: float (from library/coretests/tests/num/dec2flt/mod.rs)
// REPLACED: mod float; -> use crate::float::*;
use crate::float::*;
// MOD DECLARATION: lemire (from library/coretests/tests/num/dec2flt/mod.rs)
// REPLACED: mod lemire; -> use crate::lemire::*;
use crate::lemire::*;
// MOD DECLARATION: parse (from library/coretests/tests/num/dec2flt/mod.rs)
