# AST Trace: ../rust/compiler/rustc_pattern_analysis/src/lib.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=PrivateUninhabitedField(pub | COMPLEXITY=33 | LINES=98
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=MatchArm | COMPLEXITY=5 | LINES=8
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=clone | COMPLEXITY=6 | LINES=6
