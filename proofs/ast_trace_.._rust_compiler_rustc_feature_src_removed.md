# AST Trace: ../rust/compiler/rustc_feature/src/removed.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=RemovedFeature | COMPLEXITY=2 | LINES=6
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=9 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=11 | LINES=19
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=41 | LINES=180
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=17 | LINES=90
