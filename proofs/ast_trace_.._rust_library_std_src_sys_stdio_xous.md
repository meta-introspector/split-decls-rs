# AST Trace: ../rust/library/std/src/sys/stdio/xous.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=Stdout; | COMPLEXITY=3 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=write | COMPLEXITY=13 | LINES=21
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=write | COMPLEXITY=13 | LINES=21
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=is_ebadf | COMPLEXITY=2 | LINES=6
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=PanicWriter | COMPLEXITY=2 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=write | COMPLEXITY=19 | LINES=32
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=panic_output | COMPLEXITY=6 | LINES=15
