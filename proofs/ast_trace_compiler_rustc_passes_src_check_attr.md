# AST Trace: compiler/rustc_passes/src/check_attr.rs
...
```rust
// SRC: compiler/rustc_passes/src/check_attr.rs
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=dcx | COMPLEXITY=1406 | LINES=2419
