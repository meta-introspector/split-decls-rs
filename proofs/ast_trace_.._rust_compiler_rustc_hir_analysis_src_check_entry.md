# AST Trace: ../rust/compiler/rustc_hir_analysis/src/check/entry.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=check_main_fn_ty | COMPLEXITY=107 | LINES=172
