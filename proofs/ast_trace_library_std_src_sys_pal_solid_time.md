# AST Trace: library/std/src/sys/pal/solid/time.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=SystemTime(abi::time_t); | COMPLEXITY=27 | LINES=74

```rust
// SRC: library/std/src/sys/pal/solid/time.rs
