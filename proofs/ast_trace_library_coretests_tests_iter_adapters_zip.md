# AST Trace: library/coretests/tests/iter/adapters/zip.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_zip_nth | COMPLEXITY=4 | LINES=37

```rust
// SRC: library/coretests/tests/iter/adapters/zip.rs
