# AST Trace: library/core/src/iter/traits/marker.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=10 | LINES=30

```rust
// SRC: library/core/src/iter/traits/marker.rs
