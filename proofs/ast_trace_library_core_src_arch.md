# AST Trace: library/core/src/arch.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=43

```rust
// SRC: library/core/src/arch.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=breakpoint | COMPLEXITY=4 | LINES=26
