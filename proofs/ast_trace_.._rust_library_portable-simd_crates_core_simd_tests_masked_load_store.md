# AST Trace: ../rust/library/portable-simd/crates/core_simd/tests/masked_load_store.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=masked_load_store | COMPLEXITY=4 | LINES=35
