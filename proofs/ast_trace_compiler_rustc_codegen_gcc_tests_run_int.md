# AST Trace: compiler/rustc_codegen_gcc/tests/run/int.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=main | COMPLEXITY=70 | LINES=337

```rust
// SRC: compiler/rustc_codegen_gcc/tests/run/int.rs
