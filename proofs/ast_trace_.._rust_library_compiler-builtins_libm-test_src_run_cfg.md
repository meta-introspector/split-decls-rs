# AST Trace: ../rust/library/compiler-builtins/libm-test/src/run_cfg.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=SlowTest | COMPLEXITY=5 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=matches_ctx | COMPLEXITY=5 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=extensive_max_iterations | COMPLEXITY=7 | LINES=11
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=CheckCtx | COMPLEXITY=5 | LINES=19
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=new | COMPLEXITY=13 | LINES=34
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=14
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=16 | LINES=35
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=STRUCT | NAME=TestEnv | COMPLEXITY=3 | LINES=15
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=from_env | COMPLEXITY=9 | LINES=25
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=slow_platform | COMPLEXITY=2 | LINES=11
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=iteration_count | COMPLEXITY=78 | LINES=110
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=int_range | COMPLEXITY=20 | LINES=31
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=check_point_count | COMPLEXITY=8 | LINES=15
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=check_near_count | COMPLEXITY=14 | LINES=20
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=skip_extensive_test | COMPLEXITY=2 | LINES=6
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=bigint_fuzz_iteration_count | COMPLEXITY=11 | LINES=9
