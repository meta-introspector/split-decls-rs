# AST Trace: library/std/src/sys/random/unix_legacy.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fill_bytes | COMPLEXITY=7 | LINES=37

```rust
// SRC: library/std/src/sys/random/unix_legacy.rs
