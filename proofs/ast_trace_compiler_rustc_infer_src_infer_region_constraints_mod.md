# AST Trace: compiler/rustc_infer/src/infer/region_constraints/mod.rs
...
```rust
// SRC: compiler/rustc_infer/src/infer/region_constraints/mod.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=RegionConstraintStorage | COMPLEXITY=5 | LINES=36

```rust
// MOD DECLARATION: leak_check (from compiler/rustc_infer/src/infer/region_constraints/mod.rs)
// REPLACED: mod leak_check; -> use crate::leak_check::*;
