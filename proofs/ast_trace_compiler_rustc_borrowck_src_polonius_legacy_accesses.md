# AST Trace: compiler/rustc_borrowck/src/polonius/legacy/accesses.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/polonius/legacy/accesses.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=12 | LINES=22
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=AccessFactsExtractor | COMPLEXITY=2 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=location_to_index | COMPLEXITY=3 | LINES=6
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=visit_local | COMPLEXITY=29 | LINES=41
