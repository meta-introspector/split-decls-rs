# AST Trace: library/compiler-builtins/libm/src/math/log.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log | COMPLEXITY=35 | LINES=133

```rust
// SRC: library/compiler-builtins/libm/src/math/log.rs
