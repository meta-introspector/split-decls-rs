# AST Trace: library/coretests/tests/hint.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=select_unpredictable_drop | COMPLEXITY=8 | LINES=40

```rust
// SRC: library/coretests/tests/hint.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=select_unpredictable_drop_on_panic | COMPLEXITY=14 | LINES=36
