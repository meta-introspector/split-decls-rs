# AST Trace: library/std/src/sys/platform_version/darwin/tests.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_general_available | COMPLEXITY=4 | LINES=26

```rust
// SRC: library/std/src/sys/platform_version/darwin/tests.rs
