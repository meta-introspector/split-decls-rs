# AST Trace: library/alloctests/tests/const_fns.rs
...
```rust
// SRC: library/alloctests/tests/const_fns.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_const | COMPLEXITY=3 | LINES=23
