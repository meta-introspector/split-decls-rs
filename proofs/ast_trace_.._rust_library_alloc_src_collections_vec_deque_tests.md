# AST Trace: ../rust/library/alloc/src/collections/vec_deque/tests.rs

Generated 47 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=bench_push_back_100 | COMPLEXITY=6 | LINES=16
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=bench_push_front_100 | COMPLEXITY=6 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=bench_pop_back_100 | COMPLEXITY=11 | LINES=17
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=bench_retain_whole_10000 | COMPLEXITY=7 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=bench_retain_odd_10000 | COMPLEXITY=7 | LINES=11
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=bench_retain_half_10000 | COMPLEXITY=7 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=bench_pop_front_100 | COMPLEXITY=12 | LINES=17
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_swap_front_back_remove | COMPLEXITY=32 | LINES=41
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_insert | COMPLEXITY=25 | LINES=34
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=test_get | COMPLEXITY=3 | LINES=22
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_get_mut | COMPLEXITY=9 | LINES=31
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=test_swap | COMPLEXITY=3 | LINES=23
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_swap_panic | COMPLEXITY=2 | LINES=10
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_reserve_exact | COMPLEXITY=2 | LINES=13
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_reserve_exact_panic | COMPLEXITY=2 | LINES=7
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_try_reserve_exact | COMPLEXITY=3 | LINES=15
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_try_reserve | COMPLEXITY=3 | LINES=15
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_contains | COMPLEXITY=2 | LINES=17
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_rotate_left_right | COMPLEXITY=3 | LINES=29
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_rotate_left_panic | COMPLEXITY=2 | LINES=7
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_rotate_right_panic | COMPLEXITY=2 | LINES=7
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_binary_search | COMPLEXITY=4 | LINES=24
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_binary_search_by | COMPLEXITY=3 | LINES=15
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_binary_search_key | COMPLEXITY=6 | LINES=61
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=make_contiguous_big_head | COMPLEXITY=9 | LINES=22
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=make_contiguous_big_tail | COMPLEXITY=8 | LINES=19
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=make_contiguous_small_free | COMPLEXITY=16 | LINES=42
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=make_contiguous_head_to_end | COMPLEXITY=16 | LINES=53
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=make_contiguous_head_to_end_2 | COMPLEXITY=4 | LINES=15
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=test_remove | COMPLEXITY=28 | LINES=38
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_range | COMPLEXITY=22 | LINES=26
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_range_mut | COMPLEXITY=19 | LINES=34
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_drain | COMPLEXITY=19 | LINES=35
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=issue_108453 | COMPLEXITY=2 | LINES=16
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_shrink_to | COMPLEXITY=14 | LINES=26
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=test_shrink_to_fit | COMPLEXITY=15 | LINES=33
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_split_off | COMPLEXITY=23 | LINES=39
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_from_vec | COMPLEXITY=8 | LINES=15
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_extend_basic | COMPLEXITY=2 | LINES=5
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=test_extend_trusted_len | COMPLEXITY=2 | LINES=5
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=test_extend_impl | COMPLEXITY=25 | LINES=81
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_from_array | COMPLEXITY=9 | LINES=24
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=test_vec_from_vecdeque | COMPLEXITY=41 | LINES=65
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=test_clone_from | COMPLEXITY=26 | LINES=24
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=test_vec_deque_truncate_drop | COMPLEXITY=13 | LINES=23
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=issue_53529 | COMPLEXITY=5 | LINES=17
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=issue_80303 | COMPLEXITY=17 | LINES=40
