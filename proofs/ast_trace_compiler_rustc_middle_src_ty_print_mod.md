# AST Trace: compiler/rustc_middle/src/ty/print/mod.rs
...
```rust
// SRC: compiler/rustc_middle/src/ty/print/mod.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=print | COMPLEXITY=4 | LINES=10
