# AST Trace: ../rust/compiler/rustc_mir_transform/src/ref_prop.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=27 | LINES=75
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=move_to_copy_pointers | COMPLEXITY=22 | LINES=32
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=propagate_ssa | COMPLEXITY=6 | LINES=18
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=compute_replacement | COMPLEXITY=114 | LINES=210
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=fully_replaceable_locals | COMPLEXITY=13 | LINES=20
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=Replacer | COMPLEXITY=2 | LINES=9
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=47 | LINES=64
