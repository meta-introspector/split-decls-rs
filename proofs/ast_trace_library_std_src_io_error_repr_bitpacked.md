# AST Trace: library/std/src/io/error/repr_bitpacked.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=5 | LINES=34

```rust
// SRC: library/std/src/io/error/repr_bitpacked.rs
