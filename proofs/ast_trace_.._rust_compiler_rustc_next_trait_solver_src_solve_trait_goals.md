# AST Trace: ../rust/compiler/rustc_next_trait_solver/src/solve/trait_goals.rs
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=self_ty | COMPLEXITY=359 | LINES=827
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=trait_predicate_with_def_id | COMPLEXITY=4 | LINES=19
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=consider_builtin_dyn_upcast_candidates | COMPLEXITY=177 | LINES=424
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=7 | LINES=22
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=try_stall_coroutine | COMPLEXITY=116 | LINES=187
