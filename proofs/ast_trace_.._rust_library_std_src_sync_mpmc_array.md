# AST Trace: ../rust/library/std/src/sync/mpmc/array.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=Slot | COMPLEXITY=2 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=default | COMPLEXITY=6 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=13 | LINES=39
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=start_send | COMPLEXITY=328 | LINES=483
