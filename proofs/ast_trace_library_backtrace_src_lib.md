# AST Trace: library/backtrace/src/lib.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=17 | LINES=55

```rust
// SRC: library/backtrace/src/lib.rs
...
// SRC: library/backtrace/src/lib.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/library/backtrace/src/lib.rs
<<<<<<< HEAD
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=22 | LINES=69
...
```rust
// MOD DECLARATION: backtrace (from library/backtrace/src/lib.rs)
// REPLACED: mod backtrace; -> use crate::backtrace::*;
use crate::backtrace::*;
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=16

```rust
// MOD DECLARATION: symbolize (from library/backtrace/src/lib.rs)
// REPLACED: mod symbolize; -> use crate::symbolize::*;
use crate::symbolize::*;

pub use self::types::BytesOrWideString;
// MOD DECLARATION: types (from library/backtrace/src/lib.rs)
// REPLACED: mod types; -> use crate::types::*;
use crate::types::*;

#[cfg(feature = "std")]
pub use self::symbolize::clear_symbol_cache;

// MOD DECLARATION: print (from library/backtrace/src/lib.rs)
// REPLACED: mod print; -> use crate::print::*;
use crate::print::*;
pub use print::{BacktraceFmt, BacktraceFrameFmt, PrintFmt};
```

## Block 5
**Metadata**: AST_ID=5 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=11
...
// MOD DECLARATION: capture (from library/backtrace/src/lib.rs)
// REPLACED: mod capture; -> use crate::capture::*;
use crate::capture::*;
    }
}
```
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=5 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=LockGuard(Option | COMPLEXITY=35 | LINES=92
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=26
...
// MOD DECLARATION: dbghelp (from library/backtrace/src/lib.rs)
// REPLACED: mod dbghelp; -> use crate::dbghelp::*;
use crate::dbghelp::*;
// Auto-generated by windows-bindgen/riddle
#[cfg(any(windows, target_os = "cygwin"))]
// MOD DECLARATION: windows_sys (from library/backtrace/src/lib.rs)
// REPLACED: mod windows_sys; -> use crate::windows_sys::*;
use crate::windows_sys::*;
=======
extern crate libc;

#[macro_use]
// MOD DECLARATION: macros (from library/backtrace/src/lib.rs)
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=Bomb | COMPLEXITY=2 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=8 | LINES=8
