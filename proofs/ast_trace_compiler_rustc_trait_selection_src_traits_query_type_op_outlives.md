# AST Trace: compiler/rustc_trait_selection/src/traits/query/type_op/outlives.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/traits/query/type_op/outlives.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=try_fast_path | COMPLEXITY=8 | LINES=27
