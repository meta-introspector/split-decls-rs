# AST Trace: ../rust/library/coretests/tests/ops/control_flow.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=control_flow_discriminants_match_result | COMPLEXITY=8 | LINES=18
