# AST Trace: library/std/src/sys/pal/sgx/abi/usercalls/tests.rs
...
```rust
// SRC: library/std/src/sys/pal/sgx/abi/usercalls/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_copy_to_userspace_function | COMPLEXITY=25 | LINES=28
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_copy_from_userspace_function | COMPLEXITY=22 | LINES=26
