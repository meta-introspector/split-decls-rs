# AST Trace: compiler/rustc_trait_selection/src/solve/inspect/analyse.rs

Generated 14 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=35

```rust
// SRC: compiler/rustc_trait_selection/src/solve/inspect/analyse.rs
