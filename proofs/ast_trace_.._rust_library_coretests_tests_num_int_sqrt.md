# AST Trace: ../rust/library/coretests/tests/num/int_sqrt.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=isqrt | COMPLEXITY=65 | LINES=173
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=isqrt_consistency_check | COMPLEXITY=34 | LINES=47
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=isqrt_consistency_check | COMPLEXITY=22 | LINES=25
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=1 | LINES=3
