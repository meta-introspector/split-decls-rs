# AST Trace: ../rust/library/alloctests/tests/rc.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=uninhabited | COMPLEXITY=3 | LINES=12
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=slice | COMPLEXITY=2 | LINES=13
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=trait_object | COMPLEXITY=2 | LINES=18
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=float_nan_ne | COMPLEXITY=2 | LINES=7
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=partial_eq | COMPLEXITY=6 | LINES=16
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=eq | COMPLEXITY=6 | LINES=17
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=assert_trusted_len | COMPLEXITY=2 | LINES=4
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=shared_from_iter_normal | COMPLEXITY=7 | LINES=22
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=shared_from_iter_trustedlen_normal | COMPLEXITY=8 | LINES=37
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=shared_from_iter_trustedlen_panic | COMPLEXITY=7 | LINES=15
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=shared_from_iter_trustedlen_no_fuse | COMPLEXITY=15 | LINES=26
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=weak_may_dangle | COMPLEXITY=7 | LINES=15
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=panic_no_leak | COMPLEXITY=28 | LINES=36
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=pin_rc | COMPLEXITY=11 | LINES=17
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_clone | COMPLEXITY=2 | LINES=8
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_simple | COMPLEXITY=2 | LINES=6
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_simple_clone | COMPLEXITY=2 | LINES=8
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=test_destructor | COMPLEXITY=2 | LINES=6
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_live | COMPLEXITY=2 | LINES=7
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_dead | COMPLEXITY=2 | LINES=8
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=weak_self_cyclic | COMPLEXITY=4 | LINES=13
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=is_unique | COMPLEXITY=3 | LINES=18
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_weak_count | COMPLEXITY=2 | LINES=17
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=weak_counts | COMPLEXITY=3 | LINES=27
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=try_unwrap | COMPLEXITY=2 | LINES=12
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=into_inner | COMPLEXITY=2 | LINES=15
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=into_from_raw | COMPLEXITY=7 | LINES=17
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_into_from_raw_unsized | COMPLEXITY=23 | LINES=22
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=into_from_weak_raw | COMPLEXITY=7 | LINES=18
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_into_from_weak_raw_unsized | COMPLEXITY=23 | LINES=24
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=get_mut | COMPLEXITY=2 | LINES=13
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_cowrc_clone_make_unique | COMPLEXITY=3 | LINES=24
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=test_cowrc_clone_unique2 | COMPLEXITY=3 | LINES=23
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_cowrc_clone_weak | COMPLEXITY=2 | LINES=14
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_cowrc_unsized | COMPLEXITY=5 | LINES=18
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=test_show | COMPLEXITY=3 | LINES=6
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=test_unsized | COMPLEXITY=2 | LINES=6
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=test_maybe_thin_unsized | COMPLEXITY=4 | LINES=17
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=test_from_owned | COMPLEXITY=2 | LINES=7
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=test_new_weak | COMPLEXITY=2 | LINES=6
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=test_ptr_eq | COMPLEXITY=2 | LINES=10
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=test_from_str | COMPLEXITY=2 | LINES=7
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=test_copy_from_slice | COMPLEXITY=2 | LINES=8
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=test_clone_from_slice | COMPLEXITY=2 | LINES=11
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=test_clone_from_slice_panic | COMPLEXITY=11 | LINES=23
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=test_from_box | COMPLEXITY=2 | LINES=8
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=test_from_box_str | COMPLEXITY=2 | LINES=14
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=test_from_box_slice | COMPLEXITY=2 | LINES=8
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=test_from_box_trait | COMPLEXITY=2 | LINES=11
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=test_from_box_trait_zero_sized | COMPLEXITY=3 | LINES=10
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=test_from_vec | COMPLEXITY=2 | LINES=8
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=test_downcast | COMPLEXITY=2 | LINES=20
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=test_array_from_slice | COMPLEXITY=2 | LINES=12
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=test_rc_cyclic_with_zero_refs | COMPLEXITY=5 | LINES=18
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=test_rc_cyclic_with_one_ref | COMPLEXITY=6 | LINES=22
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=test_rc_cyclic_with_two_ref | COMPLEXITY=6 | LINES=26
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=test_unique_rc_weak | COMPLEXITY=2 | LINES=10
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=test_unique_rc_drop_weak | COMPLEXITY=2 | LINES=10
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=test_unique_rc_drops_contents | COMPLEXITY=7 | LINES=16
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=test_unique_rc_with_alloc_drops_contents | COMPLEXITY=7 | LINES=17
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=test_unique_rc_weak_clone_holding_ref | COMPLEXITY=2 | LINES=9
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=test_unique_rc_unsizing_coercion | COMPLEXITY=2 | LINES=9
