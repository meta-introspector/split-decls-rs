# AST Trace: library/compiler-builtins/libm/src/math/log10.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=log10 | COMPLEXITY=34 | LINES=133

```rust
// SRC: library/compiler-builtins/libm/src/math/log10.rs
