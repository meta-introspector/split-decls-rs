# AST Trace: compiler/rustc_next_trait_solver/src/solve/eval_ctxt/mod.rs
...
```rust
// SRC: compiler/rustc_next_trait_solver/src/solve/eval_ctxt/mod.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=8 | LINES=27

```rust
pub(super) mod canonical;
// MOD DECLARATION: probe (from compiler/rustc_next_trait_solver/src/solve/eval_ctxt/mod.rs)
// REPLACED: mod probe; -> use crate::probe::*;
use crate::probe::*;
