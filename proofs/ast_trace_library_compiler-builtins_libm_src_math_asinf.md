# AST Trace: library/compiler-builtins/libm/src/math/asinf.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=r | COMPLEXITY=7 | LINES=48

```rust
// SRC: library/compiler-builtins/libm/src/math/asinf.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=asinf | COMPLEXITY=22 | LINES=37
