# AST Trace: ../rust/compiler/rustc_middle/src/ty/inhabitedness/inhabited_predicate.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=3
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=12 | LINES=25
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=apply | COMPLEXITY=155 | LINES=240
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=try_and | COMPLEXITY=9 | LINES=14
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=try_or | COMPLEXITY=9 | LINES=12
