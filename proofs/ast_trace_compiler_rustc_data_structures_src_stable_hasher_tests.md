# AST Trace: compiler/rustc_data_structures/src/stable_hasher/tests.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=hash | COMPLEXITY=4 | LINES=30

```rust
// SRC: compiler/rustc_data_structures/src/stable_hasher/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_hash_bit_set | COMPLEXITY=2 | LINES=10
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_hash_bit_matrix | COMPLEXITY=2 | LINES=10
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_attribute_permutation | COMPLEXITY=21 | LINES=42
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_isize_compression | COMPLEXITY=6 | LINES=21
