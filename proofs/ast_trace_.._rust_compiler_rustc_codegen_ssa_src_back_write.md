# AST Trace: ../rust/compiler/rustc_codegen_ssa/src/back/write.rs
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=16
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=STRUCT | NAME=ModuleConfig | COMPLEXITY=8 | LINES=44
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=new | COMPLEXITY=70 | LINES=158
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=STRUCT | NAME=TargetMachineFactoryConfig | COMPLEXITY=7 | LINES=12
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=new | COMPLEXITY=9 | LINES=25
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=STRUCT | NAME=CodegenContext | COMPLEXITY=16 | LINES=58
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=create_dcx | COMPLEXITY=3 | LINES=6
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=generate_thin_lto_work | COMPLEXITY=7 | LINES=34
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=STRUCT | NAME=CompiledModules | COMPLEXITY=2 | LINES=5
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=need_bitcode_in_object | COMPLEXITY=2 | LINES=7
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=need_pre_lto_bitcode_for_incr_comp | COMPLEXITY=9 | LINES=11
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=47
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=copy_all_cgu_workproducts_to_incr_comp_cache_dir | COMPLEXITY=28 | LINES=42
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=produce_final_output_artifacts | COMPLEXITY=120 | LINES=177
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=17
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=short_description | COMPLEXITY=30 | LINES=51
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=14
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=3 | LINES=5
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=7
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=27 | LINES=35
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=execute_optimize_work_item | COMPLEXITY=39 | LINES=62
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=execute_copy_from_cache_work_item | COMPLEXITY=30 | LINES=88
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=execute_fat_lto_work_item | COMPLEXITY=7 | LINES=23
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=execute_thin_lto_work_item | COMPLEXITY=2 | LINES=11
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=15 | LINES=31
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=STRUCT | NAME=CguMessage; | COMPLEXITY=7 | LINES=21
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=12
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=start_executing_work | COMPLEXITY=293 | LINES=624
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=spawn_work | COMPLEXITY=24 | LINES=52
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=STRUCT | NAME=SharedEmitter | COMPLEXITY=2 | LINES=5
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=STRUCT | NAME=SharedEmitterMain | COMPLEXITY=2 | LINES=4
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=new | COMPLEXITY=8 | LINES=22
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=emit_diagnostic | COMPLEXITY=13 | LINES=39
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=STRUCT | NAME=Coordinator | COMPLEXITY=4 | LINES=7
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=join | COMPLEXITY=3 | LINES=6
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=10 | LINES=11
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=STRUCT | NAME=OngoingCodegen | COMPLEXITY=5 | LINES=12
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=join | COMPLEXITY=29 | LINES=64
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=9
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=8
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=22
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=pre_lto_bitcode_filename | COMPLEXITY=4 | LINES=4
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=msvc_imps_needed | COMPLEXITY=6 | LINES=23
