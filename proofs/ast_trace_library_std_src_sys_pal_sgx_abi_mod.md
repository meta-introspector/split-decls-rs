# AST Trace: library/std/src/sys/pal/sgx/abi/mod.rs
...
```rust
// SRC: library/std/src/sys/pal/sgx/abi/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=EntryReturn(u64, | COMPLEXITY=22 | LINES=55
...
// runtime features
pub mod panic;
// MOD DECLARATION: reloc (from library/std/src/sys/pal/sgx/abi/mod.rs)
// REPLACED: mod reloc; -> use crate::reloc::*;
use crate::reloc::*;
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=main | COMPLEXITY=25 | LINES=37
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=9
