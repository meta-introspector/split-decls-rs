# AST Trace: ../rust/library/compiler-builtins/compiler-builtins/src/int/trailing_zeros.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=trailing_zeros | COMPLEXITY=19 | LINES=52
