# AST Trace: compiler/rustc_mir_transform/src/coverage/counters/node_flow/tests.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/coverage/counters/node_flow/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=node_flow_data | COMPLEXITY=2 | LINES=4
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=make_graph | COMPLEXITY=2 | LINES=4
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=example_driver | COMPLEXITY=7 | LINES=25
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=format_counter_expressions | COMPLEXITY=14 | LINES=20
