# AST Trace: library/alloctests/tests/sort/zipf.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=ZipfDistribution | COMPLEXITY=4 | LINES=30

```rust
// SRC: library/alloctests/tests/sort/zipf.rs
