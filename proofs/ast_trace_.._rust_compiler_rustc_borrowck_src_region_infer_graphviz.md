# AST Trace: ../rust/compiler/rustc_borrowck/src/region_infer/graphviz.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=render_outlives_constraint | COMPLEXITY=13 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=render_universe | COMPLEXITY=6 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=render_region_vid | COMPLEXITY=29 | LINES=33
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=10 | LINES=28
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=RawConstraints | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=graph_id | COMPLEXITY=11 | LINES=21
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=nodes | COMPLEXITY=9 | LINES=24
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=SccConstraints | COMPLEXITY=2 | LINES=6
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=graph_id | COMPLEXITY=14 | LINES=22
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=nodes | COMPLEXITY=11 | LINES=37
