# AST Trace: library/std/src/sys/fs/unix/tests.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_debug_permissions | COMPLEXITY=51 | LINES=88

```rust
// SRC: library/std/src/sys/fs/unix/tests.rs
