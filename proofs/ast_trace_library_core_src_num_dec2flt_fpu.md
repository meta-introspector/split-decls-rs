# AST Trace: library/core/src/num/dec2flt/fpu.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=set_cw | COMPLEXITY=47 | LINES=110

```rust
// SRC: library/core/src/num/dec2flt/fpu.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
