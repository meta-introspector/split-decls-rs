# AST Trace: ../rust/compiler/rustc_middle/src/mir/interpret/allocation/init_mask/tests.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=uninit_mask | COMPLEXITY=15 | LINES=20
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=materialized_block_count | COMPLEXITY=9 | LINES=8
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=materialize_mask_within_range | COMPLEXITY=11 | LINES=19
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=grow_within_unused_bits_with_full_overwrite | COMPLEXITY=11 | LINES=20
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=grow_same_state_within_unused_bits | COMPLEXITY=16 | LINES=28
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=grow_mixed_state_within_unused_bits | COMPLEXITY=16 | LINES=31
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=grow_within_unused_bits_with_overlap | COMPLEXITY=12 | LINES=27
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=grow_mixed_state_within_unused_bits_and_full_overwrite | COMPLEXITY=3 | LINES=23
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=grow_same_state_outside_capacity | COMPLEXITY=9 | LINES=19
