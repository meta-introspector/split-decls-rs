# AST Trace: ../rust/library/std/src/sys/net/connection/xous/tcplistener.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=8 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=TcpListener | COMPLEXITY=2 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=bind | COMPLEXITY=99 | LINES=197
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=10 | LINES=16
