# AST Trace: ../rust/library/std/src/sys/pal/wasip1/helpers.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=is_interrupted | COMPLEXITY=2 | LINES=8
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=decode_error_kind | COMPLEXITY=27 | LINES=97
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=2 | LINES=5
