# AST Trace: ../rust/library/std/src/sys/alloc/wasm.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=12 | LINES=21
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=SyncDlmalloc(dlmalloc::Dlmalloc); | COMPLEXITY=8 | LINES=3
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=63 | LINES=38
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=DropLock; | COMPLEXITY=51 | LINES=105
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=lock | COMPLEXITY=3 | LINES=6
