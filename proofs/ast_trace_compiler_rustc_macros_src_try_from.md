# AST Trace: compiler/rustc_macros/src/try_from.rs
...
```rust
// SRC: compiler/rustc_macros/src/try_from.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=try_from | COMPLEXITY=28 | LINES=53
