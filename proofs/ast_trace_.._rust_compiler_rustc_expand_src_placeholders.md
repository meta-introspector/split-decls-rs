# AST Trace: ../rust/compiler/rustc_expand/src/placeholders.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=mac_placeholder | COMPLEXITY=57 | LINES=209
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=2 | LINES=5
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=remove | COMPLEXITY=4 | LINES=11
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=flat_map_arm | COMPLEXITY=128 | LINES=196
