# AST Trace: compiler/rustc_hir_analysis/src/variance/mod.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/variance/mod.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=15
