# AST Trace: compiler/rustc_session/src/config/externs/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_split_extern_opt | COMPLEXITY=6 | LINES=50

```rust
// SRC: compiler/rustc_session/src/config/externs/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_split_extern_opt_invalid | COMPLEXITY=5 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_split_extern_opt_nested | COMPLEXITY=7 | LINES=29
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_split_extern_opt_nested_invalid | COMPLEXITY=6 | LINES=13
