# AST Trace: library/std/src/thread/mod.rs

Generated 79 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=15 | LINES=59

```rust
// SRC: library/std/src/thread/mod.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=21 | LINES=84
...
// MOD DECLARATION: tests (from library/std/src/thread/mod.rs)
...
// MOD DECLARATION: scoped (from library/std/src/thread/mod.rs)
// REPLACED: mod scoped; -> use crate::scoped::*;
use crate::scoped::*;
...
```rust
// MOD DECLARATION: current (from library/std/src/thread/mod.rs)
// REPLACED: mod current; -> use crate::current::*;
use crate::current::*;
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=19

```rust
// MOD DECLARATION: spawnhook (from library/std/src/thread/mod.rs)
// REPLACED: mod spawnhook; -> use crate::spawnhook::*;
use crate::spawnhook::*;
...
#[macro_use]
// MOD DECLARATION: local (from library/std/src/thread/mod.rs)
// REPLACED: mod local; -> use crate::local::*;
use crate::local::*;
