# AST Trace: compiler/rustc_thread_pool/tests/scoped_threadpool.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=Local(i32); | COMPLEXITY=6 | LINES=37

```rust
// SRC: compiler/rustc_thread_pool/tests/scoped_threadpool.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=spawn_scoped_tls_threadpool | COMPLEXITY=17 | LINES=43
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=build_scoped_tls_threadpool | COMPLEXITY=14 | LINES=34
