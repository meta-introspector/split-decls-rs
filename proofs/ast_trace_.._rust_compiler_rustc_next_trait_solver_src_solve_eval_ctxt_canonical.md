# AST Trace: ../rust/compiler/rustc_next_trait_solver/src/solve/eval_ctxt/canonical.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=var_values | COMPLEXITY=2 | LINES=4
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=var_values | COMPLEXITY=5 | LINES=6
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=var_values | COMPLEXITY=5 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=compute_external_query_constraints | COMPLEXITY=176 | LINES=411
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=7 | LINES=21
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=instantiate_canonical_state | COMPLEXITY=7 | LINES=30
