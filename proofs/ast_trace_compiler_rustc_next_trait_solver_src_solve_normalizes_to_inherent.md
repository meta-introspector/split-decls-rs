# AST Trace: compiler/rustc_next_trait_solver/src/solve/normalizes_to/inherent.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=6 | LINES=25

```rust
// SRC: compiler/rustc_next_trait_solver/src/solve/normalizes_to/inherent.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=52
