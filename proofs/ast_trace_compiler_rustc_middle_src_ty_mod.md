# AST Trace: compiler/rustc_middle/src/ty/mod.rs
...
```rust
// SRC: compiler/rustc_middle/src/ty/mod.rs
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=STRUCT | NAME=ResolverGlobalCtxt | COMPLEXITY=14 | LINES=119
...
// MOD DECLARATION: adt (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod adt; -> use crate::adt::*;
use crate::adt::*;
// MOD DECLARATION: assoc (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod assoc; -> use crate::assoc::*;
use crate::assoc::*;
// MOD DECLARATION: closure (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod closure; -> use crate::closure::*;
use crate::closure::*;
// MOD DECLARATION: consts (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod consts; -> use crate::consts::*;
use crate::consts::*;
// MOD DECLARATION: context (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod context; -> use crate::context::*;
use crate::context::*;
// MOD DECLARATION: diagnostics (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod diagnostics; -> use crate::diagnostics::*;
use crate::diagnostics::*;
// MOD DECLARATION: elaborate_impl (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod elaborate_impl; -> use crate::elaborate_impl::*;
use crate::elaborate_impl::*;
// MOD DECLARATION: erase_regions (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod erase_regions; -> use crate::erase_regions::*;
use crate::erase_regions::*;
// MOD DECLARATION: fold (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod fold; -> use crate::fold::*;
use crate::fold::*;
// MOD DECLARATION: generic_args (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod generic_args; -> use crate::generic_args::*;
use crate::generic_args::*;
// MOD DECLARATION: generics (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod generics; -> use crate::generics::*;
use crate::generics::*;
// MOD DECLARATION: impls_ty (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod impls_ty; -> use crate::impls_ty::*;
use crate::impls_ty::*;
// MOD DECLARATION: instance (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod instance; -> use crate::instance::*;
use crate::instance::*;
// MOD DECLARATION: intrinsic (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod intrinsic; -> use crate::intrinsic::*;
use crate::intrinsic::*;
// MOD DECLARATION: list (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod list; -> use crate::list::*;
use crate::list::*;
// MOD DECLARATION: opaque_types (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod opaque_types; -> use crate::opaque_types::*;
use crate::opaque_types::*;
// MOD DECLARATION: predicate (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod predicate; -> use crate::predicate::*;
use crate::predicate::*;
// MOD DECLARATION: region (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod region; -> use crate::region::*;
use crate::region::*;
// MOD DECLARATION: rvalue_scopes (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod rvalue_scopes; -> use crate::rvalue_scopes::*;
use crate::rvalue_scopes::*;
// MOD DECLARATION: structural_impls (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod structural_impls; -> use crate::structural_impls::*;
use crate::structural_impls::*;
#[allow(hidden_glob_reexports)]
// MOD DECLARATION: sty (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod sty; -> use crate::sty::*;
use crate::sty::*;
// MOD DECLARATION: typeck_results (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod typeck_results; -> use crate::typeck_results::*;
use crate::typeck_results::*;
// MOD DECLARATION: visit (from compiler/rustc_middle/src/ty/mod.rs)
// REPLACED: mod visit; -> use crate::visit::*;
use crate::visit::*;
