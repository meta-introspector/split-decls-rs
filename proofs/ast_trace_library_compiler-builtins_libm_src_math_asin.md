# AST Trace: library/compiler-builtins/libm/src/math/asin.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/asin.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=comp_r | COMPLEXITY=6 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=asin | COMPLEXITY=31 | LINES=53
