# AST Trace: library/compiler-builtins/libm/src/math/j1.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=14 | LINES=72

```rust
// SRC: library/compiler-builtins/libm/src/math/j1.rs
