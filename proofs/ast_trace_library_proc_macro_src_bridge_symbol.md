# AST Trace: library/proc_macro/src/bridge/symbol.rs

Generated 12 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Symbol(NonZero | COMPLEXITY=11 | LINES=39

```rust
// SRC: library/proc_macro/src/bridge/symbol.rs
