# AST Trace: compiler/rustc_data_structures/src/marker.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=15 | LINES=26

```rust
// SRC: compiler/rustc_data_structures/src/marker.rs
