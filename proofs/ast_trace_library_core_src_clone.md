# AST Trace: library/core/src/clone.rs

Generated 29 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=7 | LINES=46

```rust
// SRC: library/core/src/clone.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=13 | LINES=40

```rust
// MOD DECLARATION: uninit (from library/core/src/clone.rs)
// REPLACED: mod uninit; -> use crate::uninit::*;
use crate::uninit::*;
