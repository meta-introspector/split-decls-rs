# AST Trace: library/backtrace/src/backtrace/miri.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=miri_backtrace_size | COMPLEXITY=8 | LINES=25

```rust
// SRC: library/backtrace/src/backtrace/miri.rs
