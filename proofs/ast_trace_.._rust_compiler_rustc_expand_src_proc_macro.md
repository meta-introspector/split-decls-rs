# AST Trace: ../rust/compiler/rustc_expand/src/proc_macro.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=MessagePipe | COMPLEXITY=2 | LINES=5
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=new | COMPLEXITY=9 | LINES=16
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=exec_strategy | COMPLEXITY=2 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=BangProcMacro | COMPLEXITY=2 | LINES=4
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=expand | COMPLEXITY=10 | LINES=26
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=AttrProcMacro | COMPLEXITY=2 | LINES=4
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=expand | COMPLEXITY=11 | LINES=29
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=STRUCT | NAME=DeriveProcMacro | COMPLEXITY=2 | LINES=4
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=expand | COMPLEXITY=47 | LINES=77
