# AST Trace: library/compiler-builtins/libm/src/math/exp.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=exp | COMPLEXITY=67 | LINES=167

```rust
// SRC: library/compiler-builtins/libm/src/math/exp.rs
