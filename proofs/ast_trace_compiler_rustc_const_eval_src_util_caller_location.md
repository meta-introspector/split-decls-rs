# AST Trace: compiler/rustc_const_eval/src/util/caller_location.rs
...
```rust
// SRC: compiler/rustc_const_eval/src/util/caller_location.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=alloc_caller_location | COMPLEXITY=23 | LINES=45
