# AST Trace: library/std/src/ffi/os_str/tests.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_os_string_with_capacity | COMPLEXITY=4 | LINES=33

```rust
// SRC: library/std/src/ffi/os_str/tests.rs
