# AST Trace: compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=42

```rust
// SRC: compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs
...
// MOD DECLARATION: emit (from compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs)
// REPLACED: mod emit; -> use crate::emit::*;
use crate::emit::*;
// MOD DECLARATION: line_info (from compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs)
// REPLACED: mod line_info; -> use crate::line_info::*;
use crate::line_info::*;
// MOD DECLARATION: object (from compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs)
// REPLACED: mod object; -> use crate::object::*;
use crate::object::*;
// MOD DECLARATION: types (from compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs)
// REPLACED: mod types; -> use crate::types::*;
use crate::types::*;
// MOD DECLARATION: unwind (from compiler/rustc_codegen_cranelift/src/debuginfo/mod.rs)
// REPLACED: mod unwind; -> use crate::unwind::*;
use crate::unwind::*;
