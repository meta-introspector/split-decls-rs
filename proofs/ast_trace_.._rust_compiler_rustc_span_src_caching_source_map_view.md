# AST Trace: ../rust/compiler/rustc_span/src/caching_source_map_view.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=CacheEntry | COMPLEXITY=14 | LINES=21
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=update | COMPLEXITY=8 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=CachingSourceMapView | COMPLEXITY=2 | LINES=7
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=new | COMPLEXITY=116 | LINES=223
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=file_contains | COMPLEXITY=9 | LINES=10
