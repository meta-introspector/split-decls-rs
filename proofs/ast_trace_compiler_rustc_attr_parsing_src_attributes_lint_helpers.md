# AST Trace: compiler/rustc_attr_parsing/src/attributes/lint_helpers.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=9 | LINES=30

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/lint_helpers.rs
