# AST Trace: compiler/rustc_hir/src/tests.rs
...
```rust
// SRC: compiler/rustc_hir/src/tests.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=def_path_hash_depends_on_crate_id | COMPLEXITY=10 | LINES=37
