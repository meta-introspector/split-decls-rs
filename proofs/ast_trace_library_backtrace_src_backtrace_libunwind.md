# AST Trace: library/backtrace/src/backtrace/libunwind.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=8 | LINES=46

```rust
// SRC: library/backtrace/src/backtrace/libunwind.rs
