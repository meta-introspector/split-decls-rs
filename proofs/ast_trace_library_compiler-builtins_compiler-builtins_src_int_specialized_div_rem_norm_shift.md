# AST Trace: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/norm_shift.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$name | COMPLEXITY=81 | LINES=123

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/norm_shift.rs
