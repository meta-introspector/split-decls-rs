# AST Trace: compiler/rustc_thread_pool/src/lib.rs

Generated 29 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=24 | LINES=86

```rust
// SRC: compiler/rustc_thread_pool/src/lib.rs
