# AST Trace: ../rust/library/alloctests/tests/fmt.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_format | COMPLEXITY=3 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=A; | COMPLEXITY=5 | LINES=11
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=5 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=5 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_format_macro_interface | COMPLEXITY=255 | LINES=287
