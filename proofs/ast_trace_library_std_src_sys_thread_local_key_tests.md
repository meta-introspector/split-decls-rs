# AST Trace: library/std/src/sys/thread_local/key/tests.rs
...
```rust
// SRC: library/std/src/sys/thread_local/key/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=smoke | COMPLEXITY=8 | LINES=23
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=destructors | COMPLEXITY=28 | LINES=38
