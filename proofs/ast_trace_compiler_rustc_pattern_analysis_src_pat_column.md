# AST Trace: compiler/rustc_pattern_analysis/src/pat_column.rs
...
```rust
// SRC: compiler/rustc_pattern_analysis/src/pat_column.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=PatternColumn | COMPLEXITY=5 | LINES=14
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=new | COMPLEXITY=33 | LINES=73
