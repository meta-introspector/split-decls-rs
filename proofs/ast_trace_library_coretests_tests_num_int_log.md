# AST Trace: library/coretests/tests/num/int_log.rs

Generated 16 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=16

```rust
// SRC: library/coretests/tests/num/int_log.rs
