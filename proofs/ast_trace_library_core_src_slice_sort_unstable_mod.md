# AST Trace: library/core/src/slice/sort/unstable/mod.rs
...
```rust
// SRC: library/core/src/slice/sort/unstable/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sort | COMPLEXITY=29 | LINES=45
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=ipnsort | COMPLEXITY=19 | LINES=32
