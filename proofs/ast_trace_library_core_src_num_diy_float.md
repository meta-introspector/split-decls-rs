# AST Trace: library/core/src/num/diy_float.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Fp | COMPLEXITY=10 | LINES=35

```rust
// SRC: library/core/src/num/diy_float.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=mul | COMPLEXITY=9 | LINES=29
