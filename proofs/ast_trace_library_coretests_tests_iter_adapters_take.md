# AST Trace: library/coretests/tests/iter/adapters/take.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_take | COMPLEXITY=11 | LINES=45

```rust
// SRC: library/coretests/tests/iter/adapters/take.rs
