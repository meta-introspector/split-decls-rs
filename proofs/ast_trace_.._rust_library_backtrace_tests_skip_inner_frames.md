# AST Trace: ../rust/library/backtrace/tests/skip_inner_frames.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=backtrace_new_unresolved_should_start_with_call_site_trace | COMPLEXITY=11 | LINES=31
