# AST Trace: ../rust/compiler/rustc_driver_impl/src/signal_handler.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=backtrace_symbols_fd | COMPLEXITY=6 | LINES=13
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=backtrace_stderr | COMPLEXITY=7 | LINES=5
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=RawStderr(()); | COMPLEXITY=14 | LINES=12
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=4 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=65 | LINES=99
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=19
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=min_sigstack_size | COMPLEXITY=8 | LINES=11
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=min_sigstack_size | COMPLEXITY=2 | LINES=6
