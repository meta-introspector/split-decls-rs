# AST Trace: compiler/rustc_mir_build/src/thir/constant.rs
...
```rust
// SRC: compiler/rustc_mir_build/src/thir/constant.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=56 | LINES=82
