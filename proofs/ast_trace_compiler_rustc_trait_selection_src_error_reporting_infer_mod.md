# AST Trace: compiler/rustc_trait_selection/src/error_reporting/infer/mod.rs

Generated 58 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=68

```rust
// SRC: compiler/rustc_trait_selection/src/error_reporting/infer/mod.rs
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=escape_literal | COMPLEXITY=11 | LINES=24

```rust
// MOD DECLARATION: note_and_explain (from compiler/rustc_trait_selection/src/error_reporting/infer/mod.rs)
// REPLACED: mod note_and_explain; -> use crate::note_and_explain::*;
use crate::note_and_explain::*;
// MOD DECLARATION: suggest (from compiler/rustc_trait_selection/src/error_reporting/infer/mod.rs)
// REPLACED: mod suggest; -> use crate::suggest::*;
use crate::suggest::*;
