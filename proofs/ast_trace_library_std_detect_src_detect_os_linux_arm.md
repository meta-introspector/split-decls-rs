# AST Trace: library/std_detect/src/detect/os/linux/arm.rs
...
```rust
// SRC: library/std_detect/src/detect/os/linux/arm.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=30
