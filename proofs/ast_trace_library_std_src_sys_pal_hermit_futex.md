# AST Trace: library/std/src/sys/pal/hermit/futex.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=futex_wait | COMPLEXITY=17 | LINES=54

```rust
// SRC: library/std/src/sys/pal/hermit/futex.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=futex_wake | COMPLEXITY=7 | LINES=5
