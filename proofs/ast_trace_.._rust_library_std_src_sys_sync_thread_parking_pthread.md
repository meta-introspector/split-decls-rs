# AST Trace: ../rust/library/std/src/sys/sync/thread_parking/pthread.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=Parker | COMPLEXITY=2 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=lock | COMPLEXITY=99 | LINES=148
