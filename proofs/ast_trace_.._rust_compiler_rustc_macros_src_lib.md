# AST Trace: ../rust/compiler/rustc_macros/src/lib.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=current_rustc_version | COMPLEXITY=2 | LINES=4
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=rustc_queries | COMPLEXITY=2 | LINES=5
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=symbols | COMPLEXITY=2 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=extension | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=35 | LINES=125
