# AST Trace: library/std/src/sys/pal/unix/sync/mutex.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Mutex | COMPLEXITY=3 | LINES=24

```rust
// SRC: library/std/src/sys/pal/unix/sync/mutex.rs
