# AST Trace: compiler/rustc_mir_build/src/builder/custom/parse.rs
...
```rust
// SRC: compiler/rustc_mir_build/src/builder/custom/parse.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=8 | LINES=14

```rust
// MOD DECLARATION: instruction (from compiler/rustc_mir_build/src/builder/custom/parse.rs)
// REPLACED: mod instruction; -> use crate::instruction::*;
