# AST Trace: compiler/rustc_hir_analysis/src/impl_wf_check.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/impl_wf_check.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=25
...
// MOD DECLARATION: min_specialization (from compiler/rustc_hir_analysis/src/impl_wf_check.rs)
// REPLACED: mod min_specialization; -> use crate::min_specialization::*;
use crate::min_specialization::*;
