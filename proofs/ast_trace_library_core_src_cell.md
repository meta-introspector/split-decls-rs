# AST Trace: library/core/src/cell.rs

Generated 103 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=31 | LINES=139

```rust
// SRC: library/core/src/cell.rs
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=3 | LINES=33

```rust
// MOD DECLARATION: lazy (from library/core/src/cell.rs)
// REPLACED: mod lazy; -> use crate::lazy::*;
use crate::lazy::*;
// MOD DECLARATION: once (from library/core/src/cell.rs)
