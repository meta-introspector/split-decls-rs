# AST Trace: compiler/rustc_mir_dataflow/src/framework/lattice.rs

Generated 20 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=22

```rust
// SRC: compiler/rustc_mir_dataflow/src/framework/lattice.rs
