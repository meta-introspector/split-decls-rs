# AST Trace: library/coretests/tests/num/dec2flt/decimal.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=check_fast_path_f16 | COMPLEXITY=9 | LINES=39

```rust
// SRC: library/coretests/tests/num/dec2flt/decimal.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=check_fast_path_f32 | COMPLEXITY=6 | LINES=10
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=check_fast_path_f64 | COMPLEXITY=6 | LINES=10
