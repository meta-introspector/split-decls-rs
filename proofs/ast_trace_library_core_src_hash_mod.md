# AST Trace: library/core/src/hash/mod.rs
...
```rust
// SRC: library/core/src/hash/mod.rs
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=22

```rust
// MOD DECLARATION: sip (from library/core/src/hash/mod.rs)
// REPLACED: mod sip; -> use crate::sip::*;
use crate::sip::*;
