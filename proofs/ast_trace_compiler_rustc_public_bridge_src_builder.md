# AST Trace: compiler/rustc_public_bridge/src/builder.rs
...
```rust
// SRC: compiler/rustc_public_bridge/src/builder.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=37
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=visit_const_operand | COMPLEXITY=13 | LINES=24
