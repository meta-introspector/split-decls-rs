# AST Trace: library/backtrace/crates/without_debuginfo/tests/smoke.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=all_frames_have_symbols | COMPLEXITY=21 | LINES=44

```rust
// SRC: library/backtrace/crates/without_debuginfo/tests/smoke.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=all_frames_have_module_base_address | COMPLEXITY=9 | LINES=15
