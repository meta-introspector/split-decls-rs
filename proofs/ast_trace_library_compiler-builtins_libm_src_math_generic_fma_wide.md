# AST Trace: library/compiler-builtins/libm/src/math/generic/fma_wide.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/generic/fma_wide.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=fma_wide_round | COMPLEXITY=27 | LINES=70
