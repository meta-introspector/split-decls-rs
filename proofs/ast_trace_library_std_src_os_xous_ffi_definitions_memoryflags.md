# AST Trace: library/std/src/os/xous/ffi/definitions/memoryflags.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=MemoryFlags | COMPLEXITY=4 | LINES=25

```rust
// SRC: library/std/src/os/xous/ffi/definitions/memoryflags.rs
