# AST Trace: ../rust/compiler/rustc_codegen_gcc/tests/lang_tests_common.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=2 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=main_inner | COMPLEXITY=51 | LINES=130
