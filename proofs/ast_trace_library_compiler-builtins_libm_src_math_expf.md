# AST Trace: library/compiler-builtins/libm/src/math/expf.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=expf | COMPLEXITY=45 | LINES=112

```rust
// SRC: library/compiler-builtins/libm/src/math/expf.rs
