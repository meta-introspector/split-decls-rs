# AST Trace: library/backtrace/crates/macos_frames_test/tests/main.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=backtrace_no_dsym | COMPLEXITY=11 | LINES=46

```rust
// SRC: library/backtrace/crates/macos_frames_test/tests/main.rs
