# AST Trace: compiler/rustc_mir_build/src/builder/expr/as_place.rs
...
```rust
// SRC: compiler/rustc_mir_build/src/builder/expr/as_place.rs
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=PlaceBuilder | COMPLEXITY=5 | LINES=12
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=to_place | COMPLEXITY=41 | LINES=83
