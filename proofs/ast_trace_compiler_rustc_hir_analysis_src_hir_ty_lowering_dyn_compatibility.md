# AST Trace: compiler/rustc_hir_analysis/src/hir_ty_lowering/dyn_compatibility.rs
...
```rust
// SRC: compiler/rustc_hir_analysis/src/hir_ty_lowering/dyn_compatibility.rs
