# AST Trace: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/binary_long.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=263 | LINES=567

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/binary_long.rs
