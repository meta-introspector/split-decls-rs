# AST Trace: library/coretests/tests/iter/adapters/cloned.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_cloned | COMPLEXITY=4 | LINES=33

```rust
// SRC: library/coretests/tests/iter/adapters/cloned.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_cloned_side_effects | COMPLEXITY=7 | LINES=18
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_cloned_try_folds | COMPLEXITY=3 | LINES=17
