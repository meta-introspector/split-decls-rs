# AST Trace: library/compiler-builtins/libm/src/math/arch/i586.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=ceil | COMPLEXITY=21 | LINES=50

```rust
// SRC: library/compiler-builtins/libm/src/math/arch/i586.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=floor | COMPLEXITY=14 | LINES=27
