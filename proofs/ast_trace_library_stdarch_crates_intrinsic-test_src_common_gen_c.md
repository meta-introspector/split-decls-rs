# AST Trace: library/stdarch/crates/intrinsic-test/src/common/gen_c.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=generate_c_test_loop | COMPLEXITY=18 | LINES=46

```rust
// SRC: library/stdarch/crates/intrinsic-test/src/common/gen_c.rs
