# AST Trace: ../rust/compiler/rustc_trait_selection/src/traits/query/dropck_outlives.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=trivial_dropck_outlives | COMPLEXITY=36 | LINES=79
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=compute_dropck_outlives_inner | COMPLEXITY=6 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=compute_dropck_outlives_with_errors | COMPLEXITY=67 | LINES=147
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=dtorck_constraint_for_ty_inner | COMPLEXITY=91 | LINES=176
