# AST Trace: library/std/src/sys/thread_local/native/mod.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=__init | COMPLEXITY=61 | LINES=132

```rust
// SRC: library/std/src/sys/thread_local/native/mod.rs
...
// MOD DECLARATION: eager (from library/std/src/sys/thread_local/native/mod.rs)
// REPLACED: mod eager; -> use crate::eager::*;
use crate::eager::*;
// MOD DECLARATION: lazy (from library/std/src/sys/thread_local/native/mod.rs)
