# AST Trace: ../rust/compiler/rustc_const_eval/src/interpret/projection.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=layout | COMPLEXITY=28 | LINES=74
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=ArrayIterator | COMPLEXITY=2 | LINES=9
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=next | COMPLEXITY=8 | LINES=21
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=project_field | COMPLEXITY=126 | LINES=280
