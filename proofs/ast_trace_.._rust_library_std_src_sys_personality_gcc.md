# AST Trace: ../rust/library/std/src/sys/personality/gcc.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=42
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=__gnu_unwind_frame | COMPLEXITY=167 | LINES=279
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=19 | LINES=19
