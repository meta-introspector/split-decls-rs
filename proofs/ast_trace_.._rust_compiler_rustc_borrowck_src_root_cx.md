# AST Trace: ../rust/compiler/rustc_borrowck/src/root_cx.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=5 | LINES=18
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=handle_opaque_type_uses | COMPLEXITY=92 | LINES=251
