# AST Trace: compiler/rustc_monomorphize/src/util.rs
...
```rust
// SRC: compiler/rustc_monomorphize/src/util.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=32 | LINES=67
