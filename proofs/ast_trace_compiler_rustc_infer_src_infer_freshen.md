# AST Trace: compiler/rustc_infer/src/infer/freshen.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=22 | LINES=55

```rust
// SRC: compiler/rustc_infer/src/infer/freshen.rs
