# AST Trace: library/std/src/sys/sync/mutex/xous.rs
...
```rust
// SRC: library/std/src/sys/sync/mutex/xous.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=Mutex | COMPLEXITY=7 | LINES=19
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=index | COMPLEXITY=61 | LINES=76
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=8 | LINES=11
