# AST Trace: compiler/rustc_hir_typeck/src/cast.rs

Generated 17 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=23 | LINES=51

```rust
// SRC: compiler/rustc_hir_typeck/src/cast.rs
