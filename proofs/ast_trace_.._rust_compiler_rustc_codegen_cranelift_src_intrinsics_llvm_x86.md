# AST Trace: ../rust/compiler/rustc_codegen_cranelift/src/intrinsics/llvm_x86.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=select4 | COMPLEXITY=351 | LINES=1327
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=llvm_add_sub | COMPLEXITY=4 | LINES=31
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=ret_clif_type | COMPLEXITY=34 | LINES=44
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=divisor | COMPLEXITY=7 | LINES=8
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=pack_instruction | COMPLEXITY=18 | LINES=46
