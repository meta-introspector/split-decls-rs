# AST Trace: ../rust/library/alloc/src/collections/vec_deque/iter_mut.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=IterMut | COMPLEXITY=4 | LINES=12
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=into_slices | COMPLEXITY=14 | LINES=113
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=next | COMPLEXITY=38 | LINES=73
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=next_back | COMPLEXITY=21 | LINES=46
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=len | COMPLEXITY=6 | LINES=11
