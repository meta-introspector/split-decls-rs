# AST Trace: ../rust/library/backtrace/tests/current-exe-mismatch.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=main | COMPLEXITY=22 | LINES=32
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=parent | COMPLEXITY=17 | LINES=28
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=child | COMPLEXITY=19 | LINES=29
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=find_interpreter | COMPLEXITY=21 | LINES=27
