# AST Trace: ../rust/library/std/src/sys/pal/uefi/time.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Instant(Duration); | COMPLEXITY=3 | LINES=25
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=now | COMPLEXITY=13 | LINES=27
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=now | COMPLEXITY=16 | LINES=31
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=now | COMPLEXITY=50 | LINES=137
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=timestamp_protocol | COMPLEXITY=77 | LINES=97
