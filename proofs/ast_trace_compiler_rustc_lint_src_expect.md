# AST Trace: compiler/rustc_lint/src/expect.rs
...
```rust
// SRC: compiler/rustc_lint/src/expect.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=lint_expectations | COMPLEXITY=5 | LINES=13
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=check_expectations | COMPLEXITY=24 | LINES=46
