# AST Trace: compiler/rustc_borrowck/src/type_check/free_region_relations.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/type_check/free_region_relations.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=9
