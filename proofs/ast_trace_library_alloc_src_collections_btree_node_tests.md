# AST Trace: library/alloc/src/collections/btree/node/tests.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=28 | LINES=56

```rust
// SRC: library/alloc/src/collections/btree/node/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_splitpoint | COMPLEXITY=12 | LINES=24
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_partial_eq | COMPLEXITY=14 | LINES=26
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_sizes | COMPLEXITY=2 | LINES=10
