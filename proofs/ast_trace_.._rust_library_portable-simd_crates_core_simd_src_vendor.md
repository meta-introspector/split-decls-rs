# AST Trace: ../rust/library/portable-simd/crates/core_simd/src/vendor.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=from | COMPLEXITY=31 | LINES=18
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=MODULE | NAME=UNNAMED | COMPLEXITY=1 | LINES=16
