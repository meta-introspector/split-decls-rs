# AST Trace: compiler/rustc_codegen_cranelift/src/optimize/peephole.rs
...
```rust
// SRC: compiler/rustc_codegen_cranelift/src/optimize/peephole.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=19 | LINES=24
