# AST Trace: compiler/rustc_middle/src/middle/lang_items.rs
...
```rust
// SRC: compiler/rustc_middle/src/middle/lang_items.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=require_lang_item | COMPLEXITY=41 | LINES=69
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=required | COMPLEXITY=14 | LINES=18
