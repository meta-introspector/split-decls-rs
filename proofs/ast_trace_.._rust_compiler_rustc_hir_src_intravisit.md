# AST Trace: ../rust/compiler/rustc_hir/src/intravisit.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=into_visitor | COMPLEXITY=2 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=header | COMPLEXITY=10 | LINES=18
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=hir_node | COMPLEXITY=5 | LINES=13
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=hir_node | COMPLEXITY=11 | LINES=22
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=None(()); | COMPLEXITY=15 | LINES=41
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=maybe_tcx | COMPLEXITY=139 | LINES=319
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=visit_ty_unambig | COMPLEXITY=5 | LINES=19
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=walk_param | COMPLEXITY=3 | LINES=6
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=walk_item | COMPLEXITY=44 | LINES=108
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=walk_body | COMPLEXITY=3 | LINES=6
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=walk_ident | COMPLEXITY=2 | LINES=4
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=walk_mod | COMPLEXITY=3 | LINES=6
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=walk_foreign_item | COMPLEXITY=13 | LINES=25
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=walk_local | COMPLEXITY=4 | LINES=12
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=walk_block | COMPLEXITY=3 | LINES=8
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=walk_stmt | COMPLEXITY=8 | LINES=12
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=walk_arm | COMPLEXITY=3 | LINES=8
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=walk_ty_pat | COMPLEXITY=9 | LINES=14
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=walk_pat | COMPLEXITY=19 | LINES=44
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=walk_pat_field | COMPLEXITY=3 | LINES=7
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=walk_pat_expr | COMPLEXITY=8 | LINES=10
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=walk_anon_const | COMPLEXITY=3 | LINES=6
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=walk_inline_const | COMPLEXITY=3 | LINES=9
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=walk_expr | COMPLEXITY=60 | LINES=139
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=walk_expr_field | COMPLEXITY=3 | LINES=7
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=walk_generic_arg | COMPLEXITY=8 | LINES=15
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=walk_unambig_ty | COMPLEXITY=8 | LINES=10
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=walk_ty | COMPLEXITY=26 | LINES=52
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=walk_unambig_const_arg | COMPLEXITY=8 | LINES=13
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=walk_const_arg | COMPLEXITY=7 | LINES=12
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=walk_generic_param | COMPLEXITY=22 | LINES=34
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=walk_const_param_default | COMPLEXITY=2 | LINES=7
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=walk_generics | COMPLEXITY=3 | LINES=13
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=walk_where_predicate | COMPLEXITY=15 | LINES=33
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=walk_fn_decl | COMPLEXITY=3 | LINES=10
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=walk_fn_ret_ty | COMPLEXITY=5 | LINES=7
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=walk_fn | COMPLEXITY=2 | LINES=12
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=walk_fn_kind | COMPLEXITY=8 | LINES=10
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=walk_use | COMPLEXITY=7 | LINES=12
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=walk_trait_item | COMPLEXITY=17 | LINES=46
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=walk_trait_item_ref | COMPLEXITY=2 | LINES=4
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=walk_impl_item | COMPLEXITY=18 | LINES=39
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=FUNCTION | NAME=walk_foreign_item_ref | COMPLEXITY=2 | LINES=4
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=walk_impl_item_ref | COMPLEXITY=2 | LINES=4
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=walk_trait_ref | COMPLEXITY=3 | LINES=9
...
## Block 51
**Metadata**: AST_ID=51 | TYPE=FUNCTION | NAME=walk_param_bound | COMPLEXITY=7 | LINES=14
...
## Block 52
**Metadata**: AST_ID=52 | TYPE=FUNCTION | NAME=walk_precise_capturing_arg | COMPLEXITY=8 | LINES=14
...
## Block 53
**Metadata**: AST_ID=53 | TYPE=FUNCTION | NAME=walk_poly_trait_ref | COMPLEXITY=3 | LINES=9
...
## Block 54
**Metadata**: AST_ID=54 | TYPE=FUNCTION | NAME=walk_opaque_ty | COMPLEXITY=3 | LINES=7
...
## Block 55
**Metadata**: AST_ID=55 | TYPE=FUNCTION | NAME=walk_struct_def | COMPLEXITY=2 | LINES=9
...
## Block 56
**Metadata**: AST_ID=56 | TYPE=FUNCTION | NAME=walk_field_def | COMPLEXITY=2 | LINES=4
...
## Block 57
**Metadata**: AST_ID=57 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=2 | LINES=6
...
## Block 58
**Metadata**: AST_ID=58 | TYPE=FUNCTION | NAME=walk_enum_def | COMPLEXITY=3 | LINES=9
...
## Block 59
**Metadata**: AST_ID=59 | TYPE=FUNCTION | NAME=walk_variant | COMPLEXITY=3 | LINES=9
...
## Block 60
**Metadata**: AST_ID=60 | TYPE=FUNCTION | NAME=walk_label | COMPLEXITY=3 | LINES=5
...
## Block 61
**Metadata**: AST_ID=61 | TYPE=FUNCTION | NAME=walk_inf | COMPLEXITY=3 | LINES=5
...
## Block 62
**Metadata**: AST_ID=62 | TYPE=FUNCTION | NAME=walk_lifetime | COMPLEXITY=3 | LINES=6
...
## Block 63
**Metadata**: AST_ID=63 | TYPE=FUNCTION | NAME=walk_qpath | COMPLEXITY=9 | LINES=18
...
## Block 64
**Metadata**: AST_ID=64 | TYPE=FUNCTION | NAME=walk_path | COMPLEXITY=3 | LINES=6
...
## Block 65
**Metadata**: AST_ID=65 | TYPE=FUNCTION | NAME=walk_path_segment | COMPLEXITY=3 | LINES=11
...
## Block 66
**Metadata**: AST_ID=66 | TYPE=FUNCTION | NAME=walk_generic_args | COMPLEXITY=3 | LINES=10
...
## Block 67
**Metadata**: AST_ID=67 | TYPE=FUNCTION | NAME=walk_assoc_item_constraint | COMPLEXITY=15 | LINES=20
...
## Block 68
**Metadata**: AST_ID=68 | TYPE=FUNCTION | NAME=walk_defaultness | COMPLEXITY=2 | LINES=7
...
## Block 69
**Metadata**: AST_ID=69 | TYPE=FUNCTION | NAME=walk_inline_asm | COMPLEXITY=25 | LINES=32
