# AST Trace: library/panic_abort/src/lib.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=48

```rust
// SRC: library/panic_abort/src/lib.rs
...
// MOD DECLARATION: android (from library/panic_abort/src/lib.rs)
// REPLACED: mod android; -> use crate::android::*;
use crate::android::*;

#[cfg(target_os = "zkvm")]
// MOD DECLARATION: zkvm (from library/panic_abort/src/lib.rs)
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=22 | LINES=22
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=14 | LINES=43
