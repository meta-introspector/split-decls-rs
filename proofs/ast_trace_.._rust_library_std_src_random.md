# AST Trace: ../rust/library/std/src/random.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=DefaultRandomSource; | COMPLEXITY=24 | LINES=66
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=random | COMPLEXITY=14 | LINES=30
