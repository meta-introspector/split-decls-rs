# AST Trace: compiler/rustc_codegen_gcc/src/back/lto.rs

Generated 24 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=18 | LINES=35

```rust
// SRC: compiler/rustc_codegen_gcc/src/back/lto.rs
