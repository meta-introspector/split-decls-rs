# AST Trace: compiler/rustc_codegen_ssa/src/mono_item.rs
...
```rust
// SRC: compiler/rustc_codegen_ssa/src/mono_item.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=define | COMPLEXITY=56 | LINES=72
