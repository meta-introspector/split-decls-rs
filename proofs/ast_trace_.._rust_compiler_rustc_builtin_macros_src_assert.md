# AST Trace: ../rust/compiler/rustc_builtin_macros/src/assert.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=31 | LINES=84
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Assert | COMPLEXITY=2 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=expr_if_not | COMPLEXITY=2 | LINES=9
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=parse_assert | COMPLEXITY=25 | LINES=46
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=parse_custom_message | COMPLEXITY=6 | LINES=5
