# AST Trace: ../rust/compiler/rustc_infer/src/infer/canonical/query_response.rs
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=make_canonicalized_query_response | COMPLEXITY=218 | LINES=549
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=make_query_region_constraints | COMPLEXITY=8 | LINES=31
