# AST Trace: library/stdarch/crates/core_arch/src/simd.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=JustOne([$elem_type; | COMPLEXITY=49 | LINES=87

```rust
// SRC: library/stdarch/crates/core_arch/src/simd.rs
