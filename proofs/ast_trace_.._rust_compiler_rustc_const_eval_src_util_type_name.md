# AST Trace: ../rust/compiler/rustc_const_eval/src/util/type_name.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=TypeNamePrinter | COMPLEXITY=2 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=53 | LINES=151
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=should_print_optional_region | COMPLEXITY=14 | LINES=32
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=write_str | COMPLEXITY=5 | LINES=7
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=type_name | COMPLEXITY=3 | LINES=6
