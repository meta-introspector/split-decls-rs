# AST Trace: compiler/rustc_codegen_gcc/src/intrinsic/mod.rs
...
```rust
// SRC: compiler/rustc_codegen_gcc/src/intrinsic/mod.rs
...
pub mod llvm;
// MOD DECLARATION: simd (from compiler/rustc_codegen_gcc/src/intrinsic/mod.rs)
