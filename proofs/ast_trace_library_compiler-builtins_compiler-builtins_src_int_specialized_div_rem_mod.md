# AST Trace: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=zero_div_fn | COMPLEXITY=27 | LINES=105

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs
...
#[macro_use]
// MOD DECLARATION: norm_shift (from library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs)
// REPLACED: mod norm_shift; -> use crate::norm_shift::*;
use crate::norm_shift::*;

#[macro_use]
// MOD DECLARATION: binary_long (from library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs)
// REPLACED: mod binary_long; -> use crate::binary_long::*;
use crate::binary_long::*;

#[macro_use]
// MOD DECLARATION: delegate (from library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs)
...
#[macro_use]
// MOD DECLARATION: trifecta (from library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs)
// REPLACED: mod trifecta; -> use crate::trifecta::*;
use crate::trifecta::*;

#[macro_use]
// MOD DECLARATION: asymmetric (from library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/mod.rs)
// REPLACED: mod asymmetric; -> use crate::asymmetric::*;
