# AST Trace: library/coretests/tests/num/i32.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_arith_operation | COMPLEXITY=5 | LINES=47

```rust
// SRC: library/coretests/tests/num/i32.rs
