# AST Trace: ../rust/library/coretests/tests/num/dec2flt/float.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_f16_integer_decode | COMPLEXITY=3 | LINES=18
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_f32_integer_decode | COMPLEXITY=3 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_f64_integer_decode | COMPLEXITY=3 | LINES=16
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_f16_consts | COMPLEXITY=4 | LINES=23
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_f32_consts | COMPLEXITY=3 | LINES=19
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_f64_consts | COMPLEXITY=3 | LINES=19
