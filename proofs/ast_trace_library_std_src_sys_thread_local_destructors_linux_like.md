# AST Trace: library/std/src/sys/thread_local/destructors/linux_like.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=c_int(#[allow(dead_code)] | COMPLEXITY=53 | LINES=70

```rust
// SRC: library/std/src/sys/thread_local/destructors/linux_like.rs
