# AST Trace: library/backtrace/src/symbolize/gimli/stash.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Stash | COMPLEXITY=6 | LINES=31

```rust
// SRC: library/backtrace/src/symbolize/gimli/stash.rs
