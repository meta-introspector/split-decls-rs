# AST Trace: library/compiler-builtins/compiler-builtins/src/int/leading_zeros.rs
...
```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/leading_zeros.rs
