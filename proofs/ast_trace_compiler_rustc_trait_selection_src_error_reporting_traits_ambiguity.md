# AST Trace: compiler/rustc_trait_selection/src/error_reporting/traits/ambiguity.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/error_reporting/traits/ambiguity.rs
