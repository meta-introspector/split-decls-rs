# AST Trace: compiler/rustc_macros/src/visitable.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=walk_ref | COMPLEXITY=62 | LINES=99

```rust
// SRC: compiler/rustc_macros/src/visitable.rs
