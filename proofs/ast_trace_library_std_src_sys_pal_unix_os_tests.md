# AST Trace: library/std/src/sys/pal/unix/os/tests.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_glibc_version | COMPLEXITY=3 | LINES=21

```rust
// SRC: library/std/src/sys/pal/unix/os/tests.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_parse_glibc_version | COMPLEXITY=5 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_confstr | COMPLEXITY=23 | LINES=25
