# AST Trace: library/stdarch/crates/stdarch-verify/tests/mips.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Function | COMPLEXITY=4 | LINES=35

```rust
// SRC: library/stdarch/crates/stdarch-verify/tests/mips.rs
