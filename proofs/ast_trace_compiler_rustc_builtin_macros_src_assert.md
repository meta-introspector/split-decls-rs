# AST Trace: compiler/rustc_builtin_macros/src/assert.rs
...
```rust
// SRC: compiler/rustc_builtin_macros/src/assert.rs
...
// MOD DECLARATION: context (from compiler/rustc_builtin_macros/src/assert.rs)
