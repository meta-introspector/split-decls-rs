# AST Trace: library/stdarch/crates/intrinsic-test/src/common/intrinsic_helpers.rs
...
```rust
// SRC: library/stdarch/crates/intrinsic-test/src/common/intrinsic_helpers.rs
