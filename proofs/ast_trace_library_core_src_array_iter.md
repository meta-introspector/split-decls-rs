# AST Trace: library/core/src/array/iter.rs
...
```rust
// SRC: library/core/src/array/iter.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=IntoIter | COMPLEXITY=3 | LINES=16

```rust
// MOD DECLARATION: iter_inner (from library/core/src/array/iter.rs)
// REPLACED: mod iter_inner; -> use crate::iter_inner::*;
use crate::iter_inner::*;
