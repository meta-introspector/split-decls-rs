# AST Trace: compiler/rustc_next_trait_solver/src/solve/normalizes_to/free_alias.rs
...
```rust
// SRC: compiler/rustc_next_trait_solver/src/solve/normalizes_to/free_alias.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=33
