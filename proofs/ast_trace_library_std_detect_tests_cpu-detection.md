# AST Trace: library/std_detect/tests/cpu-detection.rs

Generated 11 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=all | COMPLEXITY=11 | LINES=64

```rust
// SRC: library/std_detect/tests/cpu-detection.rs
