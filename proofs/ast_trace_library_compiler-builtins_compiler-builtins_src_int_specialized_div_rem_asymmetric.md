# AST Trace: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/asymmetric.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=$fn | COMPLEXITY=58 | LINES=84

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/int/specialized_div_rem/asymmetric.rs
