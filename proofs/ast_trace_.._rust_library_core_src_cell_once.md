# AST Trace: ../rust/library/core/src/cell/once.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=4 | LINES=28
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=OnceCell | COMPLEXITY=2 | LINES=8
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=get | COMPLEXITY=97 | LINES=311
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=default | COMPLEXITY=5 | LINES=8
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=clone | COMPLEXITY=12 | LINES=15
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=eq | COMPLEXITY=5 | LINES=8
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=from | COMPLEXITY=6 | LINES=10
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=6 | LINES=4
