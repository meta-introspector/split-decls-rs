# AST Trace: ../rust/library/alloctests/tests/collections/binary_heap.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=test_iterator | COMPLEXITY=5 | LINES=12
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=test_iter_rev_cloned_collect | COMPLEXITY=2 | LINES=10
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=test_into_iter_collect | COMPLEXITY=2 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_into_iter_size_hint | COMPLEXITY=2 | LINES=17
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=test_into_iter_rev_collect | COMPLEXITY=2 | LINES=10
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=test_into_iter_sorted_collect | COMPLEXITY=2 | LINES=8
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=test_drain_sorted_collect | COMPLEXITY=2 | LINES=8
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=check_exact_size_iterator | COMPLEXITY=5 | LINES=14
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=test_exact_size_iterator | COMPLEXITY=2 | LINES=10
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=check_trusted_len | COMPLEXITY=8 | LINES=12
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=test_trusted_len | COMPLEXITY=2 | LINES=7
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=test_peek_and_pop | COMPLEXITY=5 | LINES=12
...
## Block 15
**Metadata**: AST_ID=15 | TYPE=FUNCTION | NAME=test_peek_mut | COMPLEXITY=3 | LINES=12
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=test_peek_mut_leek | COMPLEXITY=6 | LINES=18
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=test_peek_mut_pop | COMPLEXITY=3 | LINES=13
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=test_push | COMPLEXITY=3 | LINES=22
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=test_push_unique | COMPLEXITY=3 | LINES=22
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=check_to_vec | COMPLEXITY=2 | LINES=10
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=test_to_vec | COMPLEXITY=3 | LINES=17
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=test_in_place_iterator_specialization | COMPLEXITY=2 | LINES=12
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=test_empty_pop | COMPLEXITY=2 | LINES=6
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=test_empty_peek | COMPLEXITY=2 | LINES=6
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=test_empty_peek_mut | COMPLEXITY=2 | LINES=6
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=test_from_iter | COMPLEXITY=5 | LINES=11
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=test_drain | COMPLEXITY=2 | LINES=9
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=test_drain_sorted | COMPLEXITY=2 | LINES=9
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=test_drain_sorted_leak | COMPLEXITY=3 | LINES=29
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=test_drain_forget | COMPLEXITY=6 | LINES=27
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=test_drain_sorted_forget | COMPLEXITY=6 | LINES=26
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=FUNCTION | NAME=test_extend_ref | COMPLEXITY=2 | LINES=25
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=test_append | COMPLEXITY=2 | LINES=11
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=test_append_to_empty | COMPLEXITY=2 | LINES=11
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=test_extend_specialization | COMPLEXITY=2 | LINES=10
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=assert_covariance | COMPLEXITY=3 | LINES=7
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=test_retain | COMPLEXITY=2 | LINES=21
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=test_retain_catch_unwind | COMPLEXITY=10 | LINES=20
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=panic_safe | COMPLEXITY=36 | LINES=83
