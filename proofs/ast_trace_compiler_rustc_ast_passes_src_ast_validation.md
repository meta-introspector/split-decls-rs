# AST Trace: compiler/rustc_ast_passes/src/ast_validation.rs

Generated 20 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=29

```rust
// SRC: compiler/rustc_ast_passes/src/ast_validation.rs
