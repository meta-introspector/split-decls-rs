# AST Trace: library/coretests/tests/iter/adapters/peekable.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_iterator_peekable | COMPLEXITY=7 | LINES=77

```rust
// SRC: library/coretests/tests/iter/adapters/peekable.rs
