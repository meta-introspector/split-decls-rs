# AST Trace: compiler/rustc_hir/src/attrs/encode_cross_crate.rs
...
```rust
// SRC: compiler/rustc_hir/src/attrs/encode_cross_crate.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=encode_cross_crate | COMPLEXITY=58 | LINES=97
