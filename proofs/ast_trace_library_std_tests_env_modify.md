# AST Trace: library/std/tests/env_modify.rs
...
```rust
// SRC: library/std/tests/env_modify.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=make_rand_name | COMPLEXITY=3 | LINES=15

```rust
// MOD DECLARATION: common (from library/std/tests/env_modify.rs)
