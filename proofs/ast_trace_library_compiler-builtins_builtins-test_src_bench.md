# AST Trace: library/compiler-builtins/builtins-test/src/bench.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=skip_sys_checks | COMPLEXITY=19 | LINES=70

```rust
// SRC: library/compiler-builtins/builtins-test/src/bench.rs
