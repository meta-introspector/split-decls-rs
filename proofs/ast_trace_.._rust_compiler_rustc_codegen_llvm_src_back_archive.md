# AST Trace: ../rust/compiler/rustc_codegen_llvm/src/back/archive.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=get_llvm_object_symbols | COMPLEXITY=62 | LINES=59
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=llvm_is_64_bit_object_file | COMPLEXITY=7 | LINES=4
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=llvm_is_ec_object_file | COMPLEXITY=7 | LINES=4
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=llvm_is_any_arm64_coff | COMPLEXITY=7 | LINES=4
