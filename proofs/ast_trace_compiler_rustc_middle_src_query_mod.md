# AST Trace: compiler/rustc_middle/src/query/mod.rs

Generated 31 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=15 | LINES=45

```rust
// SRC: compiler/rustc_middle/src/query/mod.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=8 | LINES=2
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=27 | LINES=44
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=5
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=8
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=1785 | LINES=2578
...
rustc_queries! {
    ...
    /// of crate::rustc_middle::hir::source_map.
    ...
    query hir_crate_items(_: ()) -> &'tcx crate::rustc_middle::hir::ModuleItems {
        arena_cache
        eval_always
    ...
    query hir_module_items(key: LocalModDefId) -> &'tcx crate::rustc_middle::hir::ModuleItems {
        arena_cache
    ...
    ///
    /// [alias type]: crate::rustc_middle::ty::AliasTy
    ...
    ///
    /// [free]: crate::rustc_middle::ty::Free
    /// [alias type]: crate::rustc_middle::ty::AliasTy
    ...
    query unsizing_params_for_adt(key: DefId) -> &'tcx crate::rustc_index::bit_set::DenseBitSet<u32>
    {
        arena_cache
        desc { |tcx|
    ...
    query shallow_lint_levels_on(key: hir::OwnerId) -> &'tcx crate::rustc_middle::lint::ShallowLintLevelMap {
        arena_cache
    ...
    query expn_that_defined(key: DefId) -> crate::rustc_span::ExpnId {
    ...
    query representability(_: LocalDefId) -> crate::rustc_middle::ty::Representability {
    ...
    query representability_adt_ty(_: Ty<'tcx>) -> crate::rustc_middle::ty::Representability {
    ...
    query params_in_repr(key: DefId) -> &'tcx crate::rustc_index::bit_set::DenseBitSet<u32> {
    ...
    /// constructors.
    query mir_keys(_: ()) -> &'tcx crate::rustc_data_structures::fx::FxIndexSet<LocalDefId> {
        arena_cache
    ...
    query explicit_supertraits_containing_assoc_item(
        key: (DefId, crate::rustc_span::Ident)
    ...
    query type_param_predicates(
        key: (LocalDefId, LocalDefId, crate::rustc_span::Ident)
    ) -> ty::EarlyBinder<'tcx, &'tcx [(ty::Clause<'tcx>, Span)]> {
    ...
    query fn_arg_idents(def_id: DefId) -> &'tcx [Option<crate::rustc_span::Ident>] {
    ...
    query all_local_trait_impls(_: ()) -> &'tcx crate::rustc_data_structures::fx::FxIndexMap<DefId, Vec<LocalDefId>> {
    ...
    ) -> Result<&'tcx crate::rustc_target::callconv::FnAbi<'tcx, Ty<'tcx>>, &'tcx ty::layout::FnAbiError<'tcx>> {
    ...
    // The macro which defines `crate::rustc_metadata::provide_extern` depends on this query's name.
    ...
    query intrinsic_raw(def_id: DefId) -> Option<crate::rustc_middle::ty::IntrinsicDef> {
    ...
    query all_diagnostic_items(_: ()) -> &'tcx crate::rustc_hir::diagnostic_items::DiagnosticItems {
        arena_cache
        eval_always
    ...
    query diagnostic_items(_: CrateNum) -> &'tcx crate::rustc_hir::diagnostic_items::DiagnosticItems {
        arena_cache
    ...
    /// See the [provider docs](`crate::rustc_middle::ty::print::trimmed_def_paths`) for more info.
    ...
    query rust_target_features(_: CrateNum) -> &'tcx UnordMap<String, crate::rustc_target::target_features::Stability> {
        arena_cache
        eval_always
    ...
    query features_query(_: ()) -> &'tcx crate::rustc_feature::Features {
        feedable
        desc { "looking up enabled feature gates" }
    }

    query crate_for_resolver((): ()) -> &'tcx Steal<(crate::rustc_ast::Crate, crate::rustc_ast::AttrVec)> {
        feedable
        no_hash
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=FUNCTION | NAME=describe_as_module | COMPLEXITY=7 | LINES=9
