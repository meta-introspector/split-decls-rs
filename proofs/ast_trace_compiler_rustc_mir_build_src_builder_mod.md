# AST Trace: compiler/rustc_mir_build/src/builder/mod.rs
...
```rust
// SRC: compiler/rustc_mir_build/src/builder/mod.rs
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=3 | LINES=32
...
// MOD DECLARATION: block (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod block; -> use crate::block::*;
use crate::block::*;
// MOD DECLARATION: cfg (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod cfg; -> use crate::cfg::*;
use crate::cfg::*;
// MOD DECLARATION: coverageinfo (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod coverageinfo; -> use crate::coverageinfo::*;
use crate::coverageinfo::*;
// MOD DECLARATION: custom (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod custom; -> use crate::custom::*;
use crate::custom::*;
// MOD DECLARATION: expr (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod expr; -> use crate::expr::*;
use crate::expr::*;
// MOD DECLARATION: matches (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod matches; -> use crate::matches::*;
use crate::matches::*;
// MOD DECLARATION: misc (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod misc; -> use crate::misc::*;
use crate::misc::*;
// MOD DECLARATION: scope (from compiler/rustc_mir_build/src/builder/mod.rs)
// REPLACED: mod scope; -> use crate::scope::*;
use crate::scope::*;
