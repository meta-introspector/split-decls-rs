# AST Trace: compiler/rustc_traits/src/coroutine_witnesses.rs
...
```rust
// SRC: compiler/rustc_traits/src/coroutine_witnesses.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=9 | LINES=37
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=compute_assumptions | COMPLEXITY=8 | LINES=46
