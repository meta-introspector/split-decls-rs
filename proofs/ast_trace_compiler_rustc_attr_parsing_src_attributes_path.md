# AST Trace: compiler/rustc_attr_parsing/src/attributes/path.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=convert | COMPLEXITY=10 | LINES=45

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/path.rs
