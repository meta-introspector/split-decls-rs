# AST Trace: library/coretests/tests/fmt/num.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_format_int_zero | COMPLEXITY=21 | LINES=40

```rust
// SRC: library/coretests/tests/fmt/num.rs
