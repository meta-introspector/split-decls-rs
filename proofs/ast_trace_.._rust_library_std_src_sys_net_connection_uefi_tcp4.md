# AST Trace: ../rust/library/std/src/sys/net/connection/uefi/tcp4.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=wait_for_flag | COMPLEXITY=187 | LINES=243
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=7 | LINES=5
