# AST Trace: library/compiler-builtins/crates/libm-macros/src/shared.rs

Generated 35 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=NestedOp | COMPLEXITY=4 | LINES=27

```rust
// SRC: library/compiler-builtins/crates/libm-macros/src/shared.rs
