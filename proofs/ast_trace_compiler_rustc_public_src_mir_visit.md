# AST Trace: compiler/rustc_public/src/mir/visit.rs

Generated 13 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=11 | LINES=56

```rust
// SRC: compiler/rustc_public/src/mir/visit.rs
