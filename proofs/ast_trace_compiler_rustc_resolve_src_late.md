# AST Trace: compiler/rustc_resolve/src/late.rs
...
```rust
// SRC: compiler/rustc_resolve/src/late.rs
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=2 | LINES=8

```rust
// MOD DECLARATION: diagnostics (from compiler/rustc_resolve/src/late.rs)
