# AST Trace: library/std/src/sys/sync/rwlock/queue.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=32 | LINES=135

```rust
// SRC: library/std/src/sys/sync/rwlock/queue.rs
