# AST Trace: library/unwind/src/wasm.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=6 | LINES=33

```rust
// SRC: library/unwind/src/wasm.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=_Unwind_Exception | COMPLEXITY=2 | LINES=13
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=14 | LINES=9
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=17 | LINES=25
