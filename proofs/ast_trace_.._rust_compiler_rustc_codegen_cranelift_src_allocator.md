# AST Trace: ../rust/compiler/rustc_codegen_cranelift/src/allocator.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=4 | LINES=18
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=codegen_inner | COMPLEXITY=36 | LINES=117
