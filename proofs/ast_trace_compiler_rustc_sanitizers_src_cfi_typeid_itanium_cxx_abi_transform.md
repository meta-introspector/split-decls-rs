# AST Trace: compiler/rustc_sanitizers/src/cfi/typeid/itanium_cxx_abi/transform.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=30

```rust
// SRC: compiler/rustc_sanitizers/src/cfi/typeid/itanium_cxx_abi/transform.rs
