# AST Trace: ../rust/library/alloctests/tests/sort/tests.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=check_is_sorted | COMPLEXITY=33 | LINES=61
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=test_is_sorted | COMPLEXITY=2 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=get_val | COMPLEXITY=2 | LINES=4
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=DynValA | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=STRUCT | NAME=DynValB | COMPLEXITY=2 | LINES=5
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=get_val | COMPLEXITY=5 | LINES=6
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=get_val | COMPLEXITY=5 | LINES=6
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=partial_cmp | COMPLEXITY=5 | LINES=6
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=cmp | COMPLEXITY=5 | LINES=6
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=FUNCTION | NAME=eq | COMPLEXITY=5 | LINES=6
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=shift_i32_to_u32 | COMPLEXITY=2 | LINES=4
...
## Block 17
**Metadata**: AST_ID=17 | TYPE=FUNCTION | NAME=reverse_shift_i32_to_u32 | COMPLEXITY=2 | LINES=4
...
## Block 18
**Metadata**: AST_ID=18 | TYPE=FUNCTION | NAME=extend_i32_to_u64 | COMPLEXITY=4 | LINES=6
...
## Block 19
**Metadata**: AST_ID=19 | TYPE=FUNCTION | NAME=extend_i32_to_u128 | COMPLEXITY=4 | LINES=6
...
## Block 20
**Metadata**: AST_ID=20 | TYPE=FUNCTION | NAME=dyn_trait_from_i32 | COMPLEXITY=8 | LINES=8
...
## Block 21
**Metadata**: AST_ID=21 | TYPE=FUNCTION | NAME=i32_from_i32 | COMPLEXITY=2 | LINES=4
...
## Block 22
**Metadata**: AST_ID=22 | TYPE=FUNCTION | NAME=i32_from_i32_ref | COMPLEXITY=2 | LINES=4
...
## Block 23
**Metadata**: AST_ID=23 | TYPE=FUNCTION | NAME=string_from_i32 | COMPLEXITY=3 | LINES=4
...
## Block 24
**Metadata**: AST_ID=24 | TYPE=FUNCTION | NAME=i32_from_string | COMPLEXITY=2 | LINES=4
...
## Block 25
**Metadata**: AST_ID=25 | TYPE=FUNCTION | NAME=cell_i32_from_i32 | COMPLEXITY=2 | LINES=4
...
## Block 26
**Metadata**: AST_ID=26 | TYPE=FUNCTION | NAME=i32_from_cell_i32 | COMPLEXITY=2 | LINES=4
...
## Block 27
**Metadata**: AST_ID=27 | TYPE=FUNCTION | NAME=calc_comps_required | COMPLEXITY=3 | LINES=12
...
## Block 28
**Metadata**: AST_ID=28 | TYPE=STRUCT | NAME=CompCount | COMPLEXITY=2 | LINES=7
...
## Block 29
**Metadata**: AST_ID=29 | TYPE=FUNCTION | NAME=new | COMPLEXITY=4 | LINES=6
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=15 | LINES=16
...
## Block 31
**Metadata**: AST_ID=31 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=12 | LINES=31
...
## Block 32
**Metadata**: AST_ID=32 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=15 | LINES=32
...
## Block 33
**Metadata**: AST_ID=33 | TYPE=FUNCTION | NAME=basic_impl | COMPLEXITY=3 | LINES=17
...
## Block 34
**Metadata**: AST_ID=34 | TYPE=FUNCTION | NAME=fixed_seed_impl | COMPLEXITY=2 | LINES=7
...
## Block 35
**Metadata**: AST_ID=35 | TYPE=FUNCTION | NAME=fixed_seed_rand_vec_prefix_impl | COMPLEXITY=2 | LINES=7
...
## Block 36
**Metadata**: AST_ID=36 | TYPE=FUNCTION | NAME=int_edge_impl | COMPLEXITY=4 | LINES=37
...
## Block 37
**Metadata**: AST_ID=37 | TYPE=FUNCTION | NAME=sort_vs_sort_by_impl | COMPLEXITY=2 | LINES=14
...
## Block 38
**Metadata**: AST_ID=38 | TYPE=FUNCTION | NAME=stability_legacy_impl | COMPLEXITY=37 | LINES=150
...
## Block 39
**Metadata**: AST_ID=39 | TYPE=FUNCTION | NAME=stability_with_patterns | COMPLEXITY=8 | LINES=42
...
## Block 40
**Metadata**: AST_ID=40 | TYPE=FUNCTION | NAME=observable_is_less | COMPLEXITY=7 | LINES=28
...
## Block 41
**Metadata**: AST_ID=41 | TYPE=FUNCTION | NAME=panic_retain_orig_set | COMPLEXITY=10 | LINES=46
...
## Block 42
**Metadata**: AST_ID=42 | TYPE=FUNCTION | NAME=panic_observable_is_less | COMPLEXITY=15 | LINES=54
...
## Block 43
**Metadata**: AST_ID=43 | TYPE=FUNCTION | NAME=deterministic | COMPLEXITY=8 | LINES=42
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=self_cmp | COMPLEXITY=11 | LINES=27
...
## Block 45
**Metadata**: AST_ID=45 | TYPE=FUNCTION | NAME=violate_ord_retain_orig_set | COMPLEXITY=71 | LINES=162
...
## Block 46
**Metadata**: AST_ID=46 | TYPE=FUNCTION | NAME=$test_fn_name | COMPLEXITY=12 | LINES=22
...
## Block 47
**Metadata**: AST_ID=47 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=20 | LINES=22
...
## Block 48
**Metadata**: AST_ID=48 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=32 | LINES=230
...
## Block 49
**Metadata**: AST_ID=49 | TYPE=FUNCTION | NAME=SortImpl | COMPLEXITY=10 | LINES=26
...
## Block 50
**Metadata**: AST_ID=50 | TYPE=FUNCTION | NAME=SortImpl | COMPLEXITY=10 | LINES=26
