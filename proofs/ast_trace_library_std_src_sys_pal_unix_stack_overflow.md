# AST Trace: library/std/src/sys/pal/unix/stack_overflow.rs
...
```rust
// SRC: library/std/src/sys/pal/unix/stack_overflow.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=sigstack_size | COMPLEXITY=403 | LINES=582
...
// MOD DECLARATION: thread_info (from library/std/src/sys/pal/unix/stack_overflow.rs)
// REPLACED: mod thread_info; -> use crate::thread_info::*;
