# AST Trace: library/portable-simd/crates/test_helpers/src/subnormals.rs

Generated 11 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=flush | COMPLEXITY=5 | LINES=22

```rust
// SRC: library/portable-simd/crates/test_helpers/src/subnormals.rs
