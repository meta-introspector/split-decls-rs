# AST Trace: compiler/rustc_pattern_analysis/tests/complexity.rs

Generated 10 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=check | COMPLEXITY=9 | LINES=38

```rust
// SRC: compiler/rustc_pattern_analysis/tests/complexity.rs
...
#[macro_use]
// MOD DECLARATION: common (from compiler/rustc_pattern_analysis/tests/complexity.rs)
