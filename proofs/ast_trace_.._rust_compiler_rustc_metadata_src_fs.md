# AST Trace: ../rust/compiler/rustc_metadata/src/fs.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=emit_wrapper_file | COMPLEXITY=11 | LINES=19
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=encode_and_write_metadata | COMPLEXITY=58 | LINES=78
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=non_durable_rename | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=non_durable_rename | COMPLEXITY=9 | LINES=13
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=copy_to_stdout | COMPLEXITY=2 | LINES=7
