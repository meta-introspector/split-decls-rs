# AST Trace: library/stdarch/crates/intrinsic-test/src/common/argument.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Argument | COMPLEXITY=7 | LINES=34

```rust
// SRC: library/stdarch/crates/intrinsic-test/src/common/argument.rs
