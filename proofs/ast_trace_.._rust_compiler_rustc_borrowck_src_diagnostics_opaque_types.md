# AST Trace: ../rust/compiler/rustc_borrowck/src/diagnostics/opaque_types.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=99 | LINES=195
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=FindOpaqueRegion | COMPLEXITY=4 | LINES=7
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=visit_ty | COMPLEXITY=36 | LINES=50
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=CheckExplicitRegionMentionAndCollectGenerics | COMPLEXITY=2 | LINES=8
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=visit_ty | COMPLEXITY=28 | LINES=36
