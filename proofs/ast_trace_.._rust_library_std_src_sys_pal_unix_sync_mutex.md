# AST Trace: ../rust/library/std/src/sys/pal/unix/sync/mutex.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Mutex | COMPLEXITY=2 | LINES=9
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=68 | LINES=90
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=17 | LINES=20
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=AttrGuard | COMPLEXITY=10 | LINES=11
