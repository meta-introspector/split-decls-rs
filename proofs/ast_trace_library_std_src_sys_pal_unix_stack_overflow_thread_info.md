# AST Trace: library/std/src/sys/pal/unix/stack_overflow/thread_info.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=11 | LINES=48

```rust
// SRC: library/std/src/sys/pal/unix/stack_overflow/thread_info.rs
