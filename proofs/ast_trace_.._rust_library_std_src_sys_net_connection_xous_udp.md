# AST Trace: ../rust/library/std/src/sys/net/connection/xous/udp.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=UdpSocket | COMPLEXITY=2 | LINES=13
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=bind | COMPLEXITY=227 | LINES=411
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=7 | LINES=6
