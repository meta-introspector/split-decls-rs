# AST Trace: ../rust/library/compiler-builtins/builtins-test/tests/cmp.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=cmp_f16 | COMPLEXITY=49 | LINES=150
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cmp_f32 | COMPLEXITY=30 | LINES=55
