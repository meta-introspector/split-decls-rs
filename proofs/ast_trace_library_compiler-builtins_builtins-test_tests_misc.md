# AST Trace: library/compiler-builtins/builtins-test/tests/misc.rs

Generated 4 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=fuzz_values | COMPLEXITY=10 | LINES=81

```rust
// SRC: library/compiler-builtins/builtins-test/tests/misc.rs
