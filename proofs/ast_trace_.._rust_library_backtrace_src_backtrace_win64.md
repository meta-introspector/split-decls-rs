# AST Trace: ../rust/library/backtrace/src/backtrace/win64.rs

Generated 7 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Frame | COMPLEXITY=5 | LINES=19
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=8 | LINES=4
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=ip | COMPLEXITY=7 | LINES=23
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=MyContext(CONTEXT); | COMPLEXITY=4 | LINES=16
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=ip | COMPLEXITY=4 | LINES=13
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=49 | LINES=75
