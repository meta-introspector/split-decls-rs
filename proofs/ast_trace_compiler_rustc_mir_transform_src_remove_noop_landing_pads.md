# AST Trace: compiler/rustc_mir_transform/src/remove_noop_landing_pads.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=is_enabled | COMPLEXITY=45 | LINES=96

```rust
// SRC: compiler/rustc_mir_transform/src/remove_noop_landing_pads.rs
