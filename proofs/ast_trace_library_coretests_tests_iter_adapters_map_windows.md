# AST Trace: library/coretests/tests/iter/adapters/map_windows.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=DropInfo | COMPLEXITY=43 | LINES=163

```rust
// SRC: library/coretests/tests/iter/adapters/map_windows.rs
