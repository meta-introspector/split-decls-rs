# AST Trace: ../rust/compiler/rustc_mir_transform/src/elaborate_drops.rs
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=13 | LINES=29
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=18 | LINES=49
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=compute_dead_unwinds | COMPLEXITY=12 | LINES=26
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=STRUCT | NAME=InitializationData | COMPLEXITY=2 | LINES=5
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=seek_before | COMPLEXITY=4 | LINES=11
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=patch_ref | COMPLEXITY=63 | LINES=106
...
impl<'a, 'tcx> DropElaborator<'a, 'tcx> for ElaborateDropsCtxt<'a, 'tcx> {
    ...
    fn field_subpath(&self, path: Self::Path, field: FieldIdx) -> Option<Self::Path> {
        crate::rustc_mir_dataflow::move_path_children_matching(self.move_data(), path, |e| match e {
    ...
    fn deref_subpath(&self, path: Self::Path) -> Option<Self::Path> {
        crate::rustc_mir_dataflow::move_path_children_matching(self.move_data(), path, |e| {
...
## Block 14
**Metadata**: AST_ID=14 | TYPE=STRUCT | NAME=ElaborateDropsCtxt | COMPLEXITY=2 | LINES=9
...
## Block 16
**Metadata**: AST_ID=16 | TYPE=FUNCTION | NAME=move_data | COMPLEXITY=144 | LINES=261
...
impl<'a, 'tcx> ElaborateDropsCtxt<'a, 'tcx> {
    ...
    fn drop_flags_for_args(&mut self) {
        let loc = Location::START;
        crate::rustc_mir_dataflow::drop_flag_effects_for_function_entry(
            self.body,
            &self.env.move_data,
            |path, ds| {
    ...
    fn drop_flags_for_locs(&mut self) {
        ...
        for (bb, data) in self.body.basic_blocks.iter_enumerated() {
            ...
            for i in 0..(data.statements.len() + 1) {
                ...
                crate::rustc_mir_dataflow::drop_flag_effects_for_location(
                    self.body,
                    &self.env.move_data,
                    loc,
