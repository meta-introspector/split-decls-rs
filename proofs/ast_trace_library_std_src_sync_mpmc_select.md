# AST Trace: library/std/src/sync/mpmc/select.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Token | COMPLEXITY=4 | LINES=26

```rust
// SRC: library/std/src/sync/mpmc/select.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=Operation(usize); | COMPLEXITY=7 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=4 | LINES=16
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=from | COMPLEXITY=9 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=into | COMPLEXITY=9 | LINES=12
