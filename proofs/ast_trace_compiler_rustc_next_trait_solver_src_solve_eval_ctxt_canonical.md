# AST Trace: compiler/rustc_next_trait_solver/src/solve/eval_ctxt/canonical.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=7 | LINES=38

```rust
// SRC: compiler/rustc_next_trait_solver/src/solve/eval_ctxt/canonical.rs
