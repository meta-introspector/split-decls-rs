# AST Trace: library/stdarch/crates/stdarch-test/src/wasm.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=33 | LINES=72

```rust
// SRC: library/stdarch/crates/stdarch-test/src/wasm.rs
