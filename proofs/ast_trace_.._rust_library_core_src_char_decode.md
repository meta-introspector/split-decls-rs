# AST Trace: ../rust/library/core/src/char/decode.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=DecodeUtf16 | COMPLEXITY=5 | LINES=21
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=DecodeUtf16Error | COMPLEXITY=2 | LINES=9
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=7
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=next | COMPLEXITY=50 | LINES=70
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=unpaired_surrogate | COMPLEXITY=3 | LINES=9
