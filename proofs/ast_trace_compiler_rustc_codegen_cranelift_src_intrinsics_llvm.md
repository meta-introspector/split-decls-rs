# AST Trace: compiler/rustc_codegen_cranelift/src/intrinsics/llvm.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=41 | LINES=107

```rust
// SRC: compiler/rustc_codegen_cranelift/src/intrinsics/llvm.rs
