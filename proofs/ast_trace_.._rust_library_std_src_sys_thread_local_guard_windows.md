# AST Trace: ../rust/library/std/src/sys/thread_local/guard/windows.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=27 | LINES=74
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=enable | COMPLEXITY=13 | LINES=12
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=21 | LINES=17
