# AST Trace: ../rust/library/test/src/time.rs
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=26 | LINES=44
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=TestExecTime(pub | COMPLEXITY=6 | LINES=10
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=6 | LINES=10
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=TimeThreshold | COMPLEXITY=4 | LINES=7
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=new | COMPLEXITY=25 | LINES=41
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=TestTimeOptions | COMPLEXITY=6 | LINES=11
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=new_from_env | COMPLEXITY=23 | LINES=54
