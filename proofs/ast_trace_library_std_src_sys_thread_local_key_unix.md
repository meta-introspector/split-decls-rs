# AST Trace: library/std/src/sys/thread_local/key/unix.rs

Generated 5 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=pthread_key_create | COMPLEXITY=14 | LINES=38

```rust
// SRC: library/std/src/sys/thread_local/key/unix.rs
