# AST Trace: ../rust/library/std/src/sys/path/windows_prefix.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=PrefixParser | COMPLEXITY=2 | LINES=7
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=get_prefix | COMPLEXITY=15 | LINES=24
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=PrefixParserSlice | COMPLEXITY=2 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=strip_prefix | COMPLEXITY=12 | LINES=20
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=parse_prefix | COMPLEXITY=68 | LINES=122
