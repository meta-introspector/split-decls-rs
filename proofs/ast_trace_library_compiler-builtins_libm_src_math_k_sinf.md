# AST Trace: library/compiler-builtins/libm/src/math/k_sinf.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=6 | LINES=47

```rust
// SRC: library/compiler-builtins/libm/src/math/k_sinf.rs
