# AST Trace: ../rust/library/portable-simd/crates/core_simd/src/simd/num/float.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cast | COMPLEXITY=68 | LINES=233
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=cast | COMPLEXITY=154 | LINES=213
