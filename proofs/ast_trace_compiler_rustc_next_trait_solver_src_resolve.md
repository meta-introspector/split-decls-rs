# AST Trace: compiler/rustc_next_trait_solver/src/resolve.rs
...
```rust
// SRC: compiler/rustc_next_trait_solver/src/resolve.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=EagerResolver | COMPLEXITY=3 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=eager_resolve_vars | COMPLEXITY=6 | LINES=12
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=cx | COMPLEXITY=57 | LINES=68
