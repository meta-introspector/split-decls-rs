# AST Trace: compiler/rustc_public/src/unstable/internal_cx/mod.rs
...
```rust
// SRC: compiler/rustc_public/src/unstable/internal_cx/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=new_from_args | COMPLEXITY=5 | LINES=14
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=new_from_args | COMPLEXITY=5 | LINES=10
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=new_from_args | COMPLEXITY=5 | LINES=10
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=17 | LINES=53
