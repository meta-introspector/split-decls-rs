# AST Trace: library/std_detect/src/detect/os/freebsd/arm.rs
...
```rust
// SRC: library/std_detect/src/detect/os/freebsd/arm.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=11 | LINES=32
