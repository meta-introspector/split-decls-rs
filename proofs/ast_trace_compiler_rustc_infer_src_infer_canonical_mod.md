# AST Trace: compiler/rustc_infer/src/infer/canonical/mod.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=6 | LINES=44

```rust
// SRC: compiler/rustc_infer/src/infer/canonical/mod.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=instantiate_canonical | COMPLEXITY=48 | LINES=112

```rust
// MOD DECLARATION: canonicalizer (from compiler/rustc_infer/src/infer/canonical/mod.rs)
// REPLACED: mod canonicalizer; -> use crate::canonicalizer::*;
use crate::canonicalizer::*;
// MOD DECLARATION: instantiate (from compiler/rustc_infer/src/infer/canonical/mod.rs)
// REPLACED: mod instantiate; -> use crate::instantiate::*;
