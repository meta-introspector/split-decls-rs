# AST Trace: library/backtrace/src/symbolize/gimli/libs_aix.rs
...
```rust
// SRC: library/backtrace/src/symbolize/gimli/libs_aix.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=errno_location | COMPLEXITY=6 | LINES=8
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=42 | LINES=64
