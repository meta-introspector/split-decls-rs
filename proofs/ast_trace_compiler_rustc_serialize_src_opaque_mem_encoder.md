# AST Trace: compiler/rustc_serialize/src/opaque/mem_encoder.rs
...
```rust
// SRC: compiler/rustc_serialize/src/opaque/mem_encoder.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=STRUCT | NAME=MemEncoder | COMPLEXITY=2 | LINES=4
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=new | COMPLEXITY=39 | LINES=62
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=$this_fn | COMPLEXITY=9 | LINES=9
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=emit_u16 | COMPLEXITY=9 | LINES=32
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=encode | COMPLEXITY=5 | LINES=9
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=encode | COMPLEXITY=5 | LINES=10
