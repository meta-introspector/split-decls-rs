# AST Trace: library/core/src/num/dec2flt/decimal.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Decimal | COMPLEXITY=4 | LINES=47

```rust
// SRC: library/core/src/num/dec2flt/decimal.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=can_use_fast_path | COMPLEXITY=31 | LINES=55
