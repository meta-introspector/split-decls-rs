# AST Trace: library/std/src/sys/pal/windows/stack_overflow.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=reserve_stack | COMPLEXITY=13 | LINES=27

```rust
// SRC: library/std/src/sys/pal/windows/stack_overflow.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=18 | LINES=17
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=init | COMPLEXITY=10 | LINES=12
