# AST Trace: library/core/src/iter/traits/accum.rs
...
```rust
// SRC: library/core/src/iter/traits/accum.rs
...
// SRC: library/core/src/iter/traits/accum.rs
// GENERATED BY: build.rs (split-decls-genesis)
// SRC: ../rust/library/core/src/iter/traits/accum.rs
use crate::iter;
use crate::num::{Saturating, Wrapping};
```

## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=sum | COMPLEXITY=7 | LINES=20
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=product | COMPLEXITY=8 | LINES=21
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=sum | COMPLEXITY=26 | LINES=56
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=sum | COMPLEXITY=26 | LINES=55
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=sum | COMPLEXITY=25 | LINES=48
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=sum | COMPLEXITY=15 | LINES=31
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=product | COMPLEXITY=11 | LINES=30
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=sum | COMPLEXITY=11 | LINES=30
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=product | COMPLEXITY=11 | LINES=30
