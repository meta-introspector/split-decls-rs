# AST Trace: ../rust/compiler/rustc_codegen_llvm/src/coverageinfo/mapgen.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=3 | LINES=21
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=to_u32 | COMPLEXITY=3 | LINES=6
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=34 | LINES=62
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=GlobalFileTable | COMPLEXITY=3 | LINES=19
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=build | COMPLEXITY=17 | LINES=51
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=VirtualFileMapping | COMPLEXITY=2 | LINES=7
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=push_file | COMPLEXITY=8 | LINES=21
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=generate_covmap_record | COMPLEXITY=9 | LINES=38
