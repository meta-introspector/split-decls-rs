# AST Trace: compiler/rustc_borrowck/src/polonius/legacy/loan_invalidations.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/polonius/legacy/loan_invalidations.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=visit_statement | COMPLEXITY=115 | LINES=180
