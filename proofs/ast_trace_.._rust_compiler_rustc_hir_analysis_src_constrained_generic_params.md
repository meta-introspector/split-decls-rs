# AST Trace: ../rust/compiler/rustc_hir_analysis/src/constrained_generic_params.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=from | COMPLEXITY=5 | LINES=11
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=from | COMPLEXITY=5 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=STRUCT | NAME=ParameterCollector | COMPLEXITY=2 | LINES=5
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=visit_ty | COMPLEXITY=32 | LINES=42
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=56 | LINES=118
