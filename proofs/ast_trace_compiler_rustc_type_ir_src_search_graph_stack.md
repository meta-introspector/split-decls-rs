# AST Trace: compiler/rustc_type_ir/src/search_graph/stack.rs
...
```rust
// SRC: compiler/rustc_type_ir/src/search_graph/stack.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=13 | LINES=44
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=11
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=21 | LINES=49
