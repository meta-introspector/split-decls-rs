# AST Trace: ../rust/library/std/src/sys/sync/thread_parking/windows7.rs

Generated 6 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=25 | LINES=63
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=Parker | COMPLEXITY=2 | LINES=5
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=unpark | COMPLEXITY=75 | LINES=113
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=keyed_event_handle | COMPLEXITY=74 | LINES=94
