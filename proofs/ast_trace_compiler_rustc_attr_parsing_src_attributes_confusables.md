# AST Trace: compiler/rustc_attr_parsing/src/attributes/confusables.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=4 | LINES=23

```rust
// SRC: compiler/rustc_attr_parsing/src/attributes/confusables.rs
