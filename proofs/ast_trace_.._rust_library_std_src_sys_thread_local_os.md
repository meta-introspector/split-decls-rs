# AST Trace: ../rust/library/std/src/sys/thread_local/os.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=__init | COMPLEXITY=25 | LINES=40
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=STRUCT | NAME=Storage | COMPLEXITY=2 | LINES=8
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=Value | COMPLEXITY=4 | LINES=6
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=get | COMPLEXITY=55 | LINES=65
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=27 | LINES=24
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=5 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=2 | LINES=4
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=get | COMPLEXITY=16 | LINES=14
