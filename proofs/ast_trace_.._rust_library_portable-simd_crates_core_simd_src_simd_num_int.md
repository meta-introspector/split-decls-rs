# AST Trace: ../rust/library/portable-simd/crates/core_simd/src/simd/num/int.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=cast | COMPLEXITY=43 | LINES=235
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=cast | COMPLEXITY=112 | LINES=169
