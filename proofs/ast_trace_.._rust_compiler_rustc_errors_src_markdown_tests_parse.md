# AST Trace: ../rust/compiler/rustc_errors/src/markdown/tests/parse.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=test_parse_simple | COMPLEXITY=2 | LINES=16
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=test_parse_comment | COMPLEXITY=49 | LINES=350
