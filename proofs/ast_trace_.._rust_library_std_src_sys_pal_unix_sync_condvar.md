# AST Trace: ../rust/library/std/src/sys/pal/unix/sync/condvar.rs

Generated 8 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=Condvar | COMPLEXITY=2 | LINES=13
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=new | COMPLEXITY=50 | LINES=72
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=AttrGuard | COMPLEXITY=23 | LINES=41
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=20 | LINES=28
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=IMPL | NAME=UNNAMED | COMPLEXITY=8 | LINES=2
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=drop | COMPLEXITY=17 | LINES=16
