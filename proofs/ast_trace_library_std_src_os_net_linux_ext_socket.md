# AST Trace: library/std/src/os/net/linux_ext/socket.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=passcred | COMPLEXITY=9 | LINES=59

```rust
// SRC: library/std/src/os/net/linux_ext/socket.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=passcred | COMPLEXITY=6 | LINES=11
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=passcred | COMPLEXITY=6 | LINES=11
