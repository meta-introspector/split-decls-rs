# AST Trace: compiler/rustc_type_ir/src/solve/inspect.rs

Generated 9 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=USE | NAME=UNNAMED | COMPLEXITY=9 | LINES=38

```rust
// SRC: compiler/rustc_type_ir/src/solve/inspect.rs
