# AST Trace: compiler/rustc_lint/src/multiple_supertrait_upcastable.rs
...
```rust
// SRC: compiler/rustc_lint/src/multiple_supertrait_upcastable.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=10 | LINES=29
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=check_item | COMPLEXITY=14 | LINES=28
