# AST Trace: compiler/rustc_ty_utils/src/layout.rs
...
```rust
// SRC: compiler/rustc_ty_utils/src/layout.rs
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=3 | LINES=5
