# AST Trace: compiler/rustc_mir_transform/src/add_call_guards.rs
...
```rust
// SRC: compiler/rustc_mir_transform/src/add_call_guards.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=58 | LINES=93
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=generates_invoke | COMPLEXITY=8 | LINES=8
