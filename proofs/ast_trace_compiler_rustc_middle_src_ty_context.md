# AST Trace: compiler/rustc_middle/src/ty/context.rs
...
```rust
// SRC: compiler/rustc_middle/src/ty/context.rs
...
## Block 74
**Metadata**: AST_ID=74 | TYPE=FUNCTION | NAME=create_def | COMPLEXITY=137 | LINES=317
