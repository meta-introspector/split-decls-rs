# AST Trace: library/compiler-builtins/compiler-builtins/src/arm.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=__udivmodsi4 | COMPLEXITY=8 | LINES=24

```rust
// SRC: library/compiler-builtins/compiler-builtins/src/arm.rs
