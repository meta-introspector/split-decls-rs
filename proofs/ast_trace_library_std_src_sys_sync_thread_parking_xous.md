# AST Trace: library/std/src/sys/sync/thread_parking/xous.rs
...
```rust
// SRC: library/std/src/sys/sync/thread_parking/xous.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=Parker | COMPLEXITY=2 | LINES=9
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=index | COMPLEXITY=43 | LINES=89
