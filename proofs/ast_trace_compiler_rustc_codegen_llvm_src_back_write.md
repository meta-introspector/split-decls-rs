# AST Trace: compiler/rustc_codegen_llvm/src/back/write.rs
...
```rust
// SRC: compiler/rustc_codegen_llvm/src/back/write.rs
...
## Block 30
**Metadata**: AST_ID=30 | TYPE=FUNCTION | NAME=write_bitcode_to_file | COMPLEXITY=7 | LINES=7
...
## Block 44
**Metadata**: AST_ID=44 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=113 | LINES=225
