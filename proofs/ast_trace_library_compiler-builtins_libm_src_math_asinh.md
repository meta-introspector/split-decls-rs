# AST Trace: library/compiler-builtins/libm/src/math/asinh.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/asinh.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=asinh | COMPLEXITY=20 | LINES=35
