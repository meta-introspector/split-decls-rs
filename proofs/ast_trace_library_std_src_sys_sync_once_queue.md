# AST Trace: library/std/src/sys/sync/once/queue.rs

Generated 15 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=UNNAMED | COMPLEXITY=22 | LINES=76

```rust
// SRC: library/std/src/sys/sync/once/queue.rs
