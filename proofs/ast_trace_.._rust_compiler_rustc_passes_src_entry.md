# AST Trace: ../rust/compiler/rustc_passes/src/entry.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=EntryContext | COMPLEXITY=2 | LINES=11
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=entry_fn | COMPLEXITY=13 | LINES=21
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=FUNCTION | NAME=attr_span_by_symbol | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=check_and_search_item | COMPLEXITY=27 | LINES=39
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=configure_main | COMPLEXITY=16 | LINES=24
...
## Block 11
**Metadata**: AST_ID=11 | TYPE=FUNCTION | NAME=sigpipe | COMPLEXITY=6 | LINES=9
...
## Block 12
**Metadata**: AST_ID=12 | TYPE=FUNCTION | NAME=no_main_err | COMPLEXITY=6 | LINES=33
...
## Block 13
**Metadata**: AST_ID=13 | TYPE=FUNCTION | NAME=provide | COMPLEXITY=3 | LINES=4
