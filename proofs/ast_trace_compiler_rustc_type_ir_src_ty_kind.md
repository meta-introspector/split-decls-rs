# AST Trace: compiler/rustc_type_ir/src/ty_kind.rs
...
```rust
// SRC: compiler/rustc_type_ir/src/ty_kind.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=3 | LINES=18

```rust
// MOD DECLARATION: closure (from compiler/rustc_type_ir/src/ty_kind.rs)
