# AST Trace: compiler/rustc_trait_selection/src/solve/fulfill.rs
...
```rust
// SRC: compiler/rustc_trait_selection/src/solve/fulfill.rs
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=STRUCT | NAME=FulfillmentCtxt | COMPLEXITY=6 | LINES=27
