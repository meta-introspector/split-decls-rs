# AST Trace: library/std/src/sys/args/uefi.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=args | COMPLEXITY=28 | LINES=49

```rust
// SRC: library/std/src/sys/args/uefi.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=parse_lp_cmd_line | COMPLEXITY=51 | LINES=86
