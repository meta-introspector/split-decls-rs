# AST Trace: ../rust/library/std/src/sys/process/unix/fuchsia.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=spawn | COMPLEXITY=56 | LINES=126
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=FUNCTION | NAME=id | COMPLEXITY=45 | LINES=84
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=ExitStatus(i64); | COMPLEXITY=23 | LINES=65
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=ExitStatusError(NonZero | COMPLEXITY=5 | LINES=9
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=code | COMPLEXITY=3 | LINES=7
