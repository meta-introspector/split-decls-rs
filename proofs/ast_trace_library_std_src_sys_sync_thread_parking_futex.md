# AST Trace: library/std/src/sys/sync/thread_parking/futex.rs
...
```rust
// SRC: library/std/src/sys/sync/thread_parking/futex.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=STRUCT | NAME=Parker | COMPLEXITY=2 | LINES=12
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=unpark | COMPLEXITY=65 | LINES=84
