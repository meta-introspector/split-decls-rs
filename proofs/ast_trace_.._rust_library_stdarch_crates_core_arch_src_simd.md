# AST Trace: ../rust/library/stdarch/crates/core_arch/src/simd.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=JustOne([$elem_type; | COMPLEXITY=48 | LINES=70
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=JustOne([$elem_type; | COMPLEXITY=39 | LINES=57
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=19 | LINES=894
