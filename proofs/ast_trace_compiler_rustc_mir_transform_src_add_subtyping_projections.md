# AST Trace: compiler/rustc_mir_transform/src/add_subtyping_projections.rs

Generated 3 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=SubTypeChecker | COMPLEXITY=4 | LINES=30

```rust
// SRC: compiler/rustc_mir_transform/src/add_subtyping_projections.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=tcx | COMPLEXITY=18 | LINES=34
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=run_pass | COMPLEXITY=11 | LINES=22
