# AST Trace: library/core/src/slice/sort/shared/pivot.rs
...
```rust
// SRC: library/core/src/slice/sort/shared/pivot.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=choose_pivot | COMPLEXITY=30 | LINES=42
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=18 | LINES=28
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=median3 | COMPLEXITY=11 | LINES=21
