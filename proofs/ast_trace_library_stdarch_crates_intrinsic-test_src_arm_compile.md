# AST Trace: library/stdarch/crates/intrinsic-test/src/arm/compile.rs
...
```rust
// SRC: library/stdarch/crates/intrinsic-test/src/arm/compile.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=build_cpp_compilation | COMPLEXITY=22 | LINES=49
