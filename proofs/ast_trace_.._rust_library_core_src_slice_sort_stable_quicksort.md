# AST Trace: ../rust/library/core/src/slice/sort/stable/quicksort.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=quicksort | COMPLEXITY=40 | LINES=71
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=stable_partition | COMPLEXITY=57 | LINES=101
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=PartitionState | COMPLEXITY=2 | LINES=12
...
## Block 6
**Metadata**: AST_ID=6 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=30 | LINES=41
...
## Block 7
**Metadata**: AST_ID=7 | TYPE=FUNCTION | NAME=is_freeze | COMPLEXITY=2 | LINES=4
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=is_freeze | COMPLEXITY=5 | LINES=5
...
## Block 10
**Metadata**: AST_ID=10 | TYPE=FUNCTION | NAME=has_direct_interior_mutability | COMPLEXITY=2 | LINES=8
