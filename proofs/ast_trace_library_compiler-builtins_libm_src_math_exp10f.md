# AST Trace: library/compiler-builtins/libm/src/math/exp10f.rs
...
```rust
// SRC: library/compiler-builtins/libm/src/math/exp10f.rs
...
## Block 2
**Metadata**: AST_ID=2 | TYPE=FUNCTION | NAME=exp10f | COMPLEXITY=9 | LINES=22
