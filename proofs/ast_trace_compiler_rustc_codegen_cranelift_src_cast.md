# AST Trace: compiler/rustc_codegen_cranelift/src/cast.rs

Generated 2 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=18 | LINES=46

```rust
// SRC: compiler/rustc_codegen_cranelift/src/cast.rs
