# AST Trace: ../rust/library/std/src/sys/pal/windows/pipe.rs
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=STRUCT | NAME=AnonPipe | COMPLEXITY=2 | LINES=8
...
## Block 8
**Metadata**: AST_ID=8 | TYPE=STRUCT | NAME=Pipes | COMPLEXITY=2 | LINES=5
...
## Block 9
**Metadata**: AST_ID=9 | TYPE=FUNCTION | NAME=anon_pipe | COMPLEXITY=337 | LINES=523
