# AST Trace: compiler/rustc_mir_build/src/builder/cfg.rs

Generated 1 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=42 | LINES=152

```rust
// SRC: compiler/rustc_mir_build/src/builder/cfg.rs
