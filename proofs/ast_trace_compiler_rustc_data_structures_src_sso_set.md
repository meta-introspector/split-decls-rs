# AST Trace: compiler/rustc_data_structures/src/sso/set.rs

Generated 11 AST blocks from source file

## Block 1
**Metadata**: AST_ID=1 | TYPE=STRUCT | NAME=SsoHashSet | COMPLEXITY=5 | LINES=44

```rust
// SRC: compiler/rustc_data_structures/src/sso/set.rs
