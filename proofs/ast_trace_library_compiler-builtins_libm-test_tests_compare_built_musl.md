# AST Trace: library/compiler-builtins/libm-test/tests/compare_built_musl.rs
...
```rust
// SRC: library/compiler-builtins/libm-test/tests/compare_built_musl.rs
...
## Block 3
**Metadata**: AST_ID=3 | TYPE=FUNCTION | NAME=musl_runner | COMPLEXITY=5 | LINES=15
...
## Block 4
**Metadata**: AST_ID=4 | TYPE=FUNCTION | NAME=[ | COMPLEXITY=16 | LINES=46
...
## Block 5
**Metadata**: AST_ID=5 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=3 | LINES=32
