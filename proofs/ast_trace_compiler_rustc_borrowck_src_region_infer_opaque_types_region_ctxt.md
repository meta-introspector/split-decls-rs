# AST Trace: compiler/rustc_borrowck/src/region_infer/opaque_types/region_ctxt.rs
...
```rust
// SRC: compiler/rustc_borrowck/src/region_infer/opaque_types/region_ctxt.rs
