...
include!("depcrate_generated__accountsdefines.rs");
...
include!("depcrate_generated__acaccounttype.rs");
...
include!("depcrate_generated__acaccountcredential.rs");
