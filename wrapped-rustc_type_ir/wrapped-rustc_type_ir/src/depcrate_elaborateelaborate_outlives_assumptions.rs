// Generated macro for elaborate_outlives_assumptions (function)
macro_rules! Depcrate_elaborateelaborate_outlives_assumptions {
() => {
// Module: crate::elaborate
// Provides: {"elaborate_outlives_assumptions"}
// Dependencies: {}
