...
#[doc = " PASETO public tokens with [`version4`], using [`claims::Claims`]."]
pub mod public {
    use super::*;
    ...
    #[doc = " Create a public token using the latest PASETO version (v4)."]
    pub fn sign(
    ...
    #[doc = " Verify a public token using the latest PASETO version (v4). If verification passes,"]
