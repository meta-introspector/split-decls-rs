// Generated macro for stable_order_of_exportable_impls (function)
macro_rules! Depcrate_check_exportstable_order_of_exportable_impls {
() => {
// Module: crate::check_export
// Provides: {"stable_order_of_exportable_impls"}
// Dependencies: {}
