// Generated macro for check_invalid_crate_level_attr (function)
macro_rules! Depcrate_check_attrcheck_invalid_crate_level_attr {
() => {
// Module: crate::check_attr
// Provides: {"check_invalid_crate_level_attr"}
// Dependencies: {}
