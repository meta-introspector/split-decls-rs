// Generated macro for has_allow_dead_code_or_lang_attr (function)
macro_rules! Depcrate_deadhas_allow_dead_code_or_lang_attr {
() => {
// Module: crate::dead
// Provides: {"has_allow_dead_code_or_lang_attr"}
// Dependencies: {}
