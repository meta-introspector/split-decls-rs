// Generated macro for UnnecessaryPartialStableFeature (struct)
macro_rules! Depcrate_errorsUnnecessaryPartialStableFeature {
() => {
// Module: crate::errors
// Provides: {"UnnecessaryPartialStableFeature"}
// Dependencies: {}
