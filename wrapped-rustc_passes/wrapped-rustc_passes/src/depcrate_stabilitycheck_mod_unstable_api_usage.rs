// Generated macro for check_mod_unstable_api_usage (function)
macro_rules! Depcrate_stabilitycheck_mod_unstable_api_usage {
() => {
// Module: crate::stability
// Provides: {"check_mod_unstable_api_usage"}
// Dependencies: {}
