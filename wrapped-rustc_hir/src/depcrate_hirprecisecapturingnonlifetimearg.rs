// Generated macro for PreciseCapturingNonLifetimeArg (struct)
macro_rules! Depcrate_hirPreciseCapturingNonLifetimeArg {
() => {
// Module: crate::hir
// Provides: {"PreciseCapturingNonLifetimeArg"}
// Dependencies: {}
