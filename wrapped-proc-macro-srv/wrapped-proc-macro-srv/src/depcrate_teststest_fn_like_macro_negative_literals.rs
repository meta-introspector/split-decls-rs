// Generated macro for test_fn_like_macro_negative_literals (function)
macro_rules! Depcrate_teststest_fn_like_macro_negative_literals {
() => {
// Module: crate::tests
// Provides: {"test_fn_like_macro_negative_literals"}
// Dependencies: {}
