// Generated macro for test_fn_like_macro_clone_ident_subtree (function)
macro_rules! Depcrate_teststest_fn_like_macro_clone_ident_subtree {
() => {
// Module: crate::tests
// Provides: {"test_fn_like_macro_clone_ident_subtree"}
// Dependencies: {}
