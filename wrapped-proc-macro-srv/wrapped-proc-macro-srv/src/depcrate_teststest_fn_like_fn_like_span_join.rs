// Generated macro for test_fn_like_fn_like_span_join (function)
macro_rules! Depcrate_teststest_fn_like_fn_like_span_join {
() => {
// Module: crate::tests
// Provides: {"test_fn_like_fn_like_span_join"}
// Dependencies: {}
