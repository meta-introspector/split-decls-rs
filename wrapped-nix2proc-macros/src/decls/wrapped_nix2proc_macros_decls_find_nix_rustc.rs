...
#[doc = " A procedural macro to find Rust compilers in the Nix store."]
#[doc = " It can optionally take a string literal as a filter."]
#[doc = " Returns a Vec<String> of paths."]
#[doc = ""]
#[doc = " Usage:"]
#[doc = " `let rustc_paths: Vec<String> = find_nix_rustc!();`"]
#[doc = " `let rustc_filtered_paths: Vec<String> = find_nix_rustc!(\"1.91\");`"]
#[proc_macro]
...
pub fn find_nix_rustc(input: TokenStream) -> TokenStream {
    ...
    let output = quote! { vec ! [# (# quoted_paths) ,*] };
    output.into()
}
