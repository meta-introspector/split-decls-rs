...
#[path = "src/dot_dot_rust_library_compiler_builtins_compiler_builtins_src_hexagon.rs"]
mod dot_dot_rust_library_compiler_builtins_compiler_builtins_src_hexagon;