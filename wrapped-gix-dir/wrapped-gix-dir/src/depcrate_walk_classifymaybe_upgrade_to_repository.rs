// Generated macro for maybe_upgrade_to_repository (function)
macro_rules! Depcrate_walk_classifymaybe_upgrade_to_repository {
() => {
// Module: crate::walk::classify
// Provides: {"maybe_upgrade_to_repository"}
// Dependencies: {}
