...
impl Guid {
    fn to_tokens(&self) -> syn::Result<proc_macro2::TokenStream> {
        ...
        if let Some(value) = &self.0 {
            ...
            Ok(
                quote! { :: windows_core :: GUID { data1 : # data1 , data2 : # data2 , data3 : # data3 , data4 : [# data4_1 , # data4_2 , # data4_3 , # data4_4 , # data4_5 , # data4_6 , # data4_7 , # data4_8] } },
            )
        } else {
            Ok(quote! { :: windows_core :: GUID :: zeroed () })
        }
    }
}
