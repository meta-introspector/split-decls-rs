...
where
    ...
    FT: FormatTime,
{
    #[doc = " Enables terminal colors, boldness and italics."]
    ...
    #[doc = " Renders an ascii art tree instead of just using whitespace indentation."]
    ...
    #[doc = " Specifies how to measure and format time at which event has occurred."]
    ...
    #[doc = " Whether to render the event and span targets. Usually targets are the module path to the"]
    #[doc = " event/span macro invocation."]
    ...
    #[doc = " Whether to render the thread id in the beginning of every line. This is helpful to"]
    #[doc = " untangle the tracing statements emitted by each thread."]
    ...
    #[doc = " Whether to render the thread name in the beginning of every line. Not all threads have"]
    #[doc = " names, but if they do, this may be more helpful than the generic thread ids."]
    ...
    #[doc = " Resets the indentation to zero after `wraparound` indentation levels."]
    #[doc = " This is helpful if you expect very deeply nested spans as otherwise the indentation"]
    #[doc = " just runs out of your screen."]
    ...
    #[doc = " Whether to print the currently active span's message again before entering a new span."]
    #[doc = " This helps if the entry to the current span was quite a while back (and with scrolling"]
    #[doc = " upwards in logs)."]
    ...
    #[doc = " Whether to print the currently active span's message again before dropping it."]
    #[doc = " This helps if the entry to the current span was quite a while back (and with scrolling"]
    #[doc = " upwards in logs)."]
    ...
    #[doc = " Whether to print the currently active span's message again if another span was entered in"]
    #[doc = " the meantime"]
    #[doc = " This helps during concurrent or multi-threaded events where threads are entered, but not"]
    #[doc = " necessarily *exited* before other *divergent* spans are entered and generating events."]
    ...
    #[doc = " Defers printing span opening until an event is generated within the span."]
    #[doc = ""]
    #[doc = " Avoids printing empty spans with no generated events."]
    ...
    #[doc = " Prefixes each branch with the event mode, such as `open`, or `close`"]
    ...
    #[doc = " Whether to print `{}` around the fields when printing a span."]
    #[doc = " This can help visually distinguish fields from the rest of the message."]
    ...
    #[doc = " Ensures that `new_span` and all its ancestors are properly printed before an event"]
    ...
    fn is_recursive() -> Option<RecursiveGuard> {
        thread_local! { pub static IS_EMPTY : AtomicBool = const { AtomicBool :: new (true) } ; }
