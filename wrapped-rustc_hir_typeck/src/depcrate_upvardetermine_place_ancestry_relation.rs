// Generated macro for determine_place_ancestry_relation (function)
macro_rules! Depcrate_upvardetermine_place_ancestry_relation {
() => {
// Module: crate::upvar
// Provides: {"determine_place_ancestry_relation"}
// Dependencies: {}
