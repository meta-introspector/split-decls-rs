// Generated macro for construct_capture_info_string (function)
macro_rules! Depcrate_upvarconstruct_capture_info_string {
() => {
// Module: crate::upvar
// Provides: {"construct_capture_info_string"}
// Dependencies: {}
