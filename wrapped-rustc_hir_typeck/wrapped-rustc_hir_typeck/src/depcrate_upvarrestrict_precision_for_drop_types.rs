// Generated macro for restrict_precision_for_drop_types (function)
macro_rules! Depcrate_upvarrestrict_precision_for_drop_types {
() => {
// Module: crate::upvar
// Provides: {"restrict_precision_for_drop_types"}
// Dependencies: {}
