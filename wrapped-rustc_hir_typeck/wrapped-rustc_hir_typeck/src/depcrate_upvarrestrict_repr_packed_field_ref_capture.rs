// Generated macro for restrict_repr_packed_field_ref_capture (function)
macro_rules! Depcrate_upvarrestrict_repr_packed_field_ref_capture {
() => {
// Module: crate::upvar
// Provides: {"restrict_repr_packed_field_ref_capture"}
// Dependencies: {}
