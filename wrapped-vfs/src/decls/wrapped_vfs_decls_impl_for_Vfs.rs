...
impl Vfs {
    #[doc = " Id of the given path if it exists in the `Vfs` and is not deleted."]
    ...
    #[doc = " File path corresponding to the given `file_id`."]
    #[doc = ""]
    #[doc = " # Panics"]
    #[doc = ""]
    #[doc = " Panics if the id is not present in the `Vfs`."]
    pub fn file_path(&self, file_id: FileId) -> &VfsPath {
        self.interner.lookup(file_id)
    }
    #[doc = " Returns an iterator over the stored ids and their corresponding paths."]
    #[doc = ""]
    #[doc = " This will skip deleted files."]
    ...
    #[doc = " Update the `path` with the given `contents`. `None` means the file was deleted."]
    #[doc = ""]
    #[doc = " Returns `true` if the file was modified, and saves the [change](ChangedFile)."]
    #[doc = ""]
    #[doc = " If the path does not currently exists in the `Vfs`, allocates a new"]
    #[doc = " [`FileId`] for it."]
    ...
    #[doc = " Drain and returns all the changes in the `Vfs`."]
    pub fn take_changes(&mut self) -> IndexMap<FileId, ChangedFile, BuildHasherDefault<FxHasher>> {
        mem::take(&mut self.changes)
    }
    #[doc = " Provides a panic-less way to verify file_id validity."]
    pub fn exists(&self, file_id: FileId) -> bool {
        matches!(self.get(file_id), FileState::Exists(_))
    }
    #[doc = " Returns the id associated with `path`"]
    #[doc = ""]
    #[doc = " - If `path` does not exists in the `Vfs`, allocate a new id for it, associated with a"]
    #[doc = "   deleted file;"]
    #[doc = " - Else, returns `path`'s id."]
    #[doc = ""]
    #[doc = " Does not record a change."]
    ...
    #[doc = " Returns the status of the file associated with the given `file_id`."]
    #[doc = ""]
    #[doc = " # Panics"]
    #[doc = ""]
    #[doc = " Panics if no file is associated to that id."]
    fn get(&self, file_id: FileId) -> FileState {
        self.data[file_id.0 as usize]
    }
    #[doc = " We cannot ignore excluded files, because this will lead to errors when the client"]
    #[doc = " requests semantic information for them, so we instead mark them specially."]
