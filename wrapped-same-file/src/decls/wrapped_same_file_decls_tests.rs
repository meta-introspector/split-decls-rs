...
mod tests {
    ...
    #[doc = " Create an error from a format!-like syntax."]
    macro_rules ! err { ($ ($ tt : tt) *) => { Box ::< dyn error :: Error + Send + Sync >:: from (format ! ($ ($ tt) *)) } }
    #[doc = " A simple wrapper for creating a temporary directory that is"]
    #[doc = " automatically deleted when it's dropped."]
    #[doc = ""]
    #[doc = " We use this in lieu of tempfile because tempfile brings in too many"]
    #[doc = " dependencies."]
    #[derive(Debug)]
    ...
    impl TempDir {
        #[doc = " Create a new empty temporary directory under the system's"]
        #[doc = " configured temporary directory."]
        ...
        #[doc = " Return the underlying path to this temporary directory."]
        fn path(&self) -> &Path {
            &self.0
        }
    }
