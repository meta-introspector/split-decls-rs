...
impl Level {
    #[doc = " Converts a level to a lower-case string."]
    ...
    #[doc = " Converts a lower-case string to a level. This will never construct the expect"]
    #[doc = " level as that would require a [`LintExpectationId`]."]
    ...
    #[doc = " Converts an `Attribute` to a level."]
    ...
    #[doc = " Converts a `Symbol` to a level."]
    pub fn from_symbol(
        s: Symbol,
