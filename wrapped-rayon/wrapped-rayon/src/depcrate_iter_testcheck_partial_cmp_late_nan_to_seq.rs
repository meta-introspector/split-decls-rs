// Generated macro for check_partial_cmp_late_nan_to_seq (function)
macro_rules! Depcrate_iter_testcheck_partial_cmp_late_nan_to_seq {
() => {
// Module: crate::iter::test
// Provides: {"check_partial_cmp_late_nan_to_seq"}
// Dependencies: {}
