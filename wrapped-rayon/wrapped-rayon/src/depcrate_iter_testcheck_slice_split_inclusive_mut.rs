// Generated macro for check_slice_split_inclusive_mut (function)
macro_rules! Depcrate_iter_testcheck_slice_split_inclusive_mut {
() => {
// Module: crate::iter::test
// Provides: {"check_slice_split_inclusive_mut"}
// Dependencies: {}
