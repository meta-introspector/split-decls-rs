// Generated macro for left_produces_fewer_items_drops (function)
macro_rules! Depcrate_iter_collect_testleft_produces_fewer_items_drops {
() => {
// Module: crate::iter::collect::test
// Provides: {"left_produces_fewer_items_drops"}
// Dependencies: {}
