// Generated macro for execute_pseudo_indexed_range (function)
macro_rules! Depcrate_iter_testexecute_pseudo_indexed_range {
() => {
// Module: crate::iter::test
// Provides: {"execute_pseudo_indexed_range"}
// Dependencies: {}
