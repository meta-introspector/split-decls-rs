// Generated macro for check_range_split_at_overflow (function)
macro_rules! Depcrate_rangecheck_range_split_at_overflow {
() => {
// Module: crate::range
// Provides: {"check_range_split_at_overflow"}
// Dependencies: {}
