// Generated macro for produces_items_with_no_complete (function)
macro_rules! Depcrate_iter_collect_testproduces_items_with_no_complete {
() => {
// Module: crate::iter::collect::test
// Provides: {"produces_items_with_no_complete"}
// Dependencies: {}
