// Generated macro for starts_emoji_presentation_seq (function)
macro_rules! Depcrate_tablesstarts_emoji_presentation_seq {
() => {
// Module: crate::tables
// Provides: {"starts_emoji_presentation_seq"}
// Dependencies: {}
