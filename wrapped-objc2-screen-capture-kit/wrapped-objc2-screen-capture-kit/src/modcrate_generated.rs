...
() => {
        ...
        Depcrate_generated__SCContentSharingPicker!();
        Depcrate_generated__SCError!();
        Depcrate_generated__SCRecordingOutput!();
        Depcrate_generated__SCScreenshotManager!();
        Depcrate_generated__SCShareableContent!();
        Depcrate_generated__SCStream!();
