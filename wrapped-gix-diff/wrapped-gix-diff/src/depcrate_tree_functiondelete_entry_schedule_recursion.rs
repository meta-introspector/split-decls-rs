// Generated macro for delete_entry_schedule_recursion (function)
macro_rules! Depcrate_tree_functiondelete_entry_schedule_recursion {
() => {
// Module: crate::tree::function
// Provides: {"delete_entry_schedule_recursion"}
// Dependencies: {}
