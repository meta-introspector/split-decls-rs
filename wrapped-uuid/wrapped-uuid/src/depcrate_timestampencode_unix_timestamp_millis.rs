// Generated macro for encode_unix_timestamp_millis (function)
macro_rules! Depcrate_timestampencode_unix_timestamp_millis {
() => {
// Module: crate::timestamp
// Provides: {"encode_unix_timestamp_millis"}
// Dependencies: {}
