...
impl<'a> Utf8Component<'a> {
    ...
    #[doc = " Extracts the underlying [`str`] slice."]
    #[doc = ""]
    #[doc = " # Examples"]
    #[doc = ""]
    #[doc = " ```"]
    ...
    #[doc = " let components: Vec<_> = path.components().map(|comp| comp.as_str()).collect();"]
    #[doc = " assert_eq!(&components, &[\".\", \"tmp\", \"foo\", \"bar.txt\"]);"]
    #[doc = " ```"]
    #[must_use]
    #[inline]
    ...
    #[doc = " Extracts the underlying [`OsStr`] slice."]
    #[doc = ""]
    #[doc = " # Examples"]
    #[doc = ""]
    #[doc = " ```"]
    ...
    #[doc = ""]
    #[doc = " let path = Utf8Path::new(\"./tmp/foo/bar.txt\");"]
    #[doc = " let components: Vec<_> = path.components().map(|comp| comp.as_os_str()).collect();"]
    #[doc = " assert_eq!(&components, &[\".\", \"tmp\", \"foo\", \"bar.txt\"]);"]
    #[doc = " ```"]
    #[must_use]
