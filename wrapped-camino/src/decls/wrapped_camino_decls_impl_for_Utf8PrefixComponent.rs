...
impl<'a> Utf8PrefixComponent<'a> {
    #[doc = " Returns the parsed prefix data."]
    #[doc = ""]
    #[doc = " See [`Utf8Prefix`]'s documentation for more information on the different"]
    #[doc = " kinds of prefixes."]
    #[must_use]
    ...
    #[doc = " Returns the [`str`] slice for this prefix."]
    #[must_use]
    #[inline]
    pub fn as_str(&self) -> &'a str {
        unsafe { str_assume_utf8(self.as_os_str()) }
    }
    #[doc = " Returns the raw [`OsStr`] slice for this prefix."]
    #[must_use]
    #[inline]
