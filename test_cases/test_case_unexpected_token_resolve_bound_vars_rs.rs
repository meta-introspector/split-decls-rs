...
// Original file: ../rust/compiler/rustc_hir_analysis/src/collect/resolve_bound_vars.rs
...
fn main() {
    runbuild!("../rust/compiler/rustc_hir_analysis/src/collect/resolve_bound_vars.rs");
}
