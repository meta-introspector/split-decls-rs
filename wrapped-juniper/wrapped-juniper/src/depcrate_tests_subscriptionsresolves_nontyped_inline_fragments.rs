// Generated macro for resolves_nontyped_inline_fragments (function)
macro_rules! Depcrate_tests_subscriptionsresolves_nontyped_inline_fragments {
() => {
// Module: crate::tests::subscriptions
// Provides: {"resolves_nontyped_inline_fragments"}
// Dependencies: {}
# [test] fn resolves_nontyped_inline_fragments () { let query = r#"subscription {
             ... {
                asyncHuman(id: "32") {
                  id
                }
