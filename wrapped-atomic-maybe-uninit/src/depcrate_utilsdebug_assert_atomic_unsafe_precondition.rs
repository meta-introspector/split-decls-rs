// Generated macro for debug_assert_atomic_unsafe_precondition (macro)
macro_rules! Depcrate_utilsdebug_assert_atomic_unsafe_precondition {
() => {
// Module: crate::utils
// Provides: {"debug_assert_atomic_unsafe_precondition"}
// Dependencies: {}
