...
() => {
        ...
        Depcrate_generated__CHHapticDeviceCapability!();
        Depcrate_generated__CHHapticEngine!();
        Depcrate_generated__CHHapticErrors!();
        Depcrate_generated__CHHapticEvent!();
        Depcrate_generated__CHHapticParameter!();
        Depcrate_generated__CHHapticPattern!();
        Depcrate_generated__CHHapticPatternPlayer!();
