...
impl<'s> ShortFlags<'s> {
    ...
    #[doc = " Move the iterator forward by `n` short flags"]
    ...
    #[doc = " No short flags left"]
    pub fn is_empty(&self) -> bool {
        self.invalid_suffix.is_none() && self.utf8_prefix.as_str().is_empty()
    }
    #[doc = " Does the short flag look like a number"]
    #[doc = ""]
    #[doc = " Ideally call this before doing any iterator"]
    pub fn is_negative_number(&self) -> bool {
        self.invalid_suffix.is_none() && is_number(self.utf8_prefix.as_str())
    }
    #[doc = " Advance the iterator, returning the next short flag on success"]
    #[doc = ""]
    #[doc = " On error, returns the invalid-UTF8 value"]
    ...
    #[doc = " Advance the iterator, returning everything left as a value"]
