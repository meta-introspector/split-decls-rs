...
impl RawArgs {
    ...
    #[doc = ""]
    #[doc = " **NOTE:** The argument returned will be the current binary."]
    #[doc = ""]
    #[doc = " </div>"]
    #[doc = ""]
    #[doc = " # Example"]
    ...
    #[doc = " let raw = clap_lex::RawArgs::from_args();"]
    #[doc = " let mut cursor = raw.cursor();"]
    #[doc = " let _bin = raw.next_os(&mut cursor);"]
    #[doc = ""]
    #[doc = " let mut paths = raw.remaining(&mut cursor).map(PathBuf::from).collect::<Vec<_>>();"]
    #[doc = " println!(\"{paths:?}\");"]
    #[doc = " ```"]
    ...
    #[doc = " ```rust,no_run"]
    #[doc = " # use std::path::PathBuf;"]
    #[doc = " let raw = clap_lex::RawArgs::new([\"bin\", \"foo.txt\"]);"]
    #[doc = " let mut cursor = raw.cursor();"]
    #[doc = " let _bin = raw.next_os(&mut cursor);"]
    #[doc = ""]
    #[doc = " let mut paths = raw.remaining(&mut cursor).map(PathBuf::from).collect::<Vec<_>>();"]
    ...
    #[doc = " Create a cursor for walking the arguments"]
    #[doc = ""]
    #[doc = " # Example"]
    #[doc = ""]
    #[doc = " ```rust,no_run"]
    ...
    #[doc = " Advance the cursor, returning the next [`ParsedArg`]"]
    pub fn next(&self, cursor: &mut ArgCursor) -> Option<ParsedArg<'_>> {
        self.next_os(cursor).map(ParsedArg::new)
    }
    #[doc = " Advance the cursor, returning a raw argument value."]
    ...
    #[doc = " Adjust the cursor's position"]
    ...
    #[doc = " Inject arguments before the [`RawArgs::next`]"]
    pub fn insert(
        &mut self,
        cursor: &ArgCursor,
