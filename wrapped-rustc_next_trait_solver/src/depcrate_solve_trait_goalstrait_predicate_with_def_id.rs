// Generated macro for trait_predicate_with_def_id (function)
macro_rules! Depcrate_solve_trait_goalstrait_predicate_with_def_id {
() => {
// Module: crate::solve::trait_goals
// Provides: {"trait_predicate_with_def_id"}
// Dependencies: {}
