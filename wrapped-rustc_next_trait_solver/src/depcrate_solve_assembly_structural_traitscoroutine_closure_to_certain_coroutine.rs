// Generated macro for coroutine_closure_to_certain_coroutine (function)
macro_rules! Depcrate_solve_assembly_structural_traitscoroutine_closure_to_certain_coroutine {
() => {
// Module: crate::solve::assembly::structural_traits
// Provides: {"coroutine_closure_to_certain_coroutine"}
// Dependencies: {}
