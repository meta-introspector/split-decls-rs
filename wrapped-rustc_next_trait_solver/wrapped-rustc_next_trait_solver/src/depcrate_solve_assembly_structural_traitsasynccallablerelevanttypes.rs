// Generated macro for AsyncCallableRelevantTypes (struct)
macro_rules! Depcrate_solve_assembly_structural_traitsAsyncCallableRelevantTypes {
() => {
// Module: crate::solve::assembly::structural_traits
// Provides: {"AsyncCallableRelevantTypes"}
// Dependencies: {}
