// Generated macro for evaluate_root_goal_for_proof_tree (function)
macro_rules! Depcrate_solve_eval_ctxtevaluate_root_goal_for_proof_tree {
() => {
// Module: crate::solve::eval_ctxt
// Provides: {"evaluate_root_goal_for_proof_tree"}
// Dependencies: {}
