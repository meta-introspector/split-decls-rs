// Generated macro for find_source_directory_in_iter (function)
macro_rules! Depcrate_persist_fsfind_source_directory_in_iter {
() => {
// Module: crate::persist::fs
// Provides: {"find_source_directory_in_iter"}
// Dependencies: {}
