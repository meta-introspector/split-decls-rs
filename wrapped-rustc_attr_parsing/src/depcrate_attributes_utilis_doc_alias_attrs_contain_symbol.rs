// Generated macro for is_doc_alias_attrs_contain_symbol (function)
macro_rules! Depcrate_attributes_utilis_doc_alias_attrs_contain_symbol {
() => {
// Module: crate::attributes::util
// Provides: {"is_doc_alias_attrs_contain_symbol"}
// Dependencies: {}
