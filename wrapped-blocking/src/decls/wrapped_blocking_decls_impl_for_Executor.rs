...
impl Executor {
    ...
    #[doc = " Get a reference to the global executor."]
    #[inline]
    fn get() -> &'static Self {
        #[cfg(not(target_family = "wasm"))]
        {
    ...
    #[doc = " Spawns a future onto this executor."]
    #[doc = ""]
    #[doc = " Returns a [`Task`] handle for the spawned task."]
    ...
    #[doc = " Runs the main loop on the current thread."]
    #[doc = ""]
    #[doc = " This function runs blocking tasks until it becomes idle and times out."]
    ...
    #[doc = " Schedules a runnable task for execution."]
    ...
    #[doc = " Spawns more blocking threads if the pool is overloaded with work."]
