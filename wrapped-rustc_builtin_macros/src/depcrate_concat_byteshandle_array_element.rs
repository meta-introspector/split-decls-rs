// Generated macro for handle_array_element (function)
macro_rules! Depcrate_concat_byteshandle_array_element {
() => {
// Module: crate::concat_bytes
// Provides: {"handle_array_element"}
// Dependencies: {}
