// Generated macro for default_enum_substructure (function)
macro_rules! Depcrate_deriving_defaultdefault_enum_substructure {
() => {
// Module: crate::deriving::default
// Provides: {"default_enum_substructure"}
// Dependencies: {}
