// Generated macro for expand_trace_macros (function)
macro_rules! Depcrate_trace_macrosexpand_trace_macros {
() => {
// Module: crate::trace_macros
// Provides: {"expand_trace_macros"}
// Dependencies: {}
