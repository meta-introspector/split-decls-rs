// Generated macro for invalid_placeholder_type_error (function)
macro_rules! Depcrate_formatinvalid_placeholder_type_error {
() => {
// Module: crate::format
// Provides: {"invalid_placeholder_type_error"}
// Dependencies: {}
