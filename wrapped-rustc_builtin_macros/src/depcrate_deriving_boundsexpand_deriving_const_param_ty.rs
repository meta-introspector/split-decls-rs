// Generated macro for expand_deriving_const_param_ty (function)
macro_rules! Depcrate_deriving_boundsexpand_deriving_const_param_ty {
() => {
// Module: crate::deriving::bounds
// Provides: {"expand_deriving_const_param_ty"}
// Dependencies: {}
