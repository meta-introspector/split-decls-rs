// Generated macro for validate_default_attribute (function)
macro_rules! Depcrate_deriving_defaultvalidate_default_attribute {
() => {
// Module: crate::deriving::default
// Provides: {"validate_default_attribute"}
// Dependencies: {}
