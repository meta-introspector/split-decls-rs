// Generated macro for get_single_str_spanned_from_tts (function)
macro_rules! Depcrate_utilget_single_str_spanned_from_tts {
() => {
// Module: crate::util
// Provides: {"get_single_str_spanned_from_tts"}
// Dependencies: {}
