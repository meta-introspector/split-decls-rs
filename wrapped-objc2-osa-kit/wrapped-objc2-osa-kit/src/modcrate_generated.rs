...
() => {
        ...
        Depcrate_generated__OSALanguage!();
        Depcrate_generated__OSALanguageInstance!();
        Depcrate_generated__OSAScript!();
        Depcrate_generated__OSAScriptController!();
        Depcrate_generated__OSAScriptView!();
