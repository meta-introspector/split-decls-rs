    ...
    C: CharAccumulator,
{
    ...
    #[doc = " Advance the parser state"]
    #[doc = ""]
    #[doc = " Requires a [`Perform`] in case `byte` triggers an action"]
    #[inline]
    ...
    #[doc = " Separate method for `osc_dispatch` that borrows self as read-only"]
    #[doc = ""]
    #[doc = " The aliasing is needed here for multiple slices into `self.osc_raw`"]
    #[inline]
