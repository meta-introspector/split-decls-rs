// Generated macro for initial_counter_overflow_err (function)
macro_rules! Depcrate_test_framework_streamcipher_interfaceinitial_counter_overflow_err {
() => {
// Module: crate::test_framework::streamcipher_interface
// Provides: {"initial_counter_overflow_err"}
// Dependencies: {}
