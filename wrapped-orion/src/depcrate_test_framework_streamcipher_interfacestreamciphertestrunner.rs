// Generated macro for StreamCipherTestRunner (function)
macro_rules! Depcrate_test_framework_streamcipher_interfaceStreamCipherTestRunner {
() => {
// Module: crate::test_framework::streamcipher_interface
// Provides: {"StreamCipherTestRunner"}
// Dependencies: {}
