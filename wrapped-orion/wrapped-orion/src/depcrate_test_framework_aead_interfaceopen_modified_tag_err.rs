// Generated macro for open_modified_tag_err (function)
macro_rules! Depcrate_test_framework_aead_interfaceopen_modified_tag_err {
() => {
// Module: crate::test_framework::aead_interface
// Provides: {"open_modified_tag_err"}
// Dependencies: {}
