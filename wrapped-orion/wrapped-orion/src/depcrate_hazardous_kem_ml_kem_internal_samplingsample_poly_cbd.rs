// Generated macro for sample_poly_cbd (function)
macro_rules! Depcrate_hazardous_kem_ml_kem_internal_samplingsample_poly_cbd {
() => {
// Module: crate::hazardous::kem::ml_kem::internal::sampling
// Provides: {"sample_poly_cbd"}
// Dependencies: {}
