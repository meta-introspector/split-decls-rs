// Generated macro for create_compaction_filter_callback (function)
macro_rules! Depcrate_compaction_filter_factorycreate_compaction_filter_callback {
() => {
// Module: crate::compaction_filter_factory
// Provides: {"create_compaction_filter_callback"}
// Dependencies: {}
