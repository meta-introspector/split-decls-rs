// Generated macro for CompactionFilterContext (struct)
macro_rules! Depcrate_compaction_filter_factoryCompactionFilterContext {
() => {
// Module: crate::compaction_filter_factory
// Provides: {"CompactionFilterContext"}
// Dependencies: {}
