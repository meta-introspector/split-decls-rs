// Generated macro for CompactionFilterFactory (trait)
macro_rules! Depcrate_compaction_filter_factoryCompactionFilterFactory {
() => {
// Module: crate::compaction_filter_factory
// Provides: {"CompactionFilterFactory"}
// Dependencies: {}
