// Generated macro for test_comments_preserve_trailing_whitespace (function)
macro_rules! Depcrate_asttest_comments_preserve_trailing_whitespace {
() => {
// Module: crate::ast
// Provides: {"test_comments_preserve_trailing_whitespace"}
// Dependencies: {}
