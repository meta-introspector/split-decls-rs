// Generated macro for test_doc_comment_single_line_block_strips_suffix (function)
macro_rules! Depcrate_asttest_doc_comment_single_line_block_strips_suffix {
() => {
// Module: crate::ast
// Provides: {"test_doc_comment_single_line_block_strips_suffix"}
// Dependencies: {}
