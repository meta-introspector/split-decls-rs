// Generated macro for validate_impl_object_ty_plus (function)
macro_rules! Depcrate_validationvalidate_impl_object_ty_plus {
() => {
// Module: crate::validation
// Provides: {"validate_impl_object_ty_plus"}
// Dependencies: {}
