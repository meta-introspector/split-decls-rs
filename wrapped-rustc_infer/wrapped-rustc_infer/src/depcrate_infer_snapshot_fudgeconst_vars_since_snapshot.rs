// Generated macro for const_vars_since_snapshot (function)
macro_rules! Depcrate_infer_snapshot_fudgeconst_vars_since_snapshot {
() => {
// Module: crate::infer::snapshot::fudge
// Provides: {"const_vars_since_snapshot"}
// Dependencies: {}
