// Generated macro for VerifyBoundCx (struct)
macro_rules! Depcrate_infer_outlives_verifyVerifyBoundCx {
() => {
// Module: crate::infer::outlives::verify
// Provides: {"VerifyBoundCx"}
// Dependencies: {}
