// Generated macro for FreeRegionsVisitor (struct)
macro_rules! Depcrate_infer_outlives_for_livenessFreeRegionsVisitor {
() => {
// Module: crate::infer::outlives::for_liveness
// Provides: {"FreeRegionsVisitor"}
// Dependencies: {}
