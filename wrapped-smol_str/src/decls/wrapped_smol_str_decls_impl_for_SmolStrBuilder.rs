...
impl SmolStrBuilder {
    #[doc = " Creates a new empty [`SmolStrBuilder`]."]
    #[must_use]
    ...
    #[doc = " Builds a [`SmolStr`] from `self`."]
    #[must_use]
    ...
    #[doc = " Appends the given [`char`] to the end of `self`'s buffer."]
    ...
    #[doc = " Appends a given string slice onto the end of `self`'s buffer."]
