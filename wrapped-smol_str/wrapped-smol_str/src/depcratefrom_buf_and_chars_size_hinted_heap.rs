// Generated macro for from_buf_and_chars_size_hinted_heap (function)
macro_rules! Depcratefrom_buf_and_chars_size_hinted_heap {
() => {
// Module: crate
// Provides: {"from_buf_and_chars_size_hinted_heap"}
// Dependencies: {}
