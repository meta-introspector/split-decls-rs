// Generated macro for BitReaderReversed (struct)
macro_rules! Depcrate_bit_io_bit_reader_reverseBitReaderReversed {
() => {
// Module: crate::bit_io::bit_reader_reverse
// Provides: {"BitReaderReversed"}
// Dependencies: {}
