// Generated macro for LiteralsSectionType (enum)
macro_rules! Depcrate_blocks_literals_sectionLiteralsSectionType {
() => {
// Module: crate::blocks::literals_section
// Provides: {"LiteralsSectionType"}
// Dependencies: {}
