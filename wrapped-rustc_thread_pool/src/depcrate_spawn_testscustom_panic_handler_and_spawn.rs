// Generated macro for custom_panic_handler_and_spawn (function)
macro_rules! Depcrate_spawn_testscustom_panic_handler_and_spawn {
() => {
// Module: crate::spawn::tests
// Provides: {"custom_panic_handler_and_spawn"}
// Dependencies: {}
