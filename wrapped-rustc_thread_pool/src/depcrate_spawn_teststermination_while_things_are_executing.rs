// Generated macro for termination_while_things_are_executing (function)
macro_rules! Depcrate_spawn_teststermination_while_things_are_executing {
() => {
// Module: crate::spawn::tests
// Provides: {"termination_while_things_are_executing"}
// Dependencies: {}
