// Generated macro for spawn_broadcast_mutual_sleepy (function)
macro_rules! Depcrate_broadcast_testsspawn_broadcast_mutual_sleepy {
() => {
// Module: crate::broadcast::tests
// Provides: {"spawn_broadcast_mutual_sleepy"}
// Dependencies: {}
