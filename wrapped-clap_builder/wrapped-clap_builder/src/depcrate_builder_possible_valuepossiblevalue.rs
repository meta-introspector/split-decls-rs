// Generated macro for PossibleValue (struct)
macro_rules! Depcrate_builder_possible_valuePossibleValue {
() => {
// Module: crate::builder::possible_value
// Provides: {"PossibleValue"}
// Dependencies: {}
