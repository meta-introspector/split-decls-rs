// Generated macro for NonEmptyStringValueParser (struct)
macro_rules! Depcrate_builder_value_parserNonEmptyStringValueParser {
() => {
// Module: crate::builder::value_parser
// Provides: {"NonEmptyStringValueParser"}
// Dependencies: {}
