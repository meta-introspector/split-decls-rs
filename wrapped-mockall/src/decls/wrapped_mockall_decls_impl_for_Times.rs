...
impl Times {
    ...
    #[doc = " Return how many times this expectation has been called"]
    pub fn count(&self) -> usize {
        self.count.load(Ordering::Relaxed)
    }
    #[doc = " Has this expectation already been called the maximum allowed number of"]
    #[doc = " times?"]
    pub fn is_done(&self) -> bool {
        self.count.load(Ordering::Relaxed) >= self.range.0.end - 1
    }
    #[doc = " Is it required that this expectation be called an exact number of times,"]
    #[doc = " or may it be satisfied by a range of call counts?"]
    pub fn is_exact(&self) -> bool {
        (self.range.0.end - self.range.0.start) == 1
    }
    #[doc = " Has this expectation already been called the expected number of times?"]
    #[doc = " If not, was it too many or too few?"]
    ...
    #[doc = " The maximum number of times that this expectation must be called"]
    pub fn maximum(&self) -> usize {
        self.range.0.end - 1
    }
    #[doc = " The minimum number of times that this expectation must be called"]
