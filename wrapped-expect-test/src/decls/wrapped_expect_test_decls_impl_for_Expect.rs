...
impl Expect {
    #[doc = " Checks if this expect is equal to `actual`."]
    ...
    #[doc = " Checks if this expect is equal to `format!(\"{:#?}\", actual)`."]
    pub fn assert_debug_eq(&self, actual: &impl fmt::Debug) {
        let actual = format!("{:#?}\n", actual);
        self.assert_eq(&actual)
    }
    #[doc = " If `true` (default), in-place update will indent the string literal."]
    pub fn indent(&mut self, yes: bool) {
        self.indent = yes;
    }
    #[doc = " Returns the content of this expect."]
