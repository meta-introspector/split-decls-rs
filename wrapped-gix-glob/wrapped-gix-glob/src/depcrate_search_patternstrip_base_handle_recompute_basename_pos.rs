// Generated macro for strip_base_handle_recompute_basename_pos (function)
macro_rules! Depcrate_search_patternstrip_base_handle_recompute_basename_pos {
() => {
// Module: crate::search::pattern
// Provides: {"strip_base_handle_recompute_basename_pos"}
// Dependencies: {}
