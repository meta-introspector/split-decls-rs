// Generated macro for check_win_devices_and_illegal_characters (function)
macro_rules! Depcrate_pathcheck_win_devices_and_illegal_characters {
() => {
// Module: crate::path
// Provides: {"check_win_devices_and_illegal_characters"}
// Dependencies: {}
