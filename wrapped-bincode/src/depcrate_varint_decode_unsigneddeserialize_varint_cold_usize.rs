// Generated macro for deserialize_varint_cold_usize (function)
macro_rules! Depcrate_varint_decode_unsigneddeserialize_varint_cold_usize {
() => {
// Module: crate::varint::decode_unsigned
// Provides: {"deserialize_varint_cold_usize"}
// Dependencies: {}
