// Generated macro for seed_decode_from_slice (function)
macro_rules! Depcrate_features_serde_de_borrowedseed_decode_from_slice {
() => {
// Module: crate::features::serde::de_borrowed
// Provides: {"seed_decode_from_slice"}
// Dependencies: {}
