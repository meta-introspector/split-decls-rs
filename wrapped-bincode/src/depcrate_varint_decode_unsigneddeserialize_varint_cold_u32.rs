// Generated macro for deserialize_varint_cold_u32 (function)
macro_rules! Depcrate_varint_decode_unsigneddeserialize_varint_cold_u32 {
() => {
// Module: crate::varint::decode_unsigned
// Provides: {"deserialize_varint_cold_u32"}
// Dependencies: {}
