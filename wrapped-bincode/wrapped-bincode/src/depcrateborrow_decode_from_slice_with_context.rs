// Generated macro for borrow_decode_from_slice_with_context (function)
macro_rules! Depcrateborrow_decode_from_slice_with_context {
() => {
// Module: crate
// Provides: {"borrow_decode_from_slice_with_context"}
// Dependencies: {}
