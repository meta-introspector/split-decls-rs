// Generated macro for deserialize_varint_cold_u128 (function)
macro_rules! Depcrate_varint_decode_unsigneddeserialize_varint_cold_u128 {
() => {
// Module: crate::varint::decode_unsigned
// Provides: {"deserialize_varint_cold_u128"}
// Dependencies: {}
