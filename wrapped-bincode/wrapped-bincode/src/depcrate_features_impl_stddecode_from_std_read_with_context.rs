// Generated macro for decode_from_std_read_with_context (function)
macro_rules! Depcrate_features_impl_stddecode_from_std_read_with_context {
() => {
// Module: crate::features::impl_std
// Provides: {"decode_from_std_read_with_context"}
// Dependencies: {}
