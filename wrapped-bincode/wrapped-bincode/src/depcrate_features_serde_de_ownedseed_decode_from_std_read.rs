// Generated macro for seed_decode_from_std_read (function)
macro_rules! Depcrate_features_serde_de_ownedseed_decode_from_std_read {
() => {
// Module: crate::features::serde::de_owned
// Provides: {"seed_decode_from_std_read"}
// Dependencies: {}
