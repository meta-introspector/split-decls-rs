...
impl<T, const N: usize> AutoThinVec<T, N> {
    #[doc = " Implementation detail for the auto_thin_vec macro."]
    #[inline]
    #[doc(hidden)]
    ...
    #[doc = " Returns a raw pointer to the inner ThinVec. Note that if you dereference it from rust, you"]
    #[doc = " need to make sure not to move the ThinVec manually via something like"]
    #[doc = " `std::mem::take(&mut auto_vec)`."]
