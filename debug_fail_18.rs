...
#[path = "src/dot_dot_rust_compiler_rustc_builtin_macros_src_deriving_coerce_pointee.rs"]
mod dot_dot_rust_compiler_rustc_builtin_macros_src_deriving_coerce_pointee;