...
impl<'a> Ranker<'a> {
    ...
    #[doc = " A utility function that ranks a token again a given kind and text, returning a number that"]
    #[doc = " represents how close the token is to the given kind and text."]
