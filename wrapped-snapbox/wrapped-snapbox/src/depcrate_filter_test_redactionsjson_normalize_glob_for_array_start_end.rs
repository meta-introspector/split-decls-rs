// Generated macro for json_normalize_glob_for_array_start_end (function)
macro_rules! Depcrate_filter_test_redactionsjson_normalize_glob_for_array_start_end {
() => {
// Module: crate::filter::test_redactions
// Provides: {"json_normalize_glob_for_array_start_end"}
// Dependencies: {}
