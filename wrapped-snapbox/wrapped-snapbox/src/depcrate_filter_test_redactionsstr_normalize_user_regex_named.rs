// Generated macro for str_normalize_user_regex_named (function)
macro_rules! Depcrate_filter_test_redactionsstr_normalize_user_regex_named {
() => {
// Module: crate::filter::test_redactions
// Provides: {"str_normalize_user_regex_named"}
// Dependencies: {}
