// Generated macro for normalize_array_to_redactions (function)
macro_rules! Depcrate_filter_patternnormalize_array_to_redactions {
() => {
// Module: crate::filter::pattern
// Provides: {"normalize_array_to_redactions"}
// Dependencies: {}
