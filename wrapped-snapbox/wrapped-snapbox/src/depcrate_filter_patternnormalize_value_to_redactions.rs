// Generated macro for normalize_value_to_redactions (function)
macro_rules! Depcrate_filter_patternnormalize_value_to_redactions {
() => {
// Module: crate::filter::pattern
// Provides: {"normalize_value_to_redactions"}
// Dependencies: {}
