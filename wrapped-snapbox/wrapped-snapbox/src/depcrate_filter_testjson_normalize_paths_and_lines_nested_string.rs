// Generated macro for json_normalize_paths_and_lines_nested_string (function)
macro_rules! Depcrate_filter_testjson_normalize_paths_and_lines_nested_string {
() => {
// Module: crate::filter::test
// Provides: {"json_normalize_paths_and_lines_nested_string"}
// Dependencies: {}
