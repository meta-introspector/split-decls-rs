// Generated macro for truncate_hunks_from_from_back (function)
macro_rules! Depcrate_blob_builtin_driver_text_utilstruncate_hunks_from_from_back {
() => {
// Module: crate::blob::builtin_driver::text::utils
// Provides: {"truncate_hunks_from_from_back"}
// Dependencies: {}
