// Generated macro for possibly_rewritten_location (function)
macro_rules! Depcrate_tree_utilspossibly_rewritten_location {
() => {
// Module: crate::tree::utils
// Provides: {"possibly_rewritten_location"}
// Dependencies: {}
