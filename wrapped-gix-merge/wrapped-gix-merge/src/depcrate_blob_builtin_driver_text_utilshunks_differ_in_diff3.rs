// Generated macro for hunks_differ_in_diff3 (function)
macro_rules! Depcrate_blob_builtin_driver_text_utilshunks_differ_in_diff3 {
() => {
// Module: crate::blob::builtin_driver::text::utils
// Provides: {"hunks_differ_in_diff3"}
// Dependencies: {}
