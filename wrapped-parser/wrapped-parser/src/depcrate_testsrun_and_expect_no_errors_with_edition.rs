// Generated macro for run_and_expect_no_errors_with_edition (function)
macro_rules! Depcrate_testsrun_and_expect_no_errors_with_edition {
() => {
// Module: crate::tests
// Provides: {"run_and_expect_no_errors_with_edition"}
// Dependencies: {}
