// Generated macro for parse_named_operation_definition (function)
macro_rules! Depcrate_parse_executableparse_named_operation_definition {
() => {
// Module: crate::parse::executable
// Provides: {"parse_named_operation_definition"}
// Dependencies: {}
