// Generated macro for parse_type_system_definition (function)
macro_rules! Depcrate_parse_serviceparse_type_system_definition {
() => {
// Module: crate::parse::service
// Provides: {"parse_type_system_definition"}
// Dependencies: {}
