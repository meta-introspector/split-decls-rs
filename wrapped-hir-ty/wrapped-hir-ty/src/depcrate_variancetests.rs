...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_types () { check (r#"
//- minicore: cell
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn type_resolve_error_two_structs_deep () { check (r#"
struct Hello<'a> {
    missing: Missing<'a>,
}
...
"# , expect ! [[r#"
                Hello['a: invariant]
                Other['a: invariant]
            "#]] ,) ; } # [test] fn rustc_test_variance_associated_consts () { check (r#"
trait Trait {
    const Const: usize;
}
...
"# , expect ! [[r#"
                Foo[T: invariant]
            "#]] ,) ; } # [test] fn rustc_test_variance_associated_types () { check (r#"
trait Trait<'a> {
    type Type;
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_associated_types2 () { check (r#"
trait Foo {
    type Bar;
}

fn make() -> *const dyn Foo<Bar = &'static u32> {}
"# , expect ! [""] ,) ; } # [test] fn rustc_test_variance_trait_bounds () { check (r#"
trait Getter<T> {
    fn get(&self) -> T;
}
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_trait_matching () { check (r#"
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_trait_object_bound () { check (r#"
enum Option<T> {
    Some(T),
    None
}
...
"# , expect ! [[r#"
                ...
                TOption['a: covariant]
            "#]] ,) ; } # [test] fn rustc_test_variance_types_bounds () { check (r#"
//- minicore: send
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_unused_region_param () { check (r#"
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_unused_type_param () { check (r#"
//- minicore: sized
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_use_contravariant_struct1 () { check (r#"
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_use_contravariant_struct2 () { check (r#"
struct SomeStruct<T>(fn(T));
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_use_covariant_struct1 () { check (r#"
...
"# , expect ! [[r#"
                ...
                foo['min: contravariant, 'max: covariant]
            "#]] ,) ; } # [test] fn rustc_test_variance_use_covariant_struct2 () { check (r#"
struct SomeStruct<T>(T);
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn rustc_test_variance_use_invariant_struct1 () { check (r#"
...
"# , expect ! [[r#"
            ...
            "#]] ,) ; } # [test] fn invalid_arg_counts () { check (r#"
struct S<T>(T);
struct S2<T>(S<>);
struct S3<T>(S<T, T>);
"# , expect ! [[r#"
