// Generated macro for type_alias_bounds_with_diagnostics (function)
macro_rules! Depcrate_lowertype_alias_bounds_with_diagnostics {
() => {
// Module: crate::lower
// Provides: {"type_alias_bounds_with_diagnostics"}
// Dependencies: {}
