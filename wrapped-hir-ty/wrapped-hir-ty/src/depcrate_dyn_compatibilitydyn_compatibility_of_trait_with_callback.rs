// Generated macro for dyn_compatibility_of_trait_with_callback (function)
macro_rules! Depcrate_dyn_compatibilitydyn_compatibility_of_trait_with_callback {
() => {
// Module: crate::dyn_compatibility
// Provides: {"dyn_compatibility_of_trait_with_callback"}
// Dependencies: {}
