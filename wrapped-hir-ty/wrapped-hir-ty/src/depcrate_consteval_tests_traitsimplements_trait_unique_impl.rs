// Generated macro for implements_trait_unique_impl (function)
macro_rules! Depcrate_consteval_tests_traitsimplements_trait_unique_impl {
() => {
// Module: crate::consteval::tests::traits
// Provides: {"implements_trait_unique_impl"}
// Dependencies: {}
