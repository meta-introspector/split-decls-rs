// Generated macro for TreatNotYetDefinedOpaques (enum)
macro_rules! Depcrate_consteval_tests_method_resolutionTreatNotYetDefinedOpaques {
() => {
// Module: crate::consteval::tests::method_resolution
// Provides: {"TreatNotYetDefinedOpaques"}
// Dependencies: {}
