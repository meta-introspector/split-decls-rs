// Generated macro for callable_item_signature_query (function)
macro_rules! Depcrate_lowercallable_item_signature_query {
() => {
// Module: crate::lower
// Provides: {"callable_item_signature_query"}
// Dependencies: {}
