// Generated macro for fn_sig_for_enum_variant_constructor (function)
macro_rules! Depcrate_lowerfn_sig_for_enum_variant_constructor {
() => {
// Module: crate::lower
// Provides: {"fn_sig_for_enum_variant_constructor"}
// Dependencies: {}
