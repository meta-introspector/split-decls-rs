// Generated macro for incoherent_inherent_impls (function)
macro_rules! Depcrate_consteval_tests_method_resolutionincoherent_inherent_impls {
() => {
// Module: crate::consteval::tests::method_resolution
// Provides: {"incoherent_inherent_impls"}
// Dependencies: {}
