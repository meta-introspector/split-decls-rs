...
impl<'db> MemoryMap<'db> {
    ...
    #[doc = " This functions convert each address by a function `f` which gets the byte intervals and assign an address"]
    #[doc = " to them. It is useful when you want to load a constant with a memory map in a new memory. You can pass an"]
    #[doc = " allocator function as `f` and it will return a mapping of old addresses to new addresses."]
