// Generated macro for ComdatSectionIteratorInternal (enum)
macro_rules! Depcrate_read_anyComdatSectionIteratorInternal {
() => {
// Module: crate::read::any
// Provides: {"ComdatSectionIteratorInternal"}
// Dependencies: {}
