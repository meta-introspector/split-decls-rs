// Generated macro for collect_dependencies_with_metadata (function)
macro_rules! Depcrate_dependenciescollect_dependencies_with_metadata {
() => {
// Module: crate::dependencies
// Provides: {"collect_dependencies_with_metadata"}
// Dependencies: {}
