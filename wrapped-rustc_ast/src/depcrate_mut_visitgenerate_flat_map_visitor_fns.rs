// Generated macro for generate_flat_map_visitor_fns (macro)
macro_rules! Depcrate_mut_visitgenerate_flat_map_visitor_fns {
() => {
// Module: crate::mut_visit
// Provides: {"generate_flat_map_visitor_fns"}
// Dependencies: {}
