...
impl ProcMacro {
    #[doc = " Returns the name of the procedural macro."]
    pub fn name(&self) -> &str {
        &self.name
    }
    #[doc = " Returns the type of procedural macro."]
    ...
    #[doc = " On some server versions, the fixup ast id is different than ours. So change it to match."]
    ...
    #[doc = " Expands the procedural macro by sending an expansion request to the server."]
    #[doc = " This includes span information and environmental context."]
    pub fn expand(
        &self,
