// Generated macro for write_smir_pretty (function)
macro_rules! Depcrate_rustc_internal_prettywrite_smir_pretty {
() => {
// Module: crate::rustc_internal::pretty
// Provides: {"write_smir_pretty"}
// Dependencies: {}
