// Generated macro for render_resolution_with_import (function)
macro_rules! Depcrate_renderrender_resolution_with_import {
() => {
// Module: crate::render
// Provides: {"render_resolution_with_import"}
// Dependencies: {}
