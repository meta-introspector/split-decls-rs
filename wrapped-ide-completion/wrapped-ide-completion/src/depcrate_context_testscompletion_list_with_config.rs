// Generated macro for completion_list_with_config (function)
macro_rules! Depcrate_context_testscompletion_list_with_config {
() => {
// Module: crate::context::tests
// Provides: {"completion_list_with_config"}
// Dependencies: {}
