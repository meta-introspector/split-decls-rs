...
#[doc = " Moves a list of directories and files to another place recursively, with"]
...
#[doc = "  }"]
#[doc = "  // move dir1 and file1.txt to target/dir1 and target/file1.txt"]
#[doc = "  let mut from_paths = Vec::new();"]
#[doc = "  from_paths.push(\"source/dir1\");"]
#[doc = "  from_paths.push(\"source/file.txt\");"]
#[doc = "  move_items_with_progress(&from_paths, \"target\", &options, handle)?;"]
#[doc = " ```"]
#[doc = ""]
