...
#[doc = " Copies a list of directories and files to another place recursively, with"]
#[doc = " information about progress. This function will also copy the permission bits of the"]
#[doc = " original files to destination files (not for directories)."]
#[doc = ""]
#[doc = " # Errors"]
#[doc = ""]
#[doc = " This function will return an error in the following situations, but is not limited to just"]
#[doc = " these case:"]
#[doc = ""]
#[doc = " * List `from` contains  file or directory does not exist."]
#[doc = ""]
#[doc = " * List `from` contains  file or directory with invalid name."]
#[doc = ""]
#[doc = " * The current process does not have the permission to access to file from `lists from` or"]
#[doc = " `to`."]
#[doc = ""]
#[doc = " # Example"]
#[doc = " ```rust,ignore"]
#[doc = ""]
#[doc = "  extern crate fs_extra;"]
#[doc = "  use fs_extra::dir::copy;"]
#[doc = ""]
#[doc = "  let options = dir::CopyOptions::new(); //Initialize default values for CopyOptions"]
#[doc = "  let handle = |process_info: TransitProcess| {"]
#[doc = "     println!(\"{}\", process_info.total_bytes);"]
#[doc = "     fs_extra::dir::TransitProcessResult::ContinueOrAbort"]
#[doc = "  }"]
#[doc = "  // copy dir1 and file1.txt to target/dir1 and target/file1.txt"]
#[doc = "  let mut from_paths = Vec::new();"]
#[doc = "  from_paths.push(\"source/dir1\");"]
#[doc = "  from_paths.push(\"source/file.txt\");"]
#[doc = "  copy_items_with_progress(&from_paths, \"target\", &options, handle)?;"]
#[doc = " ```"]
#[doc = ""]
