// Generated macro for check_method_is_structurally_compatible (function)
macro_rules! Depcrate_check_compare_impl_itemcheck_method_is_structurally_compatible {
() => {
// Module: crate::check::compare_impl_item
// Provides: {"check_method_is_structurally_compatible"}
// Dependencies: {}
