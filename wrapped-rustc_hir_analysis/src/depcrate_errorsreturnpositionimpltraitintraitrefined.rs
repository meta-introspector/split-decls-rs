// Generated macro for ReturnPositionImplTraitInTraitRefined (struct)
macro_rules! Depcrate_errorsReturnPositionImplTraitInTraitRefined {
() => {
// Module: crate::errors
// Provides: {"ReturnPositionImplTraitInTraitRefined"}
// Dependencies: {}
