// Generated macro for inherit_generics_for_delegation_item (function)
macro_rules! Depcrate_delegationinherit_generics_for_delegation_item {
() => {
// Module: crate::delegation
// Provides: {"inherit_generics_for_delegation_item"}
// Dependencies: {}
