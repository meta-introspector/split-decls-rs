// Generated macro for WrongNumberOfGenericArgumentsToIntrinsic (struct)
macro_rules! Depcrate_errorsWrongNumberOfGenericArgumentsToIntrinsic {
() => {
// Module: crate::errors
// Provides: {"WrongNumberOfGenericArgumentsToIntrinsic"}
// Dependencies: {}
