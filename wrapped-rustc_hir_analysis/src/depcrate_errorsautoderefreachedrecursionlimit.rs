// Generated macro for AutoDerefReachedRecursionLimit (struct)
macro_rules! Depcrate_errorsAutoDerefReachedRecursionLimit {
() => {
// Module: crate::errors
// Provides: {"AutoDerefReachedRecursionLimit"}
// Dependencies: {}
