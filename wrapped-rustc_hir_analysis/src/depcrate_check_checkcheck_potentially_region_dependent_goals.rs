// Generated macro for check_potentially_region_dependent_goals (function)
macro_rules! Depcrate_check_checkcheck_potentially_region_dependent_goals {
() => {
// Module: crate::check::check
// Provides: {"check_potentially_region_dependent_goals"}
// Dependencies: {}
