// Generated macro for inherit_predicates_for_delegation_item (function)
macro_rules! Depcrate_delegationinherit_predicates_for_delegation_item {
() => {
// Module: crate::delegation
// Provides: {"inherit_predicates_for_delegation_item"}
// Dependencies: {}
