// Generated macro for OpaqueCapturesHigherRankedLifetime (struct)
macro_rules! Depcrate_errorsOpaqueCapturesHigherRankedLifetime {
() => {
// Module: crate::errors
// Provides: {"OpaqueCapturesHigherRankedLifetime"}
// Dependencies: {}
