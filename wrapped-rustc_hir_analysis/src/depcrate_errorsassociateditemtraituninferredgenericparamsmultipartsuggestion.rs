// Generated macro for AssociatedItemTraitUninferredGenericParamsMultipartSuggestion (struct)
macro_rules! Depcrate_errorsAssociatedItemTraitUninferredGenericParamsMultipartSuggestion {
() => {
// Module: crate::errors
// Provides: {"AssociatedItemTraitUninferredGenericParamsMultipartSuggestion"}
// Dependencies: {}
