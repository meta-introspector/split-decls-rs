// Generated macro for check_inferred_predicates (function)
macro_rules! Depcrate_outlives_implicit_infercheck_inferred_predicates {
() => {
// Module: crate::outlives::implicit_infer
// Provides: {"check_inferred_predicates"}
// Dependencies: {}
