// Generated macro for LifetimesOrBoundsMismatchOnTrait (struct)
macro_rules! Depcrate_errorsLifetimesOrBoundsMismatchOnTrait {
() => {
// Module: crate::errors
// Provides: {"LifetimesOrBoundsMismatchOnTrait"}
// Dependencies: {}
