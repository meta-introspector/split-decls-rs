// Generated macro for check_specialization_validity (function)
macro_rules! Depcrate_check_checkcheck_specialization_validity {
() => {
// Module: crate::check::check
// Provides: {"check_specialization_validity"}
// Dependencies: {}
