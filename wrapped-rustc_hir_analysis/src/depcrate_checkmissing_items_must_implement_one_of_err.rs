// Generated macro for missing_items_must_implement_one_of_err (function)
macro_rules! Depcrate_checkmissing_items_must_implement_one_of_err {
() => {
// Module: crate::check
// Provides: {"missing_items_must_implement_one_of_err"}
// Dependencies: {}
