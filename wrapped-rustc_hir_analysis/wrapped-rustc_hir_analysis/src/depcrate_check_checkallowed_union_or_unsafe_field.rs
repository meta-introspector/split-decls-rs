// Generated macro for allowed_union_or_unsafe_field (function)
macro_rules! Depcrate_check_checkallowed_union_or_unsafe_field {
() => {
// Module: crate::check::check
// Provides: {"allowed_union_or_unsafe_field"}
// Dependencies: {}
