// Generated macro for check_explicit_predicates (function)
macro_rules! Depcrate_outlives_implicit_infercheck_explicit_predicates {
() => {
// Module: crate::outlives::implicit_infer
// Provides: {"check_explicit_predicates"}
// Dependencies: {}
