// Generated macro for sanity_check_found_hidden_type (function)
macro_rules! Depcrate_check_checksanity_check_found_hidden_type {
() => {
// Module: crate::check::check
// Provides: {"sanity_check_found_hidden_type"}
// Dependencies: {}
