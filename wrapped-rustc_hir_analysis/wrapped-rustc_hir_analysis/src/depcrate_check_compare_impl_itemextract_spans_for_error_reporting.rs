// Generated macro for extract_spans_for_error_reporting (function)
macro_rules! Depcrate_check_compare_impl_itemextract_spans_for_error_reporting {
() => {
// Module: crate::check::compare_impl_item
// Provides: {"extract_spans_for_error_reporting"}
// Dependencies: {}
