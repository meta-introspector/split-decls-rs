// Generated macro for ValueOfAssociatedStructAlreadySpecified (struct)
macro_rules! Depcrate_errorsValueOfAssociatedStructAlreadySpecified {
() => {
// Module: crate::errors
// Provides: {"ValueOfAssociatedStructAlreadySpecified"}
// Dependencies: {}
