// Generated macro for rendered_precise_capturing_args (function)
macro_rules! Depcrate_collectrendered_precise_capturing_args {
() => {
// Module: crate::collect
// Provides: {"rendered_precise_capturing_args"}
// Dependencies: {}
