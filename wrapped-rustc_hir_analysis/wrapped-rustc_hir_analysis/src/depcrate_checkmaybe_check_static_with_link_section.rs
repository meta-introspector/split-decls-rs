// Generated macro for maybe_check_static_with_link_section (function)
macro_rules! Depcrate_checkmaybe_check_static_with_link_section {
() => {
// Module: crate::check
// Provides: {"maybe_check_static_with_link_section"}
// Dependencies: {}
