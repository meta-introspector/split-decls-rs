// Generated macro for try_report_async_mismatch (function)
macro_rules! Depcrate_check_compare_impl_itemtry_report_async_mismatch {
() => {
// Module: crate::check::compare_impl_item
// Provides: {"try_report_async_mismatch"}
// Dependencies: {}
