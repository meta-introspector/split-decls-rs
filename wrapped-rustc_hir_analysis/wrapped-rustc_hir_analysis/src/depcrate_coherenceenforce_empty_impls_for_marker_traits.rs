// Generated macro for enforce_empty_impls_for_marker_traits (function)
macro_rules! Depcrate_coherenceenforce_empty_impls_for_marker_traits {
() => {
// Module: crate::coherence
// Provides: {"enforce_empty_impls_for_marker_traits"}
// Dependencies: {}
