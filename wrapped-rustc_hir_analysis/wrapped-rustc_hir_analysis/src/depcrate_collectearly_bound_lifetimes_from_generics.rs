// Generated macro for early_bound_lifetimes_from_generics (function)
macro_rules! Depcrate_collectearly_bound_lifetimes_from_generics {
() => {
// Module: crate::collect
// Provides: {"early_bound_lifetimes_from_generics"}
// Dependencies: {}
