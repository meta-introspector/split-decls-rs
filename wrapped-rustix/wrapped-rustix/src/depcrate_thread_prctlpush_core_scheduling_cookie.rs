// Generated macro for push_core_scheduling_cookie (function)
macro_rules! Depcrate_thread_prctlpush_core_scheduling_cookie {
() => {
// Module: crate::thread::prctl
// Provides: {"push_core_scheduling_cookie"}
// Dependencies: {}
