// Generated macro for fd_set_num_elements_for_fd_array (function)
macro_rules! Depcrate_event_selectfd_set_num_elements_for_fd_array {
() => {
// Module: crate::event::select
// Provides: {"fd_set_num_elements_for_fd_array"}
// Dependencies: {}
