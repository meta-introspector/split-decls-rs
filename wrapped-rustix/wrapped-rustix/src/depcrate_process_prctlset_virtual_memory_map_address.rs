// Generated macro for set_virtual_memory_map_address (function)
macro_rules! Depcrate_process_prctlset_virtual_memory_map_address {
() => {
// Module: crate::process::prctl
// Provides: {"set_virtual_memory_map_address"}
// Dependencies: {}
