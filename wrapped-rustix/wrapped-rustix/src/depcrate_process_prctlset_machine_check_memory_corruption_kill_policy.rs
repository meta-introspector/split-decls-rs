// Generated macro for set_machine_check_memory_corruption_kill_policy (function)
macro_rules! Depcrate_process_prctlset_machine_check_memory_corruption_kill_policy {
() => {
// Module: crate::process::prctl
// Provides: {"set_machine_check_memory_corruption_kill_policy"}
// Dependencies: {}
