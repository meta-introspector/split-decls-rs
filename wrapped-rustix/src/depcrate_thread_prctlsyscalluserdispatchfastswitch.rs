// Generated macro for SysCallUserDispatchFastSwitch (enum)
macro_rules! Depcrate_thread_prctlSysCallUserDispatchFastSwitch {
() => {
// Module: crate::thread::prctl
// Provides: {"SysCallUserDispatchFastSwitch"}
// Dependencies: {}
