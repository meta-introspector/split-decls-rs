// Generated macro for enable_syscall_user_dispatch (function)
macro_rules! Depcrate_thread_prctlenable_syscall_user_dispatch {
() => {
// Module: crate::thread::prctl
// Provides: {"enable_syscall_user_dispatch"}
// Dependencies: {}
