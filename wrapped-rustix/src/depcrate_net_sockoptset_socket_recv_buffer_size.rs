// Generated macro for set_socket_recv_buffer_size (function)
macro_rules! Depcrate_net_sockoptset_socket_recv_buffer_size {
() => {
// Module: crate::net::sockopt
// Provides: {"set_socket_recv_buffer_size"}
// Dependencies: {}
