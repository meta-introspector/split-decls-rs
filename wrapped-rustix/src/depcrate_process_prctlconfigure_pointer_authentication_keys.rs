// Generated macro for configure_pointer_authentication_keys (function)
macro_rules! Depcrate_process_prctlconfigure_pointer_authentication_keys {
() => {
// Module: crate::process::prctl
// Provides: {"configure_pointer_authentication_keys"}
// Dependencies: {}
