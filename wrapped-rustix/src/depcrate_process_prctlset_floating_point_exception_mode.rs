// Generated macro for set_floating_point_exception_mode (function)
macro_rules! Depcrate_process_prctlset_floating_point_exception_mode {
() => {
// Module: crate::process::prctl
// Provides: {"set_floating_point_exception_mode"}
// Dependencies: {}
