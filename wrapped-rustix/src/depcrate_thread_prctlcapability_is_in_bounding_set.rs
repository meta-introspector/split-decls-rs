// Generated macro for capability_is_in_bounding_set (function)
macro_rules! Depcrate_thread_prctlcapability_is_in_bounding_set {
() => {
// Module: crate::thread::prctl
// Provides: {"capability_is_in_bounding_set"}
// Dependencies: {}
