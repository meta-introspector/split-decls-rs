// Generated macro for create_core_scheduling_cookie (function)
macro_rules! Depcrate_thread_prctlcreate_core_scheduling_cookie {
() => {
// Module: crate::thread::prctl
// Provides: {"create_core_scheduling_cookie"}
// Dependencies: {}
