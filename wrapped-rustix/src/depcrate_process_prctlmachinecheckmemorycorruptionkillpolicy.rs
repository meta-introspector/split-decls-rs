// Generated macro for MachineCheckMemoryCorruptionKillPolicy (enum)
macro_rules! Depcrate_process_prctlMachineCheckMemoryCorruptionKillPolicy {
() => {
// Module: crate::process::prctl
// Provides: {"MachineCheckMemoryCorruptionKillPolicy"}
// Dependencies: {}
