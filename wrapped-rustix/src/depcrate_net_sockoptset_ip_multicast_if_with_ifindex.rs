// Generated macro for set_ip_multicast_if_with_ifindex (function)
macro_rules! Depcrate_net_sockoptset_ip_multicast_if_with_ifindex {
() => {
// Module: crate::net::sockopt
// Provides: {"set_ip_multicast_if_with_ifindex"}
// Dependencies: {}
