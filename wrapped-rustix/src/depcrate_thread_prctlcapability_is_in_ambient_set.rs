// Generated macro for capability_is_in_ambient_set (function)
macro_rules! Depcrate_thread_prctlcapability_is_in_ambient_set {
() => {
// Module: crate::thread::prctl
// Provides: {"capability_is_in_ambient_set"}
// Dependencies: {}
