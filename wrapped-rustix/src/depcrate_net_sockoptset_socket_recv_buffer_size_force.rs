// Generated macro for set_socket_recv_buffer_size_force (function)
macro_rules! Depcrate_net_sockoptset_socket_recv_buffer_size_force {
() => {
// Module: crate::net::sockopt
// Provides: {"set_socket_recv_buffer_size_force"}
// Dependencies: {}
