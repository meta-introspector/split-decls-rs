// Generated macro for parse_to_token_tree_static_span (function)
macro_rules! Depcrateparse_to_token_tree_static_span {
() => {
// Module: crate
// Provides: {"parse_to_token_tree_static_span"}
// Dependencies: {}
