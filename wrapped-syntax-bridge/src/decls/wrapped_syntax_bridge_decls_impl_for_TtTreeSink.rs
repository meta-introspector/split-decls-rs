...
where
    ...
    Ctx: PartialEq,
{
    #[doc = " Parses a float literal as if it was a one to two name ref nodes with a dot inbetween."]
    #[doc = " This occurs when a float literal is used as a field access."]
