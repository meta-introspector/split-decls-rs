// Generated macro for WHITESPACE_ANCHORED_REV (static)
macro_rules! Depcrate_unicode_fsm_whitespace_anchored_revWHITESPACE_ANCHORED_REV {
() => {
// Module: crate::unicode::fsm::whitespace_anchored_rev
// Provides: {"WHITESPACE_ANCHORED_REV"}
// Dependencies: {}
