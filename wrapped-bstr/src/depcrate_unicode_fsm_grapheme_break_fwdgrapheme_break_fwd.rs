// Generated macro for GRAPHEME_BREAK_FWD (static)
macro_rules! Depcrate_unicode_fsm_grapheme_break_fwdGRAPHEME_BREAK_FWD {
() => {
// Module: crate::unicode::fsm::grapheme_break_fwd
// Provides: {"GRAPHEME_BREAK_FWD"}
// Dependencies: {}
