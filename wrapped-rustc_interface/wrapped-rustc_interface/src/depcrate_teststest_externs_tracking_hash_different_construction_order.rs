// Generated macro for test_externs_tracking_hash_different_construction_order (function)
macro_rules! Depcrate_teststest_externs_tracking_hash_different_construction_order {
() => {
// Module: crate::tests
// Provides: {"test_externs_tracking_hash_different_construction_order"}
// Dependencies: {}
