// Generated macro for initialize_checked_jobserver (function)
macro_rules! Depcrate_interfaceinitialize_checked_jobserver {
() => {
// Module: crate::interface
// Provides: {"initialize_checked_jobserver"}
// Dependencies: {}
