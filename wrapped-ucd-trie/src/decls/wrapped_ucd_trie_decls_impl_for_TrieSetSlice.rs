...
impl<'a> TrieSetSlice<'a> {
    #[doc = " Returns true if and only if the given Unicode scalar value is in this"]
    #[doc = " set."]
    pub fn contains_char(&self, c: char) -> bool {
        self.contains(c as usize)
    }
    #[doc = " Returns true if and only if the given codepoint is in this set."]
    #[doc = ""]
    #[doc = " If the given value exceeds the codepoint range (i.e., it's greater"]
    #[doc = " than `0x10FFFF`), then this returns false."]
