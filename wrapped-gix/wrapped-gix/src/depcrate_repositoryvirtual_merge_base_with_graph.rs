// Generated macro for virtual_merge_base_with_graph (module)
macro_rules! Depcrate_repositoryvirtual_merge_base_with_graph {
() => {
// Module: crate::repository
// Provides: {"virtual_merge_base_with_graph"}
// Dependencies: {}
