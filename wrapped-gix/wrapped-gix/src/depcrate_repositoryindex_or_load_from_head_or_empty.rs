// Generated macro for index_or_load_from_head_or_empty (module)
macro_rules! Depcrate_repositoryindex_or_load_from_head_or_empty {
() => {
// Module: crate::repository
// Provides: {"index_or_load_from_head_or_empty"}
// Dependencies: {}
