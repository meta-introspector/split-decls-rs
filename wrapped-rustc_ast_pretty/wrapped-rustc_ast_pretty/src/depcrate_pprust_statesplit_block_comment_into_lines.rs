// Generated macro for split_block_comment_into_lines (function)
macro_rules! Depcrate_pprust_statesplit_block_comment_into_lines {
() => {
// Module: crate::pprust::state
// Provides: {"split_block_comment_into_lines"}
// Dependencies: {}
