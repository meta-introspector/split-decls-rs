...
#[path = "src/dot_dot_rust_compiler_rustc_trait_selection_src_traits_dyn_compatibility.rs"]
mod dot_dot_rust_compiler_rustc_trait_selection_src_traits_dyn_compatibility;