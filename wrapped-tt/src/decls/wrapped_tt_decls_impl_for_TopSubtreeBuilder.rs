...
impl<S: Copy> TopSubtreeBuilder<S> {
    ...
    #[doc = " You cannot call this consecutively, it will only work once after close."]
    ...
    #[doc = " This does not check the token trees are valid, beware!"]
    ...
    #[doc = " Like [`Self::extend_with_tt()`], but makes sure the new tokens will never be"]
    #[doc = " joint with whatever comes after them."]
    ...
    #[doc = " Builds, and remove the top subtree if it has only one subtree child."]
