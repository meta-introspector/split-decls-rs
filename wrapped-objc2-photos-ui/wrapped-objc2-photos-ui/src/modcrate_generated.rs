...
() => {
        ...
        Depcrate_generated__PHContentEditingController!();
        Depcrate_generated__PHLivePhotoView!();
        Depcrate_generated__PHPicker!();
        Depcrate_generated__PHProjectExtensionContext!();
        Depcrate_generated__PHProjectExtensionController!();
        Depcrate_generated__PHProjectInfo!();
        Depcrate_generated__PHProjectTypeDescription!();
        Depcrate_generated__PHProjectTypeDescriptionDataSource!();
        Depcrate_generated__PhotosUITypes!();
