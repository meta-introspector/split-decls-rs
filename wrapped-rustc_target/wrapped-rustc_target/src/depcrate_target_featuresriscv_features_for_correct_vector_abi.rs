// Generated macro for RISCV_FEATURES_FOR_CORRECT_VECTOR_ABI (const)
macro_rules! Depcrate_target_featuresRISCV_FEATURES_FOR_CORRECT_VECTOR_ABI {
() => {
// Module: crate::target_features
// Provides: {"RISCV_FEATURES_FOR_CORRECT_VECTOR_ABI"}
// Dependencies: {}
