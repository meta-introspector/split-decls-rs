...
#[path = "src/dot_dot_rust_library_compiler_builtins_compiler_builtins_src_int_addsub.rs"]
mod dot_dot_rust_library_compiler_builtins_compiler_builtins_src_int_addsub;