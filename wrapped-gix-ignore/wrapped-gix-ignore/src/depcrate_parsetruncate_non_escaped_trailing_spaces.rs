// Generated macro for truncate_non_escaped_trailing_spaces (function)
macro_rules! Depcrate_parsetruncate_non_escaped_trailing_spaces {
() => {
// Module: crate::parse
// Provides: {"truncate_non_escaped_trailing_spaces"}
// Dependencies: {}
