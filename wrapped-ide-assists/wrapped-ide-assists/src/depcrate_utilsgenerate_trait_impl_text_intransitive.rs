// Generated macro for generate_trait_impl_text_intransitive (function)
macro_rules! Depcrate_utilsgenerate_trait_impl_text_intransitive {
() => {
// Module: crate::utils
// Provides: {"generate_trait_impl_text_intransitive"}
// Dependencies: {}
