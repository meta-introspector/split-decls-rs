...
#[path = "src/dot_dot_rust_library_compiler_builtins_libm_src_math_generic_fma_wide.rs"]
mod dot_dot_rust_library_compiler_builtins_libm_src_math_generic_fma_wide;