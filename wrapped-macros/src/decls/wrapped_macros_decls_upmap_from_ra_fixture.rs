...
fn upmap_from_ra_fixture(mut s: synstructure::Structure<'_>) -> proc_macro2::TokenStream {
    ...
    s.bound_impl(
        ...
        quote! {
            fn upmap_from_ra_fixture(self, __analysis :
            &::ide_db::ra_fixture::RaFixtureAnalysis, __virtual_file_id :
            ::ide_db::ra_fixture::FileId, __real_file_id : ::ide_db::ra_fixture::FileId,)
            -> Result < Self, () > { Ok(match self { # body }) }
        },
    )
}
