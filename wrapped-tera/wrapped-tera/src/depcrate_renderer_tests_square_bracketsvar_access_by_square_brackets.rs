// Generated macro for var_access_by_square_brackets (function)
macro_rules! Depcrate_renderer_tests_square_bracketsvar_access_by_square_brackets {
() => {
// Module: crate::renderer::tests::square_brackets
// Provides: {"var_access_by_square_brackets"}
// Dependencies: {}
