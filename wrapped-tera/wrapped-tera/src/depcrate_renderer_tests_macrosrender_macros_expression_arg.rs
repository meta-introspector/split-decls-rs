// Generated macro for render_macros_expression_arg (function)
macro_rules! Depcrate_renderer_tests_macrosrender_macros_expression_arg {
() => {
// Module: crate::renderer::tests::macros
// Provides: {"render_macros_expression_arg"}
// Dependencies: {}
