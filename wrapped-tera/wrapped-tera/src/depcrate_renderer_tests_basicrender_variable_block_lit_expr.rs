// Generated macro for render_variable_block_lit_expr (function)
macro_rules! Depcrate_renderer_tests_basicrender_variable_block_lit_expr {
() => {
// Module: crate::renderer::tests::basic
// Provides: {"render_variable_block_lit_expr"}
// Dependencies: {}
