// Generated macro for add_set_values_in_context (function)
macro_rules! Depcrate_renderer_tests_basicadd_set_values_in_context {
() => {
// Module: crate::renderer::tests::basic
// Provides: {"add_set_values_in_context"}
// Dependencies: {}
