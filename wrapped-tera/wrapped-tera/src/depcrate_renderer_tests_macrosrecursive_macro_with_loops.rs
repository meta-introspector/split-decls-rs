// Generated macro for recursive_macro_with_loops (function)
macro_rules! Depcrate_renderer_tests_macrosrecursive_macro_with_loops {
() => {
// Module: crate::renderer::tests::macros
// Provides: {"recursive_macro_with_loops"}
// Dependencies: {}
