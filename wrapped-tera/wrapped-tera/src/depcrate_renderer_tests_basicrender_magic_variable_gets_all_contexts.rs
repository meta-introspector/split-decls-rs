// Generated macro for render_magic_variable_gets_all_contexts (function)
macro_rules! Depcrate_renderer_tests_basicrender_magic_variable_gets_all_contexts {
() => {
// Module: crate::renderer::tests::basic
// Provides: {"render_magic_variable_gets_all_contexts"}
// Dependencies: {}
