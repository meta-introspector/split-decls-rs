// Generated macro for parse_variable_tag_negated_expr_with_parentheses (function)
macro_rules! Depcrate_parser_tests_parserparse_variable_tag_negated_expr_with_parentheses {
() => {
// Module: crate::parser::tests::parser
// Provides: {"parse_variable_tag_negated_expr_with_parentheses"}
// Dependencies: {}
