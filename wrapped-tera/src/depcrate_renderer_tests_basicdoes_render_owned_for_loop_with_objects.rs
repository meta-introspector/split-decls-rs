// Generated macro for does_render_owned_for_loop_with_objects (function)
macro_rules! Depcrate_renderer_tests_basicdoes_render_owned_for_loop_with_objects {
() => {
// Module: crate::renderer::tests::basic
// Provides: {"does_render_owned_for_loop_with_objects"}
// Dependencies: {}
