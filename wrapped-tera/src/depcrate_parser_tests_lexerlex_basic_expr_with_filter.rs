// Generated macro for lex_basic_expr_with_filter (function)
macro_rules! Depcrate_parser_tests_lexerlex_basic_expr_with_filter {
() => {
// Module: crate::parser::tests::lexer
// Provides: {"lex_basic_expr_with_filter"}
// Dependencies: {}
