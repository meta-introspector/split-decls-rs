// Generated macro for evaluate_sub_variables (function)
macro_rules! Depcrate_renderer_processorevaluate_sub_variables {
() => {
// Module: crate::renderer::processor
// Provides: {"evaluate_sub_variables"}
// Dependencies: {}
