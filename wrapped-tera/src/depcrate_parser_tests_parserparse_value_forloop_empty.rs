// Generated macro for parse_value_forloop_empty (function)
macro_rules! Depcrate_parser_tests_parserparse_value_forloop_empty {
() => {
// Module: crate::parser::tests::parser
// Provides: {"parse_value_forloop_empty"}
// Dependencies: {}
