// Generated macro for parse_variable_tag_simple_test (function)
macro_rules! Depcrate_parser_tests_parserparse_variable_tag_simple_test {
() => {
// Module: crate::parser::tests::parser
// Provides: {"parse_variable_tag_simple_test"}
// Dependencies: {}
