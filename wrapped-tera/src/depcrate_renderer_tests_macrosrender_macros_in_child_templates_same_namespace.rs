// Generated macro for render_macros_in_child_templates_same_namespace (function)
macro_rules! Depcrate_renderer_tests_macrosrender_macros_in_child_templates_same_namespace {
() => {
// Module: crate::renderer::tests::macros
// Provides: {"render_macros_in_child_templates_same_namespace"}
// Dependencies: {}
