// Generated macro for normalize_canonicalized_free_alias (function)
macro_rules! Depcrate_normalize_projection_tynormalize_canonicalized_free_alias {
() => {
// Module: crate::normalize_projection_ty
// Provides: {"normalize_canonicalized_free_alias"}
// Dependencies: {}
