// Generated macro for try_normalize_after_erasing_regions (function)
macro_rules! Depcrate_normalize_erasing_regionstry_normalize_after_erasing_regions {
() => {
// Module: crate::normalize_erasing_regions
// Provides: {"try_normalize_after_erasing_regions"}
// Dependencies: {}
