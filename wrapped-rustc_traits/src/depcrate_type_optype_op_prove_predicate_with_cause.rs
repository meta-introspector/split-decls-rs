// Generated macro for type_op_prove_predicate_with_cause (function)
macro_rules! Depcrate_type_optype_op_prove_predicate_with_cause {
() => {
// Module: crate::type_op
// Provides: {"type_op_prove_predicate_with_cause"}
// Dependencies: {}
