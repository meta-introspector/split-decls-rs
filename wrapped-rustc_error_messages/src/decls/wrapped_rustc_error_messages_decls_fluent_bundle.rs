...
#[doc = " Returns Fluent bundle with the user's locale resources from"]
#[doc = " `$sysroot/share/locale/$requested_locale/*.ftl`."]
#[doc = ""]
#[doc = " If `-Z additional-ftl-path` was provided, load that resource and add it  to the bundle"]
#[doc = " (overriding any conflicting messages)."]
