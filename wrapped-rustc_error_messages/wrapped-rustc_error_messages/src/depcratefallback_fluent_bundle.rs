// Generated macro for fallback_fluent_bundle (function)
macro_rules! Depcratefallback_fluent_bundle {
() => {
// Module: crate
// Provides: {"fallback_fluent_bundle"}
// Dependencies: {}
