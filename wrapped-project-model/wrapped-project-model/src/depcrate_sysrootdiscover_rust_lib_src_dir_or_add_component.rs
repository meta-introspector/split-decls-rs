// Generated macro for discover_rust_lib_src_dir_or_add_component (function)
macro_rules! Depcrate_sysrootdiscover_rust_lib_src_dir_or_add_component {
() => {
// Module: crate::sysroot
// Provides: {"discover_rust_lib_src_dir_or_add_component"}
// Dependencies: {}
