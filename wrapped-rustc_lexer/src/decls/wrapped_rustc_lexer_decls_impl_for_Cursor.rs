...
impl Cursor<'_> {
    #[doc = " Parses a token from the input string."]
    ...
    #[doc = " Given that one `-` was eaten, eat the rest of the frontmatter."]
    ...
    #[doc = " Eats double-quoted string and returns true"]
    #[doc = " if string is terminated."]
    ...
    #[doc = " Attempt to lex for a guarded string literal."]
    #[doc = ""]
    #[doc = " Used by `rustc_parse::lexer` to lex for guarded strings"]
    #[doc = " conditionally based on edition."]
    #[doc = ""]
    #[doc = " Note: this will not reset the `Cursor` when a"]
    #[doc = " guarded string is not found. It is the caller's"]
    #[doc = " responsibility to do so."]
    ...
    #[doc = " Eats the double-quoted string and returns `n_hashes` and an error if encountered."]
    ...
    #[doc = " Eats the float exponent. Returns true if at least one digit was met,"]
    #[doc = " and returns false otherwise."]
