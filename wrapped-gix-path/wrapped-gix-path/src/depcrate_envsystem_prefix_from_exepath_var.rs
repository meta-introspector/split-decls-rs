// Generated macro for system_prefix_from_exepath_var (function)
macro_rules! Depcrate_envsystem_prefix_from_exepath_var {
() => {
// Module: crate::env
// Provides: {"system_prefix_from_exepath_var"}
// Dependencies: {}
