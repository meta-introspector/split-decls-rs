// Generated macro for relative_path_from_value_and_path (function)
macro_rules! Depcrate_relative_pathrelative_path_from_value_and_path {
() => {
// Module: crate::relative_path
// Provides: {"relative_path_from_value_and_path"}
// Dependencies: {}
