// Generated macro for benchmark_expand_macro_rules (function)
macro_rules! Depcrate_benchmarkbenchmark_expand_macro_rules {
() => {
// Module: crate::benchmark
// Provides: {"benchmark_expand_macro_rules"}
// Dependencies: {}
