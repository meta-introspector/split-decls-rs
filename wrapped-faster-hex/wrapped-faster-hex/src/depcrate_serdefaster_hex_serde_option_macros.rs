// Generated macro for faster_hex_serde_option_macros (macro)
macro_rules! Depcrate_serdefaster_hex_serde_option_macros {
() => {
// Module: crate::serde
// Provides: {"faster_hex_serde_option_macros"}
// Dependencies: {}
