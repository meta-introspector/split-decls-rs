...
mod tests {
    ...
    #[cfg(feature = "alloc")]
    proptest! { # [test] fn test_hex_encode (ref s in ".*") { _test_hex_encode (s) ; } }
    #[cfg(not(feature = "alloc"))]
    proptest! { # [test] fn test_hex_encode (ref s in ".{0,16}") { _test_hex_encode (s) ; } }
    ...
    #[cfg(feature = "alloc")]
    proptest! { # [test] fn test_hex_decode (ref s in ".+") { _test_hex_decode (s) ; } }
    #[cfg(not(feature = "alloc"))]
    proptest! { # [test] fn test_hex_decode (ref s in ".{1,16}") { _test_hex_decode (s) ; } }
    ...
    proptest! { # [test] fn test_hex_decode_check (ref s in "([0-9a-fA-F][0-9a-fA-F])+") { _test_hex_decode_check (s , true) ; } }
    proptest! { # [test] fn test_hex_decode_check_odd (ref s in "[0-9a-fA-F]{11}") { _test_hex_decode_check (s , false) ; } }
}
