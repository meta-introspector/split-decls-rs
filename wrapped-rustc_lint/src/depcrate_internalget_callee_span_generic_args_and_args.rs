// Generated macro for get_callee_span_generic_args_and_args (function)
macro_rules! Depcrate_internalget_callee_span_generic_args_and_args {
() => {
// Module: crate::internal
// Provides: {"get_callee_span_generic_args_and_args"}
// Dependencies: {}
