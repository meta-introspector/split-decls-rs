// Generated macro for IntegerToPtrTransmutesSuggestion (enum)
macro_rules! Depcrate_lintsIntegerToPtrTransmutesSuggestion {
() => {
// Module: crate::lints
// Provides: {"IntegerToPtrTransmutesSuggestion"}
// Dependencies: {}
