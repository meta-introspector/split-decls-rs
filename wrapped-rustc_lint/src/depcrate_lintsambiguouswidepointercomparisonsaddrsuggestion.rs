// Generated macro for AmbiguousWidePointerComparisonsAddrSuggestion (struct)
macro_rules! Depcrate_lintsAmbiguousWidePointerComparisonsAddrSuggestion {
() => {
// Module: crate::lints
// Provides: {"AmbiguousWidePointerComparisonsAddrSuggestion"}
// Dependencies: {}
