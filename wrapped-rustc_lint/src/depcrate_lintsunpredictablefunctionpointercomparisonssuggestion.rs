// Generated macro for UnpredictableFunctionPointerComparisonsSuggestion (enum)
macro_rules! Depcrate_lintsUnpredictableFunctionPointerComparisonsSuggestion {
() => {
// Module: crate::lints
// Provides: {"UnpredictableFunctionPointerComparisonsSuggestion"}
// Dependencies: {}
