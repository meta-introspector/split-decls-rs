...
#[doc = " Tell the `LintStore` about all the built-in lints (the ones"]
#[doc = " defined in this crate and the ones defined in"]
#[doc = " `rustc_session::lint::builtin`)."]
fn register_builtins(store: &mut LintStore) {
    ...
    store . register_removed ("unsupported_naked_functions" , "converted into hard error, see RFC 2972 \
