// Generated macro for ClashingExternDeclarations (struct)
macro_rules! Depcrate_foreign_modulesClashingExternDeclarations {
() => {
// Module: crate::foreign_modules
// Provides: {"ClashingExternDeclarations"}
// Dependencies: {}
