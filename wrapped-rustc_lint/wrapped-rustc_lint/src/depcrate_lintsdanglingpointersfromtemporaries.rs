// Generated macro for DanglingPointersFromTemporaries (struct)
macro_rules! Depcrate_lintsDanglingPointersFromTemporaries {
() => {
// Module: crate::lints
// Provides: {"DanglingPointersFromTemporaries"}
// Dependencies: {}
