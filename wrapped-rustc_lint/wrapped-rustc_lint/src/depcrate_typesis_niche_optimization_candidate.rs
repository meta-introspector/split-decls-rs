// Generated macro for is_niche_optimization_candidate (function)
macro_rules! Depcrate_typesis_niche_optimization_candidate {
() => {
// Module: crate::types
// Provides: {"is_niche_optimization_candidate"}
// Dependencies: {}
