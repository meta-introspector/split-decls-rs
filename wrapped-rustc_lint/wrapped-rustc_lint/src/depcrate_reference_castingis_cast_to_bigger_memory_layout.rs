// Generated macro for is_cast_to_bigger_memory_layout (function)
macro_rules! Depcrate_reference_castingis_cast_to_bigger_memory_layout {
() => {
// Module: crate::reference_casting
// Provides: {"is_cast_to_bigger_memory_layout"}
// Dependencies: {}
