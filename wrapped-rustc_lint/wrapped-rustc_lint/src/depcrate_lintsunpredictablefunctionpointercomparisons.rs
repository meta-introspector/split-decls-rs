// Generated macro for UnpredictableFunctionPointerComparisons (enum)
macro_rules! Depcrate_lintsUnpredictableFunctionPointerComparisons {
() => {
// Module: crate::lints
// Provides: {"UnpredictableFunctionPointerComparisons"}
// Dependencies: {}
