// Generated macro for declare_combined_late_lint_pass (macro)
macro_rules! Depcrate_passesdeclare_combined_late_lint_pass {
() => {
// Module: crate::passes
// Provides: {"declare_combined_late_lint_pass"}
// Dependencies: {}
