// Generated macro for AmbiguousWidePointerComparisonsExpectSuggestion (struct)
macro_rules! Depcrate_lintsAmbiguousWidePointerComparisonsExpectSuggestion {
() => {
// Module: crate::lints
// Provides: {"AmbiguousWidePointerComparisonsExpectSuggestion"}
// Dependencies: {}
