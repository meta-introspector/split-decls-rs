// Generated macro for check_ptr_transmute_in_const (function)
macro_rules! Depcrate_transmutecheck_ptr_transmute_in_const {
() => {
// Module: crate::transmute
// Provides: {"check_ptr_transmute_in_const"}
// Dependencies: {}
