// Generated macro for UndroppedManuallyDropsSuggestion (struct)
macro_rules! Depcrate_lintsUndroppedManuallyDropsSuggestion {
() => {
// Module: crate::lints
// Provides: {"UndroppedManuallyDropsSuggestion"}
// Dependencies: {}
