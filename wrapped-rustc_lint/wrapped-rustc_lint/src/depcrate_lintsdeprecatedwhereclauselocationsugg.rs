// Generated macro for DeprecatedWhereClauseLocationSugg (enum)
macro_rules! Depcrate_lintsDeprecatedWhereClauseLocationSugg {
() => {
// Module: crate::lints
// Provides: {"DeprecatedWhereClauseLocationSugg"}
// Dependencies: {}
