// Generated macro for AmbiguousWidePointerComparisonsAddrMetadataSuggestion (struct)
macro_rules! Depcrate_lintsAmbiguousWidePointerComparisonsAddrMetadataSuggestion {
() => {
// Module: crate::lints
// Provides: {"AmbiguousWidePointerComparisonsAddrMetadataSuggestion"}
// Dependencies: {}
