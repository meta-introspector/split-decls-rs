// Generated macro for extract_def_id_from_arg (function)
macro_rules! Depcrate_impl_trait_overcapturesextract_def_id_from_arg {
() => {
// Module: crate::impl_trait_overcaptures
// Provides: {"extract_def_id_from_arg"}
// Dependencies: {}
