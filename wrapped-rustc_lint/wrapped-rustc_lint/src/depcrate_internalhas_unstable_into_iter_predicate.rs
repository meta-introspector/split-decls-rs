// Generated macro for has_unstable_into_iter_predicate (function)
macro_rules! Depcrate_internalhas_unstable_into_iter_predicate {
() => {
// Module: crate::internal
// Provides: {"has_unstable_into_iter_predicate"}
// Dependencies: {}
