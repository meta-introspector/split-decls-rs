// Generated macro for impl_output_slice_for_smart_ptr (macro)
macro_rules! Depcrate_types_external_list_sliceimpl_output_slice_for_smart_ptr {
() => {
// Module: crate::types::external::list::slice
// Provides: {"impl_output_slice_for_smart_ptr"}
// Dependencies: {}
