...
macro_rules! Depcrate_http_graphiql_sourcegraphiql_source {
() => {
// Module: crate::http::graphiql_source
// Provides: {"graphiql_source"}
// Dependencies: {}
# [doc = " Generate the page for GraphIQL"] pub fn graphiql_source (graphql_endpoint_url : & str , subscription_endpoint : Option < & str >) -> String { r#"
    <html>
  <head>
