// Generated macro for visit_operation_definition (function)
macro_rules! Depcrate_validation_visitorvisit_operation_definition {
() => {
// Module: crate::validation::visitor
// Provides: {"visit_operation_definition"}
// Dependencies: {}
