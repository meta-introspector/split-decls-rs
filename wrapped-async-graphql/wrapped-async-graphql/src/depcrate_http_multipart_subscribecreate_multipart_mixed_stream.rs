// Generated macro for create_multipart_mixed_stream (function)
macro_rules! Depcrate_http_multipart_subscribecreate_multipart_mixed_stream {
() => {
// Module: crate::http::multipart_subscribe
// Provides: {"create_multipart_mixed_stream"}
// Dependencies: {}
