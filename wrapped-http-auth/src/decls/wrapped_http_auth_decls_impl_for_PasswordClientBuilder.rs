...
impl PasswordClientBuilder {
    #[doc = " Considers all challenges from the given [`http::HeaderValue`] challenge list."]
    ...
    #[doc = " Returns true if no more challenges need to be examined."]
    ...
    #[doc = " Considers all challenges from the given `&str` challenge list."]
    ...
    #[doc = " Considers a single challenge."]
    ...
    #[doc = " Returns a new [`PasswordClient`] or fails."]
