...
impl<'i> ParamValue<'i> {
    #[doc = " Tries to create a new `ParamValue` from an escaped sequence, primarily for testing."]
    #[doc = ""]
    #[doc = " Validates the sequence and counts the number of escapes."]
    ...
    #[doc = " Creates a new param, panicking if invariants are not satisfied."]
    #[doc = " This is not part of the stable API; it's just for the fuzz tester to use."]
    #[doc(hidden)]
    ...
    #[doc = " Appends the unescaped form of this parameter to the supplied string."]
    ...
    #[doc = " Returns the unescaped length of this parameter; cheap."]
    #[inline]
    pub fn unescaped_len(&self) -> usize {
        self.escaped.len() - self.escapes
    }
    #[doc = " Returns the unescaped form of this parameter as a fresh `String`."]
    pub fn to_unescaped(&self) -> String {
        let mut to = String::new();
        self.append_unescaped(&mut to);
        to
    }
    #[doc = " Returns the unescaped form of this parameter, possibly appending it to `scratch`."]
    ...
    #[doc = " Returns the escaped string, unquoted."]
    #[inline]
