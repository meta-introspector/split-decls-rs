// Generated macro for StripUnconfigured (struct)
macro_rules! Depcrate_strip_unconfiguredStripUnconfigured {
() => {
// Module: crate::strip_unconfigured
// Provides: {"StripUnconfigured"}
// Dependencies: {}
