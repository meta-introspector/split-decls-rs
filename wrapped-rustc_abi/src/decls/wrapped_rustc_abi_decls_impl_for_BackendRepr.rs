...
impl BackendRepr {
    ...
    #[doc = " Returns `true` if this is a single signed integer scalar."]
    #[doc = " Sanity check: panics if this is not a scalar type (see PR #70189)."]
    #[inline]
    ...
    #[doc = " Returns `true` if this is a scalar type"]
    #[inline]
    pub fn is_scalar(&self) -> bool {
        matches!(*self, BackendRepr::Scalar(_))
    }
    #[doc = " Returns `true` if this is a bool"]
    #[inline]
    pub fn is_bool(&self) -> bool {
        matches ! (* self , BackendRepr :: Scalar (s) if s . is_bool ())
    }
    #[doc = " The psABI alignment for a `Scalar` or `ScalarPair`"]
    #[doc = ""]
    #[doc = " `None` for other variants."]
    ...
    #[doc = " The psABI size for a `Scalar` or `ScalarPair`"]
    #[doc = ""]
    #[doc = " `None` for other variants"]
    ...
    #[doc = " Discard validity range information and allow undef."]
