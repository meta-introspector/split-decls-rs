...
impl TargetDataLayout {
    #[doc = " Parse data layout from an"]
    #[doc = " [llvm data layout string](https://llvm.org/docs/LangRef.html#data-layout)"]
    #[doc = ""]
    #[doc = " This function doesn't fill `c_enum_min_size` and it will always be `I32` since it can not be"]
    #[doc = " determined from llvm string."]
    ...
    #[doc = " Returns **exclusive** upper bound on object size in bytes, in the default data address"]
    #[doc = " space."]
    #[doc = ""]
    #[doc = " The theoretical maximum object size is defined as the maximum positive `isize` value."]
    #[doc = " This ensures that the `offset` semantics remain well-defined by allowing it to correctly"]
    #[doc = " index every address within an object along with one byte past the end, along with allowing"]
    #[doc = " `isize` to store the difference between any two pointers into an object."]
    #[doc = ""]
    #[doc = " LLVM uses a 64-bit integer to represent object size in *bits*, but we care only for bytes,"]
    #[doc = " so we adopt such a more-constrained size bound due to its technical limitations."]
    #[inline]
    ...
    #[doc = " Returns **exclusive** upper bound on object size in bytes."]
    #[doc = ""]
    #[doc = " The theoretical maximum object size is defined as the maximum positive `isize` value."]
    #[doc = " This ensures that the `offset` semantics remain well-defined by allowing it to correctly"]
    #[doc = " index every address within an object along with one byte past the end, along with allowing"]
    ...
    #[doc = " psABI-mandated alignment for a vector type, if any"]
    #[inline]
    ...
    #[doc = " an alignment resembling the one LLVM would pick for a vector"]
    #[inline]
    ...
    #[doc = " Get the pointer size in the default data address space."]
    #[inline]
    pub fn pointer_size(&self) -> Size {
        self.default_address_space_pointer_spec.pointer_size
    }
    #[doc = " Get the pointer size in a specific address space."]
    #[inline]
    ...
    #[doc = " Get the pointer index in the default data address space."]
    #[inline]
    pub fn pointer_offset(&self) -> Size {
        self.default_address_space_pointer_spec.pointer_offset
    }
    #[doc = " Get the pointer index in a specific address space."]
    #[inline]
    ...
    #[doc = " Get the pointer alignment in the default data address space."]
    #[inline]
    pub fn pointer_align(&self) -> AbiAlign {
        AbiAlign::new(self.default_address_space_pointer_spec.pointer_align)
    }
    #[doc = " Get the pointer alignment in a specific address space."]
    #[inline]
