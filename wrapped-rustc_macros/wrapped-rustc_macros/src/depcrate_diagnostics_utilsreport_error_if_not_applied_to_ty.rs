// Generated macro for report_error_if_not_applied_to_ty (function)
macro_rules! Depcrate_diagnostics_utilsreport_error_if_not_applied_to_ty {
() => {
// Module: crate::diagnostics::utils
// Provides: {"report_error_if_not_applied_to_ty"}
// Dependencies: {}
