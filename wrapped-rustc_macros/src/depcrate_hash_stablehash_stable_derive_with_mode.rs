// Generated macro for hash_stable_derive_with_mode (function)
macro_rules! Depcrate_hash_stablehash_stable_derive_with_mode {
() => {
// Module: crate::hash_stable
// Provides: {"hash_stable_derive_with_mode"}
// Dependencies: {}
