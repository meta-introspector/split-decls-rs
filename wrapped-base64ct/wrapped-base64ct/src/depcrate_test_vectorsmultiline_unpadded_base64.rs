// Generated macro for MULTILINE_UNPADDED_BASE64 (const)
macro_rules! Depcrate_test_vectorsMULTILINE_UNPADDED_BASE64 {
() => {
// Module: crate::test_vectors
// Provides: {"MULTILINE_UNPADDED_BASE64"}
// Dependencies: {}
# [doc = " Unpadded multi-line Base64 example (from the `ssh-key` crate's `id_ecdsa_p256`)."] pub (crate) const MULTILINE_UNPADDED_BASE64 : & str = "b3BlbnNzaC1rZXktdjEAAAAABG5vbmUAAAAEbm9uZQAAAAAAAAABAAAAaAAAABNlY2RzYS\n\
