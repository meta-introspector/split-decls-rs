...
decl_metadata!({
name: "test_apply_workspace_package_defaults_to_root",
decl_type: "function",
...
macro_rules! test_apply_workspace_package_defaults_to_root {
    () => {
        # [test] fn test_apply_workspace_package_defaults_to_root () -> Result < () > { let dir = tempdir () ? ; let root_cargo_toml_path = dir . path () . join ("Cargo.toml") ; let initial_content = r#"
[workspace.package]
edition = "2024"
version = "1.0.0"
