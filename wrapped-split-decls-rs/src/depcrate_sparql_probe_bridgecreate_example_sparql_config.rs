// Generated macro for create_example_sparql_config (function)
macro_rules! Depcrate_sparql_probe_bridgecreate_example_sparql_config {
() => {
// Module: crate::sparql_probe_bridge
// Provides: {"create_example_sparql_config"}
// Dependencies: {}
