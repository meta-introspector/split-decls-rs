// Generated macro for generate_build_rs_token_stream (function)
macro_rules! Depcrate_buildrs_generatorgenerate_build_rs_token_stream {
() => {
// Module: crate::buildrs_generator
// Provides: {"generate_build_rs_token_stream"}
// Dependencies: {}
