// Generated macro for extract_crate_info_simple (function)
macro_rules! Depcrate_extract_crate_info_simpleextract_crate_info_simple {
() => {
// Module: crate::extract_crate_info_simple
// Provides: {"extract_crate_info_simple"}
// Dependencies: {}
