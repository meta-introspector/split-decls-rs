// Generated macro for copy_declarations_to_output (function)
macro_rules! Depcrate_eager_splittercopy_declarations_to_output {
() => {
// Module: crate::eager_splitter
// Provides: {"copy_declarations_to_output"}
// Dependencies: {}
