// Generated macro for LOAD_LIBRARY_SAFE_CURRENT_DIRS (const)
macro_rules! Depcrate_os_windowsLOAD_LIBRARY_SAFE_CURRENT_DIRS {
() => {
// Module: crate::os::windows
// Provides: {"LOAD_LIBRARY_SAFE_CURRENT_DIRS"}
// Dependencies: {}
