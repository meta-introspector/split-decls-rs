// Generated macro for report_validation_error (function)
macro_rules! Depcrate_const_eval_eval_queriesreport_validation_error {
() => {
// Module: crate::const_eval::eval_queries
// Provides: {"report_validation_error"}
// Dependencies: {}
