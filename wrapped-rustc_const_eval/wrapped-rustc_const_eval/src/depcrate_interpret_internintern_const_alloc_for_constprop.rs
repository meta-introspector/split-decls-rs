// Generated macro for intern_const_alloc_for_constprop (function)
macro_rules! Depcrate_interpret_internintern_const_alloc_for_constprop {
() => {
// Module: crate::interpret::intern
// Provides: {"intern_const_alloc_for_constprop"}
// Dependencies: {}
