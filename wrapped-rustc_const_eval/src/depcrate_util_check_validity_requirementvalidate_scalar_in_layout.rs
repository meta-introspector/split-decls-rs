// Generated macro for validate_scalar_in_layout (function)
macro_rules! Depcrate_util_check_validity_requirementvalidate_scalar_in_layout {
() => {
// Module: crate::util::check_validity_requirement
// Provides: {"validate_scalar_in_layout"}
// Dependencies: {}
