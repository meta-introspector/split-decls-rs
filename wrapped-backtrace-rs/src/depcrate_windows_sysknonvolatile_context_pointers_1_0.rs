// Generated macro for KNONVOLATILE_CONTEXT_POINTERS_1_0 (struct)
macro_rules! Depcrate_windows_sysKNONVOLATILE_CONTEXT_POINTERS_1_0 {
() => {
// Module: crate::windows_sys
// Provides: {"KNONVOLATILE_CONTEXT_POINTERS_1_0"}
// Dependencies: {}
