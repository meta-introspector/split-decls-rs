// Generated macro for parse_truncated_float (function)
macro_rules! Depcrate_lexical_parseparse_truncated_float {
() => {
// Module: crate::lexical::parse
// Provides: {"parse_truncated_float"}
// Dependencies: {}
