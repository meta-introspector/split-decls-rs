// Generated macro for create_assigned_shuffle_call (function)
macro_rules! Depcrate_big_endiancreate_assigned_shuffle_call {
() => {
// Module: crate::big_endian
// Provides: {"create_assigned_shuffle_call"}
// Dependencies: {}
