...
#[doc = " Replace any references to `Self` in `literal_type` with `actual`."]
#[doc = " `generics` is the Generics field of the parent struct.  Useful for"]
#[doc = " constructor methods."]
