...
#[doc = " Combine two Generics structs, producing a new one that has the union of"]
#[doc = " their parameters."]
fn merge_generics(x: &Generics, y: &Generics) -> Generics {
    #[doc = " Compare only the identifiers of two GenericParams"]
    ...
    #[doc = " Compare only the identifiers of two WherePredicates"]
