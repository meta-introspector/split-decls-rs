// Generated macro for impl_stable_traits_for_trivial_type (macro)
macro_rules! Depcrate_stable_hasherimpl_stable_traits_for_trivial_type {
() => {
// Module: crate::stable_hasher
// Provides: {"impl_stable_traits_for_trivial_type"}
// Dependencies: {}
