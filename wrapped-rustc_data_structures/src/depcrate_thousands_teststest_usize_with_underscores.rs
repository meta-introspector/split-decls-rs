// Generated macro for test_usize_with_underscores (function)
macro_rules! Depcrate_thousands_teststest_usize_with_underscores {
() => {
// Module: crate::thousands::tests
// Provides: {"test_usize_with_underscores"}
// Dependencies: {}
