// Generated macro for binary_search_slice_test (function)
macro_rules! Depcrate_binary_search_util_testsbinary_search_slice_test {
() => {
// Module: crate::binary_search_util::tests
// Provides: {"binary_search_slice_test"}
// Dependencies: {}
