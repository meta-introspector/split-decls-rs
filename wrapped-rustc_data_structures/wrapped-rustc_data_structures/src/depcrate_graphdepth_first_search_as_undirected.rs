// Generated macro for depth_first_search_as_undirected (function)
macro_rules! Depcrate_graphdepth_first_search_as_undirected {
() => {
// Module: crate::graph
// Provides: {"depth_first_search_as_undirected"}
// Dependencies: {}
