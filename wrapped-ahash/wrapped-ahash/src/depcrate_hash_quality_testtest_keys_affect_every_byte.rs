// Generated macro for test_keys_affect_every_byte (function)
macro_rules! Depcrate_hash_quality_testtest_keys_affect_every_byte {
() => {
// Module: crate::hash_quality_test
// Provides: {"test_keys_affect_every_byte"}
// Dependencies: {}
