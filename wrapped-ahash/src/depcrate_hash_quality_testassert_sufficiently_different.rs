// Generated macro for assert_sufficiently_different (function)
macro_rules! Depcrate_hash_quality_testassert_sufficiently_different {
() => {
// Module: crate::hash_quality_test
// Provides: {"assert_sufficiently_different"}
// Dependencies: {}
