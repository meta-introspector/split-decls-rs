// Generated macro for internal_padding_anywhere_error (function)
macro_rules! Depcrate_read_decoder_testsinternal_padding_anywhere_error {
() => {
// Module: crate::read::decoder_tests
// Provides: {"internal_padding_anywhere_error"}
// Dependencies: {}
