// Generated macro for encode_engine_slice_fits_into_precisely_sized_slice (function)
macro_rules! Depcrate_engine_testsencode_engine_slice_fits_into_precisely_sized_slice {
() => {
// Module: crate::engine::tests
// Provides: {"encode_engine_slice_fits_into_precisely_sized_slice"}
// Dependencies: {}
