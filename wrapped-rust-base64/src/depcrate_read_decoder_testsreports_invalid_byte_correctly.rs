// Generated macro for reports_invalid_byte_correctly (function)
macro_rules! Depcrate_read_decoder_testsreports_invalid_byte_correctly {
() => {
// Module: crate::read::decoder_tests
// Provides: {"reports_invalid_byte_correctly"}
// Dependencies: {}
