// Generated macro for decode_detect_invalid_last_symbol_every_possible_two_symbols (function)
macro_rules! Depcrate_engine_testsdecode_detect_invalid_last_symbol_every_possible_two_symbols {
() => {
// Module: crate::engine::tests
// Provides: {"decode_detect_invalid_last_symbol_every_possible_two_symbols"}
// Dependencies: {}
