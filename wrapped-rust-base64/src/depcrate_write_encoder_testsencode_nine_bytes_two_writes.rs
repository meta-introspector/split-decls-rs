// Generated macro for encode_nine_bytes_two_writes (function)
macro_rules! Depcrate_write_encoder_testsencode_nine_bytes_two_writes {
() => {
// Module: crate::write::encoder_tests
// Provides: {"encode_nine_bytes_two_writes"}
// Dependencies: {}
