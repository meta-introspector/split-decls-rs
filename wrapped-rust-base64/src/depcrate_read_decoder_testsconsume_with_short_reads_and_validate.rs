// Generated macro for consume_with_short_reads_and_validate (function)
macro_rules! Depcrate_read_decoder_testsconsume_with_short_reads_and_validate {
() => {
// Module: crate::read::decoder_tests
// Provides: {"consume_with_short_reads_and_validate"}
// Dependencies: {}
