// Generated macro for handles_short_read_from_delegate (function)
macro_rules! Depcrate_read_decoder_testshandles_short_read_from_delegate {
() => {
// Module: crate::read::decoder_tests
// Provides: {"handles_short_read_from_delegate"}
// Dependencies: {}
