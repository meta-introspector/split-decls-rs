// Generated macro for inner_decode_reports_padding_position (function)
macro_rules! Depcrate_engine_testsinner_decode_reports_padding_position {
() => {
// Module: crate::engine::tests
// Provides: {"inner_decode_reports_padding_position"}
// Dependencies: {}
