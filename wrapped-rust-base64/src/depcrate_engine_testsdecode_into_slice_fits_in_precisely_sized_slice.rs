// Generated macro for decode_into_slice_fits_in_precisely_sized_slice (function)
macro_rules! Depcrate_engine_testsdecode_into_slice_fits_in_precisely_sized_slice {
() => {
// Module: crate::engine::tests
// Provides: {"decode_into_slice_fits_in_precisely_sized_slice"}
// Dependencies: {}
