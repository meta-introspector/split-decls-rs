// Generated macro for SearchInterfaceForPrivateItemsVisitor (struct)
macro_rules! DepcrateSearchInterfaceForPrivateItemsVisitor {
() => {
// Module: crate
// Provides: {"SearchInterfaceForPrivateItemsVisitor"}
// Dependencies: {}
