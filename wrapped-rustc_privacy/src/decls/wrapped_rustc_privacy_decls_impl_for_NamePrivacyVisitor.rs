...
impl<'tcx> NamePrivacyVisitor<'tcx> {
    #[doc = " Gets the type-checking results for the current body."]
    #[doc = " As this will ICE if called outside bodies, only call when working with"]
    #[doc = " `Expr` or `Pat` nodes (they are guaranteed to be found only in bodies)."]
    #[track_caller]
