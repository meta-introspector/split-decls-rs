// Generated macro for PrivateInterfacesOrBoundsLint (struct)
macro_rules! Depcrate_errorsPrivateInterfacesOrBoundsLint {
() => {
// Module: crate::errors
// Provides: {"PrivateInterfacesOrBoundsLint"}
// Dependencies: {}
