// Generated macro for FromPrivateDependencyInPublicInterface (struct)
macro_rules! Depcrate_errorsFromPrivateDependencyInPublicInterface {
() => {
// Module: crate::errors
// Provides: {"FromPrivateDependencyInPublicInterface"}
// Dependencies: {}
