// Generated macro for __pin_project_make_proj_replace_block (macro)
macro_rules! Depcrate__pin_project_make_proj_replace_block {
() => {
// Module: crate
// Provides: {"__pin_project_make_proj_replace_block"}
// Dependencies: {}
