// Generated macro for __pin_project_make_proj_replace_ty_body (macro)
macro_rules! Depcrate__pin_project_make_proj_replace_ty_body {
() => {
// Module: crate
// Provides: {"__pin_project_make_proj_replace_ty_body"}
// Dependencies: {}
