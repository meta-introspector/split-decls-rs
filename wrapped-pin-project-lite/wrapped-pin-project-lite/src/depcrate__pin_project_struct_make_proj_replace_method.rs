// Generated macro for __pin_project_struct_make_proj_replace_method (macro)
macro_rules! Depcrate__pin_project_struct_make_proj_replace_method {
() => {
// Module: crate
// Provides: {"__pin_project_struct_make_proj_replace_method"}
// Dependencies: {}
