// Generated macro for __pin_project_enum_make_proj_method (macro)
macro_rules! Depcrate__pin_project_enum_make_proj_method {
() => {
// Module: crate
// Provides: {"__pin_project_enum_make_proj_method"}
// Dependencies: {}
