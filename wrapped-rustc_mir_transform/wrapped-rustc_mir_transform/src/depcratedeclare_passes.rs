// Generated macro for declare_passes (macro)
macro_rules! Depcratedeclare_passes {
() => {
// Module: crate
// Provides: {"declare_passes"}
// Dependencies: {}
