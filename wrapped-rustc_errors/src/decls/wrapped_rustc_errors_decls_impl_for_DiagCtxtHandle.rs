...
impl<'a> DiagCtxtHandle<'a> {
    ...
    #[doc = " Ensures that an error is printed. See `Level::DelayedBug`."]
    #[track_caller]
    ...
    #[doc = " Ensures that an error is printed. See [`Level::DelayedBug`]."]
    #[doc = ""]
    #[doc = " Note: this function used to be called `delay_span_bug`. It was renamed"]
    #[doc = " to match similar functions like `span_err`, `span_warn`, etc."]
    #[track_caller]
