...
#[path = "src/dot_dot_rust_compiler_rustc_codegen_llvm_src_debuginfo_metadata_type_map.rs"]
mod dot_dot_rust_compiler_rustc_codegen_llvm_src_debuginfo_metadata_type_map;