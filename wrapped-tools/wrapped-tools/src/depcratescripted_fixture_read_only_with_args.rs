// Generated macro for scripted_fixture_read_only_with_args (function)
macro_rules! Depcratescripted_fixture_read_only_with_args {
() => {
// Module: crate
// Provides: {"scripted_fixture_read_only_with_args"}
// Dependencies: {}
