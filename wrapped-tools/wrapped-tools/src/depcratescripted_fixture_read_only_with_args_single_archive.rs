// Generated macro for scripted_fixture_read_only_with_args_single_archive (function)
macro_rules! Depcratescripted_fixture_read_only_with_args_single_archive {
() => {
// Module: crate
// Provides: {"scripted_fixture_read_only_with_args_single_archive"}
// Dependencies: {}
