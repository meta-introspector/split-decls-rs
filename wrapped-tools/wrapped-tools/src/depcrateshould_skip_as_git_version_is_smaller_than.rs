// Generated macro for should_skip_as_git_version_is_smaller_than (function)
macro_rules! Depcrateshould_skip_as_git_version_is_smaller_than {
() => {
// Module: crate
// Provides: {"should_skip_as_git_version_is_smaller_than"}
// Dependencies: {}
