// Generated macro for regression_comparison (function)
macro_rules! Depcrate_plot_gnuplot_backend_regressionregression_comparison {
() => {
// Module: crate::plot::gnuplot_backend::regression
// Provides: {"regression_comparison"}
// Dependencies: {}
