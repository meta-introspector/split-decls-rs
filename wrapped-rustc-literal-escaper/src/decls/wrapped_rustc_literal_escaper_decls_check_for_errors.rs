...
#[doc = " Check a literal only for errors"]
#[doc = ""]
#[doc = " Takes the contents of a literal (without quotes)"]
#[doc = " and produces a sequence of only errors,"]
#[doc = " which are returned by invoking `error_callback`."]
#[doc = ""]
#[doc = " NB Does not produce any output other than errors"]
