// Generated macro for fs_async_serial_core_with_return (function)
macro_rules! Depcrate_serial_file_lockfs_async_serial_core_with_return {
() => {
// Module: crate::serial_file_lock
// Provides: {"fs_async_serial_core_with_return"}
// Dependencies: {}
