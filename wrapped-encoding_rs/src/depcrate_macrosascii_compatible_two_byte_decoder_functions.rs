// Generated macro for ascii_compatible_two_byte_decoder_functions (macro)
macro_rules! Depcrate_macrosascii_compatible_two_byte_decoder_functions {
() => {
// Module: crate::macros
// Provides: {"ascii_compatible_two_byte_decoder_functions"}
// Dependencies: {}
