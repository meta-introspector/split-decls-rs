// Generated macro for ascii_compatible_bmp_encoder_functions (macro)
macro_rules! Depcrate_macrosascii_compatible_bmp_encoder_functions {
() => {
// Module: crate::macros
// Provides: {"ascii_compatible_bmp_encoder_functions"}
// Dependencies: {}
