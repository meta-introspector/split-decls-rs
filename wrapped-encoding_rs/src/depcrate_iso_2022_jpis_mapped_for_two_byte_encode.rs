// Generated macro for is_mapped_for_two_byte_encode (function)
macro_rules! Depcrate_iso_2022_jpis_mapped_for_two_byte_encode {
() => {
// Module: crate::iso_2022_jp
// Provides: {"is_mapped_for_two_byte_encode"}
// Dependencies: {}
