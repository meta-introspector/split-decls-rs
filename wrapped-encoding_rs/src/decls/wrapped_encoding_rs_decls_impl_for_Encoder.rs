...
impl Encoder {
    ...
    #[doc = " The `Encoding` this `Encoder` is for."]
    #[inline]
    pub fn encoding(&self) -> &'static Encoding {
        self.encoding
    }
    #[doc = " Returns `true` if this is an ISO-2022-JP encoder that's not in the"]
    #[doc = " ASCII state and `false` otherwise."]
    #[inline]
    pub fn has_pending_state(&self) -> bool {
        self.variant.has_pending_state()
    }
    #[doc = " Query the worst-case output size when encoding from UTF-8 with"]
    #[doc = " replacement."]
    #[doc = ""]
    #[doc = " Returns the size of the output buffer in bytes that will not overflow"]
    #[doc = " given the current state of the encoder and `byte_length` number of"]
    #[doc = " additional input code units if there are no unmappable characters in"]
    #[doc = " the input or `None` if `usize` would overflow."]
    #[doc = ""]
    ...
    #[doc = " Query the worst-case output size when encoding from UTF-8 without"]
    #[doc = " replacement."]
    #[doc = ""]
    #[doc = " Returns the size of the output buffer in bytes that will not overflow"]
    #[doc = " given the current state of the encoder and `byte_length` number of"]
    #[doc = " additional input code units or `None` if `usize` would overflow."]
    #[doc = ""]
    #[doc = " Available via the C wrapper."]
    ...
    #[doc = " Incrementally encode into byte stream from UTF-8 with unmappable"]
    #[doc = " characters replaced with HTML (decimal) numeric character references."]
    #[doc = ""]
    #[doc = " See the documentation of the struct for documentation for `encode_*`"]
    ...
    #[doc = " Incrementally encode into byte stream from UTF-8 _without replacement_."]
    #[doc = ""]
    #[doc = " See the documentation of the struct for documentation for `encode_*`"]
    #[doc = " methods collectively."]
    #[doc = ""]
    ...
    #[doc = " Query the worst-case output size when encoding from UTF-16 with"]
    #[doc = " replacement."]
    #[doc = ""]
    #[doc = " Returns the size of the output buffer in bytes that will not overflow"]
    #[doc = " given the current state of the encoder and `u16_length` number of"]
    #[doc = " additional input code units if there are no unmappable characters in"]
    #[doc = " the input or `None` if `usize` would overflow."]
    #[doc = ""]
    #[doc = " Available via the C wrapper."]
    ...
    #[doc = " Query the worst-case output size when encoding from UTF-16 without"]
    #[doc = " replacement."]
    #[doc = ""]
    #[doc = " Returns the size of the output buffer in bytes that will not overflow"]
    #[doc = " given the current state of the encoder and `u16_length` number of"]
    ...
    #[doc = " Incrementally encode into byte stream from UTF-16 with unmappable"]
    #[doc = " characters replaced with HTML (decimal) numeric character references."]
    #[doc = ""]
    #[doc = " See the documentation of the struct for documentation for `encode_*`"]
    #[doc = " methods collectively."]
    ...
    #[doc = " Incrementally encode into byte stream from UTF-16 _without replacement_."]
    #[doc = ""]
    #[doc = " See the documentation of the struct for documentation for `encode_*`"]
    #[doc = " methods collectively."]
    #[doc = ""]
