// Generated macro for check_utf8_for_latin1_and_bidi (function)
macro_rules! Depcrate_memcheck_utf8_for_latin1_and_bidi {
() => {
// Module: crate::mem
// Provides: {"check_utf8_for_latin1_and_bidi"}
// Dependencies: {}
