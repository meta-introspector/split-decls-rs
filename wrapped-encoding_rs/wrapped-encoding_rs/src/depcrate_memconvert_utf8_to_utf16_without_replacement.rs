// Generated macro for convert_utf8_to_utf16_without_replacement (function)
macro_rules! Depcrate_memconvert_utf8_to_utf16_without_replacement {
() => {
// Module: crate::mem
// Provides: {"convert_utf8_to_utf16_without_replacement"}
// Dependencies: {}
