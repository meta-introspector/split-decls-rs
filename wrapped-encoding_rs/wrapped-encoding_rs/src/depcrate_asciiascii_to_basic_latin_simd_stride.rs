// Generated macro for ascii_to_basic_latin_simd_stride (macro)
macro_rules! Depcrate_asciiascii_to_basic_latin_simd_stride {
() => {
// Module: crate::ascii
// Provides: {"ascii_to_basic_latin_simd_stride"}
// Dependencies: {}
