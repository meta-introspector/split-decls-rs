// Generated macro for decode_to_utf8_with_boundary (function)
macro_rules! Depcrate_testingdecode_to_utf8_with_boundary {
() => {
// Module: crate::testing
// Provides: {"decode_to_utf8_with_boundary"}
// Dependencies: {}
