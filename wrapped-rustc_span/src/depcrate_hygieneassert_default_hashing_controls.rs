// Generated macro for assert_default_hashing_controls (function)
macro_rules! Depcrate_hygieneassert_default_hashing_controls {
() => {
// Module: crate::hygiene
// Provides: {"assert_default_hashing_controls"}
// Dependencies: {}
