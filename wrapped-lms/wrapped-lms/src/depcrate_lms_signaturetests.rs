...
# [cfg (test)] mod tests { use std :: ops :: { Add , Mul } ; use crate :: lms :: modes :: * ; use crate :: lms :: { Signature , SigningKey , VerifyingKey } ; use crate :: ots :: modes :: * ; use hex_literal :: hex ; use hybrid_array :: ArraySize ; use rand :: rng ; use signature :: { RandomizedSignerMut , Verifier } ; use typenum :: { Prod , Sum , U1 , U4 } ; # [test] fn test_deserialize_kat1 () { let pk_bytes = hex ! ("0000000500000004d2f14ff6346af964569f7d6cb880a1b66c5004917da6eafe4d9ef6c6407b3db0e5485b122d9ebe15cda93cfec582d7ab") ; let sig_bytes = hex ! ("
        ...
        2e0a") ; let pk = VerifyingKey :: < LmsSha256M32H5 < LmsOtsSha256N32W8 > > :: try_from (& pk_bytes [..]) . unwrap () ; let sig = Signature :: < LmsSha256M32H5 < LmsOtsSha256N32W8 > > :: try_from (& sig_bytes [..]) . unwrap () ; assert ! (pk . verify (& msg [..] , & sig) . is_ok ()) ; } fn test_serialize_deserialize_random < Mode : LmsMode > () where < Mode :: OtsMode as LmsOtsMode > :: PLen : Add < U1 > , < Mode :: OtsMode as LmsOtsMode > :: NLen : Mul < Sum < < Mode :: OtsMode as LmsOtsMode > :: PLen , U1 > > , Prod < < Mode :: OtsMode as LmsOtsMode > :: NLen , Sum < < Mode :: OtsMode as LmsOtsMode > :: PLen , U1 > > : Add < U4 > , Sum < Prod < < Mode :: OtsMode as LmsOtsMode > :: NLen , Sum < < Mode :: OtsMode as LmsOtsMode > :: PLen , U1 > > , U4 , > : ArraySize , { let mut rng = rng () ; let mut sk = SigningKey :: < Mode > :: new (& mut rng) ; let pk = sk . public () ; let msg = b"Hello, world!" ; let sig = sk . sign_with_rng (& mut rng , msg) ; let sig_bytes : Vec < _ > = sig . clone () . into () ; let sig2 = Signature :: < Mode > :: try_from (& sig_bytes [..]) . unwrap () ; assert ! (pk . verify (msg , & sig2) . is_ok ()) ; } # [test] fn test_serialize_deserialize_random_h5_w1 () { test_serialize_deserialize_random :: < LmsSha256M32H5 < LmsOtsSha256N32W1 > > () ; } # [test] fn test_serialize_deserialize_random_h5_w2 () { test_serialize_deserialize_random :: < LmsSha256M32H5 < LmsOtsSha256N32W2 > > () ; } # [test] fn test_serialize_deserialize_random_h5_w4 () { test_serialize_deserialize_random :: < LmsSha256M32H5 < LmsOtsSha256N32W4 > > () ; } # [test] fn test_serialize_deserialize_random_h5_w8 () { test_serialize_deserialize_random :: < LmsSha256M32H5 < LmsOtsSha256N32W8 > > () ; } # [test] fn test_serialize_deserialize_random_h10_w1 () { test_serialize_deserialize_random :: < LmsSha256M32H10 < LmsOtsSha256N32W1 > > () ; } # [test] fn test_serialize_deserialize_random_h10_w2 () { test_serialize_deserialize_random :: < LmsSha256M32H10 < LmsOtsSha256N32W2 > > () ; } # [test] fn test_serialize_deserialize_random_h10_w4 () { test_serialize_deserialize_random :: < LmsSha256M32H10 < LmsOtsSha256N32W4 > > () ; } # [test] fn test_serialize_deserialize_random_h10_w8 () { test_serialize_deserialize_random :: < LmsSha256M32H10 < LmsOtsSha256N32W8 > > () ; } }
};
}
