// Generated macro for associated_item_from_trait_item (function)
macro_rules! Depcrate_assocassociated_item_from_trait_item {
() => {
// Module: crate::assoc
// Provides: {"associated_item_from_trait_item"}
// Dependencies: {}
