...
#[doc = " Computes the symbol name for the given instance. This function will call"]
#[doc = " `compute_instantiating_crate` if it needs to factor the instantiating crate"]
#[doc = " into the symbol name."]
