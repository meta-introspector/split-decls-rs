// Generated macro for test_datetime_is_send_and_copy (function)
macro_rules! Depcrate_datetime_teststest_datetime_is_send_and_copy {
() => {
// Module: crate::datetime::tests
// Provides: {"test_datetime_is_send_and_copy"}
// Dependencies: {}
