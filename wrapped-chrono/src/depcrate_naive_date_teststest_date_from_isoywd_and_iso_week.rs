// Generated macro for test_date_from_isoywd_and_iso_week (function)
macro_rules! Depcrate_naive_date_teststest_date_from_isoywd_and_iso_week {
() => {
// Module: crate::naive::date::tests
// Provides: {"test_date_from_isoywd_and_iso_week"}
// Dependencies: {}
