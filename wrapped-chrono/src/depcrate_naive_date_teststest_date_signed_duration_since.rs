// Generated macro for test_date_signed_duration_since (function)
macro_rules! Depcrate_naive_date_teststest_date_signed_duration_since {
() => {
// Module: crate::naive::date::tests
// Provides: {"test_date_signed_duration_since"}
// Dependencies: {}
