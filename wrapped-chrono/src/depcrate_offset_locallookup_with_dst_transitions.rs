// Generated macro for lookup_with_dst_transitions (function)
macro_rules! Depcrate_offset_locallookup_with_dst_transitions {
() => {
// Module: crate::offset::local
// Provides: {"lookup_with_dst_transitions"}
// Dependencies: {}
