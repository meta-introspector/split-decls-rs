// Generated macro for test_datetime_from_timestamp_micros (function)
macro_rules! Depcrate_datetime_teststest_datetime_from_timestamp_micros {
() => {
// Module: crate::datetime::tests
// Provides: {"test_datetime_from_timestamp_micros"}
// Dependencies: {}
