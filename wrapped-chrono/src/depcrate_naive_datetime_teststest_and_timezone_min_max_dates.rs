// Generated macro for test_and_timezone_min_max_dates (function)
macro_rules! Depcrate_naive_datetime_teststest_and_timezone_min_max_dates {
() => {
// Module: crate::naive::datetime::tests
// Provides: {"test_and_timezone_min_max_dates"}
// Dependencies: {}
