// Generated macro for warn_on_confusing_output_filename_flag (function)
macro_rules! Depcratewarn_on_confusing_output_filename_flag {
() => {
// Module: crate
// Provides: {"warn_on_confusing_output_filename_flag"}
// Dependencies: {}
