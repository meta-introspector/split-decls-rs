// Generated macro for init_logger_with_additional_layer (function)
macro_rules! Depcrateinit_logger_with_additional_layer {
() => {
// Module: crate
// Provides: {"init_logger_with_additional_layer"}
// Dependencies: {}
