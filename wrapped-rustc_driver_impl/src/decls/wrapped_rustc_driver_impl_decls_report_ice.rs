...
#[doc = " Prints the ICE message, including query stack, but without backtrace."]
#[doc = ""]
#[doc = " The message will point the user at `bug_report_url` to report the ICE."]
#[doc = ""]
#[doc = " When `install_ice_hook` is called, this function will be called as the panic"]
#[doc = " hook."]
fn report_ice(
