// Generated macro for report_arm_reachability (function)
macro_rules! Depcrate_thir_pattern_check_matchreport_arm_reachability {
() => {
// Module: crate::thir::pattern::check_match
// Provides: {"report_arm_reachability"}
// Dependencies: {}
