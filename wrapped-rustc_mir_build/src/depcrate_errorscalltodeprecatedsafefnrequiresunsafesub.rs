// Generated macro for CallToDeprecatedSafeFnRequiresUnsafeSub (struct)
macro_rules! Depcrate_errorsCallToDeprecatedSafeFnRequiresUnsafeSub {
() => {
// Module: crate::errors
// Provides: {"CallToDeprecatedSafeFnRequiresUnsafeSub"}
// Dependencies: {}
