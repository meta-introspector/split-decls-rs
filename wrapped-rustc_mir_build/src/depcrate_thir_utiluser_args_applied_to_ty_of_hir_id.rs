// Generated macro for user_args_applied_to_ty_of_hir_id (function)
macro_rules! Depcrate_thir_utiluser_args_applied_to_ty_of_hir_id {
() => {
// Module: crate::thir::util
// Provides: {"user_args_applied_to_ty_of_hir_id"}
// Dependencies: {}
