// Generated macro for CallToUnsafeFunctionRequiresUnsafe (struct)
macro_rules! Depcrate_errorsCallToUnsafeFunctionRequiresUnsafe {
() => {
// Module: crate::errors
// Provides: {"CallToUnsafeFunctionRequiresUnsafe"}
// Dependencies: {}
