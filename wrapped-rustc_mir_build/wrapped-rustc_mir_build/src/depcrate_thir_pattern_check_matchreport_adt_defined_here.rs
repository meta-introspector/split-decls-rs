// Generated macro for report_adt_defined_here (function)
macro_rules! Depcrate_thir_pattern_check_matchreport_adt_defined_here {
() => {
// Module: crate::thir::pattern::check_match
// Provides: {"report_adt_defined_here"}
// Dependencies: {}
