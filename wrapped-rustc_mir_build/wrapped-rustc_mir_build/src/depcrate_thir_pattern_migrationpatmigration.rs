// Generated macro for PatMigration (struct)
macro_rules! Depcrate_thir_pattern_migrationPatMigration {
() => {
// Module: crate::thir::pattern::migration
// Provides: {"PatMigration"}
// Dependencies: {}
