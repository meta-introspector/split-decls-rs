        ...
        if main_lib_path.is_file() {
            ...
            for (module_name, fn_names) in impl_calls {
                ...
                let item_use: syn::ItemUse =
                    parse_quote! { pub use # module_ident :: # use_tree ; };
            ...
            let modules_list_idents: Vec<Ident> = config
                ...
                .collect();
            let decl_module_invocation: syn::ItemMacro =
                parse_quote! { decl_module ! (# (# modules_list_idents) ,*) ; };
            let decl_module_use: syn::ItemUse =
                parse_quote! { use introspector_decl2_macros :: decl_module ; };
