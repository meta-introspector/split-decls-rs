...
impl<BS: ArraySize> BlockBuffer<BS, Eager> {
    #[doc = " Compress remaining data after padding it with `delim`, zeros and"]
    #[doc = " the `suffix` bytes. If there is not enough unused space, `compress`"]
    #[doc = " will be called twice."]
    #[doc = ""]
    #[doc = " # Panics"]
    #[doc = " If suffix length is bigger than block size."]
    #[inline(always)]
    pub fn digest_pad(
        &mut self,
        delim: u8,
    ...
    #[doc = " Pad message with 0x80, zeros and 64-bit message length using"]
    #[doc = " big-endian byte order."]
    #[inline]
    ...
    #[doc = " Pad message with 0x80, zeros and 128-bit message length using"]
    #[doc = " big-endian byte order."]
    #[inline]
