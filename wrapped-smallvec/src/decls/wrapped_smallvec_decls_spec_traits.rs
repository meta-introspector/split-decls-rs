...
mod spec_traits {
    use super::*;
    #[doc = " A trait for specializing the implementation of [`from_elem`]."]
    #[doc = ""]
    #[doc = " [`from_elem`]: crate::from_elem"]
    pub(crate) trait SpecFromElem<T> {
        #[doc = " Creates a `Smallvec` value where `elem` is repeated `n` times."]
        #[doc = " This will use the inline storage, not the heap."]
        #[doc = ""]
        #[doc = " # Safety"]
        #[doc = ""]
        #[doc = " The caller must ensure that `n <= Self::inline_size()`."]
    ...
    #[doc = " A trait for specializing the implementations of [`Extend`] and [`extend_from_slice`]."]
    #[doc = ""]
    #[doc = " [`extend_from_slice`]: crate::SmallVec::extend_from_slice"]
    ...
    #[doc = " A trait for specializing the implementation of [`extend_from_within`]."]
    #[doc = ""]
    #[doc = " [`extend_from_within`]: crate::SmallVec::extend_from_within"]
    pub(crate) trait SpecExtendFromWithin<T> {
        #[doc = " Main worker for [`extend_from_within`]."]
        #[doc = ""]
        #[doc = " # Safety"]
        #[doc = ""]
        #[doc = " * The length of the vector is larger than or equal to `src.len()`."]
        #[doc = " * The spare capacity of the vector is larger than or equal to `src.len()`."]
        #[doc = ""]
        #[doc = " [`extend_from_within`]: SmallVec::extend_from_within"]
    ...
    #[doc = " A trait for specializing the implementation of [`FromIterator`]."]
    #[doc = ""]
    #[doc = " [`clone_from`]: Clone::clone_from"]
    ...
    #[doc = " A trait for specializing the implementation of [`clone_from`]."]
    #[doc = ""]
    #[doc = " [`clone_from`]: Clone::clone_from"]
    ...
    #[doc = " A trait for specializing the implementation of [`From`]"]
    #[doc = " with the source type being slices."]
    pub(crate) trait SpecFromSlice<T> {
        #[doc = " Creates a `SmallVec` value based on the contents of `slice`."]
        #[doc = " This will use the inline storage, not the heap."]
        #[doc = ""]
        #[doc = " # Safety"]
        #[doc = ""]
        #[doc = " The caller must ensure that `slice.len() <= Self::inline_size()`."]
