// Generated macro for parse_single_line_trailer (function)
macro_rules! Depcrate_commit_message_bodyparse_single_line_trailer {
() => {
// Module: crate::commit::message::body
// Provides: {"parse_single_line_trailer"}
// Dependencies: {}
