...
impl SourceRootConfig {
    ...
    #[doc = " Maps local source roots to their parent source roots by bytewise comparing of root paths ."]
    #[doc = " If a `SourceRoot` doesn't have a parent and is local then it is not contained in this mapping but it can be asserted that it is a root `SourceRoot`."]
