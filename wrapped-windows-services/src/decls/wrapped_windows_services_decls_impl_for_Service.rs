...
impl<'a> Service<'a> {
    #[doc = " Creates a new `Service` object."]
    #[doc = ""]
    #[doc = " By default, the service does not accept any service commands other than start."]
    pub fn new() -> Self {
        Self {
            accept: 0,
            fallback: None,
    ...
    #[doc = " The service accepts stop and shutdown commands."]
    pub fn can_stop(&mut self) -> &mut Self {
        self.accept |= SERVICE_ACCEPT_STOP | SERVICE_ACCEPT_SHUTDOWN;
        self
    }
    #[doc = " The service accepts pause and resume commands."]
    pub fn can_pause(&mut self) -> &mut Self {
        self.accept |= SERVICE_ACCEPT_PAUSE_CONTINUE;
        self
    }
    #[doc = " The service accepts other specified commands."]
    pub fn can_accept(&mut self, accept: u32) -> &mut Self {
        self.accept |= accept;
        self
    }
    #[doc = " Runs the fallback closure if the service is not started by the Service Control Manager."]
    pub fn can_fallback<F: FnOnce(&Service) + Send + 'a>(&mut self, f: F) -> &mut Self {
        self.fallback = Some(Box::new(f));
        self
    }
    #[doc = " Runs the service with the given callback closure to receive commands sent by the service"]
    #[doc = " control manager."]
    #[doc = ""]
    #[doc = " This method will block for the life of the service. It will never return and immediately"]
    #[doc = " terminate the current process after indicating to the service control manager that the"]
    #[doc = " service has stopped."]
    ...
    #[doc = " Sets the current state of the service."]
    #[doc = ""]
    #[doc = " In most cases, the service state is updated automatically and does not need to be set directly."]
    ...
    #[doc = " The raw handle representing the service."]
    pub fn handle(&self) -> *mut core::ffi::c_void {
        *self.handle.read().unwrap()
    }
    #[doc = " The current state the service."]
    ...
    #[doc = " Sends the command to the service callback."]
    pub fn command(&self, command: Command) {
        let mut write = self.callback.write().unwrap();
        (write.as_deref_mut().unwrap())(self, command);
    }
    #[doc = " Low-level dispatcher to send control commands directly to the service."]
