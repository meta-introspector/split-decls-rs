...
impl LineIndex {
    #[doc = " Returns a `LineIndex` for the `text`."]
    ...
    #[doc = " Transforms the `TextSize` into a `LineCol`."]
    #[doc = ""]
    #[doc = " # Panics"]
    #[doc = ""]
    #[doc = " If the offset is invalid. See [`Self::try_line_col`]."]
    pub fn line_col(&self, offset: TextSize) -> LineCol {
        self.try_line_col(offset).expect("invalid offset")
    }
    #[doc = " Transforms the `TextSize` into a `LineCol`."]
    #[doc = ""]
    #[doc = " Returns `None` if the `offset` was invalid, e.g. if it extends past the end of the text or"]
    #[doc = " points to the middle of a multi-byte character."]
    ...
    #[doc = " Transforms the `LineCol` into a `TextSize`."]
    ...
    #[doc = " Transforms the `LineCol` with the given `WideEncoding` into a `WideLineCol`."]
    ...
    #[doc = " Transforms the `WideLineCol` with the given `WideEncoding` into a `LineCol`."]
    ...
    #[doc = " Returns the given line's range."]
    ...
    #[doc = " Given a range [start, end), returns a sorted iterator of non-empty ranges [start, x1), [x1,"]
    #[doc = " x2), ..., [xn, end) where all the xi, which are positions of newlines, are inside the range"]
    #[doc = " [start, end)."]
    ...
    #[doc = " Returns the length of the original text."]
