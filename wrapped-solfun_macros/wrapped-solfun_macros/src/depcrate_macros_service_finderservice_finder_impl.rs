// Generated macro for service_finder_impl (function)
macro_rules! Depcrate_macros_service_finderservice_finder_impl {
() => {
// Module: crate::macros::service_finder
// Provides: {"service_finder_impl"}
// Dependencies: {}
