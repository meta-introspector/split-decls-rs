...
impl Builder {
    #[doc = " Should we detect collisions at all? Default: true"]
    pub fn detect_collision(mut self, detect: bool) -> Self {
        self.detect_collision = detect;
        self
    }
    #[doc = " Should a fix be automatically be applied, or the original hash be returned? Default: true"]
    pub fn safe_hash(mut self, safe_hash: bool) -> Self {
        self.safe_hash = safe_hash;
        self
    }
    #[doc = " Should unavoidable bitconditions be used to speed up the check? Default: true"]
    pub fn use_ubc(mut self, ubc: bool) -> Self {
        self.ubc_check = ubc;
        self
    }
    #[doc = " Should reduced round collisions be used? Default: false"]
    ...
    #[doc = " Create a Sha1 with a specific collision detection configuration."]
