// Generated macro for escaped_char_in_index_json_blob (function)
macro_rules! Depcrate_indexescaped_char_in_index_json_blob {
() => {
// Module: crate::index
// Provides: {"escaped_char_in_index_json_blob"}
// Dependencies: {}
