// Generated macro for draw_progress_bar_fn (function)
macro_rules! Depcrate_render_tui_draw_progressdraw_progress_bar_fn {
() => {
// Module: crate::render::tui::draw::progress
// Provides: {"draw_progress_bar_fn"}
// Dependencies: {}
