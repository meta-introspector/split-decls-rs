...
#[path = "src/dot_dot_rust_compiler_rustc_mir_transform_src_lint_tail_expr_drop_order.rs"]
mod dot_dot_rust_compiler_rustc_mir_transform_src_lint_tail_expr_drop_order;