...
impl ProjectBuilder {
    ...
    #[doc = " Create project, relative to [`paths::root`]"]
    ...
    #[doc = " Adds a symlink to a file to the project."]
    ...
    #[doc = " Create a symlink to a directory"]
