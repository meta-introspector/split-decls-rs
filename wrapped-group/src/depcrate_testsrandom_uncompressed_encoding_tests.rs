// Generated macro for random_uncompressed_encoding_tests (function)
macro_rules! Depcrate_testsrandom_uncompressed_encoding_tests {
() => {
// Module: crate::tests
// Provides: {"random_uncompressed_encoding_tests"}
// Dependencies: {}
