// Generated macro for random_compressed_encoding_tests (function)
macro_rules! Depcrate_testsrandom_compressed_encoding_tests {
() => {
// Module: crate::tests
// Provides: {"random_compressed_encoding_tests"}
// Dependencies: {}
