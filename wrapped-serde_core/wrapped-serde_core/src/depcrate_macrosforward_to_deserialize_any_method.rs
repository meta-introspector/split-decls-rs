// Generated macro for forward_to_deserialize_any_method (macro)
macro_rules! Depcrate_macrosforward_to_deserialize_any_method {
() => {
// Module: crate::macros
// Provides: {"forward_to_deserialize_any_method"}
// Dependencies: {}
