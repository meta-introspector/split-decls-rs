...
mod test {
    ...
    #[doc = " Checks that \"mapping\" a 0-length file derefs to an empty slice."]
    #[test]
    fn map_empty_file() {
        let tempdir = tempfile::tempdir().unwrap();
        let path = tempdir.path().join("mmap");
    ...
    #[doc = " Something that relies on StableDeref"]
    #[test]
    ...
    #[doc = " Returns true if a non-zero amount of memory is locked."]
    #[cfg(target_os = "linux")]
    fn is_locked() -> bool {
