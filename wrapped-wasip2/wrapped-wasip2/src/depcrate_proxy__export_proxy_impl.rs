...
// Dependencies: {}
# [doc = " Generates `#[unsafe(no_mangle)]` functions to export the specified type as"] # [doc = " the root implementation of all generated traits."] # [doc = ""] # [doc = " For more information see the documentation of `wit_bindgen::generate!`."] # [doc = ""] # [doc = " ```rust"] # [doc = " # macro_rules! _export_proxy{ ($($t:tt)*) => (); }"] # [doc = " # trait Guest {}"] # [doc = " struct MyType;"] # [doc = ""] # [doc = " impl Guest for MyType {"] # [doc = "     // ..."] # [doc = " }"] # [doc = ""] # [doc = " _export_proxy!(MyType);"] # [doc = " ```"] # [allow (unused_macros)] # [doc (hidden)] # [macro_export] macro_rules ! __export_proxy_impl { ($ ty : ident) => { $ crate :: _export_proxy ! ($ ty with_types_in $ crate) ; } ; ($ ty : ident with_types_in $ ($ path_to_types_root : tt) *) => { $ ($ path_to_types_root) *:: exports :: wasi :: http :: incoming_handler :: __export_wasi_http_incoming_handler_0_2_4_cabi ! ($ ty with_types_in $ ($ path_to_types_root) *:: exports :: wasi :: http :: incoming_handler) ; const _ : () = { # [rustfmt :: skip] # [cfg (target_arch = "wasm32")] # [unsafe (link_section = "component-type:wit-bindgen:0.46.0:wasi:http@0.2.4:proxy:imports and exportsrust-wasip2-1.0.1+wasi-0.2.4-from-crates-io-proxy-world")] # [doc (hidden)] # [allow (clippy :: octal_escapes)] pub static __WIT_BINDGEN_COMPONENT_TYPE : [u8 ; 7040] = * b"\
