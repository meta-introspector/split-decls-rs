...
use rustc_complete::emitter::stderr_destination;
use rustc_complete::registry::Registry;
use rustc_complete::translation::Translator;
use rustc_complete::{ColorConfig, DiagCtxt, ErrCode, FatalError, PResult, markdown};
...
use rustc_complete::ty::TyCtxt;
use rustc_parse::lexer::StripTokens;
use rustc_parse::{new_parser_from_file, new_parser_from_source_str, unwrap_or_emit_fatal};
use rustc_complete::config::{
...
use rustc_complete::getopts::{self, Matches};
use rustc_complete::lint::{Lint, LintId};
use rustc_complete::output::{CRATE_TYPES, collect_crate_types, invalid_output_for_target};
use rustc_complete::{EarlyDiagCtxt, Session, config};
use rustc_complete::FileName;
use rustc_complete::def_id::LOCAL_CRATE;
...
fn print_crate_info(
    ...
    use rustc_complete::config::PrintKind::*;
