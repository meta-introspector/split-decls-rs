...
#[path = "src/dot_dot_rust_library_std_src_sys_thread_local_destructors_linux_like.rs"]
mod dot_dot_rust_library_std_src_sys_thread_local_destructors_linux_like;