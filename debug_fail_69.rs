...
#[path = "src/dot_dot_rust_compiler_rustc_trait_selection_src_error_reporting_mod.rs"]
mod dot_dot_rust_compiler_rustc_trait_selection_src_error_reporting_mod;