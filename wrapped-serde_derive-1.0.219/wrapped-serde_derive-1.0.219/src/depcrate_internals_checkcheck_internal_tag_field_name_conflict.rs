// Generated macro for check_internal_tag_field_name_conflict (function)
macro_rules! Depcrate_internals_checkcheck_internal_tag_field_name_conflict {
() => {
// Module: crate::internals::check
// Provides: {"check_internal_tag_field_name_conflict"}
// Dependencies: {}
