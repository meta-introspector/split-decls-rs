// Generated macro for serialize_tuple_struct_visitor (function)
macro_rules! Depcrate_serserialize_tuple_struct_visitor {
() => {
// Module: crate::ser
// Provides: {"serialize_tuple_struct_visitor"}
// Dependencies: {}
