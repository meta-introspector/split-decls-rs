// Generated macro for ownedref_drop_from_other_threads (function)
macro_rules! Depcrate_tests_loom_poolownedref_drop_from_other_threads {
() => {
// Module: crate::tests::loom_pool
// Provides: {"ownedref_drop_from_other_threads"}
// Dependencies: {}
