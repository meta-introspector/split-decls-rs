// Generated macro for create_mut_downgrade_during_clear (function)
macro_rules! Depcrate_tests_loom_poolcreate_mut_downgrade_during_clear {
() => {
// Module: crate::tests::loom_pool
// Provides: {"create_mut_downgrade_during_clear"}
// Dependencies: {}
