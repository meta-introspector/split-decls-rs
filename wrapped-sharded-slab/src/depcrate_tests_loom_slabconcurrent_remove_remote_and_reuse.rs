// Generated macro for concurrent_remove_remote_and_reuse (function)
macro_rules! Depcrate_tests_loom_slabconcurrent_remove_remote_and_reuse {
() => {
// Module: crate::tests::loom_slab
// Provides: {"concurrent_remove_remote_and_reuse"}
// Dependencies: {}
