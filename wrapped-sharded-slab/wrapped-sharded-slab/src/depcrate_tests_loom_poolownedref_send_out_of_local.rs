// Generated macro for ownedref_send_out_of_local (function)
macro_rules! Depcrate_tests_loom_poolownedref_send_out_of_local {
() => {
// Module: crate::tests::loom_pool
// Provides: {"ownedref_send_out_of_local"}
// Dependencies: {}
