// Generated macro for owned_entry_drop_from_other_threads (function)
macro_rules! Depcrate_tests_loom_slabowned_entry_drop_from_other_threads {
() => {
// Module: crate::tests::loom_slab
// Provides: {"owned_entry_drop_from_other_threads"}
// Dependencies: {}
