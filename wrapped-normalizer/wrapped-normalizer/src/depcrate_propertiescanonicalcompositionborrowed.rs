// Generated macro for CanonicalCompositionBorrowed (struct)
macro_rules! Depcrate_propertiesCanonicalCompositionBorrowed {
() => {
// Module: crate::properties
// Provides: {"CanonicalCompositionBorrowed"}
// Dependencies: {}
