// Generated macro for QueueableToken (enum)
macro_rules! Depcrate_iterators_queueable_tokenQueueableToken {
() => {
// Module: crate::iterators::queueable_token
// Provides: {"QueueableToken"}
// Dependencies: {}
