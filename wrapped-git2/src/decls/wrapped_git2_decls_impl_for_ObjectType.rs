...
impl ObjectType {
    ...
    #[doc = " Determine if the given git_object_t is a valid loose object type."]
    pub fn is_loose(&self) -> bool {
        unsafe { call!(raw::git_object_typeisloose(*self)) == 1 }
    }
    #[doc = " Convert a raw git_object_t to an ObjectType"]
    ...
    #[doc = " Convert this kind into its raw representation"]
    pub fn raw(&self) -> raw::git_object_t {
        call::convert(self)
    }
    #[doc = " Convert a string object type representation to its object type."]
