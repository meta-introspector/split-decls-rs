// Generated macro for token_is_method_call_receiver (function)
macro_rules! Depcrate_replacingtoken_is_method_call_receiver {
() => {
// Module: crate::replacing
// Provides: {"token_is_method_call_receiver"}
// Dependencies: {}
