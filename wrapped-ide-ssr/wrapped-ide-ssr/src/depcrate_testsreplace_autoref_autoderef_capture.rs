// Generated macro for replace_autoref_autoderef_capture (function)
macro_rules! Depcrate_testsreplace_autoref_autoderef_capture {
() => {
// Module: crate::tests
// Provides: {"replace_autoref_autoderef_capture"}
// Dependencies: {}
