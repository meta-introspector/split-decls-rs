// Generated macro for anchored_not_allowed_even_if_technically_available (function)
macro_rules! Depcrate_testsanchored_not_allowed_even_if_technically_available {
() => {
// Module: crate::tests
// Provides: {"anchored_not_allowed_even_if_technically_available"}
// Dependencies: {}
