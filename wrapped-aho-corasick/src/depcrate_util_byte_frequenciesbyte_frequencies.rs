// Generated macro for BYTE_FREQUENCIES (const)
macro_rules! Depcrate_util_byte_frequenciesBYTE_FREQUENCIES {
() => {
// Module: crate::util::byte_frequencies
// Provides: {"BYTE_FREQUENCIES"}
// Dependencies: {}
