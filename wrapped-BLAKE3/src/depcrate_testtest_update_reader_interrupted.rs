// Generated macro for test_update_reader_interrupted (function)
macro_rules! Depcrate_testtest_update_reader_interrupted {
() => {
// Module: crate::test
// Provides: {"test_update_reader_interrupted"}
// Dependencies: {}
