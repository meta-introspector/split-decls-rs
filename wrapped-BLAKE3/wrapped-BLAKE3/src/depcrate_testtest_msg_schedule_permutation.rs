// Generated macro for test_msg_schedule_permutation (function)
macro_rules! Depcrate_testtest_msg_schedule_permutation {
() => {
// Module: crate::test
// Provides: {"test_msg_schedule_permutation"}
// Dependencies: {}
