// Generated macro for compress_subtree_to_parent_node (function)
macro_rules! Depcratecompress_subtree_to_parent_node {
() => {
// Module: crate
// Provides: {"compress_subtree_to_parent_node"}
// Dependencies: {}
