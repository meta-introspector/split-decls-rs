...
#[doc = " A trait defining types that are used to emulate rustc_public components, which is really"]
#[doc = " useful when programming in rustc_public-agnostic settings."]
