// Generated macro for build_closure_env_di_node (function)
macro_rules! Depcrate_debuginfo_metadatabuild_closure_env_di_node {
() => {
// Module: crate::debuginfo::metadata
// Provides: {"build_closure_env_di_node"}
// Dependencies: {}
