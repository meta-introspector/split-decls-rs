// Generated macro for declare_constant (macro)
macro_rules! Depcrate_debuginfo_dwarf_constdeclare_constant {
() => {
// Module: crate::debuginfo::dwarf_const
// Provides: {"declare_constant"}
// Dependencies: {}
