// Generated macro for get_bitcode_slice_from_object_data (function)
macro_rules! Depcrate_back_ltoget_bitcode_slice_from_object_data {
() => {
// Module: crate::back::lto
// Provides: {"get_bitcode_slice_from_object_data"}
// Dependencies: {}
