// Generated macro for build_foreign_type_di_node (function)
macro_rules! Depcrate_debuginfo_metadatabuild_foreign_type_di_node {
() => {
// Module: crate::debuginfo::metadata
// Provides: {"build_foreign_type_di_node"}
// Dependencies: {}
