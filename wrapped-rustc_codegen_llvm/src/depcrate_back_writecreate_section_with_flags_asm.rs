// Generated macro for create_section_with_flags_asm (function)
macro_rules! Depcrate_back_writecreate_section_with_flags_asm {
() => {
// Module: crate::back::write
// Provides: {"create_section_with_flags_asm"}
// Dependencies: {}
