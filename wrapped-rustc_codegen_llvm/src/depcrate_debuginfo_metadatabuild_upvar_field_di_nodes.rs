// Generated macro for build_upvar_field_di_nodes (function)
macro_rules! Depcrate_debuginfo_metadatabuild_upvar_field_di_nodes {
() => {
// Module: crate::debuginfo::metadata
// Provides: {"build_upvar_field_di_nodes"}
// Dependencies: {}
