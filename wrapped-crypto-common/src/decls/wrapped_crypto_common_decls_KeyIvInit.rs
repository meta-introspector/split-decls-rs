...
#[doc = " Types which can be initialized from key and initialization vector (nonce)."]
pub trait KeyIvInit: KeySizeUser + IvSizeUser + Sized {
    #[doc = " Create new value from fixed length key and nonce."]
    fn new(key: &Key<Self>, iv: &Iv<Self>) -> Self;
    #[doc = " Check if the key might be considered weak."]
    #[inline]
    fn weak_key_test(_key: &Key<Self>) -> Result<(), WeakKeyError> {
        Ok(())
    }
    #[doc = " Create new value from fixed length key and nonce after checking the key for weakness."]
    #[inline]
    fn new_checked(key: &Key<Self>, iv: &Iv<Self>) -> Result<Self, WeakKeyError> {
        Self::weak_key_test(key)?;
        Ok(Self::new(key, iv))
    }
    #[doc = " Create new value from variable length key and nonce."]
    #[inline]
    ...
    #[doc = " Generate random key using the operating system's secure RNG."]
    ...
    #[doc = " Generate random key using the provided [`CryptoRng`]."]
    ...
    #[doc = " Generate random key using the provided [`TryCryptoRng`]."]
    #[cfg(feature = "rand_core")]
    #[inline]
    ...
    #[doc = " Generate random IV using the operating system's secure RNG."]
    #[cfg(feature = "getrandom")]
    #[inline]
    ...
    #[doc = " Generate random IV using the provided [`CryptoRng`]."]
    #[cfg(feature = "rand_core")]
    #[inline]
    ...
    #[doc = " Generate random IV using the provided [`TryCryptoRng`]."]
    #[cfg(feature = "rand_core")]
    #[inline]
    ...
    #[doc = " Generate random key and IV using the operating system's secure RNG."]
    #[cfg(feature = "getrandom")]
    #[inline]
    ...
    #[doc = " Generate random key and IV using the provided [`CryptoRng`]."]
    #[cfg(feature = "rand_core")]
    #[inline]
    ...
    #[doc = " Generate random key and IV using the provided [`TryCryptoRng`]."]
    #[cfg(feature = "rand_core")]
    #[inline]
