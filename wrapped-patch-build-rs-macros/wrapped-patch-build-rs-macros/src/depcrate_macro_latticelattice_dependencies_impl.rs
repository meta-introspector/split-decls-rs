// Generated macro for lattice_dependencies_impl (function)
macro_rules! Depcrate_macro_latticelattice_dependencies_impl {
() => {
// Module: crate::macro_lattice
// Provides: {"lattice_dependencies_impl"}
// Dependencies: {}
