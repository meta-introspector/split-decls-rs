// Generated macro for mkbuildrs_with_macros_impl (function)
macro_rules! Depcrate_macro_generatormkbuildrs_with_macros_impl {
() => {
// Module: crate::macro_generator
// Provides: {"mkbuildrs_with_macros_impl"}
// Dependencies: {}
