// Generated macro for generate_common_macros_impl (function)
macro_rules! Depcrate_macro_generatorgenerate_common_macros_impl {
() => {
// Module: crate::macro_generator
// Provides: {"generate_common_macros_impl"}
// Dependencies: {}
