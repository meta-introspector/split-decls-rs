// Generated macro for nghttp2_on_extension_chunk_recv_callback (type)
macro_rules! Depcratenghttp2_on_extension_chunk_recv_callback {
() => {
// Module: crate
// Provides: {"nghttp2_on_extension_chunk_recv_callback"}
// Dependencies: {}
