// Generated macro for borrow_conflicts_with_place (function)
macro_rules! Depcrate_places_conflictborrow_conflicts_with_place {
() => {
// Module: crate::places_conflict
// Provides: {"borrow_conflicts_with_place"}
// Dependencies: {}
