...
#[doc = " Using the region constraints computed by [borrowck_collect_region_constraints]"]
#[doc = " and the additional constraints from [BorrowCheckRootCtxt::handle_opaque_type_uses],"]
#[doc = " compute the region graph and actually check for any borrowck errors."]
