// Generated macro for for_each_late_bound_region_in_item (function)
macro_rules! Depcrate_universal_regionsfor_each_late_bound_region_in_item {
() => {
// Module: crate::universal_regions
// Provides: {"for_each_late_bound_region_in_item"}
// Dependencies: {}
