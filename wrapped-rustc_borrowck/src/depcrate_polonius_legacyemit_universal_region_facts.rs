// Generated macro for emit_universal_region_facts (function)
macro_rules! Depcrate_polonius_legacyemit_universal_region_facts {
() => {
// Module: crate::polonius::legacy
// Provides: {"emit_universal_region_facts"}
// Dependencies: {}
