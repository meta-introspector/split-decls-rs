// Generated macro for LocalizedConstraintGraph (struct)
macro_rules! Depcrate_polonius_loan_livenessLocalizedConstraintGraph {
() => {
// Module: crate::polonius::loan_liveness
// Provides: {"LocalizedConstraintGraph"}
// Dependencies: {}
