// Generated macro for PoloniusLocationTable (struct)
macro_rules! Depcrate_polonius_legacy_locationPoloniusLocationTable {
() => {
// Module: crate::polonius::legacy::location
// Provides: {"PoloniusLocationTable"}
// Dependencies: {}
