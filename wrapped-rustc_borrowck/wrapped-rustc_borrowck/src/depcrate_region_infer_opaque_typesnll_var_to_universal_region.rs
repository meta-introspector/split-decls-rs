// Generated macro for nll_var_to_universal_region (function)
macro_rules! Depcrate_region_infer_opaque_typesnll_var_to_universal_region {
() => {
// Module: crate::region_infer::opaque_types
// Provides: {"nll_var_to_universal_region"}
// Dependencies: {}
