// Generated macro for try_extract_error_from_fulfill_cx (function)
macro_rules! Depcrate_diagnostics_bound_region_errorstry_extract_error_from_fulfill_cx {
() => {
// Module: crate::diagnostics::bound_region_errors
// Provides: {"try_extract_error_from_fulfill_cx"}
// Dependencies: {}
