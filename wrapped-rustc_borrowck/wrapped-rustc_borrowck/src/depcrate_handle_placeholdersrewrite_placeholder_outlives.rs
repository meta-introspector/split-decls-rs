// Generated macro for rewrite_placeholder_outlives (function)
macro_rules! Depcrate_handle_placeholdersrewrite_placeholder_outlives {
() => {
// Module: crate::handle_placeholders
// Provides: {"rewrite_placeholder_outlives"}
// Dependencies: {}
