// Generated macro for add_concrete_opaque_type (function)
macro_rules! Depcrate_region_infer_opaque_typesadd_concrete_opaque_type {
() => {
// Module: crate::region_infer::opaque_types
// Provides: {"add_concrete_opaque_type"}
// Dependencies: {}
