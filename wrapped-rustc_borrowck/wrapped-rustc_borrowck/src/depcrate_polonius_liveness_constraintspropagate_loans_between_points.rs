// Generated macro for propagate_loans_between_points (function)
macro_rules! Depcrate_polonius_liveness_constraintspropagate_loans_between_points {
() => {
// Module: crate::polonius::liveness_constraints
// Provides: {"propagate_loans_between_points"}
// Dependencies: {}
