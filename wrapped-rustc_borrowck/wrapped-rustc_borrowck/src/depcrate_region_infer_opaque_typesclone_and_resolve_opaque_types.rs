// Generated macro for clone_and_resolve_opaque_types (function)
macro_rules! Depcrate_region_infer_opaque_typesclone_and_resolve_opaque_types {
() => {
// Module: crate::region_infer::opaque_types
// Provides: {"clone_and_resolve_opaque_types"}
// Dependencies: {}
