// Generated macro for serialize_externally_tagged_variant (function)
macro_rules! Depcrate_serserialize_externally_tagged_variant {
() => {
// Module: crate::ser
// Provides: {"serialize_externally_tagged_variant"}
// Dependencies: {}
