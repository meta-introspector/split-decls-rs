// Generated macro for define_substring_reverse_quickcheck (macro)
macro_rules! Depcrate_tests_substring_propdefine_substring_reverse_quickcheck {
() => {
// Module: crate::tests::substring::prop
// Provides: {"define_substring_reverse_quickcheck"}
// Dependencies: {}
