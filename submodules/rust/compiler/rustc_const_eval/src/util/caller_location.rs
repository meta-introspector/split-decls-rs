...
mkuse!{use crate :: const_eval :: { CanAccessMutGlobal , CompileTimeInterpCx , mk_eval_cx_to_read_const_val } ;}
mkuse!{use crate :: interpret :: * ;}

macro_rules! alloc_caller_location_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function alloc_caller_location in module {}", module_path!());
    };
}

mkfn!{
    alloc_caller_location_introspect!();
...
macro_rules! const_caller_location_provider_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function const_caller_location_provider in module {}", module_path!());
    };
}

mkfn!{
    const_caller_location_provider_introspect!();
