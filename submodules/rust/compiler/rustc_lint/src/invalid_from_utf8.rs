...
mkuse!{use crate :: lints :: InvalidFromUtf8Diag ;}
mkuse!{use crate :: { LateContext , LateLintPass , LintContext } ;}
mkitem!{declare_lint ! { #[doc = " The `invalid_from_utf8_unchecked` lint checks for calls to"] #[doc = " `std::str::from_utf8_unchecked` and `std::str::from_utf8_unchecked_mut`"] #[doc = " with a known invalid UTF-8 value."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust,compile_fail"] #[doc = " # #[allow(unused)]"] #[doc = " unsafe {"] #[doc = "     std::str::from_utf8_unchecked(b\"Ru\\x82st\");"] #[doc = " }"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " Creating such a `str` would result in undefined behavior as per documentation"] #[doc = " for `std::str::from_utf8_unchecked` and `std::str::from_utf8_unchecked_mut`."] pub INVALID_FROM_UTF8_UNCHECKED , Deny , "using a non UTF-8 literal in `std::str::from_utf8_unchecked`" }}
mkitem!{declare_lint ! { #[doc = " The `invalid_from_utf8` lint checks for calls to"] #[doc = " `std::str::from_utf8` and `std::str::from_utf8_mut`"] #[doc = " with a known invalid UTF-8 value."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust"] #[doc = " # #[allow(unused)]"] #[doc = " std::str::from_utf8(b\"Ru\\x82st\");"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " Trying to create such a `str` would always return an error as per documentation"] #[doc = " for `std::str::from_utf8` and `std::str::from_utf8_mut`."] pub INVALID_FROM_UTF8 , Warn , "using a non UTF-8 literal in `std::str::from_utf8`" }}
mkitem!{declare_lint_pass ! (InvalidFromUtf8 => [INVALID_FROM_UTF8_UNCHECKED , INVALID_FROM_UTF8]) ;}
