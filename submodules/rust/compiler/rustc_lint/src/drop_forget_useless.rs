...
macro_rules! is_single_call_in_arm_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function is_single_call_in_arm in module {}", module_path!());
    };
}

mkfn!{
    is_single_call_in_arm_introspect!();
