...
mkuse!{use rustc_hir :: def_id :: { LocalDefId , LocalModDefId } ;}
...
mkuse!{use rustc_session :: lint :: LintPass ;}
mkuse!{use rustc_session :: lint :: builtin :: HardwiredLints ;}
mkuse!{use rustc_span :: Span ;}
mkuse!{use tracing :: debug ;}
mkuse!{use crate :: passes :: LateLintPassObject ;}
mkuse!{use crate :: { LateContext , LateLintPass , LintId , LintStore } ;}

macro_rules! unerased_lint_store_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function unerased_lint_store in module {}", module_path!());
    };
}

mkfn!{
    unerased_lint_store_introspect!();
...
macro_rules! late_lint_mod_inner_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function late_lint_mod_inner in module {}", module_path!());
    };
}

mkfn!{
    late_lint_mod_inner_introspect!();
...
macro_rules! late_lint_crate_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function late_lint_crate in module {}", module_path!());
    };
}

mkfn!{
    late_lint_crate_introspect!();
...
macro_rules! late_lint_crate_inner_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function late_lint_crate_inner in module {}", module_path!());
    };
}

mkfn!{
    late_lint_crate_inner_introspect!();
