...
mkuse!{use std :: iter ;}
mkuse!{use rustc_abi :: { BackendRepr , TagEncoding , Variants , WrappingRange } ;}
mkuse!{use rustc_hir :: { Expr , ExprKind , HirId , LangItem } ;}
mkuse!{use rustc_middle :: bug ;}
mkuse!{use rustc_middle :: ty :: layout :: { LayoutOf , SizeSkeleton } ;}
mkuse!{use rustc_middle :: ty :: { self , Ty , TyCtxt , TypeVisitableExt } ;}
mkuse!{use rustc_session :: { declare_lint , declare_lint_pass , impl_lint_pass } ;}
mkuse!{use rustc_span :: { Span , Symbol , sym } ;}
mkuse!{use tracing :: debug ;}
mkuse!{use { rustc_ast as ast , rustc_hir as hir } ;}
mkmod!{improper_ctypes, { 
                getname!(improper_ctypes);
                getsrc!(improper_ctypes);
                getpath!(improper_ctypes);
                get_deps!(improper_ctypes);
                get_crates!(improper_ctypes);
                mkinclude!(improper_ctypes);
                 
            }}
mkuse!{pub (crate) use improper_ctypes :: ImproperCTypesLint ;}
mkuse!{use crate :: lints :: { AmbiguousWidePointerComparisons , AmbiguousWidePointerComparisonsAddrMetadataSuggestion , AmbiguousWidePointerComparisonsAddrSuggestion , AmbiguousWidePointerComparisonsCastSuggestion , AmbiguousWidePointerComparisonsExpectSuggestion , AtomicOrderingFence , AtomicOrderingLoad , AtomicOrderingStore , InvalidAtomicOrderingDiag , InvalidNanComparisons , InvalidNanComparisonsSuggestion , UnpredictableFunctionPointerComparisons , UnpredictableFunctionPointerComparisonsSuggestion , UnusedComparisons , VariantSizeDifferencesDiag , } ;}
...
mkuse!{use literal :: { int_ty_range , lint_literal , uint_ty_range } ;}
mkitem!{declare_lint ! { #[doc = " The `unused_comparisons` lint detects comparisons made useless by"] #[doc = " limits of the types involved."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust"] #[doc = " fn foo(x: u8) {"] #[doc = "     x >= 0;"] #[doc = " }"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " A useless comparison may indicate a mistake, and should be fixed or"] #[doc = " removed."] UNUSED_COMPARISONS , Warn , "comparisons made useless by limits of the types involved" }}
mkitem!{declare_lint ! { #[doc = " The `overflowing_literals` lint detects literals out of range for their type."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust,compile_fail"] #[doc = " let x: u8 = 1000;"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " It is usually a mistake to use a literal that overflows its type"] #[doc = " Change either the literal or its type such that the literal is"] #[doc = " within the range of its type."] OVERFLOWING_LITERALS , Deny , "literal out of range for its type" }}
mkitem!{declare_lint ! { #[doc = " The `variant_size_differences` lint detects enums with widely varying"] #[doc = " variant sizes."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust,compile_fail"] #[doc = " #![deny(variant_size_differences)]"] #[doc = " enum En {"] #[doc = "     V0(u8),"] #[doc = "     VBig([u8; 1024]),"] #[doc = " }"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " It can be a mistake to add a variant to an enum that is much larger"] #[doc = " than the other variants, bloating the overall size required for all"] #[doc = " variants. This can impact performance and memory usage. This is"] #[doc = " triggered if one variant is more than 3 times larger than the"] #[doc = " second-largest variant."] #[doc = ""] #[doc = " Consider placing the large variant's contents on the heap (for example"] #[doc = " via [`Box`]) to keep the overall size of the enum itself down."] #[doc = ""] #[doc = " This lint is \"allow\" by default because it can be noisy, and may not be"] #[doc = " an actual problem. Decisions about this should be guided with"] #[doc = " profiling and benchmarking."] #[doc = ""] #[doc = " [`Box`]: https://doc.rust-lang.org/std/boxed/index.html"] VARIANT_SIZE_DIFFERENCES , Allow , "detects enums with widely varying variant sizes" }}
mkitem!{declare_lint ! { #[doc = " The `invalid_nan_comparisons` lint checks comparison with `f32::NAN` or `f64::NAN`"] #[doc = " as one of the operand."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust"] #[doc = " let a = 2.3f32;"] #[doc = " if a == f32::NAN {}"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " NaN does not compare meaningfully to anything – not"] #[doc = " even itself – so those comparisons are always false."] INVALID_NAN_COMPARISONS , Warn , "detects invalid floating point NaN comparisons" }}
mkitem!{declare_lint ! { #[doc = " The `ambiguous_wide_pointer_comparisons` lint checks comparison"] #[doc = " of `*const/*mut ?Sized` as the operands."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust"] #[doc = " # struct A;"] #[doc = " # struct B;"] #[doc = ""] #[doc = " # trait T {}"] #[doc = " # impl T for A {}"] #[doc = " # impl T for B {}"] #[doc = ""] #[doc = " let ab = (A, B);"] #[doc = " let a = &ab.0 as *const dyn T;"] #[doc = " let b = &ab.1 as *const dyn T;"] #[doc = ""] #[doc = " let _ = a == b;"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " The comparison includes metadata which may not be expected."] AMBIGUOUS_WIDE_POINTER_COMPARISONS , Warn , "detects ambiguous wide pointer comparisons" }}
mkitem!{declare_lint ! { #[doc = " The `unpredictable_function_pointer_comparisons` lint checks comparison"] #[doc = " of function pointer as the operands."] #[doc = ""] #[doc = " ### Example"] #[doc = ""] #[doc = " ```rust"] #[doc = " fn a() {}"] #[doc = " fn b() {}"] #[doc = ""] #[doc = " let f: fn() = a;"] #[doc = " let g: fn() = b;"] #[doc = ""] #[doc = " let _ = f == g;"] #[doc = " ```"] #[doc = ""] #[doc = " {{produces}}"] #[doc = ""] #[doc = " ### Explanation"] #[doc = ""] #[doc = " Function pointers comparisons do not produce meaningful result since"] #[doc = " they are never guaranteed to be unique and could vary between different"] #[doc = " code generation units. Furthermore, different functions could have the"] #[doc = " same address after being merged together."] UNPREDICTABLE_FUNCTION_POINTER_COMPARISONS , Warn , "detects unpredictable function pointer comparisons" , report_in_external_macro }}
mkitem!{mkstruct!{#[derive (Copy , Clone , Default)] pub (crate) struct TypeLimits { #[doc = " Id of the last visited negated expression"] negated_expr_id : Option < hir :: HirId > , #[doc = " Span of the last visited negated expression"] negated_expr_span : Option < Span > , }}}
mkitem!{impl_lint_pass ! (TypeLimits => [UNUSED_COMPARISONS , OVERFLOWING_LITERALS , INVALID_NAN_COMPARISONS , AMBIGUOUS_WIDE_POINTER_COMPARISONS , UNPREDICTABLE_FUNCTION_POINTER_COMPARISONS]) ;}
mkitem!{mkimpl!{impl TypeLimits { pub (crate) fn new () -> TypeLimits { TypeLimits { negated_expr_id : None , negated_expr_span : None } } }}}

macro_rules! lint_nan_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lint_nan in module {}", module_path!());
    };
}
...
mkitem!{mkenum!{#[derive (Debug , PartialEq , Copy , Clone)] enum ComparisonOp { BinOp (hir :: BinOpKind) , Other , }}}

macro_rules! lint_wide_pointer_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lint_wide_pointer in module {}", module_path!());
    };
}

mkfn!{
    lint_wide_pointer_introspect!();
...
macro_rules! lint_fn_pointer_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lint_fn_pointer in module {}", module_path!());
    };
}

mkfn!{
    lint_fn_pointer_introspect!();
...
mkitem!{mkimpl!{impl < 'tcx > LateLintPass < 'tcx > for TypeLimits { fn check_lit (& mut self , cx : & LateContext < 'tcx > , hir_id : HirId , lit : hir :: Lit , negated : bool) { if negated { self . negated_expr_id = Some (hir_id) ; self . negated_expr_span = Some (lit . span) ; } lint_literal (cx , self , hir_id , lit . span , & lit , negated) ; } fn check_expr (& mut self , cx : & LateContext < 'tcx > , e : & 'tcx hir :: Expr < 'tcx >) { match e . kind { hir :: ExprKind :: Unary (hir :: UnOp :: Neg , expr) => { if self . negated_expr_id != Some (e . hir_id) { self . negated_expr_id = Some (expr . hir_id) ; self . negated_expr_span = Some (e . span) ; } } hir :: ExprKind :: Binary (binop , ref l , ref r) => { if is_comparison (binop . node) { if ! check_limits (cx , binop . node , l , r) { cx . emit_span_lint (UNUSED_COMPARISONS , e . span , UnusedComparisons) ; } else { lint_nan (cx , e , binop . node , l , r) ; let cmpop = ComparisonOp :: BinOp (binop . node) ; lint_wide_pointer (cx , e , cmpop , l , r) ; lint_fn_pointer (cx , e , cmpop , l , r) ; } } } hir :: ExprKind :: Call (path , [l , r]) if let ExprKind :: Path (ref qpath) = path . kind && let Some (def_id) = cx . qpath_res (qpath , path . hir_id) . opt_def_id () && let Some (diag_item) = cx . tcx . get_diagnostic_name (def_id) && let Some (cmpop) = diag_item_cmpop (diag_item) => { lint_wide_pointer (cx , e , cmpop , l , r) ; lint_fn_pointer (cx , e , cmpop , l , r) ; } hir :: ExprKind :: MethodCall (_ , l , [r] , _) if let Some (def_id) = cx . typeck_results () . type_dependent_def_id (e . hir_id) && let Some (diag_item) = cx . tcx . get_diagnostic_name (def_id) && let Some (cmpop) = diag_item_cmpop (diag_item) => { lint_wide_pointer (cx , e , cmpop , l , r) ; lint_fn_pointer (cx , e , cmpop , l , r) ; } _ => { } } ; fn is_valid < T : PartialOrd > (binop : hir :: BinOpKind , v : T , min : T , max : T) -> bool { match binop { hir :: BinOpKind :: Lt => v > min && v <= max , hir :: BinOpKind :: Le => v >= min && v < max , hir :: BinOpKind :: Gt => v >= min && v < max , hir :: BinOpKind :: Ge => v > min && v <= max , hir :: BinOpKind :: Eq | hir :: BinOpKind :: Ne => v >= min && v <= max , _ => bug ! () , } } fn rev_binop (binop : hir :: BinOpKind) -> hir :: BinOpKind { match binop { hir :: BinOpKind :: Lt => hir :: BinOpKind :: Gt , hir :: BinOpKind :: Le => hir :: BinOpKind :: Ge , hir :: BinOpKind :: Gt => hir :: BinOpKind :: Lt , hir :: BinOpKind :: Ge => hir :: BinOpKind :: Le , _ => binop , } } fn check_limits (cx : & LateContext < '_ > , binop : hir :: BinOpKind , l : & hir :: Expr < '_ > , r : & hir :: Expr < '_ > ,) -> bool { let (lit , expr , swap) = match (& l . kind , & r . kind) { (& hir :: ExprKind :: Lit (_) , _) => (l , r , true) , (_ , & hir :: ExprKind :: Lit (_)) => (r , l , false) , _ => return true , } ; let norm_binop = if swap { rev_binop (binop) } else { binop } ; match * cx . typeck_results () . node_type (expr . hir_id) . kind () { ty :: Int (int_ty) => { let (min , max) = int_ty_range (int_ty) ; let lit_val : i128 = match lit . kind { hir :: ExprKind :: Lit (li) => match li . node { ast :: LitKind :: Int (v , ast :: LitIntType :: Signed (_) | ast :: LitIntType :: Unsuffixed ,) => v . get () as i128 , _ => return true , } , _ => bug ! () , } ; is_valid (norm_binop , lit_val , min , max) } ty :: Uint (uint_ty) => { let (min , max) : (u128 , u128) = uint_ty_range (uint_ty) ; let lit_val : u128 = match lit . kind { hir :: ExprKind :: Lit (li) => match li . node { ast :: LitKind :: Int (v , _) => v . get () , _ => return true , } , _ => bug ! () , } ; is_valid (norm_binop , lit_val , min , max) } _ => true , } } fn is_comparison (binop : hir :: BinOpKind) -> bool { matches ! (binop , hir :: BinOpKind :: Eq | hir :: BinOpKind :: Lt | hir :: BinOpKind :: Le | hir :: BinOpKind :: Ne | hir :: BinOpKind :: Ge | hir :: BinOpKind :: Gt) } fn diag_item_cmpop (diag_item : Symbol) -> Option < ComparisonOp > { Some (match diag_item { sym :: cmp_ord_max => ComparisonOp :: Other , sym :: cmp_ord_min => ComparisonOp :: Other , sym :: ord_cmp_method => ComparisonOp :: Other , sym :: cmp_partialeq_eq => ComparisonOp :: BinOp (hir :: BinOpKind :: Eq) , sym :: cmp_partialeq_ne => ComparisonOp :: BinOp (hir :: BinOpKind :: Ne) , sym :: cmp_partialord_cmp => ComparisonOp :: Other , sym :: cmp_partialord_ge => ComparisonOp :: BinOp (hir :: BinOpKind :: Ge) , sym :: cmp_partialord_gt => ComparisonOp :: BinOp (hir :: BinOpKind :: Gt) , sym :: cmp_partialord_le => ComparisonOp :: BinOp (hir :: BinOpKind :: Le) , sym :: cmp_partialord_lt => ComparisonOp :: BinOp (hir :: BinOpKind :: Lt) , _ => return None , }) } } }}}

macro_rules! nonnull_optimization_guaranteed_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function nonnull_optimization_guaranteed in module {}", module_path!());
    };
}

mkfn!{
    nonnull_optimization_guaranteed_introspect!();
...
macro_rules! transparent_newtype_field_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function transparent_newtype_field in module {}", module_path!());
    };
}

mkfn!{
    transparent_newtype_field_introspect!();
...
macro_rules! ty_is_known_nonnull_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function ty_is_known_nonnull in module {}", module_path!());
    };
}

mkfn!{
    ty_is_known_nonnull_introspect!();
...
macro_rules! pat_ty_is_known_nonnull_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function pat_ty_is_known_nonnull in module {}", module_path!());
    };
}

mkfn!{
    pat_ty_is_known_nonnull_introspect!();
...
macro_rules! get_nullable_type_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_nullable_type in module {}", module_path!());
    };
}

mkfn!{
    get_nullable_type_introspect!();
...
macro_rules! is_niche_optimization_candidate_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function is_niche_optimization_candidate in module {}", module_path!());
    };
}

mkfn!{
    is_niche_optimization_candidate_introspect!();
...
macro_rules! repr_nullable_ptr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function repr_nullable_ptr in module {}", module_path!());
    };
}

mkfn!{
    repr_nullable_ptr_introspect!();
...
macro_rules! get_nullable_type_from_pat_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_nullable_type_from_pat in module {}", module_path!());
    };
}

mkfn!{
    get_nullable_type_from_pat_introspect!();
...
mkitem!{declare_lint_pass ! (VariantSizeDifferences => [VARIANT_SIZE_DIFFERENCES]) ;}
