...
mkitem!{include ! ("list_and_v1.rs.data") ;}
...
mkuse!{#[doc (inline)] pub use __make_provider as make_provider ;}
mkitem!{#[doc = " This macro requires the following crates:"] #[doc = " * `icu_list`"] #[doc = " * `icu_locale/compiled_data`"] #[doc = " * `icu_provider`"] #[doc = " * `icu_provider/baked`"] #[doc = " * `zerovec`"] #[allow (unused_macros)] macro_rules ! impl_data_provider { ($ provider : ty) => { make_provider ! ($ provider) ; impl_list_and_v1 ! ($ provider) ; } ; }}