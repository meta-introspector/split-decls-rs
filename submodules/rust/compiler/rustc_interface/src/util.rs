...
pub fn get_codegen_backend(
    ...
    let load = LOAD.get_or_init(|| {
        let backend = backend_name
            ...
            .or(option_option_env!("CFG_DEFAULT_CODEGEN_BACKEND"))
            .unwrap_or("llvm");
    ...
    RUSTC_PATH
        .get_or_init(|| {
            let candidate = sysroot
                .default
                .join(option_env!("RUSTC_INSTALL_BINDIR"))
...
fn get_codegen_sysroot(
    ...
    let expected_names = &[
        format!("rustc_codegen_{}-{}", backend_name, option_env!("CFG_RELEASE")),
