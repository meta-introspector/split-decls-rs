...
mkuse!{use rustc_errors :: { DiagArgValue , LintEmitter } ;}
...
macro_rules! emit_attribute_lint_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function emit_attribute_lint in module {}", module_path!());
    };
}

mkfn!{
    emit_attribute_lint_introspect!();
