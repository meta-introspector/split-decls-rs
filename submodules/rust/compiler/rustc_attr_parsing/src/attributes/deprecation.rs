...
mkuse!{use rustc_hir :: attrs :: { DeprecatedSince , Deprecation } ;}
mkuse!{use super :: prelude :: * ;}
mkuse!{use super :: util :: parse_version ;}
mkuse!{use crate :: session_diagnostics :: { DeprecatedItemSuggestion , InvalidSince , MissingNote , MissingSince , } ;}
mkitem!{mkstruct!{pub (crate) struct DeprecationParser ;}}
