...
mkuse!{use rustc_data_structures :: unord :: { ExtendUnord , UnordSet } ;}
...
macro_rules! check_unused_traits_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function check_unused_traits in module {}", module_path!());
    };
}

mkfn!{
    check_unused_traits_introspect!();
