...
mkuse!{use rustc_hir :: { self as hir , AmbigArg , ForeignItem , ForeignItemKind } ;}
mkuse!{use rustc_infer :: infer :: TyCtxtInferExt ;}
mkuse!{use rustc_infer :: traits :: { ObligationCause , ObligationCauseCode , WellFormedLoc } ;}
mkuse!{use rustc_middle :: bug ;}
mkuse!{use rustc_middle :: ty :: { self , TyCtxt , TypeVisitableExt , TypingMode , fold_regions } ;}
