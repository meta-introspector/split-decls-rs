...
mkuse!{use rustc_infer :: traits :: { Obligation , ObligationCause } ;}
mkuse!{use rustc_middle :: ty :: { self , Ty , TyCtxt , TypeFoldable , TypeVisitableExt , fold_regions } ;}
mkuse!{use rustc_span :: def_id :: DefId ;}
mkuse!{use rustc_trait_selection :: traits :: { ObligationCtxt , with_replaced_escaping_bound_vars } ;}

macro_rules! coroutine_hidden_types_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function coroutine_hidden_types in module {}", module_path!());
    };
}

mkfn!{
    coroutine_hidden_types_introspect!();
...
macro_rules! compute_assumptions_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function compute_assumptions in module {}", module_path!());
    };
}

mkfn!{
    compute_assumptions_introspect!();
