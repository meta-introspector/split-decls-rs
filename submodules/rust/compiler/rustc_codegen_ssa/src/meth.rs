...
mkuse!{use rustc_middle :: ty :: { self , GenericArgKind , Ty , TyCtxt } ;}
...
macro_rules! load_vtable_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function load_vtable in module {}", module_path!());
    };
}

mkfn!{
    load_vtable_introspect!();
