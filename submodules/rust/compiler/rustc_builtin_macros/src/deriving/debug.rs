...
mkuse!{use rustc_ast :: { self as ast , EnumDef , MetaItem } ;}
...
macro_rules! expand_deriving_debug_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function expand_deriving_debug in module {}", module_path!());
    };
}

mkfn!{
    expand_deriving_debug_introspect!();
...
macro_rules! show_substructure_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function show_substructure in module {}", module_path!());
    };
}

mkfn!{
    show_substructure_introspect!();
...
macro_rules! show_fieldless_enum_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function show_fieldless_enum in module {}", module_path!());
    };
}

mkfn!{
    show_fieldless_enum_introspect!();
