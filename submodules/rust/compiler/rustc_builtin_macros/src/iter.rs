...
mkuse!{use rustc_ast :: { CoroutineKind , DUMMY_NODE_ID , Expr , ast , token } ;}
...
macro_rules! parse_closure_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function parse_closure in module {}", module_path!());
    };
}

mkfn!{
    parse_closure_introspect!();
