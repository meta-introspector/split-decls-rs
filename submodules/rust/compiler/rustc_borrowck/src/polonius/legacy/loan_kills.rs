...
mkuse!{use rustc_middle :: mir :: { Body , Local , Location , Place , PlaceRef , ProjectionElem , Rvalue , Statement , StatementKind , Terminator , TerminatorKind , } ;}
mkuse!{use rustc_middle :: ty :: TyCtxt ;}
mkuse!{use tracing :: debug ;}
mkuse!{use super :: { PoloniusFacts , PoloniusLocationTable } ;}
mkuse!{use crate :: borrow_set :: BorrowSet ;}
mkuse!{use crate :: places_conflict ;}

macro_rules! emit_loan_kills_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function emit_loan_kills in module {}", module_path!());
    };
}

mkfn!{
    emit_loan_kills_introspect!();
