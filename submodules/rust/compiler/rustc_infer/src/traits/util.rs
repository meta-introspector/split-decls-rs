...
mkuse!{pub use rustc_middle :: ty :: elaborate :: * ;}
mkuse!{use rustc_middle :: ty :: { self , TyCtxt } ;}
mkuse!{use rustc_span :: { Ident , Span } ;}
mkuse!{use crate :: traits :: { self , Obligation , ObligationCauseCode , PredicateObligation } ;}

macro_rules! anonymize_predicate_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function anonymize_predicate in module {}", module_path!());
    };
}

mkfn!{
    anonymize_predicate_introspect!();
