...
mkuse!{use super :: InferCtxt ;}
mkuse!{use super :: region_constraints :: RegionSnapshot ;}
mkmod!{fudge, { 
                getname!(fudge);
                getsrc!(fudge);
                getpath!(fudge);
