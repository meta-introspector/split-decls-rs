...
pub macro version($early_dcx: expr, $binary: literal, $matches: expr) {
    ...
    $crate::version_at_macro_invocation(
        ...
        $binary,
        $matches,
        unw(option_option_env!("CFG_VERSION")),
        unw(option_option_env!("CFG_VER_HASH")),
        unw(option_option_env!("CFG_VER_DATE")),
        unw(option_option_env!("CFG_RELEASE")),
    )
}
...
pub fn install_ice_hook(bug_report_url: &'static str, extra_info: fn(&DiagCtxt)) {
    ...
    if env::var_os("RUST_BACKTRACE").is_none() {
        ...
        if option_env!("CFG_RELEASE_CHANNEL") == "dev" && !ui_testing {
