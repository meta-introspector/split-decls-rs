...
macro_rules! walk_item_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_item in module {}", module_path!());
    };
}

mkfn!{
    walk_item_introspect!();
...
macro_rules! walk_body_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_body in module {}", module_path!());
    };
}

mkfn!{
    walk_body_introspect!();
...
macro_rules! walk_ident_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_ident in module {}", module_path!());
    };
}

mkfn!{
    walk_ident_introspect!();
    pub fn walk_ident < 'v , V : Visitor < 'v > > (visitor : & mut V , ident : Ident) -> V :: Result { visitor . visit_name (ident . name) }
}

macro_rules! walk_mod_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_mod in module {}", module_path!());
    };
}
...
macro_rules! walk_foreign_item_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_foreign_item in module {}", module_path!());
    };
}

mkfn!{
    walk_foreign_item_introspect!();
...
macro_rules! walk_local_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_local in module {}", module_path!());
    };
}

mkfn!{
    walk_local_introspect!();
...
macro_rules! walk_ty_pat_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_ty_pat in module {}", module_path!());
    };
}

mkfn!{
    walk_ty_pat_introspect!();
...
macro_rules! walk_pat_field_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_pat_field in module {}", module_path!());
    };
}

mkfn!{
    walk_pat_field_introspect!();
...
macro_rules! walk_pat_expr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_pat_expr in module {}", module_path!());
    };
}

mkfn!{
    walk_pat_expr_introspect!();
...
macro_rules! walk_anon_const_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_anon_const in module {}", module_path!());
    };
}

mkfn!{
    walk_anon_const_introspect!();
...
macro_rules! walk_inline_const_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_inline_const in module {}", module_path!());
    };
}

mkfn!{
    walk_inline_const_introspect!();
...
mkitem!{mkenum!{# [doc = " We track whether an infer var is from a [`Ty`], [`ConstArg`], or [`GenericArg`] so that"] # [doc = " HIR visitors overriding [`Visitor::visit_infer`] can determine what kind of infer is being visited"] pub enum InferKind < 'hir > { Ty (& 'hir Ty < 'hir >) , Const (& 'hir ConstArg < 'hir >) , Ambig (& 'hir InferArg) , }}}

macro_rules! walk_generic_arg_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_generic_arg in module {}", module_path!());
    };
}

mkfn!{
    walk_generic_arg_introspect!();
...
macro_rules! walk_unambig_ty_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_unambig_ty in module {}", module_path!());
    };
}

mkfn!{
    walk_unambig_ty_introspect!();
...
macro_rules! walk_const_arg_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_const_arg in module {}", module_path!());
    };
}

mkfn!{
    walk_const_arg_introspect!();
...
macro_rules! walk_generic_param_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_generic_param in module {}", module_path!());
    };
}

mkfn!{
    walk_generic_param_introspect!();
...
macro_rules! walk_const_param_default_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_const_param_default in module {}", module_path!());
    };
}

mkfn!{
    walk_const_param_default_introspect!();
    pub fn walk_const_param_default < 'v , V : Visitor < 'v > > (visitor : & mut V , ct : & 'v ConstArg < 'v > ,) -> V :: Result { visitor . visit_const_arg_unambig (ct) }
}

macro_rules! walk_generics_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_generics in module {}", module_path!());
    };
}

mkfn!{
    walk_generics_introspect!();
...
macro_rules! walk_where_predicate_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_where_predicate in module {}", module_path!());
    };
}

mkfn!{
    walk_where_predicate_introspect!();
...
macro_rules! walk_fn_decl_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_fn_decl in module {}", module_path!());
    };
}

mkfn!{
    walk_fn_decl_introspect!();
...
macro_rules! walk_fn_ret_ty_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_fn_ret_ty in module {}", module_path!());
    };
}

mkfn!{
    walk_fn_ret_ty_introspect!();
...
macro_rules! walk_fn_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_fn in module {}", module_path!());
    };
}
...
macro_rules! walk_fn_kind_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_fn_kind in module {}", module_path!());
    };
}

mkfn!{
    walk_fn_kind_introspect!();
...
macro_rules! walk_use_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_use in module {}", module_path!());
    };
}
...
macro_rules! walk_trait_item_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_trait_item in module {}", module_path!());
    };
}

mkfn!{
    walk_trait_item_introspect!();
...
macro_rules! walk_trait_item_ref_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_trait_item_ref in module {}", module_path!());
    };
}

mkfn!{
    walk_trait_item_ref_introspect!();
    pub fn walk_trait_item_ref < 'v , V : Visitor < 'v > > (visitor : & mut V , id : TraitItemId) -> V :: Result { visitor . visit_nested_trait_item (id) }
}

macro_rules! walk_impl_item_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_impl_item in module {}", module_path!());
    };
}

mkfn!{
    walk_impl_item_introspect!();
...
macro_rules! walk_foreign_item_ref_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_foreign_item_ref in module {}", module_path!());
    };
}

mkfn!{
    walk_foreign_item_ref_introspect!();
    pub fn walk_foreign_item_ref < 'v , V : Visitor < 'v > > (visitor : & mut V , id : ForeignItemId) -> V :: Result { visitor . visit_nested_foreign_item (id) }
}

macro_rules! walk_impl_item_ref_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_impl_item_ref in module {}", module_path!());
    };
}

mkfn!{
    walk_impl_item_ref_introspect!();
    pub fn walk_impl_item_ref < 'v , V : Visitor < 'v > > (visitor : & mut V , id : ImplItemId) -> V :: Result { visitor . visit_nested_impl_item (id) }
}

macro_rules! walk_trait_ref_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_trait_ref in module {}", module_path!());
    };
}

mkfn!{
    walk_trait_ref_introspect!();
...
macro_rules! walk_param_bound_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_param_bound in module {}", module_path!());
    };
}

mkfn!{
    walk_param_bound_introspect!();
...
macro_rules! walk_precise_capturing_arg_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_precise_capturing_arg in module {}", module_path!());
    };
}

mkfn!{
    walk_precise_capturing_arg_introspect!();
...
macro_rules! walk_poly_trait_ref_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_poly_trait_ref in module {}", module_path!());
    };
}

mkfn!{
    walk_poly_trait_ref_introspect!();
...
macro_rules! walk_opaque_ty_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_opaque_ty in module {}", module_path!());
    };
}

mkfn!{
    walk_opaque_ty_introspect!();
...
macro_rules! walk_struct_def_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_struct_def in module {}", module_path!());
    };
}

mkfn!{
    walk_struct_def_introspect!();
...
macro_rules! walk_field_def_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_field_def in module {}", module_path!());
    };
}

mkfn!{
    walk_field_def_introspect!();
...
macro_rules! walk_enum_def_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_enum_def in module {}", module_path!());
    };
}

mkfn!{
    walk_enum_def_introspect!();
...
macro_rules! walk_variant_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_variant in module {}", module_path!());
    };
}

mkfn!{
    walk_variant_introspect!();
...
macro_rules! walk_label_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_label in module {}", module_path!());
    };
}

mkfn!{
    walk_label_introspect!();
    pub fn walk_label < 'v , V : Visitor < 'v > > (visitor : & mut V , label : & 'v Label) -> V :: Result { let Label { ident } = label ; visitor . visit_ident (* ident) }
}

macro_rules! walk_inf_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_inf in module {}", module_path!());
    };
}
...
macro_rules! walk_lifetime_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_lifetime in module {}", module_path!());
    };
}

mkfn!{
    walk_lifetime_introspect!();
...
macro_rules! walk_qpath_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_qpath in module {}", module_path!());
    };
}

mkfn!{
    walk_qpath_introspect!();
...
macro_rules! walk_path_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_path in module {}", module_path!());
    };
}

mkfn!{
    walk_path_introspect!();
...
macro_rules! walk_path_segment_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_path_segment in module {}", module_path!());
    };
}

mkfn!{
    walk_path_segment_introspect!();
...
macro_rules! walk_generic_args_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_generic_args in module {}", module_path!());
    };
}

mkfn!{
    walk_generic_args_introspect!();
...
macro_rules! walk_assoc_item_constraint_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_assoc_item_constraint in module {}", module_path!());
    };
}

mkfn!{
    walk_assoc_item_constraint_introspect!();
...
macro_rules! walk_defaultness_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_defaultness in module {}", module_path!());
    };
}

mkfn!{
    walk_defaultness_introspect!();
    pub fn walk_defaultness < 'v , V : Visitor < 'v > > (_ : & mut V , _ : & 'v Defaultness) -> V :: Result { V :: Result :: output () }
}

macro_rules! walk_inline_asm_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function walk_inline_asm in module {}", module_path!());
    };
}

mkfn!{
    walk_inline_asm_introspect!();
