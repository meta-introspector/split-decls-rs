...
macro_rules! get_shard_hash_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_shard_hash in module {}", module_path!());
    };
}

mkfn!{
    get_shard_hash_introspect!();
