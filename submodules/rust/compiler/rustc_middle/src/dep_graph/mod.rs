...
mkuse!{use crate :: ty :: print :: with_reduced_queries ;}
mkuse!{use crate :: ty :: { self , TyCtxt } ;}
mkmod!{dep_node, { 
                getname!(dep_node);
                getsrc!(dep_node);
                getpath!(dep_node);
