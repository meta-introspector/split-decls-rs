...
mkuse!{use gsgdt :: { Edge , Graph , Node , NodeStyle } ;}
mkuse!{use crate :: mir :: * ;}

macro_rules! mir_fn_to_generic_graph_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function mir_fn_to_generic_graph in module {}", module_path!());
    };
}

mkfn!{
    mir_fn_to_generic_graph_introspect!();
...
macro_rules! bb_to_graph_node_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function bb_to_graph_node in module {}", module_path!());
    };
}

mkfn!{
    bb_to_graph_node_introspect!();
...
macro_rules! graphviz_safe_def_name_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function graphviz_safe_def_name in module {}", module_path!());
    };
}

mkfn!{
    graphviz_safe_def_name_introspect!();
    pub fn graphviz_safe_def_name (def_id : DefId) -> String { format ! ("{}_{}" , def_id . krate . index () , def_id . index . index () ,) }
}

macro_rules! node_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function node in module {}", module_path!());
    };
}

mkfn!{
    node_introspect!();
    fn node (def_id : DefId , block : BasicBlock) -> String { format ! ("bb{}__{}" , block . index () , graphviz_safe_def_name (def_id)) }
}