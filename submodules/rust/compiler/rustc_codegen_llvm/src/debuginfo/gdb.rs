...
mkuse!{use rustc_codegen_ssa :: base :: collect_debugger_visualizers_transitive ;}
mkuse!{use rustc_codegen_ssa :: traits :: * ;}
mkuse!{use rustc_hir :: def_id :: LOCAL_CRATE ;}
mkuse!{use rustc_middle :: bug ;}
mkuse!{use rustc_middle :: middle :: debugger_visualizer :: DebuggerVisualizerType ;}
mkuse!{use rustc_session :: config :: { CrateType , DebugInfo } ;}
mkuse!{use crate :: builder :: Builder ;}
mkuse!{use crate :: common :: CodegenCx ;}
mkuse!{use crate :: llvm ;}
mkuse!{use crate :: value :: Value ;}

macro_rules! insert_reference_to_gdb_debug_scripts_section_global_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function insert_reference_to_gdb_debug_scripts_section_global in module {}", module_path!());
    };
}

mkfn!{
    insert_reference_to_gdb_debug_scripts_section_global_introspect!();
...
macro_rules! get_or_insert_gdb_debug_scripts_section_global_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_or_insert_gdb_debug_scripts_section_global in module {}", module_path!());
    };
}

mkfn!{
    get_or_insert_gdb_debug_scripts_section_global_introspect!();
...
macro_rules! needs_gdb_debug_scripts_section_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function needs_gdb_debug_scripts_section in module {}", module_path!());
    };
}

mkfn!{
    needs_gdb_debug_scripts_section_introspect!();
