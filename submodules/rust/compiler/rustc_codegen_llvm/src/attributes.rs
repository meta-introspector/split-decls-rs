...
mkuse!{use rustc_hir :: attrs :: { InlineAttr , InstructionSetAttr , OptimizeAttr } ;}
mkuse!{use rustc_hir :: def_id :: DefId ;}
mkuse!{use rustc_middle :: middle :: codegen_fn_attrs :: { CodegenFnAttrFlags , PatchableFunctionEntry } ;}
mkuse!{use rustc_middle :: ty :: { self , TyCtxt } ;}
mkuse!{use rustc_session :: config :: { BranchProtection , FunctionReturn , OptLevel , PAuthKey , PacRet } ;}
mkuse!{use rustc_symbol_mangling :: mangle_internal_symbol ;}
mkuse!{use rustc_target :: spec :: { FramePointer , SanitizerSet , StackProbeType , StackProtector } ;}
mkuse!{use smallvec :: SmallVec ;}
mkuse!{use crate :: context :: CodegenCx ;}
mkuse!{use crate :: errors :: SanitizerMemtagRequiresMte ;}
mkuse!{use crate :: llvm :: AttributePlace :: Function ;}
mkuse!{use crate :: llvm :: { self , AllocKindFlags , Attribute , AttributeKind , AttributePlace , MemoryEffects } ;}
mkuse!{use crate :: value :: Value ;}
mkuse!{use crate :: { attributes , llvm_util } ;}

macro_rules! apply_to_llfn_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function apply_to_llfn in module {}", module_path!());
    };
}

mkfn!{
    apply_to_llfn_introspect!();
...
macro_rules! apply_to_callsite_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function apply_to_callsite in module {}", module_path!());
    };
}

mkfn!{
    apply_to_callsite_introspect!();
...
macro_rules! patchable_function_entry_attrs_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function patchable_function_entry_attrs in module {}", module_path!());
    };
}

mkfn!{
    patchable_function_entry_attrs_introspect!();
...
macro_rules! sanitize_attrs_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function sanitize_attrs in module {}", module_path!());
    };
}

mkfn!{
    sanitize_attrs_introspect!();
...
macro_rules! uwtable_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function uwtable_attr in module {}", module_path!());
    };
}

mkfn!{
    uwtable_attr_introspect!();
...
macro_rules! frame_pointer_type_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function frame_pointer_type_attr in module {}", module_path!());
    };
}

mkfn!{
    frame_pointer_type_attr_introspect!();
...
macro_rules! function_return_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function function_return_attr in module {}", module_path!());
    };
}

mkfn!{
    function_return_attr_introspect!();
...
macro_rules! instrument_function_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function instrument_function_attr in module {}", module_path!());
    };
}

mkfn!{
    instrument_function_attr_introspect!();
...
macro_rules! nojumptables_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function nojumptables_attr in module {}", module_path!());
    };
}

mkfn!{
    nojumptables_attr_introspect!();
...
macro_rules! probestack_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function probestack_attr in module {}", module_path!());
    };
}

mkfn!{
    probestack_attr_introspect!();
...
macro_rules! stackprotector_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function stackprotector_attr in module {}", module_path!());
    };
}

mkfn!{
    stackprotector_attr_introspect!();
...
macro_rules! backchain_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function backchain_attr in module {}", module_path!());
    };
}

mkfn!{
    backchain_attr_introspect!();
...
macro_rules! target_cpu_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function target_cpu_attr in module {}", module_path!());
    };
}

mkfn!{
    target_cpu_attr_introspect!();
...
macro_rules! tune_cpu_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function tune_cpu_attr in module {}", module_path!());
    };
}

mkfn!{
    tune_cpu_attr_introspect!();
...
macro_rules! target_features_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function target_features_attr in module {}", module_path!());
    };
}

mkfn!{
    target_features_attr_introspect!();
...
macro_rules! non_lazy_bind_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function non_lazy_bind_attr in module {}", module_path!());
    };
}

mkfn!{
    non_lazy_bind_attr_introspect!();
...
macro_rules! default_optimisation_attrs_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function default_optimisation_attrs in module {}", module_path!());
    };
}

mkfn!{
    default_optimisation_attrs_introspect!();
...
macro_rules! create_alloc_family_attr_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function create_alloc_family_attr in module {}", module_path!());
    };
}

mkfn!{
    create_alloc_family_attr_introspect!();
    fn create_alloc_family_attr (llcx : & llvm :: Context) -> & llvm :: Attribute { llvm :: CreateAttrStringValue (llcx , "alloc-family" , "__rust_alloc") }
}

macro_rules! llfn_attrs_from_instance_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function llfn_attrs_from_instance in module {}", module_path!());
    };
}

mkfn!{
    llfn_attrs_from_instance_introspect!();
...
macro_rules! wasm_import_module_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function wasm_import_module in module {}", module_path!());
    };
}

mkfn!{
    wasm_import_module_introspect!();
