...
macro_rules! codegen_return_param_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function codegen_return_param in module {}", module_path!());
    };
}

mkfn!{
    codegen_return_param_introspect!();
...
macro_rules! codegen_with_call_return_arg_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function codegen_with_call_return_arg in module {}", module_path!());
    };
}

mkfn!{
    codegen_with_call_return_arg_introspect!();
...
macro_rules! codegen_return_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function codegen_return in module {}", module_path!());
    };
}

mkfn!{
    codegen_return_introspect!();
