...
macro_rules! maybe_codegen_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function maybe_codegen in module {}", module_path!());
    };
}

mkfn!{
    maybe_codegen_introspect!();
...
macro_rules! maybe_codegen_mul_checked_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function maybe_codegen_mul_checked in module {}", module_path!());
    };
}

mkfn!{
    maybe_codegen_mul_checked_introspect!();
