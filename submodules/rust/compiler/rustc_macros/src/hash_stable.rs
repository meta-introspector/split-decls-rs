...
mkitem!{mkstruct!{struct Attributes { ignore : bool , project : Option < Ident > , }}}

macro_rules! parse_attributes_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function parse_attributes in module {}", module_path!());
    };
}

mkfn!{
    parse_attributes_introspect!();
...
macro_rules! hash_stable_derive_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function hash_stable_derive in module {}", module_path!());
    };
}

mkfn!{
    hash_stable_derive_introspect!();
...
macro_rules! hash_stable_generic_derive_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function hash_stable_generic_derive in module {}", module_path!());
    };
}

mkfn!{
    hash_stable_generic_derive_introspect!();
...
macro_rules! hash_stable_no_context_derive_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function hash_stable_no_context_derive in module {}", module_path!());
    };
}

mkfn!{
    hash_stable_no_context_derive_introspect!();
...
mkitem!{mkenum!{enum HashStableMode { Normal , Generic , NoContext , }}}

macro_rules! hash_stable_derive_with_mode_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function hash_stable_derive_with_mode in module {}", module_path!());
    };
}

mkfn!{
    hash_stable_derive_with_mode_introspect!();
...
macro_rules! hash_stable_discriminant_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function hash_stable_discriminant in module {}", module_path!());
    };
}

mkfn!{
    hash_stable_discriminant_introspect!();
...
macro_rules! hash_stable_body_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function hash_stable_body in module {}", module_path!());
    };
}

mkfn!{
    hash_stable_body_introspect!();
