...
mkuse!{use rustc_codegen_ssa :: back :: write :: { BitcodeSection , CodegenContext , EmitObj , ModuleConfig } ;}
mkuse!{use rustc_codegen_ssa :: { CompiledModule , ModuleCodegen } ;}
mkuse!{use rustc_fs_util :: link_or_copy ;}
mkuse!{use rustc_session :: config :: OutputType ;}
mkuse!{use rustc_target :: spec :: SplitDebuginfo ;}
mkuse!{use crate :: base :: add_pic_option ;}
mkuse!{use crate :: errors :: CopyBitcode ;}
mkuse!{use crate :: { GccCodegenBackend , GccContext } ;}
...
mkfn!{
    ...
    pub (crate) fn save_temp_bitcode (cgcx : & CodegenContext < GccCodegenBackend > , _module : & ModuleCodegen < GccContext > , _name : & str ,) { if ! cgcx . save_temps { return ; } unimplemented ! () ; }
}