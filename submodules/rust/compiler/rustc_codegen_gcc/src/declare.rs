...
mkuse!{#[cfg (feature = "master")] use gccjit :: { FnAttribute , ToRValue } ;}
mkuse!{use gccjit :: { Function , FunctionType , GlobalKind , LValue , RValue , Type } ;}
...
macro_rules! mangle_name_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function mangle_name in module {}", module_path!());
    };
}

mkfn!{
    mangle_name_introspect!();
