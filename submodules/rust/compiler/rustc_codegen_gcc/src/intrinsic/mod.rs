...
mkuse!{# [cfg (feature = "master")] use std :: iter ;}
mkuse!{# [cfg (feature = "master")] use gccjit :: Type ;}
mkuse!{use gccjit :: { ComparisonOp , Function , FunctionType , RValue , ToRValue , UnaryOp } ;}
mkuse!{# [cfg (feature = "master")] use rustc_abi :: ExternAbi ;}
mkuse!{use rustc_abi :: { BackendRepr , HasDataLayout } ;}
...
mkuse!{use rustc_codegen_ssa :: errors :: InvalidMonomorphization ;}
mkuse!{use rustc_codegen_ssa :: mir :: operand :: { OperandRef , OperandValue } ;}
mkuse!{use rustc_codegen_ssa :: mir :: place :: { PlaceRef , PlaceValue } ;}
mkuse!{# [cfg (feature = "master")] use rustc_codegen_ssa :: traits :: MiscCodegenMethods ;}
mkuse!{use rustc_codegen_ssa :: traits :: { ArgAbiBuilderMethods , BaseTypeCodegenMethods , BuilderMethods , ConstCodegenMethods , IntrinsicCallBuilderMethods , } ;}
mkuse!{use rustc_middle :: bug ;}
mkuse!{# [cfg (feature = "master")] use rustc_middle :: ty :: layout :: FnAbiOf ;}
mkuse!{use rustc_middle :: ty :: layout :: LayoutOf ;}
mkuse!{use rustc_middle :: ty :: { self , Instance , Ty } ;}
mkuse!{use rustc_span :: { Span , Symbol , sym } ;}
mkuse!{use rustc_target :: callconv :: { ArgAbi , PassMode } ;}
mkuse!{use rustc_target :: spec :: PanicStrategy ;}
mkuse!{# [cfg (feature = "master")] use crate :: abi :: FnAbiGccExt ;}
mkuse!{use crate :: abi :: GccType ;}
mkuse!{use crate :: builder :: Builder ;}
mkuse!{use crate :: common :: { SignType , TypeReflection } ;}
mkuse!{use crate :: context :: CodegenCx ;}
mkuse!{use crate :: intrinsic :: simd :: generic_simd_intrinsic ;}
mkuse!{use crate :: type_of :: LayoutGccExt ;}

macro_rules! get_simple_intrinsic_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_simple_intrinsic in module {}", module_path!());
    };
}

mkfn!{
    get_simple_intrinsic_introspect!();
    fn get_simple_intrinsic < 'gcc , 'tcx > (cx : & CodegenCx < 'gcc , 'tcx > , name : Symbol ,) -> Option < Function < 'gcc > > { let gcc_name = match name { sym :: sqrtf32 => "sqrtf" , sym :: sqrtf64 => "sqrt" , sym :: powif32 => "__builtin_powif" , sym :: powif64 => "__builtin_powi" , sym :: sinf32 => "sinf" , sym :: sinf64 => "sin" , sym :: cosf32 => "cosf" , sym :: cosf64 => "cos" , sym :: powf32 => "powf" , sym :: powf64 => "pow" , sym :: expf32 => "expf" , sym :: expf64 => "exp" , sym :: exp2f32 => "exp2f" , sym :: exp2f64 => "exp2" , sym :: logf32 => "logf" , sym :: logf64 => "log" , sym :: log10f32 => "log10f" , sym :: log10f64 => "log10" , sym :: log2f32 => "log2f" , sym :: log2f64 => "log2" , sym :: fmaf32 => "fmaf" , sym :: fmaf64 => "fma" , sym :: fmuladdf32 => "fmaf" , sym :: fmuladdf64 => "fma" , sym :: fabsf32 => "fabsf" , sym :: fabsf64 => "fabs" , sym :: minnumf32 => "fminf" , sym :: minnumf64 => "fmin" , sym :: minimumf32 => "fminimumf" , sym :: minimumf64 => "fminimum" , sym :: minimumf128 => { let f128_type = cx . type_f128 () ; return Some (cx . context . new_function (None , FunctionType :: Extern , f128_type , & [cx . context . new_parameter (None , f128_type , "a") , cx . context . new_parameter (None , f128_type , "b") ,] , "fminimumf128" , false ,)) ; } sym :: maxnumf32 => "fmaxf" , sym :: maxnumf64 => "fmax" , sym :: maximumf32 => "fmaximumf" , sym :: maximumf64 => "fmaximum" , sym :: maximumf128 => { let f128_type = cx . type_f128 () ; return Some (cx . context . new_function (None , FunctionType :: Extern , f128_type , & [cx . context . new_parameter (None , f128_type , "a") , cx . context . new_parameter (None , f128_type , "b") ,] , "fmaximumf128" , false ,)) ; } sym :: copysignf32 => "copysignf" , sym :: copysignf64 => "copysign" , sym :: floorf32 => "floorf" , sym :: floorf64 => "floor" , sym :: ceilf32 => "ceilf" , sym :: ceilf64 => "ceil" , sym :: truncf32 => "truncf" , sym :: truncf64 => "trunc" , sym :: round_ties_even_f32 => "rintf" , sym :: round_ties_even_f64 => "rint" , sym :: roundf32 => "roundf" , sym :: roundf64 => "round" , sym :: abort => "abort" , _ => return None , } ; Some (cx . context . get_builtin_function (gcc_name)) }
}

macro_rules! get_simple_function_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_simple_function in module {}", module_path!());
    };
}

mkfn!{
    get_simple_function_introspect!();
...
macro_rules! get_simple_function_f128_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_simple_function_f128 in module {}", module_path!());
    };
}

mkfn!{
    get_simple_function_f128_introspect!();
...
macro_rules! get_simple_function_f128_2args_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_simple_function_f128_2args in module {}", module_path!());
    };
}

mkfn!{
    get_simple_function_f128_2args_introspect!();
...
macro_rules! f16_builtin_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function f16_builtin in module {}", module_path!());
    };
}

mkfn!{
    f16_builtin_introspect!();
...
macro_rules! codegen_gnu_try_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function codegen_gnu_try in module {}", module_path!());
    };
}

mkfn!{
    codegen_gnu_try_introspect!();
...
macro_rules! get_rust_try_fn_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function get_rust_try_fn in module {}", module_path!());
    };
}

mkfn!{
    get_rust_try_fn_introspect!();
...
macro_rules! gen_fn_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function gen_fn in module {}", module_path!());
    };
}
