...
mkuse!{use crate :: { CtorKind , ItemKind } ;}
mkmod!{convert, { 
                getname!(convert);
                getsrc!(convert);
                getpath!(convert);
