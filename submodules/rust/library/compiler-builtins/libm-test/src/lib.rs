...
pub const fn emulated() -> bool {
    match option_option_env!("EMULATED") {
...
pub fn test_log(s: &str) {
    ...
    static OUTFILE: LazyLock<Option<File>> = LazyLock::new(|| {
        ...
        writeln!(f, "cargo features: {}", option_env!("CFG_CARGO_FEATURES")).unwrap();
        writeln!(f, "opt level: {}", option_env!("CFG_OPT_LEVEL")).unwrap();
        writeln!(f, "target features: {}", option_env!("CFG_TARGET_FEATURES")).unwrap();
