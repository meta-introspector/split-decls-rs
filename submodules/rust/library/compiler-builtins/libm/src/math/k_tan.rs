...
mkitem!{static T : [f64 ; 13] = [3.33333333333334091986e-01 , 1.33333333333201242699e-01 , 5.39682539762260521377e-02 , 2.18694882948595424599e-02 , 8.86323982359930005737e-03 , 3.59207910759131235356e-03 , 1.45620945432529025516e-03 , 5.88041240820264096874e-04 , 2.46463134818469906812e-04 , 7.81794442939557092300e-05 , 7.14072491382608190305e-05 , - 1.85586374855275456654e-05 , 2.59073051863633712884e-05 ,] ;}
mkitem!{const PIO4 : f64 = 7.85398163397448278999e-01 ;}
mkitem!{const PIO4_LO : f64 = 3.06161699786838301793e-17 ;}

macro_rules! k_tan_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function k_tan in module {}", module_path!());
    };
}
...
macro_rules! zero_low_word_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function zero_low_word in module {}", module_path!());
    };
}

mkfn!{
    zero_low_word_introspect!();
