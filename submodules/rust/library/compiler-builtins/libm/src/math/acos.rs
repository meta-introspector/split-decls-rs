...
mkitem!{const PS0 : f64 = 1.66666666666666657415e-01 ;}
mkitem!{const PS1 : f64 = - 3.25565818622400915405e-01 ;}
mkitem!{const PS2 : f64 = 2.01212532134862925881e-01 ;}
mkitem!{const PS3 : f64 = - 4.00555345006794114027e-02 ;}
mkitem!{const PS4 : f64 = 7.91534994289814532176e-04 ;}
mkitem!{const PS5 : f64 = 3.47933107596021167570e-05 ;}
mkitem!{const QS1 : f64 = - 2.40339491173441421878e+00 ;}
mkitem!{const QS2 : f64 = 2.02094576023350569471e+00 ;}
mkitem!{const QS3 : f64 = - 6.88283971605453293030e-01 ;}
mkitem!{const QS4 : f64 = 7.70381505559019352791e-02 ;}
...
mkfn!{
    r_introspect!();
    fn r (z : f64) -> f64 { let p : f64 = z * (PS0 + z * (PS1 + z * (PS2 + z * (PS3 + z * (PS4 + z * PS5))))) ; let q : f64 = 1.0 + z * (QS1 + z * (QS2 + z * (QS3 + z * QS4))) ; p / q }
}

macro_rules! acos_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function acos in module {}", module_path!());
    };
}
