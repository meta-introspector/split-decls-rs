...
mkuse!{use core :: f64 ;}
mkitem!{const IVLN2HI : f64 = 1.44269504072144627571e+00 ;}
mkitem!{const IVLN2LO : f64 = 1.67517131648865118353e-10 ;}
...
macro_rules! log2_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function log2 in module {}", module_path!());
    };
}
