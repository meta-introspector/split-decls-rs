...
mkitem!{const TOINT : f64 = 1.5 / f64 :: EPSILON ;}
mkitem!{# [doc = " 53 bits of 2/pi"] const INV_PIO2 : f64 = 6.36619772367581382433e-01 ;}
mkitem!{# [doc = " first 25 bits of pi/2"] const PIO2_1 : f64 = 1.57079631090164184570e+00 ;}
mkitem!{# [doc = " pi/2 - pio2_1"] const PIO2_1T : f64 = 1.58932547735281966916e-08 ;}

macro_rules! rem_pio2f_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function rem_pio2f in module {}", module_path!());
    };
}

mkfn!{
    rem_pio2f_introspect!();
