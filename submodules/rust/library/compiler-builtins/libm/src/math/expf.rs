...
mkuse!{use super :: scalbnf ;}
mkitem!{const HALF : [f32 ; 2] = [0.5 , - 0.5] ;}
mkitem!{const LN2_HI : f32 = 6.9314575195e-01 ;}
mkitem!{const LN2_LO : f32 = 1.4286067653e-06 ;}
mkitem!{const INV_LN2 : f32 = 1.4426950216e+00 ;}
mkitem!{const P1 : f32 = 1.6666625440e-1 ;}
mkitem!{const P2 : f32 = - 2.7667332906e-3 ;}

macro_rules! expf_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function expf in module {}", module_path!());
    };
}
