...
mkuse!{use super :: { fabs , get_high_word , get_low_word , sqrt , with_set_low_word } ;}
mkitem!{const PIO2_HI : f64 = 1.57079632679489655800e+00 ;}
mkitem!{const PIO2_LO : f64 = 6.12323399573676603587e-17 ;}
mkitem!{const P_S0 : f64 = 1.66666666666666657415e-01 ;}
mkitem!{const P_S1 : f64 = - 3.25565818622400915405e-01 ;}
mkitem!{const P_S2 : f64 = 2.01212532134862925881e-01 ;}
mkitem!{const P_S3 : f64 = - 4.00555345006794114027e-02 ;}
mkitem!{const P_S4 : f64 = 7.91534994289814532176e-04 ;}
mkitem!{const P_S5 : f64 = 3.47933107596021167570e-05 ;}
mkitem!{const Q_S1 : f64 = - 2.40339491173441421878e+00 ;}
mkitem!{const Q_S2 : f64 = 2.02094576023350569471e+00 ;}
mkitem!{const Q_S3 : f64 = - 6.88283971605453293030e-01 ;}
mkitem!{const Q_S4 : f64 = 7.70381505559019352791e-02 ;}

macro_rules! comp_r_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function comp_r in module {}", module_path!());
    };
}
...
macro_rules! asin_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function asin in module {}", module_path!());
    };
}
