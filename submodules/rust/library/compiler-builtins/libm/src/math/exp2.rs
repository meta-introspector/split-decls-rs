...
macro_rules! i0_wrap_test_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function i0_wrap_test in module {}", module_path!());
    };
}

mkfn!{
    i0_wrap_test_introspect!();
