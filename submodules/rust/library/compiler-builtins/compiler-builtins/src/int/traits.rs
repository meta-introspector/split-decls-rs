...
mkuse!{pub use crate :: support :: { CastFrom , CastInto , Int , MinInt } ;}
mkitem!{mktrait!{#[doc = " Trait for integers twice the bit width of another integer. This is implemented for all"] #[doc = " primitives except for `u8`, because there is not a smaller primitive."] pub trait DInt : MinInt { #[doc = " Integer that is half the bit width of the integer this trait is implemented for"] type H : HInt < D = Self > ; #[doc = " Returns the low half of `self`"] fn lo (self) -> Self :: H ; #[doc = " Returns the high half of `self`"] fn hi (self) -> Self :: H ; #[doc = " Returns the low and high halves of `self` as a tuple"] fn lo_hi (self) -> (Self :: H , Self :: H) { (self . lo () , self . hi ()) } #[doc = " Constructs an integer using lower and higher half parts"] fn from_lo_hi (lo : Self :: H , hi : Self :: H) -> Self { lo . zero_widen () | hi . widen_hi () } }}}
mkitem!{mktrait!{#[doc = " Trait for integers half the bit width of another integer. This is implemented for all"] #[doc = " primitives except for `u128`, because it there is not a larger primitive."] pub trait HInt : Int { #[doc = " Integer that is double the bit width of the integer this trait is implemented for"] type D : DInt < H = Self > + MinInt ; #[doc = " Widens (using default extension) the integer to have double bit width"] fn widen (self) -> Self :: D ; #[doc = " Widens (zero extension only) the integer to have double bit width. This is needed to get"] #[doc = " around problems with associated type bounds (such as `Int<Othersign: DInt>`) being unstable"] fn zero_widen (self) -> Self :: D ; #[doc = " Widens the integer to have double bit width and shifts the integer into the higher bits"] fn widen_hi (self) -> Self :: D ; #[doc = " Widening multiplication with zero widening. This cannot overflow."] fn zero_widen_mul (self , rhs : Self) -> Self :: D ; #[doc = " Widening multiplication. This cannot overflow."] fn widen_mul (self , rhs : Self) -> Self :: D ; }}}
