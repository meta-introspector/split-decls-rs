...
mkitem!{mkstruct!{#[doc = " we do not supported rwlock, so use mutex to simulate rwlock."] #[doc = " it's useful because so many code in std will use rwlock."] pub struct RwLock { inner : Mutex , }}}
