...
mkuse!{#[cfg (target_os = "hermit")] use hermit_abi :: iovec ;}
mkuse!{#[cfg (any (target_family = "unix" , target_os = "trusty"))] use libc :: iovec ;}
mkuse!{use crate :: ffi :: c_void ;}
mkuse!{use crate :: marker :: PhantomData ;}
mkuse!{use crate :: slice ;}
mkuse!{#[cfg (target_os = "solid_asp3")] use crate :: sys :: pal :: abi :: sockets :: iovec ;}
mkitem!{mkstruct!{#[derive (Copy , Clone)] #[repr (transparent)] pub struct IoSlice < 'a > { vec : iovec , _p : PhantomData < & 'a [u8] > , }}}
...
mkitem!{mkstruct!{#[repr (transparent)] pub struct IoSliceMut < 'a > { vec : iovec , _p : PhantomData < & 'a mut [u8] > , }}}
