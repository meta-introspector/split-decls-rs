mkitem!{pub const DIGEST_WORDS : usize = 8 ;}
mkmod!{fileno, { 
                getname!(fileno);
                getsrc!(fileno);
                getpath!(fileno);
