...
mkuse!{use crate :: os :: xous :: ffi :: blocking_scalar ;}
mkuse!{use crate :: os :: xous :: services :: SystimeScalar :: GetUtcTimeMs ;}
mkuse!{use crate :: os :: xous :: services :: TicktimerScalar :: ElapsedMs ;}
mkuse!{use crate :: os :: xous :: services :: { systime_server , ticktimer_server } ;}
