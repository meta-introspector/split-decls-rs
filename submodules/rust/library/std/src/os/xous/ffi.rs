...
mkuse!{# [stable (feature = "rust1" , since = "1.0.0")] pub use definitions :: * ;}

macro_rules! lend_mut_impl_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lend_mut_impl in module {}", module_path!());
    };
}

mkfn!{
    lend_mut_impl_introspect!();
...
macro_rules! lend_mut_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lend_mut in module {}", module_path!());
    };
}
...
macro_rules! try_lend_mut_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function try_lend_mut in module {}", module_path!());
    };
}

mkfn!{
    try_lend_mut_introspect!();
...
macro_rules! lend_impl_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lend_impl in module {}", module_path!());
    };
}

mkfn!{
    lend_impl_introspect!();
...
macro_rules! lend_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function lend in module {}", module_path!());
    };
}
...
macro_rules! try_lend_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function try_lend in module {}", module_path!());
    };
}
...
macro_rules! scalar_impl_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function scalar_impl in module {}", module_path!());
    };
}

mkfn!{
    scalar_impl_introspect!();
...
macro_rules! scalar_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function scalar in module {}", module_path!());
    };
}

mkfn!{
    scalar_introspect!();
    pub (crate) fn scalar (connection : Connection , args : [usize ; 5]) -> Result < () , Error > { scalar_impl (connection , args , true) }
}

macro_rules! try_scalar_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function try_scalar in module {}", module_path!());
    };
}

mkfn!{
    try_scalar_introspect!();
    pub (crate) fn try_scalar (connection : Connection , args : [usize ; 5]) -> Result < () , Error > { scalar_impl (connection , args , false) }
}

macro_rules! blocking_scalar_impl_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function blocking_scalar_impl in module {}", module_path!());
    };
}

mkfn!{
    blocking_scalar_impl_introspect!();
...
macro_rules! blocking_scalar_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function blocking_scalar in module {}", module_path!());
    };
}

mkfn!{
    blocking_scalar_introspect!();
    pub (crate) fn blocking_scalar (connection : Connection , args : [usize ; 5] ,) -> Result < [usize ; 5] , Error > { blocking_scalar_impl (connection , args , true) }
}

macro_rules! try_blocking_scalar_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function try_blocking_scalar in module {}", module_path!());
    };
}

mkfn!{
    try_blocking_scalar_introspect!();
    pub (crate) fn try_blocking_scalar (connection : Connection , args : [usize ; 5] ,) -> Result < [usize ; 5] , Error > { blocking_scalar_impl (connection , args , false) }
}

macro_rules! connect_impl_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function connect_impl in module {}", module_path!());
    };
}

mkfn!{
    connect_impl_introspect!();
...
macro_rules! do_yield_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function do_yield in module {}", module_path!());
    };
}
...
macro_rules! map_memory_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function map_memory in module {}", module_path!());
    };
}

mkfn!{
    map_memory_introspect!();
...
macro_rules! unmap_memory_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function unmap_memory in module {}", module_path!());
    };
}

mkfn!{
    unmap_memory_introspect!();
...
macro_rules! update_memory_flags_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function update_memory_flags in module {}", module_path!());
    };
}

mkfn!{
    update_memory_flags_introspect!();
...
macro_rules! create_thread_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function create_thread in module {}", module_path!());
    };
}

mkfn!{
    create_thread_introspect!();
...
macro_rules! join_thread_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function join_thread in module {}", module_path!());
    };
}

mkfn!{
    join_thread_introspect!();
...
macro_rules! thread_id_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function thread_id in module {}", module_path!());
    };
}

mkfn!{
    thread_id_introspect!();
...
macro_rules! adjust_limit_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function adjust_limit in module {}", module_path!());
    };
}

mkfn!{
    adjust_limit_introspect!();
