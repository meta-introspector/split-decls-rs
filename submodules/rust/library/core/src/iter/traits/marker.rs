...
mkuse!{use crate :: iter :: Step ;}
mkuse!{use crate :: num :: NonZero ;}
mkitem!{mktrait!{#[doc = " Same as FusedIterator"] #[doc = ""] #[doc = " # Safety"] #[doc = ""] #[doc = " This is used for specialization. Therefore implementations must not"] #[doc = " be lifetime-dependent."] #[unstable (issue = "none" , feature = "trusted_fused")] #[doc (hidden)] #[rustc_specialization_trait] pub unsafe trait TrustedFused { }}}
