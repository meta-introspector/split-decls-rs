...
mkuse!{# [stable (feature = "prelude_2021" , since = "1.55.0")] # [doc (no_inline)] pub use crate :: iter :: FromIterator ;}
mkuse!{# [stable (feature = "prelude_2021" , since = "1.55.0")] # [doc (no_inline)] pub use crate :: convert :: { TryFrom , TryInto } ;} 
            }}
mkmod!{rust_2024, { 
                getname!(rust_2024);
                getsrc!(rust_2024);
...
mkuse!{# [stable (feature = "prelude_2021" , since = "1.55.0")] # [doc (no_inline)] pub use crate :: iter :: FromIterator ;}
mkuse!{# [stable (feature = "prelude_2021" , since = "1.55.0")] # [doc (no_inline)] pub use crate :: convert :: { TryFrom , TryInto } ;}
mkuse!{# [stable (feature = "prelude_2024" , since = "1.85.0")] # [doc (no_inline)] pub use crate :: future :: { Future , IntoFuture } ;} 
            }}
mkmod!{rust_future, { 
                getname!(rust_future);
                getsrc!(rust_future);
