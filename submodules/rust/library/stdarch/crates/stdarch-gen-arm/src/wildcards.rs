...
mkuse!{use std :: { fmt , sync :: LazyLock } ;}
mkuse!{use crate :: { fn_suffix :: SuffixKind , predicate_forms :: PredicationMask , typekinds :: { ToRepr , TypeKind , TypeKindOptions , VectorTupleSize } , } ;}
