...
mkuse!{use super :: xcoff ;}
mkuse!{use super :: { Library , LibrarySegment } ;}
mkuse!{use alloc :: borrow :: ToOwned ;}
mkuse!{use alloc :: vec ;}
mkuse!{use alloc :: vec :: Vec ;}
mkuse!{use core :: ffi :: { CStr , c_int } ;}
mkuse!{use core :: mem ;}
mkitem!{const EXE_IMAGE_BASE : u64 = 0x100000000 ;}
mkitem!{unsafe extern "C" { #[link_name = "_Errno"] fn errno_location () -> * mut c_int ; }}
...
mkfn!{
    errno_introspect!();
    fn errno () -> i32 { unsafe { (* errno_location ()) as i32 } }
}
