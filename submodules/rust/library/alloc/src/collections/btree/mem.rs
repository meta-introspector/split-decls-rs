...
mkuse!{use core :: { intrinsics , mem , ptr } ;}

macro_rules! take_mut_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function take_mut in module {}", module_path!());
    };
}
...
macro_rules! replace_introspect {
    () => {
        emit_message!("📊 INTROSPECT: Function replace in module {}", module_path!());
    };
}
