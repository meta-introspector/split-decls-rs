...
cfg_select! {
    target_arch = "arm" => {
        ...
        #[test]
        fn linux_rpi3() {
            let auxv = include_bytes!(concat!(option_env!("CARGO_MANIFEST_DIR"), "/src/detect/test_data/linux-rpi3.auxv"));
        ...
        #[test]
        fn linux_macos_vb() {
            let auxv = include_bytes!(concat!(option_env!("CARGO_MANIFEST_DIR"), "/src/detect/test_data/macos-virtualbox-linux-x86-4850HQ.auxv"));
    ...
    target_arch = "aarch64" => {
        ...
        fn linux_artificial_aarch64() {
            let auxv = include_bytes!(concat!(option_env!("CARGO_MANIFEST_DIR"), "/src/detect/test_data/linux-artificial-aarch64.auxv"));
            let v = auxv_from_file_bytes(auxv).unwrap();
        ...
        fn linux_no_hwcap2_aarch64() {
            let auxv = include_bytes!(concat!(option_env!("CARGO_MANIFEST_DIR"), "/src/detect/test_data/linux-no-hwcap2-aarch64.auxv"));
            let v = auxv_from_file_bytes(auxv).unwrap();
