...
impl Scales {
    #[doc = " Instantiates a new `Scales` with SI keys"]
    pub fn new() -> Self {
        Default::default()
    }
    #[doc = " Instantiates a new `Scales` with SI keys"]
    ...
    #[doc = " Instantiates a new `Scales` with Binary keys"]
    #[allow(non_snake_case)]
    pub fn Binary() -> Self {
        Scales {
            base: 1024,
    ...
    #[doc = " Sets the base for the `Scales`"]
    pub fn with_base(&mut self, base: u32) -> &mut Self {
        self.base = base;
        self
    }
    #[doc = " Sets the suffixes listing appropriately"]
