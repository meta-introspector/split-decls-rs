// Generated macro for resolve_includes_recursive (function)
macro_rules! Depcrate_file_includesresolve_includes_recursive {
() => {
// Module: crate::file::includes
// Provides: {"resolve_includes_recursive"}
// Dependencies: {}
