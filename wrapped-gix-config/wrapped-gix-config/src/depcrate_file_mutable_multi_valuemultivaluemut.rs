// Generated macro for MultiValueMut (struct)
macro_rules! Depcrate_file_mutable_multi_valueMultiValueMut {
() => {
// Module: crate::file::mutable::multi_value
// Provides: {"MultiValueMut"}
// Dependencies: {}
