...
impl ExpansionInfo {
    ...
    #[doc = " Maps the passed in file range down into a macro expansion if it is the input to a macro call."]
    #[doc = ""]
    #[doc = " Note this does a linear search through the entire backing vector of the spanmap."]
    ...
    #[doc = " Maps the passed in file range down into a macro expansion if it is the input to a macro call."]
    #[doc = " Unlike [`map_range_down_exact`], this will consider spans that contain the given span."]
    #[doc = ""]
    #[doc = " Note this does a linear search through the entire backing vector of the spanmap."]
    ...
    #[doc = " Maps up the text range out of the expansion into its macro call."]
    #[doc = ""]
    #[doc = " Note that this may return multiple ranges as we lose the precise association between input to output"]
    #[doc = " and as such we may consider inputs that are unrelated."]
