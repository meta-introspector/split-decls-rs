// Generated macro for test_grapheme_cursor_ris_precontext (function)
macro_rules! Depcrate_graphemetest_grapheme_cursor_ris_precontext {
() => {
// Module: crate::grapheme
// Provides: {"test_grapheme_cursor_ris_precontext"}
// Dependencies: {}
