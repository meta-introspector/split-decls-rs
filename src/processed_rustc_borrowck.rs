...
use rustc_borrowck::dataflow::{BorrowIndex, Borrowck, BorrowckDomain, Borrows};
use rustc_borrowck::diagnostics::{
    AccessKind, BorrowckDiagnosticsBuffer, IllegalMoveOriginKind, MoveError, RegionName,
};
use rustc_borrowck::path_utils::*;
use rustc_borrowck::place_ext::PlaceExt;
use rustc_borrowck::places_conflict::{PlaceConflictBias, places_conflict};
use rustc_borrowck::polonius::legacy::{
    PoloniusFacts, PoloniusFactsExt, PoloniusLocationTable, PoloniusOutput,
};
use rustc_borrowck::polonius::{PoloniusContext, PoloniusDiagnosticsContext};
use rustc_borrowck::prefixes::PrefixSet;
use rustc_borrowck::region_infer::RegionInferenceContext;
use rustc_borrowck::region_infer::opaque_types::DeferredOpaqueTypeError;
use rustc_borrowck::renumber::RegionCtxt;
use rustc_borrowck::session_diagnostics::VarNeedNotMut;
use rustc_borrowck::type_check::free_region_relations::UniversalRegionRelations;
use rustc_borrowck::type_check::{Locations, MirTypeckRegionConstraints, MirTypeckResults};
