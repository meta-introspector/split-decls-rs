...
use crate::rustc_hir::def::{CtorKind, DefKind, DocLinkResMap, MacroKinds};
use crate::rustc_hir::def_id::{CrateNum, DefId, DefIdMap, DefIndex, DefPathHash, StableCrateId};
use crate::rustc_hir::definitions::DefKey;
use crate::rustc_hir::lang_items::LangItem;
use crate::rustc_hir::{PreciseCapturingArgKind, attrs};
...
use crate::rustc_middle::middle::exported_symbols::{ExportedSymbol, SymbolExportInfo};
use crate::rustc_middle::middle::lib_features::FeatureStability;
...
use crate::rustc_middle::ty::{self, DeducedParamAttrs, Ty, TyCtxt, UnusedGenericParams};
use crate::rustc_middle::util::Providers;
use rustc_serialize::opaque::FileEncoder;
use crate::rustc_session::config::{SymbolManglingVersion, TargetModifier};
use crate::rustc_session::cstore::{CrateDepKind, ForeignModule, LinkagePreference, NativeLib};
use crate::rustc_span::edition::Edition;
use crate::rustc_span::hygiene::{ExpnIndex, MacroKind, SyntaxContextKey};
use crate::rustc_span::{self, ExpnData, ExpnHash, ExpnId, Ident, Span, Symbol};
