...
/* AST_META: AST_ID=1 | TYPE=FUNCTION | NAME=mock_body | COMPLEXITY=12 | LINES=61 */
...
/* AST_META: AST_ID=2 | TYPE=BLOCK | NAME=UNNAMED | COMPLEXITY=7 | LINES=13 */
...
/* AST_META: AST_ID=4 | TYPE=STRUCT | NAME=MockAnalysis | COMPLEXITY=2 | LINES=8 */
///
...
/* AST_META: AST_ID=5 | TYPE=FUNCTION | NAME=mock_entry_set | COMPLEXITY=40 | LINES=75 */
...
/* AST_META: AST_ID=6 | TYPE=FUNCTION | NAME=bottom_value | COMPLEXITY=13 | LINES=56 */
...
/* AST_META: AST_ID=8 | TYPE=FUNCTION | NAME=block | COMPLEXITY=15 | LINES=28 */
...
/* AST_META: AST_ID=9 | TYPE=FUNCTION | NAME=test_cursor | COMPLEXITY=19 | LINES=41 */
...
/* AST_META: AST_ID=10 | TYPE=FUNCTION | NAME=backward_cursor | COMPLEXITY=3 | LINES=8 */
...
/* AST_META: AST_ID=11 | TYPE=FUNCTION | NAME=forward_cursor | COMPLEXITY=3 | LINES=8 */
