// SRC: ../rust/compiler/rustc_codegen_gcc/example/dst-field-align.rs
...
/* AST_META: AST_ID=3 | TYPE=FUNCTION | NAME=get | COMPLEXITY=5 | LINES=4 */
...
/* AST_META: AST_ID=6 | TYPE=FUNCTION | NAME=main | COMPLEXITY=12 | LINES=44 */
