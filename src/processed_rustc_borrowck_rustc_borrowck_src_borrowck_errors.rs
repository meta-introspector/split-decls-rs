    ...
    pub(crate) fn cannot_borrow_across_coroutine_yield(
        ...
        if matches!(coroutine_kind, hir::CoroutineKind::Coroutine(_)) {
            ...
            let span = match capture_clause {
                crate::rustc_hir::CaptureBy::Value { move_kw } => move_kw.shrink_to_lo(),
                crate::rustc_hir::CaptureBy::Use { use_kw } => use_kw.shrink_to_lo(),
                crate::rustc_hir::CaptureBy::Ref => fn_decl_span.shrink_to_lo(),
            };
