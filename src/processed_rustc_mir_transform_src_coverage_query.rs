use crate::rustc_hir::attrs::{AttributeKind, CoverageAttrKind};
use crate::rustc_hir::find_attr;
use rustc_index::bit_set::DenseBitSet;
use crate::rustc_middle::middle::codegen_fn_attrs::CodegenFnAttrFlags;
use crate::rustc_middle::mir::coverage::{BasicCoverageBlock, CoverageIdsInfo, CoverageKind, MappingKind};
use crate::rustc_middle::mir::{Body, Statement, StatementKind};
