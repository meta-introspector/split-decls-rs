...
#[cfg(feature = "nightly")]
use crate::rustc_data_structures::stable_hasher::{HashStable, StableHasher, StableOrd};
#[cfg(feature = "nightly")]
...
impl ExternAbi {
    ...
    pub fn supports_c_variadic(self) -> CVariadicStatus {
        ...
        match self {
            ...
            Self::System { .. } => {
                CVariadicStatus::Unstable { feature: crate::rustc_span::sym::extern_system_varargs }
            }
