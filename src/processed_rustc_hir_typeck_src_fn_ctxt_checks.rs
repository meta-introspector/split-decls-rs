...
use crate::rustc_hir::{ExprKind, HirId, LangItem, Node, QPath};
...
use crate::rustc_middle::ty::{self, IsSuggestable, Ty, TyCtxt, TypeVisitableExt};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    /// ```
    fn get_expr_coercion_span(&self, expr: &hir::Expr<'_>) -> crate::rustc_span::Span {
