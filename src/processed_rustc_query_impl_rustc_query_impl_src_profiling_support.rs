// SRC: ../rust/compiler/rustc_query_impl/src/profiling_support.rs
...
/* AST_META: AST_ID=5 | TYPE=STRUCT | NAME=QueryKeyStringBuilder | COMPLEXITY=2 | LINES=6 */
...
/* AST_META: AST_ID=6 | TYPE=FUNCTION | NAME=new | COMPLEXITY=30 | LINES=73 */
...
/* AST_META: AST_ID=7 | TYPE=FUNCTION | NAME=to_self_profile_string | COMPLEXITY=2 | LINES=4 */
...
/* AST_META: AST_ID=9 | TYPE=FUNCTION | NAME=to_self_profile_string | COMPLEXITY=5 | LINES=6 */
...
/* AST_META: AST_ID=10 | TYPE=FUNCTION | NAME=spec_to_self_profile_string | COMPLEXITY=2 | LINES=5 */
...
/* AST_META: AST_ID=11 | TYPE=FUNCTION | NAME=spec_to_self_profile_string | COMPLEXITY=5 | LINES=6 */
...
/* AST_META: AST_ID=12 | TYPE=FUNCTION | NAME=spec_to_self_profile_string | COMPLEXITY=5 | LINES=6 */
...
/* AST_META: AST_ID=13 | TYPE=FUNCTION | NAME=spec_to_self_profile_string | COMPLEXITY=6 | LINES=6 */
...
/* AST_META: AST_ID=14 | TYPE=FUNCTION | NAME=spec_to_self_profile_string | COMPLEXITY=6 | LINES=6 */
...
/* AST_META: AST_ID=15 | TYPE=FUNCTION | NAME=spec_to_self_profile_string | COMPLEXITY=6 | LINES=21 */
...
/* AST_META: AST_ID=16 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=21 | LINES=68 */
...
/* AST_META: AST_ID=17 | TYPE=FUNCTION | NAME=alloc_self_profile_query_strings | COMPLEXITY=11 | LINES=22 */
