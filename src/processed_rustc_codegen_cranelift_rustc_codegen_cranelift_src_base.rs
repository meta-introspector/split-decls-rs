    ...
    profiler.generic_activity("define function").run(|| {
        ...
        match module.define_function(codegened_func.func_id, context) {
            ...
            Err(ModuleError::Compilation(CodegenError::ImplLimitExceeded)) => {
                let early_dcx = crate::rustc_session::EarlyDiagCtxt::new(
                    crate::rustc_session::config::ErrorOutputType::default(),
                );
            ...
            TerminatorKind::Assert { cond, expected, msg, target, unwind } => {
                ...
                match &**msg {
                    AssertKind::BoundsCheck { ref len, ref index } => {
                        ...
                        codegen_panic_inner(
                            fx,
                            crate::rustc_hir::LangItem::PanicBoundsCheck,
                            &[index, len, location],
                            *unwind,
                            source_info.span,
                        );
                    ...
                    AssertKind::MisalignedPointerDereference { ref required, ref found } => {
                        ...
                        codegen_panic_inner(
                            fx,
                            crate::rustc_hir::LangItem::PanicMisalignedPointerDereference,
                    ...
                    AssertKind::NullPointerDereference => {
                        ...
                        codegen_panic_inner(
                            fx,
                            crate::rustc_hir::LangItem::PanicNullPointerDereference,
                            &[location],
                            *unwind,
                            source_info.span,
                        )
                    ...
                    AssertKind::InvalidEnumConstruction(source) => {
                        ...
                        codegen_panic_inner(
                            fx,
                            crate::rustc_hir::LangItem::PanicInvalidEnumConstruction,
                            &[source, location],
                            *unwind,
                            source_info.span,
                        )
    ...
    match &stmt.kind {
        ...
        StatementKind::Intrinsic(ref intrinsic) => match &**intrinsic {
            ...
            NonDivergingIntrinsic::CopyNonOverlapping(mir::CopyNonOverlapping {
                ...
                let pointee = dst
                    .layout()
                    .pointee_info_at(fx, crate::rustc_abi::Size::ZERO)
...
pub(crate) fn codegen_panic_nounwind<'tcx>(
    ...
    codegen_panic_inner(
        fx,
        crate::rustc_hir::LangItem::PanicNounwind,
        &args,
...
fn codegen_panic_inner<'tcx>(
    fx: &mut FunctionCx<'_, '_, 'tcx>,
    lang_item: crate::rustc_hir::LangItem,
    args: &[Value],
