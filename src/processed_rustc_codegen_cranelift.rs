...
pub use rustc_codegen_cranelift::config::*;
...
mod prelude {
    ...
    pub(crate) use rustc_codegen_cranelift::abi::*;
    pub(crate) use rustc_codegen_cranelift::base::{codegen_operand, codegen_place};
    pub(crate) use rustc_codegen_cranelift::cast::*;
    pub(crate) use rustc_codegen_cranelift::common::*;
    pub(crate) use rustc_codegen_cranelift::debuginfo::{DebugContext, UnwindContext};
    pub(crate) use rustc_codegen_cranelift::pointer::Pointer;
    pub(crate) use rustc_codegen_cranelift::value_and_place::{CPlace, CValue};
}
...
impl CodegenCx {
    fn new(tcx: TyCtxt<'_>, isa: &dyn TargetIsa, debug_info: bool, cgu_name: Symbol) -> Self {
        ...
        CodegenCx {
            ...
            should_write_ir: rustc_codegen_cranelift::pretty_clif::should_write_ir(tcx),
...
fn build_isa(sess: &Session, jit: bool) -> Arc<dyn TargetIsa + 'static> {
    ...
    let target_triple = rustc_codegen_cranelift::target_triple(sess);
