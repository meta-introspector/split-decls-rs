...
fn codegen_cgu_content(
    ...
    cgu_name: crate::rustc_span::Symbol,
        ...
        match mono_item {
            MonoItem::Fn(instance) => {
                ...
                if flags.contains(CodegenFnAttrFlags::NAKED) {
                    crate::rustc_codegen_ssa::mir::naked_asm::codegen_naked_asm(
            ...
            MonoItem::GlobalAsm(item_id) => {
                crate::rustc_codegen_ssa::base::codegen_global_asm(
                    &mut GlobalAsmContext { tcx, global_asm: &mut cx.global_asm },
                    item_id,
                );
            }
...
pub(crate) fn run_aot(tcx: TyCtxt<'_>) -> Box<OngoingCodegen> {
    ...
    crate::rustc_codegen_ssa::assert_module_sources::assert_module_sources(tcx, &|cgu_reuse_tracker| {
        ...
        tcx.sess.time("codegen mono items", || {
            let modules: Vec<_> = par_map(todo_cgus, |(_, cgu)| {
                ...
                let (module, _) = tcx.dep_graph.with_task(
                    ...
                    module_codegen,
                    Some(crate::rustc_middle::dep_graph::hash_result),
                );
