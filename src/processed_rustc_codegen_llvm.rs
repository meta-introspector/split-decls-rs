...
impl WriteBackendMethods for LlvmCodegenBackend {
    ...
    type TargetMachineError = rustc_codegen_llvm::errors::LlvmError<'static>;
...
impl CodegenBackend for LlvmCodegenBackend {
    fn locale_resource(&self) -> &'static str {
        rustc_codegen_llvm::DEFAULT_LOCALE_RESOURCE
    }
...
"#
    ...
    fn link(
        ...
        use rustc_codegen_llvm::back::archive::LlvmArchiveBuilderBuilder;
