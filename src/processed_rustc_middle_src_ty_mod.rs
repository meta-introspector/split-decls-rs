...
use crate::rustc_hir::attrs::{AttributeKind, StrippedCfgItem};
...
use crate::rustc_hir::{LangItem, attrs as attr, find_attr};
...
pub use crate::rustc_session::lint::RegisteredTools;
use crate::rustc_span::hygiene::MacroKind;
use crate::rustc_span::{DUMMY_SP, ExpnId, ExpnKind, Ident, Span, Symbol, sym};
