...
use rustc_errors::emitter::TimingEvent;
...
impl DiagCtxtInner {
    ...
    fn eagerly_translate_to_string<'a>(
        ...
        let args = rustc_errors::translation::to_fluent_args(args);
        self.emitter
            .translator()
    ...
    fn flush_delayed(&mut self) {
        ...
        for bug in bugs {
            ...
            if bug.level != DelayedBug {
                ...
                let msg = rustc_errors::fluent_generated::errors_invalid_flushed_delayed_diagnostic_level;
...
impl DelayedDiagInner {
    ...
    fn decorate(self, dcx: &DiagCtxtInner) -> DiagInner {
        ...
        let msg = match self.note.status() {
            BacktraceStatus::Captured => rustc_errors::fluent_generated::errors_delayed_at_with_newline,
            // Avoid the needless newline when no backtrace has been captured,
            // the display impl should just be a single line.
            _ => rustc_errors::fluent_generated::errors_delayed_at_without_newline,
        };
