...
use crate::rustc_ast::attr::{AttributeExt, MarkedAttrs};
use crate::rustc_ast::token::MetaVarKind;
use crate::rustc_ast::tokenstream::TokenStream;
use crate::rustc_ast::visit::{AssocCtxt, Visitor};
use crate::rustc_ast::{self as ast, AttrVec, Attribute, HasAttrs, Item, NodeId, PatKind};
...
use crate::rustc_hir::attrs::{AttributeKind, CfgEntry, Deprecation};
use crate::rustc_hir::def::MacroKinds;
use crate::rustc_hir::limit::Limit;
use crate::rustc_hir::{Stability, find_attr};
use rustc_lint_defs::RegisteredTools;
use rustc_parse::MACRO_ARGUMENTS;
use rustc_parse::parser::{ForceCollect, Parser};
use crate::rustc_session::Session;
use crate::rustc_session::config::CollapseMacroDebuginfo;
use crate::rustc_session::parse::ParseSess;
use crate::rustc_span::def_id::{CrateNum, DefId, LocalDefId};
use crate::rustc_span::edition::Edition;
use crate::rustc_span::hygiene::{AstPass, ExpnData, ExpnKind, LocalExpnId, MacroKind};
use crate::rustc_span::source_map::SourceMap;
use crate::rustc_span::{DUMMY_SP, FileName, Ident, Span, Symbol, kw, sym};
