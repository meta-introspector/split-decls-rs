...
/* AST_META: AST_ID=5 | TYPE=FUNCTION | NAME=with_stable_hashing_context | COMPLEXITY=34 | LINES=73 */
...
/* AST_META: AST_ID=6 | TYPE=FUNCTION | NAME=with_deps | COMPLEXITY=5 | LINES=30 */
...
/* AST_META: AST_ID=7 | TYPE=FUNCTION | NAME=dep_context | COMPLEXITY=2 | LINES=7 */
...
/* AST_META: AST_ID=8 | TYPE=FUNCTION | NAME=dep_context | COMPLEXITY=5 | LINES=9 */
...
/* AST_META: AST_ID=9 | TYPE=FUNCTION | NAME=dep_context | COMPLEXITY=5 | LINES=9 */
...
/* AST_META: AST_ID=11 | TYPE=FUNCTION | NAME=UNNAMED | COMPLEXITY=8 | LINES=12 */
