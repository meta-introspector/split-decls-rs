...
// `crate::rustc_span::Span{Encoder,Decoder}`. That's fine outside this crate, but doesn't work inside
// this crate without this line making `rustc_span` available.

use derive_where::derive_where;
use crate::rustc_data_structures::{AtomicRef, outline};
...
use crate::rustc_data_structures::stable_hasher::HashingControls;
...
use crate::rustc_data_structures::sync::{FreezeLock, FreezeWriteGuard, Lock};
