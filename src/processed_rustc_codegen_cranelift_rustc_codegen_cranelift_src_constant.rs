...
fn data_id_for_alloc_id(
    ...
    alloc_id: AllocId,
    mutability: crate::rustc_hir::Mutability,
) -> DataId {
...
fn data_id_for_static(
    ...
    if let Some(import_linkage) = attrs.import_linkage {
        ...
        let linkage = if import_linkage == crate::rustc_hir::attrs::Linkage::ExternalWeak
            || import_linkage == crate::rustc_hir::attrs::Linkage::WeakAny
        {
            Linkage::Preemptible
        } else {
            Linkage::Import
    ...
    } else if attrs.linkage == Some(crate::rustc_hir::attrs::Linkage::ExternalWeak)
        || attrs.linkage == Some(crate::rustc_hir::attrs::Linkage::WeakAny)
    {
        Linkage::Preemptible
    } else {
        Linkage::Import
