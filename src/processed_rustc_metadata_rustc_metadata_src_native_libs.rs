...
use crate::rustc_hir::attrs::{AttributeKind, NativeLibKind, PeImportNameType};
use crate::rustc_hir::find_attr;
use crate::rustc_middle::query::LocalCrate;
use crate::rustc_middle::ty::{self, List, Ty, TyCtxt};
use crate::rustc_session::Session;
use crate::rustc_session::config::CrateType;
use crate::rustc_session::cstore::{DllCallingConvention, DllImport, ForeignModule, NativeLib};
