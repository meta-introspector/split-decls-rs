...
macro_rules! provide_one {
    ...
    ($tcx:ident, $def_id:ident, $other:ident, $cdata:ident, $name:ident => $compute:block) => {
        fn $name<'tcx>(
            $tcx: TyCtxt<'tcx>,
            def_id_arg: crate::rustc_middle::query::queries::$name::Key<'tcx>,
        ) -> crate::rustc_middle::query::queries::$name::ProvidedValue<'tcx> {
            let _prof_timer =
            ...
            let cdata = crate::rustc_data_structures::sync::FreezeReadGuard::map(CStore::from_tcx($tcx), |c| {
...
pub fn provide(providers: &mut Providers) {
    ...
    providers.queries = crate::rustc_middle::query::Providers {
