...
///
/// All queries are delegated to [`crate::rustc_public_bridge::context::CompilerCtxt`] that provides
...
impl<'tcx> CompilerInterface for Container<'tcx, BridgeTys> {
    ...
    fn foreign_item_kind(&self, def: ForeignDef) -> ForeignItemKind {
        ...
        match def_kind {
            ...
            DefKind::ForeignTy => {
                use crate::rustc_public_bridge::context::TyHelpers;
...
fn smir_crate<'tcx>(
    ...
    crate_num: crate::rustc_span::def_id::CrateNum,
) -> Crate {
