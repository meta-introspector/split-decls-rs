...
macro_rules! define_queries {
    (
        ...
        pub(crate) mod query_impl { $(pub(crate) mod $name {
                ...
                -> DynamicQuery<'tcx, queries::$name::Storage<'tcx>>
            {
                DynamicQuery {
                    ...
                    cache_on_disk: |tcx, key| ::crate::rustc_middle::query::cached::$name(tcx, key),
                    ...
                    try_load_from_disk: should_ever_cache_on_disk!([$($modifiers)*] {
                        |tcx, key, prev_index, index| {
                            if ::crate::rustc_middle::query::cached::$name(tcx, key) {
                    ...
                    loadable_from_disk: |_tcx, _key, _index| {
                        should_ever_cache_on_disk!([$($modifiers)*] {
                            ::crate::rustc_middle::query::cached::$name(_tcx, _key) &&
            ...
            pub(crate) fn try_collect_active_jobs<'tcx>(
                ...
                let make_query = |tcx, key| {
                    let kind = crate::rustc_middle::dep_graph::dep_kinds::$name;
                    let name = stringify!($name);
                    $crate::plumbing::create_query_frame(tcx, crate::rustc_middle::query::descs::$name, key, kind, name)
                };
        ...
        pub fn query_callbacks<'tcx>(arena: &'tcx Arena<'tcx>) -> &'tcx [DepKindStruct<'tcx>] {
            arena.alloc_from_iter(crate::rustc_middle::make_dep_kind_array!(query_callbacks))
        }

        pub fn dep_kind_names() -> Vec<&'static str> {
            crate::rustc_middle::make_dep_kind_name_array!(query_callbacks)
        }
    }
}