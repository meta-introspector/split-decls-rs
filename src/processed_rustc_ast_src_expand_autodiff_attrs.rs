...
use crate::{Ty, TyKind};
/* AST_META: AST_ID=4 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=8 | LINES=21 */
...
/* AST_META: AST_ID=5 | TYPE=ENUM | NAME=UNNAMED | COMPLEXITY=38 | LINES=40 */
...
/* AST_META: AST_ID=6 | TYPE=FUNCTION | NAME=is_dual_or_const | COMPLEXITY=3 | LINES=7 */
...
/* AST_META: AST_ID=7 | TYPE=STRUCT | NAME=AutoDiffItem | COMPLEXITY=4 | LINES=9 */
...
/* AST_META: AST_ID=8 | TYPE=STRUCT | NAME=AutoDiffAttrs | COMPLEXITY=8 | LINES=21 */
...
/* AST_META: AST_ID=9 | TYPE=FUNCTION | NAME=has_primal_ret | COMPLEXITY=3 | LINES=6 */
...
/* AST_META: AST_ID=10 | TYPE=FUNCTION | NAME=is_rev | COMPLEXITY=4 | LINES=9 */
...
/* AST_META: AST_ID=11 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=9 | LINES=11 */
...
/* AST_META: AST_ID=12 | TYPE=FUNCTION | NAME=valid_ret_activity | COMPLEXITY=22 | LINES=22 */
...
/* AST_META: AST_ID=13 | TYPE=FUNCTION | NAME=valid_ty_for_activity | COMPLEXITY=15 | LINES=22 */
...
/* AST_META: AST_ID=14 | TYPE=FUNCTION | NAME=valid_input_activity | COMPLEXITY=7 | LINES=11 */
...
/* AST_META: AST_ID=15 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=11 | LINES=18 */
...
/* AST_META: AST_ID=16 | TYPE=FUNCTION | NAME=from_str | COMPLEXITY=9 | LINES=14 */
...
/* AST_META: AST_ID=17 | TYPE=FUNCTION | NAME=from_str | COMPLEXITY=10 | LINES=19 */
...
/* AST_META: AST_ID=18 | TYPE=FUNCTION | NAME=has_ret_activity | COMPLEXITY=15 | LINES=41 */
...
/* AST_META: AST_ID=19 | TYPE=FUNCTION | NAME=fmt | COMPLEXITY=8 | LINES=7 */
