...
use rustc_hir_typeck::check::check_fn;
use rustc_hir_typeck::coercion::DynamicCoerceMany;
use rustc_hir_typeck::diverges::Diverges;
use rustc_hir_typeck::expectation::Expectation;
use rustc_hir_typeck::fn_ctxt::LoweredTy;
use rustc_hir_typeck::gather_locals::GatherLocalsVisitor;
