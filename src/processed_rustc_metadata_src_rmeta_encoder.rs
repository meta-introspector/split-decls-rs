...
pub(super) struct EncodeContext<'a, 'tcx> {
    ...
    tcx: TyCtxt<'tcx>,
    feat: &'tcx crate::rustc_feature::Features,
...
impl<'a, 'tcx> SpanEncoder for EncodeContext<'a, 'tcx> {
    ...
    fn encode_syntax_context(&mut self, syntax_context: SyntaxContext) {
        crate::rustc_span::hygiene::raw_encode_syntax_context(syntax_context, self.hygiene_ctxt, self);
    }
...
impl<'a, 'tcx> Encodable<EncodeContext<'a, 'tcx>> for SpanData {
    fn encode(&self, s: &mut EncodeContext<'a, 'tcx>) {
        ...
        // a proc macro (e.g. `// #[proc_macro] - removed pub fn $name`) will be lost.
        ...
        // `crate::rustc_span::hygiene::raw_encode_expn_id` to handle
...
impl<'a, 'tcx> TyEncoder<'tcx> for EncodeContext<'a, 'tcx> {
    ...
    fn encode_alloc_id(&mut self, alloc_id: &crate::rustc_middle::mir::interpret::AllocId) {
...
impl<'a, 'tcx> EncodeContext<'a, 'tcx> {
    ...
    fn encode_source_map(&mut self) -> LazyTable<u32, Option<LazyValue<crate::rustc_span::SourceFile>>> {
...
fn analyze_attr(attr: &hir::Attribute, state: &mut AnalyzeAttrState<'_>) -> bool {
        ...
        && p.encode_cross_crate() == EncodeCrossCrate::No
    {
        ...
        && !crate::rustc_feature::encode_cross_crate(name)
    {
        // Attributes not marked encode-cross-crate don't need to be encoded for downstream crates.
        ...
        should_encode = crate::rustc_feature::is_stable_diagnostic_attribute(seg, state.features);
    } else {
        should_encode = true;
    }
    should_encode
