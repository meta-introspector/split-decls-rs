// Generated macro for create_mono_items_for_vtable_methods (function)
macro_rules! Depcrate_collectorcreate_mono_items_for_vtable_methods {
() => {
// Module: crate::collector
// Provides: {"create_mono_items_for_vtable_methods"}
// Dependencies: {}
