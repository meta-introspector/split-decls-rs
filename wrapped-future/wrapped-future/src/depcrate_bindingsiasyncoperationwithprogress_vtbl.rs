// Generated macro for IAsyncOperationWithProgress_Vtbl (struct)
macro_rules! Depcrate_bindingsIAsyncOperationWithProgress_Vtbl {
() => {
// Module: crate::bindings
// Provides: {"IAsyncOperationWithProgress_Vtbl"}
// Dependencies: {}
