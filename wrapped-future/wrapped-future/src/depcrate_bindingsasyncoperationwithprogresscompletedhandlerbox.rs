// Generated macro for AsyncOperationWithProgressCompletedHandlerBox (struct)
macro_rules! Depcrate_bindingsAsyncOperationWithProgressCompletedHandlerBox {
() => {
// Module: crate::bindings
// Provides: {"AsyncOperationWithProgressCompletedHandlerBox"}
// Dependencies: {}
