// Generated macro for drop_flag_effects_for_location (function)
macro_rules! Depcrate_drop_flag_effectsdrop_flag_effects_for_location {
() => {
// Module: crate::drop_flag_effects
// Provides: {"drop_flag_effects_for_location"}
// Dependencies: {}
