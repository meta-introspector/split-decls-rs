// Generated macro for check_new_solver_banned_features (function)
macro_rules! Depcrate_feature_gatecheck_new_solver_banned_features {
() => {
// Module: crate::feature_gate
// Provides: {"check_new_solver_banned_features"}
// Dependencies: {}
