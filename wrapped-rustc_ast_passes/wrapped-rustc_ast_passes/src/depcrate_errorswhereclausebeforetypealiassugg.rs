// Generated macro for WhereClauseBeforeTypeAliasSugg (enum)
macro_rules! Depcrate_errorsWhereClauseBeforeTypeAliasSugg {
() => {
// Module: crate::errors
// Provides: {"WhereClauseBeforeTypeAliasSugg"}
// Dependencies: {}
