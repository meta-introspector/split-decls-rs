// Generated macro for AbiMustNotHaveParametersOrReturnType (struct)
macro_rules! Depcrate_errorsAbiMustNotHaveParametersOrReturnType {
() => {
// Module: crate::errors
// Provides: {"AbiMustNotHaveParametersOrReturnType"}
// Dependencies: {}
