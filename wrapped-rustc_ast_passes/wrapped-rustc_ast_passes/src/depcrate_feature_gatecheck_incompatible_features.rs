// Generated macro for check_incompatible_features (function)
macro_rules! Depcrate_feature_gatecheck_incompatible_features {
() => {
// Module: crate::feature_gate
// Provides: {"check_incompatible_features"}
// Dependencies: {}
