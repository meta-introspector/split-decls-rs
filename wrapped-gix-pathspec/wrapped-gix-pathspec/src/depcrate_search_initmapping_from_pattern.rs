// Generated macro for mapping_from_pattern (function)
macro_rules! Depcrate_search_initmapping_from_pattern {
() => {
// Module: crate::search::init
// Provides: {"mapping_from_pattern"}
// Dependencies: {}
