// Generated macro for push_closure_or_coroutine_name (function)
macro_rules! Depcrate_debuginfo_type_namespush_closure_or_coroutine_name {
() => {
// Module: crate::debuginfo::type_names
// Provides: {"push_closure_or_coroutine_name"}
// Dependencies: {}
