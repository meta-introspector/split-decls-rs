// Generated macro for needs_allocator_shim_for_linking (function)
macro_rules! Depcrate_baseneeds_allocator_shim_for_linking {
() => {
// Module: crate::base
// Provides: {"needs_allocator_shim_for_linking"}
// Dependencies: {}
