// Generated macro for get_rpath_relative_to_output (function)
macro_rules! Depcrate_back_rpathget_rpath_relative_to_output {
() => {
// Module: crate::back::rpath
// Provides: {"get_rpath_relative_to_output"}
// Dependencies: {}
