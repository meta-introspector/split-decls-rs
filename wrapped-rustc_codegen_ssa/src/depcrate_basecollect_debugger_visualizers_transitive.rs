// Generated macro for collect_debugger_visualizers_transitive (function)
macro_rules! Depcrate_basecollect_debugger_visualizers_transitive {
() => {
// Module: crate::base
// Provides: {"collect_debugger_visualizers_transitive"}
// Dependencies: {}
