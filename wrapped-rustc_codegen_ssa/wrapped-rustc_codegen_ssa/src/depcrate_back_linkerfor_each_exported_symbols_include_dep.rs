// Generated macro for for_each_exported_symbols_include_dep (function)
macro_rules! Depcrate_back_linkerfor_each_exported_symbols_include_dep {
() => {
// Module: crate::back::linker
// Provides: {"for_each_exported_symbols_include_dep"}
// Dependencies: {}
