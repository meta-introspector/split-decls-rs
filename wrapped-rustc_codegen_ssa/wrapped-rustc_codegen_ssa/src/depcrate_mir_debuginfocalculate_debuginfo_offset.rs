// Generated macro for calculate_debuginfo_offset (function)
macro_rules! Depcrate_mir_debuginfocalculate_debuginfo_offset {
() => {
// Module: crate::mir::debuginfo
// Provides: {"calculate_debuginfo_offset"}
// Dependencies: {}
