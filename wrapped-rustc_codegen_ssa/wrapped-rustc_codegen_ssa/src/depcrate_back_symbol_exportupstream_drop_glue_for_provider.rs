// Generated macro for upstream_drop_glue_for_provider (function)
macro_rules! Depcrate_back_symbol_exportupstream_drop_glue_for_provider {
() => {
// Module: crate::back::symbol_export
// Provides: {"upstream_drop_glue_for_provider"}
// Dependencies: {}
