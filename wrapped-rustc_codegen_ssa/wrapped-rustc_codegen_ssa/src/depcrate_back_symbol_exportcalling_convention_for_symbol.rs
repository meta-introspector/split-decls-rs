// Generated macro for calling_convention_for_symbol (function)
macro_rules! Depcrate_back_symbol_exportcalling_convention_for_symbol {
() => {
// Module: crate::back::symbol_export
// Provides: {"calling_convention_for_symbol"}
// Dependencies: {}
