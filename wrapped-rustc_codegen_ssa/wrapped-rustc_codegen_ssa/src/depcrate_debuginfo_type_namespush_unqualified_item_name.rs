// Generated macro for push_unqualified_item_name (function)
macro_rules! Depcrate_debuginfo_type_namespush_unqualified_item_name {
() => {
// Module: crate::debuginfo::type_names
// Provides: {"push_unqualified_item_name"}
// Dependencies: {}
