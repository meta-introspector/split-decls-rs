// Generated macro for push_generic_params_internal (function)
macro_rules! Depcrate_debuginfo_type_namespush_generic_params_internal {
() => {
// Module: crate::debuginfo::type_names
// Provides: {"push_generic_params_internal"}
// Dependencies: {}
