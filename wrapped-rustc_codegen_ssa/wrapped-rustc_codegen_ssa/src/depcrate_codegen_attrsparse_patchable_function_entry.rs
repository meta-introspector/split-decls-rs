// Generated macro for parse_patchable_function_entry (function)
macro_rules! Depcrate_codegen_attrsparse_patchable_function_entry {
() => {
// Module: crate::codegen_attrs
// Provides: {"parse_patchable_function_entry"}
// Dependencies: {}
