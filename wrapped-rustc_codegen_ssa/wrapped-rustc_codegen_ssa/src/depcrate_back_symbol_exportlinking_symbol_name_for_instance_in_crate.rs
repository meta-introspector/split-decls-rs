// Generated macro for linking_symbol_name_for_instance_in_crate (function)
macro_rules! Depcrate_back_symbol_exportlinking_symbol_name_for_instance_in_crate {
() => {
// Module: crate::back::symbol_export
// Provides: {"linking_symbol_name_for_instance_in_crate"}
// Dependencies: {}
