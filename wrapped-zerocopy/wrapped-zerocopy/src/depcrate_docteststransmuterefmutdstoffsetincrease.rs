// Generated macro for TransmuteRefMutDstOffsetIncrease (enum)
macro_rules! Depcrate_doctestsTransmuteRefMutDstOffsetIncrease {
() => {
// Module: crate::doctests
// Provides: {"TransmuteRefMutDstOffsetIncrease"}
// Dependencies: {}
