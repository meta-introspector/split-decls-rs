// Generated macro for TransmuteRefMutAlignmentIncrease (enum)
macro_rules! Depcrate_doctestsTransmuteRefMutAlignmentIncrease {
() => {
// Module: crate::doctests
// Provides: {"TransmuteRefMutAlignmentIncrease"}
// Dependencies: {}
