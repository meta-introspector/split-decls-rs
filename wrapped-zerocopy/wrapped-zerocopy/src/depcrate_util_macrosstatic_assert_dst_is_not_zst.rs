// Generated macro for static_assert_dst_is_not_zst (macro)
macro_rules! Depcrate_util_macrosstatic_assert_dst_is_not_zst {
() => {
// Module: crate::util::macros
// Provides: {"static_assert_dst_is_not_zst"}
// Dependencies: {}
