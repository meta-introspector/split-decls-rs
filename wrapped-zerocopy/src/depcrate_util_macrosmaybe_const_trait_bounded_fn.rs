// Generated macro for maybe_const_trait_bounded_fn (macro)
macro_rules! Depcrate_util_macrosmaybe_const_trait_bounded_fn {
() => {
// Module: crate::util::macros
// Provides: {"maybe_const_trait_bounded_fn"}
// Dependencies: {}
