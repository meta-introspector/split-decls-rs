// Generated macro for TransmuteRefMutDstOffsetNotMultiple (enum)
macro_rules! Depcrate_doctestsTransmuteRefMutDstOffsetNotMultiple {
() => {
// Module: crate::doctests
// Provides: {"TransmuteRefMutDstOffsetNotMultiple"}
// Dependencies: {}
