// Generated macro for version_and_date_from_rustc_version (function)
macro_rules! Depcrateversion_and_date_from_rustc_version {
() => {
// Module: crate
// Provides: {"version_and_date_from_rustc_version"}
// Dependencies: {}
