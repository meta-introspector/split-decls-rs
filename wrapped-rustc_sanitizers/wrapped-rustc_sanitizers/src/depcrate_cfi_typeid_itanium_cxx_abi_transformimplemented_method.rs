// Generated macro for implemented_method (function)
macro_rules! Depcrate_cfi_typeid_itanium_cxx_abi_transformimplemented_method {
() => {
// Module: crate::cfi::typeid::itanium_cxx_abi::transform
// Provides: {"implemented_method"}
// Dependencies: {}
