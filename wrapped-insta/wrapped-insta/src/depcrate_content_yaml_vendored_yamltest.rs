...
macro_rules! Depcrate_content_yaml_vendored_yamltest {
() => {
// Module: crate::content::yaml::vendored::yaml
// Provides: {"test"}
// Dependencies: {}
# [cfg (test)] mod test { use crate :: content :: yaml :: vendored :: yaml :: * ; use std :: f64 ; # [test] fn test_coerce () { let s = "---
a: 1
b: 2.2
c: [1, 2]
...
a6: \"double_quoted\"
a7: 你好
" . to_owned () ; let out = YamlLoader :: load_from_str (& s) . unwrap () ; let doc = & out [0] ; assert_eq ! (doc ["a7"] . as_str () . unwrap () , "你好") ; } # [test] fn test_multi_doc () { let s = "
'a scalar'
---
'a scalar'
---
'a scalar'
" ; let out = YamlLoader :: load_from_str (s) . unwrap () ; assert_eq ! (out . len () , 3) ; } # [test] fn test_bad_anchor () { let s = "
a1: &DEFAULT
    b1: 4
    b2: *DEFAULT
" ; let out = YamlLoader :: load_from_str (s) . unwrap () ; let doc = & out [0] ; assert_eq ! (doc ["a1"] ["b2"] , Yaml :: BadValue) ; } # [test] fn test_github_27 () { let s = "&a" ; let out = YamlLoader :: load_from_str (s) . unwrap () ; let doc = & out [0] ; assert_eq ! (doc . as_str () . unwrap () , "") ; } # [test] fn test_plain_datatype () { let s = "
- 'string'
- \"string\"
- string
- 123
