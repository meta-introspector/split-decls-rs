...
impl Figure {
    ...
    #[doc = " Spawns a drawing child process"]
    #[doc = ""]
    #[doc = " NOTE: stderr, stdin, and stdout are piped"]
    ...
    #[doc = " Dumps the script required to produce the figure into `sink`"]
    ...
    #[doc = " Saves the script required to produce the figure to `path`"]
