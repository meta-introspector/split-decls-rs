// Generated macro for subgraph_isomorphisms_iter (function)
macro_rules! Depcrate_algo_isomorphismsubgraph_isomorphisms_iter {
() => {
// Module: crate::algo::isomorphism
// Provides: {"subgraph_isomorphisms_iter"}
// Dependencies: {}
