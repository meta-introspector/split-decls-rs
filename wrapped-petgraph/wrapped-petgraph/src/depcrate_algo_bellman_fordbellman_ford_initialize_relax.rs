// Generated macro for bellman_ford_initialize_relax (function)
macro_rules! Depcrate_algo_bellman_fordbellman_ford_initialize_relax {
() => {
// Module: crate::algo::bellman_ford
// Provides: {"bellman_ford_initialize_relax"}
// Dependencies: {}
