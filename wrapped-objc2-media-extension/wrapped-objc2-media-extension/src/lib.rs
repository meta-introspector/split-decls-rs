...
include!("depcrate_generated__meerror.rs");
include!("depcrate_generateduse_12.rs");
include!("depcrate_generated__mevideodecoder.rs");
...
include!("depcrate_generated__meextensionplugin.rs");
...
include!("depcrate_generated__meformatreader.rs");
include!("depcrate_generated__merawprocessor.rs");
